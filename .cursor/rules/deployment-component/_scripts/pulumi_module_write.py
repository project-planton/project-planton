...
Usage examples:
  ...
  cat manifest.json | python3 .cursor/rules/deployment-component/_scripts/pulumi_module_write.py --provider aws --kindfolder awscloudfront --stdin --build

  # Or provide a manifest file without building
  python3 .cursor/rules/deployment-component/_scripts/pulumi_module_write.py --provider aws --kindfolder awscloudfront --manifest-file /tmp/manifest.json
