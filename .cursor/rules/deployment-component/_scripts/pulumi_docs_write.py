...
Usage:
  python3 .cursor/rules/deployment-component/_scripts/pulumi_docs_write.py --provider aws --kindfolder awscloudfront \
...
def base_paths(repo_root: str, provider: str, kind_folder: str) -> Tuple[str, str]:
    rel = os.path.join("apis", "org", "project_planton", "provider", provider, kind_folder, "v1", "iac", "pulumi")
