...
- Component needs updates → Use `@update-project-planton-component`
- Component has bugs → Use `@update-project-planton-component`
- Documentation needs fixing → Use `@update-project-planton-component`
- Unsure if needed → Run `@audit-project-planton-component` first
...
**Go Code:**
```go
import "org/project_planton/provider/atlas/mongodbatlas/v1"  // ⚠️ Reference found
```

**Proto Files:**
```protobuf
import "org/project_planton/provider/atlas/mongodbatlas/v1/api.proto";  // ⚠️ Reference found
```
