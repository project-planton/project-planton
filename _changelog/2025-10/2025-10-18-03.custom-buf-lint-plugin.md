...
```protobuf
// apis/ai/planton/connect/awscredential/v1/spec.proto
...
import (
	...
	"github.com/plantonhq/project-planton/buf/lint/planton/rules"
)
...
**Plugin go.mod**:
```go
module github.com/plantonhq/project-planton/buf/lint/planton
...
**File**: `apis/ai/planton/connect/awscredential/v1/spec.proto`  
**Line**: 68  
...
### Proto Fixes
- `/apis/ai/planton/connect/awscredential/v1/spec.proto` - Added `optional` to `region` field
