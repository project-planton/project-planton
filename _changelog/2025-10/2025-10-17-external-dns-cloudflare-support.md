...
**File**: `provider/kubernetes/addon/externaldnskubernetes/v1/spec.proto`
...
**File**: `provider/kubernetes/addon/externaldnskubernetes/v1/iac/pulumi/module/main.go`
...
**File**: `provider/kubernetes/addon/externaldnskubernetes/v1/iac/pulumi/module/vars.go`
...
3. **Deploy**:
   ```bash
   export EXTERNAL_DNS_MODULE=~/scm/github.com/project-planton/project-planton/pkg/provider/kubernetes/addon/externaldnskubernetes/v1/iac/pulumi
...
**File**: `provider/kubernetes/addon/externaldnskubernetes/v1/_cursor/lb-service.yaml`
...
- **Research Document**: `provider/kubernetes/addon/externaldnskubernetes/v1/_cursor/external-dns.cloudflare.research.md`
