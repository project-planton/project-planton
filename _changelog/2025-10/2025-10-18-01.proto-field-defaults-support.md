...
bazel run //:project-planton -- load-manifest \
  ~/scm/github.com/plantonhq/planton/ops/organizations/planton-cloud/infra-hub/cloud-resources/app-prod/kubernetes/addon/external-dns/external-dns.planton.cloud.yaml
```
