...
bazel run //:project-planton -- load-manifest \
  ~/scm/github.com/plantonhq/planton-cloud/ops/organizations/planton-cloud/infra-hub/cloud-resources/app-prod/kubernetes/addon/external-dns/external-dns.planton.cloud.yaml
```
