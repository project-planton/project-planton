...
**Location**: `provider/_test/testcloudresourceone/v1/`
...
**Test Resources**:
- `provider/_test/testcloudresourceone/v1/api.proto` (29 lines)
- `provider/_test/testcloudresourceone/v1/spec.proto` (32 lines)
- `provider/_test/testcloudresourceone/v1/stack_outputs.proto` (7 lines)
- `provider/_test/testcloudresourcetwo/v1/api.proto` (stub)
- `provider/_test/testcloudresourcetwo/v1/spec.proto` (stub)
- `provider/_test/testcloudresourcetwo/v1/stack_outputs.proto` (stub)
- `provider/_test/testcloudresourcethree/v1/api.proto` (stub)
- `provider/_test/testcloudresourcethree/v1/spec.proto` (stub)
- `provider/_test/testcloudresourcethree/v1/stack_outputs.proto` (stub)

**Generated Files** (via `make protos` and `make generate-cloud-resource-kind-map`):
- `provider/_test/testcloudresourceone/v1/*.pb.go` (auto-generated)
