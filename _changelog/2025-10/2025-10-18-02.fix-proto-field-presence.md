...
**Test Resources**:
- `provider/_test/testcloudresourceone/v1/spec.proto` (10 fields)

**Kubernetes Add-ons**:
- `provider/kubernetes/addon/externaldnskubernetes/v1/spec.proto` (3 fields)
- `provider/kubernetes/addon/externalsecretskubernetes/v1/spec.proto` (1 field)
- `provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto` (1 field)

**Kubernetes Workloads**:
- `provider/kubernetes/workload/temporalkubernetes/v1/spec.proto` (3 fields)
- `provider/kubernetes/workload/signozkubernetes/v1/spec.proto` (3 fields)
- `provider/kubernetes/workload/kafkakubernetes/v1/spec.proto` (2 fields)
- `provider/kubernetes/workload/cronjobkubernetes/v1/spec.proto` (7 fields)

**GCP Providers**:
- `provider/gcp/gcpgkecluster/v1/spec.proto` (2 fields)
- `provider/gcp/gcpgkenodepool/v1/spec.proto` (4 fields)
- `provider/gcp/gcpgkeclustercore/v1/spec.proto` (1 field)
- `provider/gcp/gcpvpc/v1/spec.proto` (1 field)
- `provider/gcp/gcpserviceaccount/v1/spec.proto` (1 field)
- `provider/gcp/gcpproject/v1/spec.proto` (1 field)
- `provider/gcp/gcpdnszone/v1/spec.proto` (1 field)

**Other Cloud Providers**:
- `provider/digitalocean/digitaloceandroplet/v1/spec.proto` (1 field)
- `provider/azure/azurednszone/v1/spec.proto` (1 field)
- `provider/azure/azureaksnodepool/v1/spec.proto` (1 field)
- `provider/aws/awsecsservice/v1/spec.proto` (1 field)
- `provider/aws/awsecrrepo/v1/spec.proto` (1 field)
- `provider/aws/awsec2instance/v1/spec.proto` (2 fields)
- `provider/aws/awsclientvpn/v1/spec.proto` (1 field)
- `provider/aws/awscertmanagercert/v1/spec.proto` (1 field)
