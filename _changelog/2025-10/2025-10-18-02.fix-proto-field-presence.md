...
**Kubernetes Add-ons**:
- `apis/project/planton/provider/kubernetes/addon/externaldns/v1/spec.proto` (3 fields)
- `apis/project/planton/provider/kubernetes/addon/externalsecrets/v1/spec.proto` (1 field)
- `apis/project/planton/provider/kubernetes/addon/certmanager/v1/spec.proto` (1 field)
...
```bash
cd ~/scm/github.com/plantoncloud-inc/planton-cloud/apis
