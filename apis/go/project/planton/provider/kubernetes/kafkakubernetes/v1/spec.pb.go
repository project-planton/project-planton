...
type KafkaKubernetesSpec struct {
	...
	// **Required.** The specifications for the Kafka broker containers.
	...
	// **Required.** The specifications for the Zookeeper containers.
...
type KafkaKubernetesBrokerContainer struct {
	...
	// **Required.** The number of Kafka brokers to deploy.
	// Defaults to 1 if the client sets the value to 0.
	// Recommended default value is 1.
	Replicas int32 `protobuf:"varint,1,opt,name=replicas,proto3" json:"replicas,omitempty"`
	// **Required.** The CPU and memory resources allocated to the Kafka broker containers.
	...
	// **Required.** The size of the disk to be attached to each broker instance (e.g., "30Gi").
...
type KafkaKubernetesZookeeperContainer struct {
	...
	// **Required.** The number of Zookeeper container replicas.
	...
	Replicas int32 `protobuf:"varint,1,opt,name=replicas,proto3" json:"replicas,omitempty"`
	// **Required.** The CPU and memory resources allocated to the Zookeeper containers.
	// Recommended defaults: "cpu-requests: 50m", "memory-requests: 256Mi", "cpu-limits: 1", "memory-limits: 1Gi".
	Resources *kubernetes.ContainerResources `protobuf:"bytes,2,opt,name=resources,proto3" json:"resources,omitempty"`
	// **Required.** The size of the disk to be attached to each Zookeeper instance (e.g., "30Gi").
	// A default value is set if not provided by the client.
	DiskSize string `protobuf:"bytes,3,opt,name=disk_size,json=diskSize,proto3" json:"disk_size,omitempty"`
}
...
type KafkaKubernetesSchemaRegistryContainer struct {
	...
	// **Required.** The number of Schema Registry replicas.
	// Recommended default value is "1".
	// This value has no effect if `is_enabled` is set to `false`.
	Replicas int32 `protobuf:"varint,2,opt,name=replicas,proto3" json:"replicas,omitempty"`
	// **Required.** The CPU and memory resources allocated to the Schema Registry containers.
	// Recommended defaults: "cpu-requests: 50m", "memory-requests: 256Mi", "cpu-limits: 1", "memory-limits: 1Gi".
...
func (x *KafkaTopicConfig) Reset() {
	*x = KafkaTopicConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KafkaTopicConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
var file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb1, 0x05, 0x0a,
	0x13, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73,
	0x53, 0x70, 0x65, 0x63, 0x12, 0x65, 0x0a, 0x0c, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x5f, 0x74, 0x6f,
	0x70, 0x69, 0x63, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x52, 0x0b,
	0x6b, 0x61, 0x66, 0x6b, 0x61, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x12, 0x89, 0x01, 0x0a, 0x10,
	0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x56, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	...
	0x6b, 0x61, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e,
	0x4b, 0x61, 0x66, 0x6b, 0x61, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x42,
	0x72, 0x6f, 0x6b, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x42, 0x06,
	0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0f, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x92, 0x01, 0x0a, 0x13, 0x7a, 0x6f, 0x6f, 0x6b,
	0x65, 0x65, 0x70, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x59, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e,
	...
	0x61, 0x66, 0x6b, 0x61, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5a, 0x6f,
	0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x12, 0x7a, 0x6f, 0x6f, 0x6b, 0x65, 0x65,
	0x70, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x9a, 0x01, 0x0a,
	...
	0x32, 0x5e, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x74,
	...
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52,
	...
	0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x65, 0x73, 0x73, 0x12, 0x2b, 0x0a, 0x12, 0x69, 0x73, 0x5f, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79,
	0x5f, 0x6b, 0x61, 0x66, 0x6b, 0x61, 0x5f, 0x75, 0x69, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0f, 0x69, 0x73, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x55, 0x69,
	0x22, 0xee, 0x02, 0x0a, 0x1e, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x42, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	...
	0x72, 0x63, 0x65, 0x73, 0x12, 0xca, 0x01, 0x0a, 0x09, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0xac, 0x01, 0xba, 0x48, 0xa8, 0x01, 0xba,
	...
	0x64, 0x12, 0x1a, 0x44, 0x69, 0x73, 0x6b, 0x20, 0x73, 0x69, 0x7a, 0x65, 0x20, 0x76, 0x61, 0x6c,
	...
	0x20, 0x3e, 0x20, 0x30, 0xc8, 0x01, 0x01, 0x52, 0x08, 0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a,
	0x65, 0x22, 0xf1, 0x02, 0x0a, 0x21, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x4b, 0x75, 0x62, 0x65, 0x72,
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x5a, 0x6f, 0x6f, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01,
	0x01, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x12, 0x5b, 0x0a, 0x09, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0xca, 0x01, 0x0a, 0x09, 0x64, 0x69, 0x73,
	0x6b, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0xac, 0x01, 0xba,
	...
	0x68, 0x69, 0x73, 0x29, 0x20, 0x3e, 0x20, 0x30, 0xc8, 0x01, 0x01, 0x52, 0x08, 0x64, 0x69, 0x73,
	0x6b, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xc8, 0x01, 0x0a, 0x26, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x4b,
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	...
	0x63, 0x61, 0x73, 0x12, 0x5b, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	...
	0x22, 0xcd, 0x05, 0x0a, 0x0a, 0x4b, 0x61, 0x66, 0x6b, 0x61, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12,
	...
	0x73, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x18, 0x03, 0x20,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0xc3, 0x03, 0x0a, 0x3a, 0x63,
...
var file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_goTypes = []any{
	...
	(*KafkaTopicConfig)(nil),                       // 5: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopicConfig
	nil,                                            // 6: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopic.ConfigEntry
	nil,                                            // 7: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopicConfig.ValueEntry
...
var file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_depIdxs = []int32{
	...
	8,  // 4: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaKubernetesSpec.ingress:type_name -> project.planton.shared.kubernetes.IngressSpec
	9,  // 5: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaKubernetesBrokerContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	9,  // 6: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	9,  // 7: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	6,  // 8: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopic.config:type_name -> project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopic.ConfigEntry
	7,  // 9: project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopicConfig.value:type_name -> project.planton.provider.kubernetes.kafkakubernetes.v1.KafkaTopicConfig.ValueEntry
...
func file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_project_planton_provider_kubernetes_kafkakubernetes_v1_spec_proto_msgTypes[5].Exporter = func(v any, i int) any {
