...
func (x *Probe) Reset() {
	*x = Probe{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[0]
...
func (*Probe) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{0}
}
...
func (x *HTTPGetAction) Reset() {
	*x = HTTPGetAction{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPGetAction) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{1}
}
...
func (x *HTTPHeader) Reset() {
	*x = HTTPHeader{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HTTPHeader) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{2}
}
...
func (x *GRPCAction) Reset() {
	*x = GRPCAction{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GRPCAction) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{3}
}
...
func (x *TCPSocketAction) Reset() {
	*x = TCPSocketAction{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TCPSocketAction) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{4}
}
...
func (x *ExecAction) Reset() {
	*x = ExecAction{}
	mi := &file_project_planton_shared_kubernetes_probe_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExecAction) Descriptor() ([]byte, []int) {
	return file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP(), []int{5}
}
...
var File_project_planton_shared_kubernetes_probe_proto protoreflect.FileDescriptor

const file_project_planton_shared_kubernetes_probe_proto_rawDesc = "" +
	"\n" +
	"-project/planton/shared/kubernetes/probe.proto\x12!project.planton.shared.kubernetes\x1a\x1bbuf/validate/validate.proto\"\x9e\x04\n" +
	"\x05Probe\x122\n" +
	...
	"\x11failure_threshold\x18\x05 \x01(\x05R\x10failureThreshold\x12M\n" +
	"\bhttp_get\x18\x06 \x01(\v20.project.planton.shared.kubernetes.HTTPGetActionH\x00R\ahttpGet\x12C\n" +
	"\x04grpc\x18\a \x01(\v2-.project.planton.shared.kubernetes.GRPCActionH\x00R\x04grpc\x12S\n" +
	"\n" +
	"tcp_socket\x18\b \x01(\v22.project.planton.shared.kubernetes.TCPSocketActionH\x00R\ttcpSocket\x12C\n" +
	"\x04exec\x18\t \x01(\v2-.project.planton.shared.kubernetes.ExecActionH\x00R\x04execB\t\n" +
	"\ahandler\"\xeb\x01\n" +
	...
	"\fhttp_headers\x18\x06 \x03(\v2-.project.planton.shared.kubernetes.HTTPHeaderR\vhttpHeadersB\x06\n" +
	"\x04port\"6\n" +
	"\n" +
	"HTTPHeader\x12\x12\n" +
	...
	"\n" +
	"ExecAction\x12\x18\n" +
	"\acommand\x18\x01 \x03(\tR\acommandB\xae\x02\n" +
	"%com.project.planton.shared.kubernetesB\n" +
	"ProbeProtoP\x01ZQgithub.com/project-planton/project-planton/apis/project/planton/shared/kubernetes\xa2\x02\x04PPSK\xaa\x02!Project.Planton.Shared.Kubernetes\xca\x02!Project\\Planton\\Shared\\Kubernetes\xe2\x02-Project\\Planton\\Shared\\Kubernetes\\GPBMetadata\xea\x02$Project::Planton::Shared::Kubernetesb\x06proto3"

var (
	file_project_planton_shared_kubernetes_probe_proto_rawDescOnce sync.Once
	file_project_planton_shared_kubernetes_probe_proto_rawDescData []byte
)

func file_project_planton_shared_kubernetes_probe_proto_rawDescGZIP() []byte {
	file_project_planton_shared_kubernetes_probe_proto_rawDescOnce.Do(func() {
		file_project_planton_shared_kubernetes_probe_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_shared_kubernetes_probe_proto_rawDesc), len(file_project_planton_shared_kubernetes_probe_proto_rawDesc)))
	})
	return file_project_planton_shared_kubernetes_probe_proto_rawDescData
}

var file_project_planton_shared_kubernetes_probe_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_project_planton_shared_kubernetes_probe_proto_goTypes = []any{
	(*Probe)(nil),           // 0: project.planton.shared.kubernetes.Probe
	(*HTTPGetAction)(nil),   // 1: project.planton.shared.kubernetes.HTTPGetAction
	(*HTTPHeader)(nil),      // 2: project.planton.shared.kubernetes.HTTPHeader
	(*GRPCAction)(nil),      // 3: project.planton.shared.kubernetes.GRPCAction
	(*TCPSocketAction)(nil), // 4: project.planton.shared.kubernetes.TCPSocketAction
	(*ExecAction)(nil),      // 5: project.planton.shared.kubernetes.ExecAction
}
var file_project_planton_shared_kubernetes_probe_proto_depIdxs = []int32{
	1, // 0: project.planton.shared.kubernetes.Probe.http_get:type_name -> project.planton.shared.kubernetes.HTTPGetAction
	3, // 1: project.planton.shared.kubernetes.Probe.grpc:type_name -> project.planton.shared.kubernetes.GRPCAction
	4, // 2: project.planton.shared.kubernetes.Probe.tcp_socket:type_name -> project.planton.shared.kubernetes.TCPSocketAction
	5, // 3: project.planton.shared.kubernetes.Probe.exec:type_name -> project.planton.shared.kubernetes.ExecAction
	2, // 4: project.planton.shared.kubernetes.HTTPGetAction.http_headers:type_name -> project.planton.shared.kubernetes.HTTPHeader
...
func init() { file_project_planton_shared_kubernetes_probe_proto_init() }
func file_project_planton_shared_kubernetes_probe_proto_init() {
	if File_project_planton_shared_kubernetes_probe_proto != nil {
		return
	}
	file_project_planton_shared_kubernetes_probe_proto_msgTypes[0].OneofWrappers = []any{
		(*Probe_HttpGet)(nil),
		(*Probe_Grpc)(nil),
		(*Probe_TcpSocket)(nil),
		(*Probe_Exec)(nil),
	}
	file_project_planton_shared_kubernetes_probe_proto_msgTypes[1].OneofWrappers = []any{
		(*HTTPGetAction_PortNumber)(nil),
		(*HTTPGetAction_PortName)(nil),
	}
	file_project_planton_shared_kubernetes_probe_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_shared_kubernetes_probe_proto_rawDesc), len(file_project_planton_shared_kubernetes_probe_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_shared_kubernetes_probe_proto_goTypes,
		DependencyIndexes: file_project_planton_shared_kubernetes_probe_proto_depIdxs,
		MessageInfos:      file_project_planton_shared_kubernetes_probe_proto_msgTypes,
	}.Build()
	File_project_planton_shared_kubernetes_probe_proto = out.File
	file_project_planton_shared_kubernetes_probe_proto_goTypes = nil
	file_project_planton_shared_kubernetes_probe_proto_depIdxs = nil
}
