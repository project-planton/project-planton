		...
		input := &AwsCloudFront{
			...
			Spec: &AwsCloudFrontSpec{
				DefaultCacheBehavior: &AwsCloudFrontSpec_DefaultCacheBehavior{
					OriginId:             "origin-1",
					ViewerProtocolPolicy: AwsCloudFrontSpec_DefaultCacheBehavior_REDIRECT_TO_HTTPS,
				},
				Origins: []*AwsCloudFrontSpec_Origin{{Id: "origin-1", DomainName: "example.s3.amazonaws.com"}},
			},
		}
