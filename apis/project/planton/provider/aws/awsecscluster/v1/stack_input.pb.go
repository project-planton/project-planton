...
const file_project_planton_provider_aws_awsecscluster_v1_stack_input_proto_rawDesc = "" +
	"\n" +
	"?project/planton/provider/aws/awsecscluster/v1/stack_input.proto\x12-project.planton.provider.aws.awsecscluster.v1\x1a7project/planton/provider/aws/awsecscluster/v1/api.proto\x1a+project/planton/provider/aws/provider.proto\"\xc9\x01\n" +
