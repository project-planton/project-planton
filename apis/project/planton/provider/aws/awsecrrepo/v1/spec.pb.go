...
type AwsEcrRepoSpec struct {
	...
	// scanOnPush enables or disables basic vulnerability scanning for images
	// when they are pushed to this ECR repository. Recommended default is true.
	ScanOnPush bool `protobuf:"varint,3,opt,name=scan_on_push,json=scanOnPush,proto3" json:"scan_on_push,omitempty"`
	...
	EncryptionType EncryptionType `protobuf:"varint,4,opt,name=encryption_type,json=encryptionType,proto3,enum=project.planton.provider.aws.awsecrrepo.v1.EncryptionType" json:"encryption_type,omitempty"`
	...
	// lifecyclePolicy is an optional JSON string that defines how old or untagged
	// images are pruned. If not provided, no lifecycle rules are enforced by default.
	// Example: a policy that retains only the last N images or deletes untagged
	// images older than X days.
	LifecyclePolicy string `protobuf:"bytes,6,opt,name=lifecycle_policy,json=lifecyclePolicy,proto3" json:"lifecycle_policy,omitempty"`
	// repositoryPolicy is an optional JSON policy document granting cross-account
	// or external access to this repository. If omitted, IAM roles within the same
	// AWS account typically handle push/pull permissions.
	RepositoryPolicy string `protobuf:"bytes,7,opt,name=repository_policy,json=repositoryPolicy,proto3" json:"repository_policy,omitempty"`
...
func (x *AwsEcrRepoSpec) GetLifecyclePolicy() string {
	if x != nil {
...
func (x *AwsEcrRepoSpec) GetRepositoryPolicy() string {
	if x != nil {
...
var file_project_planton_provider_aws_awsecrrepo_v1_spec_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x0e, 0x41, 0x77, 0x73, 0x45, 0x63, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x53, 0x70, 0x65,
	...
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x42, 0x0d, 0x8a, 0xa6, 0x1d, 0x09, 0x69, 0x6d, 0x6d,
	0x75, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x12, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x54, 0x61, 0x67,
	0x4d, 0x75, 0x74, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x2a, 0x0a, 0x0c, 0x73, 0x63,
	0x61, 0x6e, 0x5f, 0x6f, 0x6e, 0x5f, 0x70, 0x75, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	0x42, 0x08, 0x8a, 0xa6, 0x1d, 0x04, 0x74, 0x72, 0x75, 0x65, 0x52, 0x0a, 0x73, 0x63, 0x61, 0x6e,
	0x4f, 0x6e, 0x50, 0x75, 0x73, 0x68, 0x12, 0x6f, 0x0a, 0x0f, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70,
	...
	,
	...
	0x2e, 0x61, 0x77, 0x73, 0x65, 0x63, 0x72, 0x72, 0x65, 0x70, 0x6f, 0x2e, 0x76, 0x31, 0x42, 0x09,
	0x53, 0x70, 0x65, 0x63, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x67, 0x67, 0x69, 0x74,
