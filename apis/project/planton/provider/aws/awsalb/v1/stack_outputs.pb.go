...
type AwsAlbStackOutputs struct {
	...
	// security_group_id is the ID of the security group associated to the ALB (if created by the module).
...
func (x *AwsAlbStackOutputs) GetSecurityGroupId() string {
	if x != nil {
...
const file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	":project/planton/provider/aws/awsalb/v1/stack_outputs.proto\x12&project.planton.provider.aws.awsalb.v1\"\x8f\x02\n" +
	...
	"\x1cload_balancer_hosted_zone_id\x18\x04 \x01(\tR\x18loadBalancerHostedZoneId\x12*\n" +
	"\x11security_group_id\x18\x05 \x01(\tR\x0fsecurityGroupIdB\xdf\x02\n" +
...
var (
	...
	file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDescData []byte
)
...
func file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDesc)))
	})
...
func file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_aws_awsalb_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
