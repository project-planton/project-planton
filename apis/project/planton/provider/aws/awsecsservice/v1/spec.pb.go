...
const file_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDesc = "" +
	...
	"\x03alb\x18\x05 \x01(\v2?.project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceAlbR\x03alb\"\xc7\x02\n" +
	...
	"\x03tag\x18\x02 \x01(\tR\x03tag\"\xfd\x02\n" +
	...
	"\asecrets\x18\x02 \x03(\v2U.project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntryR\asecrets\x1a<\n" +
