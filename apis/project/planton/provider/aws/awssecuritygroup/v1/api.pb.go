...
type AwsSecurityGroupStatus struct {
	...
	// stack-outputs
	StackOutputs *AwsSecurityGroupStackOutputs `protobuf:"bytes,1,opt,name=stack_outputs,json=stackOutputs,proto3" json:"stack_outputs,omitempty"`
}
...
func (x *AwsSecurityGroupStatus) GetStackOutputs() *AwsSecurityGroupStackOutputs {
	if x != nil {
...
var file_project_planton_provider_aws_awssecuritygroup_v1_api_proto_rawDesc = []byte{
	...
	0x22, 0xbb, 0x02, 0x0a, 0x16, 0x41, 0x77, 0x73, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79,
	...
	0x72, 0x6f, 0x75, 0x70, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73,
	...
	0x61, 0x77, 0x73, 0x2e, 0x61, 0x77, 0x73, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x41, 0x70, 0x69, 0x50, 0x72, 0x6f, 0x74,
...
var file_project_planton_provider_aws_awssecuritygroup_v1_api_proto_depIdxs = []int32{
	...
	6, // 5: project.planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupStatus.stack_outputs:type_name -> project.planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupStackOutputs
