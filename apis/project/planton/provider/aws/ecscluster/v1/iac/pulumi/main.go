...
import (
	...
	"github.com/project-planton/project-planton/apis/project/planton/provider/aws/ecscluster/v1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &ecsclusterv1.EcsClusterStackInput{}
