...
const file_project_planton_provider_civo_civoipaddress_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9project/planton/provider/civo/civoipaddress/v1/spec.proto\x12.project.planton.provider.civo.civoipaddress.v1\x1a\x1bbuf/validate/validate.proto\x1a*project/planton/provider/civo/region.proto\"\x89\x01\n" +
