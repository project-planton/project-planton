...
const file_project_planton_provider_civo_civovolume_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6project/planton/provider/civo/civovolume/v1/spec.proto\x12+project.planton.provider.civo.civovolume.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\x10\n" +
	"\x0eCivoVolumeSpecB\xf9\x02\n" +
...
var file_project_planton_provider_civo_civovolume_v1_spec_proto_goTypes = []any{
	(*CivoVolumeSpec)(nil), // 0: project.planton.provider.civo.civovolume.v1.CivoVolumeSpec
}
