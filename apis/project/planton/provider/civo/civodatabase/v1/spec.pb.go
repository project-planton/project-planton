...
const file_project_planton_provider_civo_civodatabase_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8project/planton/provider/civo/civodatabase/v1/spec.proto\x12-project.planton.provider.civo.civodatabase.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\x12\n" +
	"\x10CivoDatabaseSpecB\x87\x03\n" +
...
var file_project_planton_provider_civo_civodatabase_v1_spec_proto_goTypes = []any{
	(*CivoDatabaseSpec)(nil), // 0: project.planton.provider.civo.civodatabase.v1.CivoDatabaseSpec
}
