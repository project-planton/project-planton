...
const file_project_planton_provider_civo_civobucket_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6project/planton/provider/civo/civobucket/v1/spec.proto\x12+project.planton.provider.civo.civobucket.v1\x1a\x1bbuf/validate/validate.proto\x1a*project/planton/provider/civo/region.proto\"\xf8\x01\n" +
