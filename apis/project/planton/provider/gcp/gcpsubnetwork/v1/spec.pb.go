...
const file_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8project/planton/provider/gcp/gcpsubnetwork/v1/spec.proto\x12-project.planton.provider.gcp.gcpsubnetwork.v1\x1a\x1bbuf/validate/validate.proto\x1a6project/planton/shared/foreignkey/v1/foreign_key.proto\"\xdf\x04\n" +
