...
var (
	...
	file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDescData []byte
)
...
func file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDescGZIP() []byte {
	file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDesc), len(file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDesc)))
	})
...
func file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDesc), len(file_project_planton_provider_gcp_gcpartifactregistryrepo_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
