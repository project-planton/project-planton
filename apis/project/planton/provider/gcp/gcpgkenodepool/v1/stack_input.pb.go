...
func (x *GcpGkeNodePoolStackInput) GetProvisioner() shared.IacProvisioner {
	if x != nil {
...
func (x *GcpGkeNodePoolStackInput) GetPulumi() *pulumi.PulumiStackInfo {
	if x != nil {
		return x.Pulumi
	}
	return nil
...
func (x *GcpGkeNodePoolStackInput) GetTerraform() *terraform.TerraformStackInfo {
	if x != nil {
		return x.Terraform
	}
	return nil
