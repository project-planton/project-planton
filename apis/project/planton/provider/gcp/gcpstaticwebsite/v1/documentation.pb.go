...
// 	protoc        (unknown)
// source: project/planton/provider/gcp/gcpstaticwebsite/v1/documentation.proto
...
var File_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto protoreflect.FileDescriptor

var file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_rawDesc = []byte{
...
var file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_goTypes = []any{}
var file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_init() }
func file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_init() {
	if File_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_depIdxs,
	}.Build()
	File_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto = out.File
	file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_rawDesc = nil
	file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_goTypes = nil
	file_project_planton_provider_gcp_gcpstaticwebsite_v1_documentation_proto_depIdxs = nil
}
