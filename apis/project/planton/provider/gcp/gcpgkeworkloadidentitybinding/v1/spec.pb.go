...
const file_project_planton_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Hproject/planton/provider/gcp/gcpgkeworkloadidentitybinding/v1/spec.proto\x12=project.planton.provider.gcp.gcpgkeworkloadidentitybinding.v1\x1a\x1bbuf/validate/validate.proto\x1a6project/planton/shared/foreignkey/v1/foreign_key.proto\"\x86\x03\n" +
