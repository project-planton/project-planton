...
var file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_input_proto_depIdxs = []int32{
	...
	2, // 1: project.planton.provider.digitalocean.digitaloceandnszone.v1.DigitalOceanDnsZoneStackInput.provider_credential:type_name -> project.planton.credential.digitaloceancredential.v1.DigitalOceanCredentialSpec
