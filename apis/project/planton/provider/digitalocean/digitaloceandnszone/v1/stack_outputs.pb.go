...
var (
	file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescData []byte
)

func file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDesc)))
	})
	return file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDescData
}
...
func file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_init() {
	if File_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto = out.File
	file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_goTypes = nil
	file_project_planton_provider_digitalocean_digitaloceandnszone_v1_stack_outputs_proto_depIdxs = nil
}
