...
func (x *DigitalOceanDropletSpec) Reset() {
	*x = DigitalOceanDropletSpec{}
	mi := &file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_msgTypes[0]
...
var File_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto protoreflect.FileDescriptor
...
const file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDesc = "" +
	...
	"\x03vpc\x18\x06 \x01(\v26.project.planton.shared.foreignkey.v1.StringValueOrRefB$\xbaH\x03\xc8\x01\x01\x88\xd4a\xb1\t\x92\xd4a\x15status.outputs.vpc_idR\x03vpc\x12\x1f\n" +
	...
	"\n" +
	"volume_ids\x18\n" +
	" \x03(\v26.project.planton.shared.foreignkey.v1.StringValueOrRefB!\x88\xd4a\xb6\t\x92\xd4a\x18status.outputs.volume_idR\tvolumeIds\x12\x1c\n" +
	...
	"@com.project.planton.provider.digitalocean.digitaloceandroplet.v1B\tSpecProtoP\x01Z\x82\x01github.com/project-planton/project-planton/apis/project/planton/provider/digitalocean/digitaloceandroplet/v1;digitaloceandropletv1\xa2\x02\x05PPPDD\xaa\x02<Project.Planton.Provider.Digitalocean.Digitaloceandroplet.V1\xca\x02<Project\\Planton\\Provider\\Digitalocean\\Digitaloceandroplet\\V1\xe2\x02HProject\\Planton\\Provider\\Digitalocean\\Digitaloceandroplet\\V1\\GPBMetadata\xea\x02AProject::Planton::Provider::Digitalocean::Digitaloceandroplet::V1b\x06proto3"

var (
	file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDesc), len(file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_depIdxs,
		EnumInfos:         file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_enumTypes,
		MessageInfos:      file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto = out.File
	file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_goTypes = nil
	file_project_planton_provider_digitalocean_digitaloceandroplet_v1_spec_proto_depIdxs = nil
}
