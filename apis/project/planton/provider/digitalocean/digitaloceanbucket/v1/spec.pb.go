...
type DigitalOceanBucketSize int32

const (
	DigitalOceanBucketSize_digital_ocean_bucket_size_unspecified DigitalOceanBucketSize = 0
	DigitalOceanBucketSize_s_2vcpu_4gb                           DigitalOceanBucketSize = 1 // basic: 2 vCPUs, 4 GB RAM
	DigitalOceanBucketSize_s_4vcpu_8gb                           DigitalOceanBucketSize = 2 // basic: 4 vCPUs, 8 GB RAM
	DigitalOceanBucketSize_g_2vcpu_8gb                           DigitalOceanBucketSize = 3 // general purpose: 2 vCPUs (dedicated), 8 GB RAM
	DigitalOceanBucketSize_g_4vcpu_16gb                          DigitalOceanBucketSize = 4 // general purpose: 4 vCPUs (dedicated), 16 GB RAM
)

// Enum value maps for DigitalOceanBucketSize.
var (
	DigitalOceanBucketSize_name = map[int32]string{
		0: "digital_ocean_bucket_size_unspecified",
		1: "s_2vcpu_4gb",
		2: "s_4vcpu_8gb",
		3: "g_2vcpu_8gb",
		4: "g_4vcpu_16gb",
	}
	DigitalOceanBucketSize_value = map[string]int32{
		"digital_ocean_bucket_size_unspecified": 0,
		"s_2vcpu_4gb":                           1,
		"s_4vcpu_8gb":                           2,
		"g_2vcpu_8gb":                           3,
		"g_4vcpu_16gb":                          4,
...
func (x DigitalOceanBucketSize) Enum() *DigitalOceanBucketSize {
	p := new(DigitalOceanBucketSize)
	*p = x
	return p
}

func (x DigitalOceanBucketSize) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DigitalOceanBucketSize) Descriptor() protoreflect.EnumDescriptor {
	return file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanBucketSize) Type() protoreflect.EnumType {
	return &file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_enumTypes[0]
}

func (x DigitalOceanBucketSize) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DigitalOceanBucketSize.Descriptor instead.
func (DigitalOceanBucketSize) EnumDescriptor() ([]byte, []int) {
...
type DigitalOceanBucketTimezone int32

const (
	DigitalOceanBucketTimezone_utc   DigitalOceanBucketTimezone = 0 // coordinated universal time
	DigitalOceanBucketTimezone_local DigitalOceanBucketTimezone = 1 // local timezone
)

// Enum value maps for DigitalOceanBucketTimezone.
var (
	DigitalOceanBucketTimezone_name = map[int32]string{
		0: "utc",
		1: "local",
	}
	DigitalOceanBucketTimezone_value = map[string]int32{
		"utc":   0,
		"local": 1,
	}
)

func (x DigitalOceanBucketTimezone) Enum() *DigitalOceanBucketTimezone {
	p := new(DigitalOceanBucketTimezone)
	*p = x
	return p
}

func (x DigitalOceanBucketTimezone) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DigitalOceanBucketTimezone) Descriptor() protoreflect.EnumDescriptor {
	return file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_enumTypes[1].Descriptor()
}

func (DigitalOceanBucketTimezone) Type() protoreflect.EnumType {
	return &file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_enumTypes[1]
}

func (x DigitalOceanBucketTimezone) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DigitalOceanBucketTimezone.Descriptor instead.
func (DigitalOceanBucketTimezone) EnumDescriptor() ([]byte, []int) {
	return file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_rawDescGZIP(), []int{1}
}

// DigitalOceanBucketSpec defines the user configuration for a DigitalOcean Droplet (VM).
type DigitalOceanBucketSpec struct {
	...
	Size DigitalOceanBucketSize `protobuf:"varint,3,opt,name=size,proto3,enum=project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSize" json:"size,omitempty"`
	...
	Timezone      DigitalOceanBucketTimezone `protobuf:"varint,13,opt,name=timezone,proto3,enum=project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketTimezone" json:"timezone,omitempty"`
...
func (x *DigitalOceanBucketSpec) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DigitalOceanBucketSpec) GetSize() DigitalOceanBucketSize {
	if x != nil {
		return x.Size
	}
	return DigitalOceanBucketSize_digital_ocean_bucket_size_unspecified
}

func (x *DigitalOceanBucketSpec) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
func (x *DigitalOceanBucketSpec) GetVpc() *v1.StringValueOrRef {
	if x != nil {
		return x.Vpc
	}
	return nil
...
func (x *DigitalOceanBucketSpec) GetEnableIpv6() bool {
	if x != nil {
		return x.EnableIpv6
	}
	return false
...
func (x *DigitalOceanBucketSpec) GetEnableBackups() bool {
	if x != nil {
...
func (x *DigitalOceanBucketSpec) GetDisableMonitoring() bool {
	if x != nil {
...
func (x *DigitalOceanBucketSpec) GetVolumeIds() []*v1.StringValueOrRef {
	if x != nil {
		return x.VolumeIds
	}
	return nil
...
func (x *DigitalOceanBucketSpec) GetUserData() string {
	if x != nil {
		return x.UserData
	}
	return ""
...
func (x *DigitalOceanBucketSpec) GetTimezone() DigitalOceanBucketTimezone {
	if x != nil {
		return x.Timezone
	}
	return DigitalOceanBucketTimezone_utc
}
...
const file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fproject/planton/provider/digitalocean/digitaloceanbucket/v1/spec.proto\x12;project.planton.provider.digitalocean.digitaloceanbucket.v1\x1a\x1bbuf/validate/validate.proto\x1a6project/planton/shared/foreignkey/v1/foreign_key.proto\x1a,project/planton/shared/options/options.proto\x1a2project/planton/provider/digitalocean/region.proto\"\xdc\b\n" +
	"\x16DigitalOceanBucketSpec\x12?\n" +
	...
	"\x04size\x18\x03 \x01(\x0e2S.project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSizeB\x06\xbaH\x03\xc8\x01\x01R\x04size\x12?\n" +
	...
	"\btimezone\x18\r \x01(\x0e2W.project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketTimezoneB\a\x8a\xa6\x1d\x03UTCR\btimezone:\xce\x01\xbaH\xca\x01\x1a\xc7\x01\n" +
	...
	"\x16DigitalOceanBucketSize\x12)\n" +
	"%digital_ocean_bucket_size_unspecified\x10\x00\x12\x0f\n" +
	"\vs_2vcpu_4gb\x10\x01\x12\x0f\n" +
	"\vs_4vcpu_8gb\x10\x02\x12\x0f\n" +
	"\vg_2vcpu_8gb\x10\x03\x12\x10\n" +
	"\fg_4vcpu_16gb\x10\x04*0\n" +
	"\x1aDigitalOceanBucketTimezone\x12\a\n" +
	"\x03utc\x10\x00\x12\t\n" +
...
var file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_goTypes = []any{
	(DigitalOceanBucketSize)(0),          // 0: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSize
	(DigitalOceanBucketTimezone)(0),      // 1: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketTimezone
	(*DigitalOceanBucketSpec)(nil),       // 2: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec
...
var file_project_planton_provider_digitalocean_digitaloceanbucket_v1_spec_proto_depIdxs = []int32{
	3, // 0: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec.region:type_name -> project.planton.provider.digitalocean.DigitalOceanRegion
	0, // 1: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec.size:type_name -> project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSize
	4, // 2: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec.vpc:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	4, // 3: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec.volume_ids:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	1, // 4: project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketSpec.timezone:type_name -> project.planton.provider.digitalocean.digitaloceanbucket.v1.DigitalOceanBucketTimezone
