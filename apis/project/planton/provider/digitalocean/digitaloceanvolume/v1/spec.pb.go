...
func (x *DigitalOceanVolumeSpec) Reset() {
	*x = DigitalOceanVolumeSpec{}
	mi := &file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_msgTypes[0]
...
const file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fproject/planton/provider/digitalocean/digitaloceanvolume/v1/spec.proto\x12;project.planton.provider.digitalocean.digitaloceanvolume.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/provider/digitalocean/region.proto\"\xf6\x03\n" +
...
var (
	file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDesc), len(file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_init() {
	if File_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_depIdxs,
		EnumInfos:         file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_enumTypes,
		MessageInfos:      file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto = out.File
	file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_goTypes = nil
	file_project_planton_provider_digitalocean_digitaloceanvolume_v1_spec_proto_depIdxs = nil
}
