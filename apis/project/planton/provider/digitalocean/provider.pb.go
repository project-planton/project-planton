...
// 	protoc        (unknown)
// source: project/planton/provider/digitalocean/provider.proto
...
type DigitalOceanProviderConfig struct {
	...
	DefaultRegion DigitalOceanRegion `protobuf:"varint,2,opt,name=default_region,json=defaultRegion,proto3,enum=project.planton.provider.digitalocean.DigitalOceanRegion" json:"default_region,omitempty"`
...
func (x *DigitalOceanProviderConfig) Reset() {
	*x = DigitalOceanProviderConfig{}
	mi := &file_project_planton_provider_digitalocean_provider_proto_msgTypes[0]
...
func (*DigitalOceanProviderConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_digitalocean_provider_proto_rawDescGZIP(), []int{0}
}
...
var File_project_planton_provider_digitalocean_provider_proto protoreflect.FileDescriptor

const file_project_planton_provider_digitalocean_provider_proto_rawDesc = "" +
	"\n" +
	"4project/planton/provider/digitalocean/provider.proto\x12%project.planton.provider.digitalocean\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/provider/digitalocean/region.proto\"\x81\x02\n" +
	...
	"\x11spaces_secret_key\x18\x04 \x01(\tR\x0fspacesSecretKeyB\xc9\x02\n" +
	")com.project.planton.provider.digitaloceanB\rProviderProtoP\x01ZUgithub.com/project-planton/project-planton/apis/project/planton/provider/digitalocean\xa2\x02\x04PPPD\xaa\x02%Project.Planton.Provider.Digitalocean\xca\x02%Project\\Planton\\Provider\\Digitalocean\xe2\x021Project\\Planton\\Provider\\Digitalocean\\GPBMetadata\xea\x02(Project::Planton::Provider::Digitaloceanb\x06proto3"

var (
	file_project_planton_provider_digitalocean_provider_proto_rawDescOnce sync.Once
	file_project_planton_provider_digitalocean_provider_proto_rawDescData []byte
)

func file_project_planton_provider_digitalocean_provider_proto_rawDescGZIP() []byte {
	file_project_planton_provider_digitalocean_provider_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_digitalocean_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_provider_proto_rawDesc), len(file_project_planton_provider_digitalocean_provider_proto_rawDesc)))
	})
	return file_project_planton_provider_digitalocean_provider_proto_rawDescData
}

var file_project_planton_provider_digitalocean_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_project_planton_provider_digitalocean_provider_proto_goTypes = []any{
	(*DigitalOceanProviderConfig)(nil), // 0: project.planton.provider.digitalocean.DigitalOceanProviderConfig
	(DigitalOceanRegion)(0),            // 1: project.planton.provider.digitalocean.DigitalOceanRegion
}
var file_project_planton_provider_digitalocean_provider_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.digitalocean.DigitalOceanProviderConfig.default_region:type_name -> project.planton.provider.digitalocean.DigitalOceanRegion
...
func init() { file_project_planton_provider_digitalocean_provider_proto_init() }
func file_project_planton_provider_digitalocean_provider_proto_init() {
	if File_project_planton_provider_digitalocean_provider_proto != nil {
		return
	}
	file_project_planton_provider_digitalocean_region_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_digitalocean_provider_proto_rawDesc), len(file_project_planton_provider_digitalocean_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_digitalocean_provider_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_digitalocean_provider_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_digitalocean_provider_proto_msgTypes,
	}.Build()
	File_project_planton_provider_digitalocean_provider_proto = out.File
	file_project_planton_provider_digitalocean_provider_proto_goTypes = nil
	file_project_planton_provider_digitalocean_provider_proto_depIdxs = nil
}
