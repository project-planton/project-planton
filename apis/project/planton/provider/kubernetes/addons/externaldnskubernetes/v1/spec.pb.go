...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/addons/externaldnskubernetes/v1/spec.proto
...
func (x *ExternalDnsKubernetesSpec) Reset() {
	*x = ExternalDnsKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes[0]
...
func (x *ExternalDnsGkeConfig) Reset() {
	*x = ExternalDnsGkeConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsGkeConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExternalDnsEksConfig) Reset() {
	*x = ExternalDnsEksConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsEksConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExternalDnsAksConfig) Reset() {
	*x = ExternalDnsAksConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsAksConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto protoreflect.FileDescriptor
...
const file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDesc = "" +
	...
	"Gcom.project.planton.provider.kubernetes.addons.externaldnskubernetes.v1B\tSpecProtoP\x01Z\x8b\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/addons/externaldnskubernetes/v1;externaldnskubernetesv1\xa2\x02\x06PPPKAE\xaa\x02CProject.Planton.Provider.Kubernetes.Addons.Externaldnskubernetes.V1\xca\x02CProject\\Planton\\Provider\\Kubernetes\\Addons\\Externaldnskubernetes\\V1\xe2\x02OProject\\Planton\\Provider\\Kubernetes\\Addons\\Externaldnskubernetes\\V1\\GPBMetadata\xea\x02IProject::Planton::Provider::Kubernetes::Addons::Externaldnskubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDescData
}
...
func file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto != nil {
		return
	}
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_addons_externaldnskubernetes_v1_spec_proto_depIdxs = nil
}
