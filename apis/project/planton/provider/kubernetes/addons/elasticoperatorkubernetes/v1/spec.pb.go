...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/addons/elasticoperatorkubernetes/v1/spec.proto
...
func (x *ElasticOperatorKubernetesSpec) Reset() {
	*x = ElasticOperatorKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_msgTypes[0]
...
func (x *ElasticOperatorKubernetesSpecContainer) Reset() {
	*x = ElasticOperatorKubernetesSpecContainer{}
	mi := &file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticOperatorKubernetesSpecContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto protoreflect.FileDescriptor
...
const file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDesc = "" +
	...
	"Kcom.project.planton.provider.kubernetes.addons.elasticoperatorkubernetes.v1B\tSpecProtoP\x01Z\x93\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/addons/elasticoperatorkubernetes/v1;elasticoperatorkubernetesv1\xa2\x02\x06PPPKAE\xaa\x02GProject.Planton.Provider.Kubernetes.Addons.Elasticoperatorkubernetes.V1\xca\x02GProject\\Planton\\Provider\\Kubernetes\\Addons\\Elasticoperatorkubernetes\\V1\xe2\x02SProject\\Planton\\Provider\\Kubernetes\\Addons\\Elasticoperatorkubernetes\\V1\\GPBMetadata\xea\x02MProject::Planton::Provider::Kubernetes::Addons::Elasticoperatorkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDescData
}
...
func file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_addons_elasticoperatorkubernetes_v1_spec_proto_depIdxs = nil
}
