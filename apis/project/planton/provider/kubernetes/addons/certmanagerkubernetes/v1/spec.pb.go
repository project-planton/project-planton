...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/addons/certmanagerkubernetes/v1/spec.proto
...
func (x *CertManagerKubernetesSpec) Reset() {
	*x = CertManagerKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes[0]
...
func (*CertManagerKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CertManagerGkeConfig) Reset() {
	*x = CertManagerGkeConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertManagerGkeConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CertManagerEksConfig) Reset() {
	*x = CertManagerEksConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertManagerEksConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *CertManagerAksConfig) Reset() {
	*x = CertManagerAksConfig{}
	mi := &file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertManagerAksConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x1amanaged_identity_client_id\x18\x02 \x01(\tR\x17managedIdentityClientIdB\x97\x04\n" +
...
var (
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto != nil {
		return
	}
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_addons_certmanagerkubernetes_v1_spec_proto_depIdxs = nil
}
