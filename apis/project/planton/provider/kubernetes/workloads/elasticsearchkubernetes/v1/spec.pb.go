...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/elasticsearchkubernetes/v1/spec.proto
...
func (x *ElasticsearchKubernetesSpec) Reset() {
	*x = ElasticsearchKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_msgTypes[0]
...
func (*ElasticsearchKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ElasticsearchKubernetesElasticsearchContainer) Reset() {
	*x = ElasticsearchKubernetesElasticsearchContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesElasticsearchContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ElasticsearchKubernetesKibanaContainer) Reset() {
	*x = ElasticsearchKubernetesKibanaContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesKibanaContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workloads/elasticsearchkubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
...
var (
	...
	E_DefaultElasticsearchContainer = &file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_extTypes[0]
	...
	E_DefaultKibanaContainer = &file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_extTypes[1]
)

var File_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Sproject/planton/provider/kubernetes/workloads/elasticsearchkubernetes/v1/spec.proto\x12Hproject.planton.provider.kubernetes.workloads.elasticsearchkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\x8f\x04\n" +
	...
	"\x18default_kibana_container\x12\x1d.google.protobuf.FieldOptions\x18ʈ\x1f \x01(\v2p.project.planton.provider.kubernetes.workloads.elasticsearchkubernetes.v1.ElasticsearchKubernetesKibanaContainerR\x16defaultKibanaContainerB\xb7\x04\n" +
...
var (
	file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_elasticsearchkubernetes_v1_spec_proto_depIdxs = nil
}
