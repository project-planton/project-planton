...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/rediskubernetes/v1/spec.proto
...
func (x *RedisKubernetesSpec) Reset() {
	*x = RedisKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_msgTypes[0]
...
func (*RedisKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *RedisKubernetesContainer) Reset() {
	*x = RedisKubernetesContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RedisKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workloads/rediskubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_extTypes[0]
)

var File_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Kproject/planton/provider/kubernetes/workloads/rediskubernetes/v1/spec.proto\x12@project.planton.provider.kubernetes.workloads.rediskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\x88\x02\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xa9\xe3  \x01(\v2Z.project.planton.provider.kubernetes.workloads.rediskubernetes.v1.RedisKubernetesContainerR\x10defaultContainerB\xff\x03\n" +
	"Dcom.project.planton.provider.kubernetes.workloads.rediskubernetes.v1B\tSpecProtoP\x01Z\x82\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/rediskubernetes/v1;rediskubernetesv1\xa2\x02\x06PPPKWR\xaa\x02@Project.Planton.Provider.Kubernetes.Workloads.Rediskubernetes.V1\xca\x02@Project\\Planton\\Provider\\Kubernetes\\Workloads\\Rediskubernetes\\V1\xe2\x02LProject\\Planton\\Provider\\Kubernetes\\Workloads\\Rediskubernetes\\V1\\GPBMetadata\xea\x02FProject::Planton::Provider::Kubernetes::Workloads::Rediskubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_rediskubernetes_v1_spec_proto_depIdxs = nil
}
