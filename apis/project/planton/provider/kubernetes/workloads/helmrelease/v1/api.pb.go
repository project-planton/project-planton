...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/helmrelease/v1/api.proto
...
func (x *HelmRelease) Reset() {
	*x = HelmRelease{}
	mi := &file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_msgTypes[0]
...
func (*HelmRelease) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *HelmReleaseStatus) Reset() {
	*x = HelmReleaseStatus{}
	mi := &file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HelmReleaseStatus) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDesc = "" +
	"\n" +
	"Fproject/planton/provider/kubernetes/workloads/helmrelease/v1/api.proto\x12<project.planton.provider.kubernetes.workloads.helmrelease.v1\x1a\x1bbuf/validate/validate.proto\x1aGproject/planton/provider/kubernetes/workloads/helmrelease/v1/spec.proto\x1aPproject/planton/provider/kubernetes/workloads/helmrelease/v1/stack_outputs.proto\x1a#project/planton/shared/status.proto\x1a%project/planton/shared/metadata.proto\"\xa5\x03\n" +
	"\vHelmRelease\x12I\n" +
	...
	"stackJobId\x12o\n" +
	"\aoutputs\x18\x01 \x01(\v2U.project.planton.provider.kubernetes.workloads.helmrelease.v1.HelmReleaseStackOutputsR\aoutputsB\xe1\x03\n" +
...
var (
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_init() }
func file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto != nil {
		return
	}
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_spec_proto_init()
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto = out.File
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_helmrelease_v1_api_proto_depIdxs = nil
}
