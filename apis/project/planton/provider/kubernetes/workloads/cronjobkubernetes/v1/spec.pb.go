...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/cronjobkubernetes/v1/spec.proto
...
func (x *CronJobKubernetesSpec) Reset() {
	*x = CronJobKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_msgTypes[0]
...
func (*CronJobKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CronJobKubernetesContainerAppEnv) Reset() {
	*x = CronJobKubernetesContainerAppEnv{}
	mi := &file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CronJobKubernetesContainerAppEnv) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Mproject/planton/provider/kubernetes/workloads/cronjobkubernetes/v1/spec.proto\x12Bproject.planton.provider.kubernetes.workloads.cronjobkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xf1\x06\n" +
	...
	"Fcom.project.planton.provider.kubernetes.workloads.cronjobkubernetes.v1B\tSpecProtoP\x01Z\x86\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/cronjobkubernetes/v1;cronjobkubernetesv1\xa2\x02\x06PPPKWC\xaa\x02BProject.Planton.Provider.Kubernetes.Workloads.Cronjobkubernetes.V1\xca\x02BProject\\Planton\\Provider\\Kubernetes\\Workloads\\Cronjobkubernetes\\V1\xe2\x02NProject\\Planton\\Provider\\Kubernetes\\Workloads\\Cronjobkubernetes\\V1\\GPBMetadata\xea\x02HProject::Planton::Provider::Kubernetes::Workloads::Cronjobkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_cronjobkubernetes_v1_spec_proto_depIdxs = nil
}
