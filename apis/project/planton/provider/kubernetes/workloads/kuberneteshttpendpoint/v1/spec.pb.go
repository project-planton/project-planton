...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/kuberneteshttpendpoint/v1/spec.proto
...
func (x *KubernetesHttpEndpointSpec) Reset() {
	*x = KubernetesHttpEndpointSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_msgTypes[0]
...
func (*KubernetesHttpEndpointSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesHttpEndpointRoutingRule) Reset() {
	*x = KubernetesHttpEndpointRoutingRule{}
	mi := &file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRule) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesHttpEndpointRoutingRuleBackendService) Reset() {
	*x = KubernetesHttpEndpointRoutingRuleBackendService{}
	mi := &file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRuleBackendService) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Rproject/planton/provider/kubernetes/workloads/kuberneteshttpendpoint/v1/spec.proto\x12Gproject.planton.provider.kubernetes.workloads.kuberneteshttpendpoint.v1\x1a\x1bbuf/validate/validate.proto\"\xc2\x02\n" +
	...
	"\x04port\x18\x03 \x01(\x05R\x04portB\xb0\x04\n" +
	"Kcom.project.planton.provider.kubernetes.workloads.kuberneteshttpendpoint.v1B\tSpecProtoP\x01Z\x90\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/kuberneteshttpendpoint/v1;kuberneteshttpendpointv1\xa2\x02\x06PPPKWK\xaa\x02GProject.Planton.Provider.Kubernetes.Workloads.Kuberneteshttpendpoint.V1\xca\x02GProject\\Planton\\Provider\\Kubernetes\\Workloads\\Kuberneteshttpendpoint\\V1\xe2\x02SProject\\Planton\\Provider\\Kubernetes\\Workloads\\Kuberneteshttpendpoint\\V1\\GPBMetadata\xea\x02MProject::Planton::Provider::Kubernetes::Workloads::Kuberneteshttpendpoint::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_kuberneteshttpendpoint_v1_spec_proto_depIdxs = nil
}
