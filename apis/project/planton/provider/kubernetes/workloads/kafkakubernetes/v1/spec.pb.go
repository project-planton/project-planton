...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/kafkakubernetes/v1/spec.proto
...
func (x *KafkaKubernetesSpec) Reset() {
	*x = KafkaKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes[0]
...
func (*KafkaKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KafkaKubernetesBrokerContainer) Reset() {
	*x = KafkaKubernetesBrokerContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesBrokerContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KafkaKubernetesZookeeperContainer) Reset() {
	*x = KafkaKubernetesZookeeperContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KafkaKubernetesSchemaRegistryContainer) Reset() {
	*x = KafkaKubernetesSchemaRegistryContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesSchemaRegistryContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KafkaTopic) Reset() {
	*x = KafkaTopic{}
	mi := &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaTopic) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KafkaKubernetesBrokerContainer)(nil),
		Field:         524001,
		Name:          "project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_broker_container",
		Tag:           "bytes,524001,opt,name=default_broker_container",
		Filename:      "project/planton/provider/kubernetes/workloads/kafkakubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KafkaKubernetesZookeeperContainer)(nil),
		Field:         524002,
		Name:          "project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_zookeeper_container",
...
var (
	// optional project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainer default_broker_container = 524001;
	E_DefaultBrokerContainer = &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_extTypes[0]
	// optional project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer default_zookeeper_container = 524002;
	E_DefaultZookeeperContainer = &file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_extTypes[1]
)

var File_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Kproject/planton/provider/kubernetes/workloads/kafkakubernetes/v1/spec.proto\x12@project.planton.provider.kubernetes.workloads.kafkakubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xab\x06\n" +
	"\x13KafkaKubernetesSpec\x12o\n" +
	"\fkafka_topics\x18\x01 \x03(\v2L.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopicR\vkafkaTopics\x12\xb7\x01\n" +
	"\x10broker_container\x18\x02 \x01(\v2`.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainerB*\x8a\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x0fbrokerContainer\x12\xc0\x01\n" +
	"\x13zookeeper_container\x18\x03 \x01(\v2c.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainerB*\x92\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x12zookeeperContainer\x12\xa4\x01\n" +
	"\x19schema_registry_container\x18\x04 \x01(\v2h.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainerR\x17schemaRegistryContainer\x12H\n" +
	...
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100MiR\tresources\"\xba\b\n" +
	"\n" +
	...
	"partitions\x12!\n" +
	"\breplicas\x18\x03 \x01(\x05B\x05\x8a\xa6\x1d\x011R\breplicas\x12\xc4\x03\n" +
	"\x06config\x18\x04 \x03(\v2X.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic.ConfigEntryB\xd1\x02\x9a\xa6\x1d\x18\n" +
	...
	"\x18default_broker_container\x12\x1d.google.protobuf.FieldOptions\x18\xe1\xfd\x1f \x01(\v2`.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainerR\x16defaultBrokerContainer:\xc4\x01\n" +
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfd\x1f \x01(\v2c.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainerR\x19defaultZookeeperContainerB\xff\x03\n" +
	"Dcom.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1B\tSpecProtoP\x01Z\x82\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/kafkakubernetes/v1;kafkakubernetesv1\xa2\x02\x06PPPKWK\xaa\x02@Project.Planton.Provider.Kubernetes.Workloads.Kafkakubernetes.V1\xca\x02@Project\\Planton\\Provider\\Kubernetes\\Workloads\\Kafkakubernetes\\V1\xe2\x02LProject\\Planton\\Provider\\Kubernetes\\Workloads\\Kafkakubernetes\\V1\\GPBMetadata\xea\x02FProject::Planton::Provider::Kubernetes::Workloads::Kafkakubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_goTypes = []any{
	(*KafkaKubernetesSpec)(nil),                    // 0: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec
	(*KafkaKubernetesBrokerContainer)(nil),         // 1: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	(*KafkaKubernetesZookeeperContainer)(nil),      // 2: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
	(*KafkaKubernetesSchemaRegistryContainer)(nil), // 3: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer
	(*KafkaTopic)(nil),                             // 4: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic
	nil,                                            // 5: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic.ConfigEntry
...
var file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_depIdxs = []int32{
	4,  // 0: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec.kafka_topics:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic
	1,  // 1: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec.broker_container:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	2,  // 2: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec.zookeeper_container:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
	3,  // 3: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec.schema_registry_container:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer
	6,  // 4: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSpec.ingress:type_name -> project.planton.shared.kubernetes.IngressSpec
	7,  // 5: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	7,  // 6: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	7,  // 7: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
	5,  // 8: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic.config:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaTopic.ConfigEntry
	8,  // 9: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_broker_container:extendee -> google.protobuf.FieldOptions
	8,  // 10: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_zookeeper_container:extendee -> google.protobuf.FieldOptions
	1,  // 11: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_broker_container:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	2,  // 12: project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.default_zookeeper_container:type_name -> project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
...
func init() { file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_kafkakubernetes_v1_spec_proto_depIdxs = nil
}
