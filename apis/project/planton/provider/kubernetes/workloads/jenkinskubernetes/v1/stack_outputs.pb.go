...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/jenkinskubernetes/v1/stack_outputs.proto
...
func (x *JenkinsKubernetesStackOutputs) Reset() {
	*x = JenkinsKubernetesStackOutputs{}
	mi := &file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_msgTypes[0]
...
func (*JenkinsKubernetesStackOutputs) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Vproject/planton/provider/kubernetes/workloads/jenkinskubernetes/v1/stack_outputs.proto\x12Bproject.planton.provider.kubernetes.workloads.jenkinskubernetes.v1\x1a2project/planton/shared/kubernetes/kubernetes.proto\"\x85\x03\n" +
	...
	"Fcom.project.planton.provider.kubernetes.workloads.jenkinskubernetes.v1B\x11StackOutputsProtoP\x01Z\x86\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/jenkinskubernetes/v1;jenkinskubernetesv1\xa2\x02\x06PPPKWJ\xaa\x02BProject.Planton.Provider.Kubernetes.Workloads.Jenkinskubernetes.V1\xca\x02BProject\\Planton\\Provider\\Kubernetes\\Workloads\\Jenkinskubernetes\\V1\xe2\x02NProject\\Planton\\Provider\\Kubernetes\\Workloads\\Jenkinskubernetes\\V1\\GPBMetadata\xea\x02HProject::Planton::Provider::Kubernetes::Workloads::Jenkinskubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_goTypes = []any{
	(*JenkinsKubernetesStackOutputs)(nil),  // 0: project.planton.provider.kubernetes.workloads.jenkinskubernetes.v1.JenkinsKubernetesStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: project.planton.shared.kubernetes.KubernetesSecretKey
}
var file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.kubernetes.workloads.jenkinskubernetes.v1.JenkinsKubernetesStackOutputs.password_secret:type_name -> project.planton.shared.kubernetes.KubernetesSecretKey
...
func file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto = out.File
	file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_jenkinskubernetes_v1_stack_outputs_proto_depIdxs = nil
}
