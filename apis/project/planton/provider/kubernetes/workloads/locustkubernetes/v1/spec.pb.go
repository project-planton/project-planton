...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/locustkubernetes/v1/spec.proto
...
func (x *LocustKubernetesSpec) Reset() {
	*x = LocustKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_msgTypes[0]
...
func (*LocustKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *LocustKubernetesContainer) Reset() {
	*x = LocustKubernetesContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LocustKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *LocustKubernetesLoadTest) Reset() {
	*x = LocustKubernetesLoadTest{}
	mi := &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LocustKubernetesLoadTest) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workloads/locustkubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*LocustKubernetesContainer)(nil),
...
var (
	...
	E_DefaultMasterContainer = &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_extTypes[0]
	...
	E_DefaultWorkerContainer = &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_extTypes[1]
)

var File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Lproject/planton/provider/kubernetes/workloads/locustkubernetes/v1/spec.proto\x12Aproject.planton.provider.kubernetes.workloads.locustkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\"\x8f\x06\n" +
	...
	"\x18default_worker_container\x12\x1d.google.protobuf.FieldOptions\x18\x82\x9d  \x01(\v2\\.project.planton.provider.kubernetes.workloads.locustkubernetes.v1.LocustKubernetesContainerR\x16defaultWorkerContainerB\x86\x04\n" +
	"Ecom.project.planton.provider.kubernetes.workloads.locustkubernetes.v1B\tSpecProtoP\x01Z\x84\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/locustkubernetes/v1;locustkubernetesv1\xa2\x02\x06PPPKWL\xaa\x02AProject.Planton.Provider.Kubernetes.Workloads.Locustkubernetes.V1\xca\x02AProject\\Planton\\Provider\\Kubernetes\\Workloads\\Locustkubernetes\\V1\xe2\x02MProject\\Planton\\Provider\\Kubernetes\\Workloads\\Locustkubernetes\\V1\\GPBMetadata\xea\x02GProject::Planton::Provider::Kubernetes::Workloads::Locustkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_depIdxs = nil
}
