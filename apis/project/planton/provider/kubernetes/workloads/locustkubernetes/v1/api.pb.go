...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/locustkubernetes/v1/api.proto
...
func (x *LocustKubernetes) Reset() {
	*x = LocustKubernetes{}
	mi := &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_msgTypes[0]
...
func (*LocustKubernetes) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *LocustKubernetesStatus) Reset() {
	*x = LocustKubernetesStatus{}
	mi := &file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LocustKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	"Kproject/planton/provider/kubernetes/workloads/locustkubernetes/v1/api.proto\x12Aproject.planton.provider.kubernetes.workloads.locustkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1aLproject/planton/provider/kubernetes/workloads/locustkubernetes/v1/spec.proto\x1aUproject/planton/provider/kubernetes/workloads/locustkubernetes/v1/stack_outputs.proto\x1a#project/planton/shared/status.proto\x1a%project/planton/shared/metadata.proto\"\xc3\x03\n" +
	...
	"stackJobId\x12y\n" +
	"\aoutputs\x18\x01 \x01(\v2_.project.planton.provider.kubernetes.workloads.locustkubernetes.v1.LocustKubernetesStackOutputsR\aoutputsB\x85\x04\n" +
...
var (
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_init() }
func file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto != nil {
		return
	}
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_spec_proto_init()
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto = out.File
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_locustkubernetes_v1_api_proto_depIdxs = nil
}
