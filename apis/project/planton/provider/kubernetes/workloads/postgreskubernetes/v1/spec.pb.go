...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/postgreskubernetes/v1/spec.proto
...
func (x *PostgresKubernetesSpec) Reset() {
	*x = PostgresKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_msgTypes[0]
...
func (*PostgresKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *PostgresKubernetesContainer) Reset() {
	*x = PostgresKubernetesContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostgresKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workloads/postgreskubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_extTypes[0]
)

var File_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Nproject/planton/provider/kubernetes/workloads/postgreskubernetes/v1/spec.proto\x12Cproject.planton.provider.kubernetes.workloads.postgreskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\x8f\x02\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xf1\xcb  \x01(\v2`.project.planton.provider.kubernetes.workloads.postgreskubernetes.v1.PostgresKubernetesContainerR\x10defaultContainerB\x94\x04\n" +
	"Gcom.project.planton.provider.kubernetes.workloads.postgreskubernetes.v1B\tSpecProtoP\x01Z\x88\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/postgreskubernetes/v1;postgreskubernetesv1\xa2\x02\x06PPPKWP\xaa\x02CProject.Planton.Provider.Kubernetes.Workloads.Postgreskubernetes.V1\xca\x02CProject\\Planton\\Provider\\Kubernetes\\Workloads\\Postgreskubernetes\\V1\xe2\x02OProject\\Planton\\Provider\\Kubernetes\\Workloads\\Postgreskubernetes\\V1\\GPBMetadata\xea\x02IProject::Planton::Provider::Kubernetes::Workloads::Postgreskubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_postgreskubernetes_v1_spec_proto_depIdxs = nil
}
