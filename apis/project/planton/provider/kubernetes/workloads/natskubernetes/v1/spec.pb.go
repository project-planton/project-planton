...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/natskubernetes/v1/spec.proto
...
func (NatsKubernetesAuthScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (NatsKubernetesAuthScheme) Type() protoreflect.EnumType {
	return &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_enumTypes[0]
}
...
func (NatsKubernetesAuthScheme) EnumDescriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *NatsKubernetesSpec) Reset() {
	*x = NatsKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes[0]
...
func (x *NatsKubernetesServerContainer) Reset() {
	*x = NatsKubernetesServerContainer{}
	mi := &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesServerContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *NatsKubernetesNoAuthUser) Reset() {
	*x = NatsKubernetesNoAuthUser{}
	mi := &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesNoAuthUser) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *NatsKubernetesAuth) Reset() {
	*x = NatsKubernetesAuth{}
	mi := &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesAuth) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workloads/natskubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultServerContainer = &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_extTypes[0]
)

var File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Jproject/planton/provider/kubernetes/workloads/natskubernetes/v1/spec.proto\x12?project.planton.provider.kubernetes.workloads.natskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xfa\x03\n" +
	...
	"\x18default_server_container\x12\x1d.google.protobuf.FieldOptions\x18Ʌ  \x01(\v2^.project.planton.provider.kubernetes.workloads.natskubernetes.v1.NatsKubernetesServerContainerR\x16defaultServerContainerB\xf8\x03\n" +
	"Ccom.project.planton.provider.kubernetes.workloads.natskubernetes.v1B\tSpecProtoP\x01Z\x80\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workloads/natskubernetes/v1;natskubernetesv1\xa2\x02\x06PPPKWN\xaa\x02?Project.Planton.Provider.Kubernetes.Workloads.Natskubernetes.V1\xca\x02?Project\\Planton\\Provider\\Kubernetes\\Workloads\\Natskubernetes\\V1\xe2\x02KProject\\Planton\\Provider\\Kubernetes\\Workloads\\Natskubernetes\\V1\\GPBMetadata\xea\x02EProject::Planton::Provider::Kubernetes::Workloads::Natskubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_spec_proto_depIdxs = nil
}
