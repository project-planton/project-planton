...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/workloads/natskubernetes/v1/stack_outputs.proto
...
func (x *NatsKubernetesStackOutputs) Reset() {
	*x = NatsKubernetesStackOutputs{}
	mi := &file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_msgTypes[0]
...
func (*NatsKubernetesStackOutputs) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Sproject/planton/provider/kubernetes/workloads/natskubernetes/v1/stack_outputs.proto\x12?project.planton.provider.kubernetes.workloads.natskubernetes.v1\x1a2project/planton/shared/kubernetes/kubernetes.proto\"\xac\x03\n" +
	...
	"\n" +
	"tls_secret\x18\a \x01(\v26.project.planton.shared.kubernetes.KubernetesSecretKeyR\ttlsSecretB\x80\x04\n" +
...
var (
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_depIdxs = []int32{
...
func file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_init() {
	if File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto = out.File
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workloads_natskubernetes_v1_stack_outputs_proto_depIdxs = nil
}
