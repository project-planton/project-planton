...
func (x *KafkaKubernetesSpec) Reset() {
	*x = KafkaKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[0]
...
func (*KafkaKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KafkaKubernetesBrokerContainer) Reset() {
	*x = KafkaKubernetesBrokerContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesBrokerContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KafkaKubernetesZookeeperContainer) Reset() {
	*x = KafkaKubernetesZookeeperContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KafkaKubernetesSchemaRegistryContainer) Reset() {
	*x = KafkaKubernetesSchemaRegistryContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesSchemaRegistryContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KafkaTopic) Reset() {
	*x = KafkaTopic{}
	mi := &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaTopic) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workload/kafkakubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
...
var (
	...
	E_DefaultBrokerContainer = &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes[0]
	...
	E_DefaultZookeeperContainer = &file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes[1]
)

var File_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	...
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfd\x1f \x01(\v2c.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1.KafkaKubernetesZookeeperContainerR\x19defaultZookeeperContainerB\xfe\x03\n" +
	"Dcom.project.planton.provider.kubernetes.workloads.kafkakubernetes.v1B\tSpecProtoP\x01Z\x81\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workload/kafkakubernetes/v1;kafkakubernetesv1\xa2\x02\x06PPPKWK\xaa\x02@Project.Planton.Provider.Kubernetes.Workloads.Kafkakubernetes.V1\xca\x02@Project\\Planton\\Provider\\Kubernetes\\Workloads\\Kafkakubernetes\\V1\xe2\x02LProject\\Planton\\Provider\\Kubernetes\\Workloads\\Kafkakubernetes\\V1\\GPBMetadata\xea\x02FProject::Planton::Provider::Kubernetes::Workloads::Kafkakubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes = []any{
...
var file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs = nil
}
