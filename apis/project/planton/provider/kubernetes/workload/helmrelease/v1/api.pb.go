...
func (x *HelmRelease) Reset() {
	*x = HelmRelease{}
	mi := &file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_msgTypes[0]
...
func (*HelmRelease) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *HelmReleaseStatus) Reset() {
	*x = HelmReleaseStatus{}
	mi := &file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HelmReleaseStatus) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto protoreflect.FileDescriptor
...
var (
	...
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDescData
}
...
func init() { file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_init() }
func file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_init() {
	if File_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto != nil {
		return
	}
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_spec_proto_init()
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto = out.File
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workload_helmrelease_v1_api_proto_depIdxs = nil
}
