...
func (NatsKubernetesAuthScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (NatsKubernetesAuthScheme) Type() protoreflect.EnumType {
	return &file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes[0]
}
...
func (NatsKubernetesAuthScheme) EnumDescriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *NatsKubernetesSpec) Reset() {
	*x = NatsKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[0]
...
func (x *NatsKubernetesServerContainer) Reset() {
	*x = NatsKubernetesServerContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesServerContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *NatsKubernetesNoAuthUser) Reset() {
	*x = NatsKubernetesNoAuthUser{}
	mi := &file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesNoAuthUser) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *NatsKubernetesAuth) Reset() {
	*x = NatsKubernetesAuth{}
	mi := &file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesAuth) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Iproject/planton/provider/kubernetes/workload/natskubernetes/v1/spec.proto\x12>project.planton.provider.kubernetes.workload.natskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\x9f\x04\n" +
...
var (
	...
	file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData
}
...
func init() { file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workload_natskubernetes_v1_spec_proto_depIdxs = nil
}
