...
func (x *Neo4JKubernetesSpec) Reset() {
	*x = Neo4JKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[0]
...
func (*Neo4JKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Neo4JKubernetesContainer) Reset() {
	*x = Neo4JKubernetesContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neo4JKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *Neo4JKubernetesMemoryConfig) Reset() {
	*x = Neo4JKubernetesMemoryConfig{}
	mi := &file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neo4JKubernetesMemoryConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "project/planton/provider/kubernetes/workload/neo4jkubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes[0]
)

var File_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto protoreflect.FileDescriptor
...
const file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc = "" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\x82ֱ\x02 \x01(\v2Z.project.planton.provider.kubernetes.workloads.neo4jkubernetes.v1.Neo4jKubernetesContainerR\x10defaultContainerB\xfe\x03\n" +
	"Dcom.project.planton.provider.kubernetes.workloads.neo4jkubernetes.v1B\tSpecProtoP\x01Z\x81\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/workload/neo4jkubernetes/v1;neo4jkubernetesv1\xa2\x02\x06PPPKWN\xaa\x02@Project.Planton.Provider.Kubernetes.Workloads.Neo4jkubernetes.V1\xca\x02@Project\\Planton\\Provider\\Kubernetes\\Workloads\\Neo4jkubernetes\\V1\xe2\x02LProject\\Planton\\Provider\\Kubernetes\\Workloads\\Neo4jkubernetes\\V1\\GPBMetadata\xea\x02FProject::Planton::Provider::Kubernetes::Workloads::Neo4jkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc)))
	})
...
func init() { file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_depIdxs = nil
}
