...
func (x *OpenFgaKubernetesSpec) Reset() {
	*x = OpenFgaKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[0]
...
func (*OpenFgaKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *OpenFgaKubernetesContainer) Reset() {
	*x = OpenFgaKubernetesContainer{}
	mi := &file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *OpenFgaKubernetesDataStore) Reset() {
	*x = OpenFgaKubernetesDataStore{}
	mi := &file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesDataStore) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *OpenFgaKubernetesIngress) Reset() {
	*x = OpenFgaKubernetesIngress{}
	mi := &file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
...
var File_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto protoreflect.FileDescriptor
...
var (
	...
	file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func init() { file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_depIdxs = nil
}
