...
const file_project_planton_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	"Jproject/planton/provider/kubernetes/workload/argocdkubernetes/v1/api.proto\x12Aproject.planton.provider.kubernetes.workloads.argocdkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1aKproject/planton/provider/kubernetes/workload/argocdkubernetes/v1/spec.proto\x1aTproject/planton/provider/kubernetes/workload/argocdkubernetes/v1/stack_outputs.proto\x1a#project/planton/shared/status.proto\x1a%project/planton/shared/metadata.proto\"\xc3\x03\n" +
	...
	"stackJobId\x12y\n" +
	"\aoutputs\x18\x01 \x01(\v2_.project.planton.provider.kubernetes.workloads.argocdkubernetes.v1.ArgocdKubernetesStackOutputsR\aoutputsB\x84\x04\n" +
