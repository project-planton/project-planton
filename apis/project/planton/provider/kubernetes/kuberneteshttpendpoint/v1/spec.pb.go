...
const file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Hproject/planton/provider/kubernetes/kuberneteshttpendpoint/v1/spec.proto\x12=project.planton.provider.kubernetes.kuberneteshttpendpoint.v1\x1a\x1bbuf/validate/validate.proto\"\xb8\x02\n" +
	...
	"\x16is_grpc_web_compatible\x18\x03 \x01(\bR\x13isGrpcWebCompatible\x12\x85\x01\n" +
	"\rrouting_rules\x18\x04 \x03(\v2`.project.planton.provider.kubernetes.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleR\froutingRules\"\xf5\x01\n" +
	"!KubernetesHttpEndpointRoutingRule\x12.\n" +
	"\x0furl_path_prefix\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\rurlPathPrefix\x12\x9f\x01\n" +
	"\x0fbackend_service\x18\x02 \x01(\v2n.project.planton.provider.kubernetes.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleBackendServiceB\x06\xbaH\x03\xc8\x01\x01R\x0ebackendService\"w\n" +
	"/KubernetesHttpEndpointRoutingRuleBackendService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x12\n" +
	"\x04port\x18\x03 \x01(\x05R\x04portB\xf2\x03\n" +
	"Acom.project.planton.provider.kubernetes.kuberneteshttpendpoint.v1B\tSpecProtoP\x01Z\x86\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/kuberneteshttpendpoint/v1;kuberneteshttpendpointv1\xa2\x02\x05PPPKK\xaa\x02=Project.Planton.Provider.Kubernetes.Kuberneteshttpendpoint.V1\xca\x02=Project\\Planton\\Provider\\Kubernetes\\Kuberneteshttpendpoint\\V1\xe2\x02IProject\\Planton\\Provider\\Kubernetes\\Kuberneteshttpendpoint\\V1\\GPBMetadata\xea\x02BProject::Planton::Provider::Kubernetes::Kuberneteshttpendpoint::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDescData []byte
)
...
func file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_kuberneteshttpendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
