...
const file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Aproject/planton/provider/kubernetes/rediskubernetes/v1/spec.proto\x126project.planton.provider.kubernetes.rediskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\xfe\x01\n" +
	"\x13RedisKubernetesSpec\x12\x9c\x01\n" +
	"\tcontainer\x18\x01 \x01(\v2P.project.planton.provider.kubernetes.rediskubernetes.v1.RedisKubernetesContainerB,ʚ\x86\x02'\b\x01\x12\x1c\n" +
	"\f\n" +
...
func file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_rediskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
