...
const file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cproject/planton/provider/kubernetes/cronjobkubernetes/v1/spec.proto\x128project.planton.provider.kubernetes.cronjobkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xe7\x06\n" +
	...
	"\x03env\x18\x03 \x01(\v2Z.project.planton.provider.kubernetes.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnvR\x03env\x12\"\n" +
	...
	"\x04args\x18\r \x03(\tR\x04args\"\xaa\x03\n" +
	" CronJobKubernetesContainerAppEnv\x12\x87\x01\n" +
	"\tvariables\x18\x01 \x03(\v2i.project.planton.provider.kubernetes.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.VariablesEntryR\tvariables\x12\x81\x01\n" +
	"\asecrets\x18\x02 \x03(\v2g.project.planton.provider.kubernetes.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.SecretsEntryR\asecrets\x1a<\n" +
...
func file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_cronjobkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
