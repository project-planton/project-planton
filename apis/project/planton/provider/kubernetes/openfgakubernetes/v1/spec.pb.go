...
const file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cproject/planton/provider/kubernetes/openfgakubernetes/v1/spec.proto\x128project.planton.provider.kubernetes.openfgakubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\"\xf9\x02\n" +
	"\x15OpenFgaKubernetesSpec\x12\x99\x01\n" +
	"\tcontainer\x18\x01 \x01(\v2T.project.planton.provider.kubernetes.openfgakubernetes.v1.OpenFgaKubernetesContainerB%ʣ\x83\x02 \b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100MiR\tcontainer\x12H\n" +
	"\aingress\x18\x02 \x01(\v2..project.planton.shared.kubernetes.IngressSpecR\aingress\x12z\n" +
	"\tdatastore\x18\x03 \x01(\v2T.project.planton.provider.kubernetes.openfgakubernetes.v1.OpenFgaKubernetesDataStoreB\x06\xbaH\x03\xc8\x01\x01R\tdatastore\"\x8d\x01\n" +
	...
	"\x03uri\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03uri:\xa2\x01\n" +
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xb9\xb4  \x01(\v2T.project.planton.provider.kubernetes.openfgakubernetes.v1.OpenFgaKubernetesContainerR\x10defaultContainerB\xce\x03\n" +
	"<com.project.planton.provider.kubernetes.openfgakubernetes.v1B\tSpecProtoP\x01Z|github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/openfgakubernetes/v1;openfgakubernetesv1\xa2\x02\x05PPPKO\xaa\x028Project.Planton.Provider.Kubernetes.Openfgakubernetes.V1\xca\x028Project\\Planton\\Provider\\Kubernetes\\Openfgakubernetes\\V1\xe2\x02DProject\\Planton\\Provider\\Kubernetes\\Openfgakubernetes\\V1\\GPBMetadata\xea\x02=Project::Planton::Provider::Kubernetes::Openfgakubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDescData []byte
)
...
func file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_openfgakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 1,
			NumServices:   0,
