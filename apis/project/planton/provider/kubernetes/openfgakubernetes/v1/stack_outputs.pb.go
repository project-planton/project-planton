...
const file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Lproject/planton/provider/kubernetes/openfgakubernetes/v1/stack_outputs.proto\x128project.planton.provider.kubernetes.openfgakubernetes.v1\"\x88\x02\n" +
...
func file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc), len(file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
