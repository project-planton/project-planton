...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/openfgakubernetes/v1/stack_outputs.proto
...
var File_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto protoreflect.FileDescriptor

var file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc = []byte{
...
var (
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescData = file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc
)

func file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescData)
	})
	return file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDescData
}
...
func init() { file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_init() }
func file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_init() {
	if File_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto = out.File
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_rawDesc = nil
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_goTypes = nil
	file_project_planton_provider_kubernetes_openfgakubernetes_v1_stack_outputs_proto_depIdxs = nil
}
