...
const file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fproject/planton/provider/kubernetes/prometheuskubernetes/v1/spec.proto\x12;project.planton.provider.kubernetes.prometheuskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xe7\x01\n" +
	"\x18PrometheusKubernetesSpec\x12\x80\x01\n" +
	"\tcontainer\x18\x01 \x01(\v2Z.project.planton.provider.kubernetes.prometheuskubernetes.v1.PrometheusKubernetesContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12H\n" +
...
func file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_prometheuskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
