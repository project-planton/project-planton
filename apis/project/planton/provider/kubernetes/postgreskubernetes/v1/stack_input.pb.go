...
type PostgresKubernetesStackInput struct {
	...
	// target api-resource
	Target *PostgresKubernetes `protobuf:"bytes,4,opt,name=target,proto3" json:"target,omitempty"`
	// provider-credential
...
func (x *PostgresKubernetesStackInput) GetProvisioner() shared.IacProvisioner {
	if x != nil {
...
func (x *PostgresKubernetesStackInput) GetTerraform() *terraform.TerraformStackInfo {
	if x != nil {
		return x.Terraform
	}
	return nil
...
var file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x1c, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x4b, 0x75, 0x62, 0x65, 0x72,
	...
	0x65, 0x73, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x52, 0x06, 0x74, 0x61,
...
var file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_goTypes = []any{
	...
	(*PostgresKubernetes)(nil),                 // 4: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetes
...
var file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesStackInput.provisioner:type_name -> project.planton.shared.IacProvisioner
	2, // 1: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesStackInput.pulumi:type_name -> project.planton.shared.iac.pulumi.PulumiStackInfo
	3, // 2: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesStackInput.terraform:type_name -> project.planton.shared.iac.terraform.TerraformStackInfo
	4, // 3: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesStackInput.target:type_name -> project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetes
	5, // 4: project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesStackInput.provider_credential:type_name -> project.planton.credential.kubernetesclustercredential.v1.KubernetesClusterCredentialSpec
