...
const file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc = "" +
	"\n" +
	"Kproject/planton/provider/kubernetes/postgreskubernetes/v1/stack_input.proto\x129project.planton.provider.kubernetes.postgreskubernetes.v1\x1aDproject/planton/credential/kubernetesclustercredential/v1/spec.proto\x1aCproject/planton/provider/kubernetes/postgreskubernetes/v1/api.proto\x1a.project/planton/shared/iac/pulumi/pulumi.proto\x1a project/planton/shared/iac.proto\x1a4project/planton/shared/iac/terraform/terraform.proto\"\x81\x04\n" +
	...
	"\x06target\x18\x04 \x01(\v2M.project.planton.provider.kubernetes.postgreskubernetes.v1.PostgresKubernetesR\x06target\x12\x8b\x01\n" +
...
func file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc), len(file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc), len(file_project_planton_provider_kubernetes_postgreskubernetes_v1_stack_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
