...
const file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Bproject/planton/provider/kubernetes/locustkubernetes/v1/spec.proto\x127project.planton.provider.kubernetes.locustkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\"\xe5\x05\n" +
	"\x14LocustKubernetesSpec\x12\xa4\x01\n" +
	"\x10master_container\x18\x01 \x01(\v2R.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesContainerB%\x8a\xe8\x81\x02 \b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100MiR\x0fmasterContainer\x12\xa4\x01\n" +
	"\x10worker_container\x18\x02 \x01(\v2R.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesContainerB%\x92\xe8\x81\x02 \b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100MiR\x0fworkerContainer\x12H\n" +
	"\aingress\x18\x03 \x01(\v2..project.planton.shared.kubernetes.IngressSpecR\aingress\x12v\n" +
	"\tload_test\x18\x04 \x01(\v2Q.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesLoadTestB\x06\xbaH\x03\xc8\x01\x01R\bloadTest\x12~\n" +
	"\vhelm_values\x18\x05 \x03(\v2].project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesSpec.HelmValuesEntryR\n" +
	"helmValues\x1a=\n" +
	...
	"\tresources\x18\x02 \x01(\v25.project.planton.shared.kubernetes.ContainerResourcesR\tresources\"\xea\x02\n" +
	"\x18LocustKubernetesLoadTest\x12\x1a\n" +
	"\x04name\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x04name\x12.\n" +
	"\x0fmain_py_content\x18\x02 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\rmainPyContent\x12\x9a\x01\n" +
	"\x11lib_files_content\x18\x03 \x03(\v2f.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesLoadTest.LibFilesContentEntryB\x06\xbaH\x03\xc8\x01\x01R\x0flibFilesContent\x12!\n" +
	...
	"\x18default_master_container\x12\x1d.google.protobuf.FieldOptions\x18\x81\x9d  \x01(\v2R.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesContainerR\x16defaultMasterContainer:\xad\x01\n" +
	"\x18default_worker_container\x12\x1d.google.protobuf.FieldOptions\x18\x82\x9d  \x01(\v2R.project.planton.provider.kubernetes.locustkubernetes.v1.LocustKubernetesContainerR\x16defaultWorkerContainerB\xc7\x03\n" +
...
var (
	...
	file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDescData []byte
)
...
func file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_locustkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 2,
			NumServices:   0,
