...
const file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cproject/planton/provider/kubernetes/mongodbkubernetes/v1/spec.proto\x128project.planton.provider.kubernetes.mongodbkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\xc6\x03\n" +
	"\x15MongodbKubernetesSpec\x12\xa0\x01\n" +
	"\tcontainer\x18\x01 \x01(\v2T.project.planton.provider.kubernetes.mongodbkubernetes.v1.MongodbKubernetesContainerB,\x8a\xe5\x82\x02'\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x18\x01\"\x031GiR\tcontainer\x12H\n" +
	"\aingress\x18\x02 \x01(\v2..project.planton.shared.kubernetes.IngressSpecR\aingress\x12\x80\x01\n" +
	"\vhelm_values\x18\x03 \x03(\v2_.project.planton.provider.kubernetes.mongodbkubernetes.v1.MongodbKubernetesSpec.HelmValuesEntryR\n" +
	"helmValues\x1a=\n" +
...
func file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_mongodbkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 1,
			NumServices:   0,
