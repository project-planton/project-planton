...
var file_project_planton_provider_kubernetes_jenkinskubernetes_v1_stack_input_proto_depIdxs = []int32{
	...
	5, // 4: project.planton.provider.kubernetes.jenkinskubernetes.v1.JenkinsKubernetesStackInput.provider_credential:type_name -> project.planton.credential.kubernetesclustercredential.v1.KubernetesClusterCredentialSpec
