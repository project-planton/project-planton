...
const file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cproject/planton/provider/kubernetes/jenkinskubernetes/v1/spec.proto\x128project.planton.provider.kubernetes.jenkinskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\"\xaf\x03\n" +
	...
	"\x0350m\x12\x05100MiR\x12containerResources\x12\x80\x01\n" +
	"\vhelm_values\x18\x03 \x03(\v2_.project.planton.provider.kubernetes.jenkinskubernetes.v1.JenkinsKubernetesSpec.HelmValuesEntryR\n" +
	"helmValues\x12H\n" +
...
func file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_jenkinskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
