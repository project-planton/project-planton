...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/addon/altinityoperatorkubernetes/v1/stack_input.proto
...
func (x *AltinityOperatorKubernetesStackInput) Reset() {
	*x = AltinityOperatorKubernetesStackInput{}
	mi := &file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_msgTypes[0]
...
func (*AltinityOperatorKubernetesStackInput) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescGZIP(), []int{0}
}
...
var File_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto protoreflect.FileDescriptor
...
var (
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDesc), len(file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDescData
}

var file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func init() {
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_init()
}
func file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_init() {
	if File_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDesc), len(file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto = out.File
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_goTypes = nil
	file_project_planton_provider_kubernetes_addon_altinityoperatorkubernetes_v1_stack_input_proto_depIdxs = nil
}
