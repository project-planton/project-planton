...
// 	protoc        (unknown)
// source: project/planton/provider/kubernetes/temporalkubernetes/v1/spec.proto
...
func (TemporalKubernetesDatabaseBackend) Descriptor() protoreflect.EnumDescriptor {
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (TemporalKubernetesDatabaseBackend) Type() protoreflect.EnumType {
	return &file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_enumTypes[0]
}
...
func (TemporalKubernetesDatabaseBackend) EnumDescriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *TemporalKubernetesSpec) Reset() {
	*x = TemporalKubernetesSpec{}
	mi := &file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes[0]
...
type TemporalKubernetesDatabaseConfig struct {
	...
	Backend TemporalKubernetesDatabaseBackend `protobuf:"varint,1,opt,name=backend,proto3,enum=project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseBackend" json:"backend,omitempty"`
...
func (x *TemporalKubernetesDatabaseConfig) Reset() {
	*x = TemporalKubernetesDatabaseConfig{}
	mi := &file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesDatabaseConfig) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *TemporalKubernetesExternalDatabase) Reset() {
	*x = TemporalKubernetesExternalDatabase{}
	mi := &file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesExternalDatabase) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *TemporalKubernetesExternalElasticsearch) Reset() {
	*x = TemporalKubernetesExternalElasticsearch{}
	mi := &file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesExternalElasticsearch) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto protoreflect.FileDescriptor
...
const file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDesc = "" +
	...
	"\x05mysql\x10\x03B\xd5\x03\n" +
	"=com.project.planton.provider.kubernetes.temporalkubernetes.v1B\tSpecProtoP\x01Z~github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/temporalkubernetes/v1;temporalkubernetesv1\xa2\x02\x05PPPKT\xaa\x029Project.Planton.Provider.Kubernetes.Temporalkubernetes.V1\xca\x029Project\\Planton\\Provider\\Kubernetes\\Temporalkubernetes\\V1\xe2\x02EProject\\Planton\\Provider\\Kubernetes\\Temporalkubernetes\\V1\\GPBMetadata\xea\x02>Project::Planton::Provider::Kubernetes::Temporalkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDescData
}

var file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_goTypes = []any{
	(TemporalKubernetesDatabaseBackend)(0),          // 0: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseBackend
	(*TemporalKubernetesSpec)(nil),                  // 1: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesSpec
	(*TemporalKubernetesDatabaseConfig)(nil),        // 2: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseConfig
	(*TemporalKubernetesExternalDatabase)(nil),      // 3: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesExternalDatabase
	(*TemporalKubernetesExternalElasticsearch)(nil), // 4: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesExternalElasticsearch
	(*kubernetes.IngressSpec)(nil),                  // 5: project.planton.shared.kubernetes.IngressSpec
}
var file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_depIdxs = []int32{
	2, // 0: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesSpec.database:type_name -> project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseConfig
	5, // 1: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesSpec.ingress:type_name -> project.planton.shared.kubernetes.IngressSpec
	4, // 2: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesSpec.external_elasticsearch:type_name -> project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesExternalElasticsearch
	0, // 3: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseConfig.backend:type_name -> project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseBackend
	3, // 4: project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesDatabaseConfig.external_database:type_name -> project.planton.provider.kubernetes.temporalkubernetes.v1.TemporalKubernetesExternalDatabase
...
func init() { file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_init() }
func file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_init() {
	if File_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto = out.File
	file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_goTypes = nil
	file_project_planton_provider_kubernetes_temporalkubernetes_v1_spec_proto_depIdxs = nil
}
