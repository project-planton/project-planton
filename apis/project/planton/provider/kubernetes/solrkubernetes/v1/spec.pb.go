...
const file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@project/planton/provider/kubernetes/solrkubernetes/v1/spec.proto\x125project.planton.provider.kubernetes.solrkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\x1a google/protobuf/descriptor.proto\"\xb5\x04\n" +
	"\x12SolrKubernetesSpec\x12\xb4\x01\n" +
	"\x0esolr_container\x18\x01 \x01(\v2R.project.planton.provider.kubernetes.solrkubernetes.v1.SolrKubernetesSolrContainerB9\x8aև\x024\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031Gi\"\r\n" +
	"\x04solr\x12\x058.7.0R\rsolrContainer\x12g\n" +
	"\x06config\x18\x02 \x01(\v2O.project.planton.provider.kubernetes.solrkubernetes.v1.SolrKubernetesSolrConfigR\x06config\x12\xb4\x01\n" +
	"\x13zookeeper_container\x18\x03 \x01(\v2W.project.planton.provider.kubernetes.solrkubernetes.v1.SolrKubernetesZookeeperContainerB*\x92և\x02%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	...
	"\tresources\x18\x02 \x01(\v25.project.planton.shared.kubernetes.ContainerResourcesR\tresources\x12\xbc\x01\n" +
	"\tdisk_size\x18\x03 \x01(\tB\x9e\x01\xbaH\x9a\x01\xba\x01\x96\x01\n" +
	"!spec.container.disk_size.required\x12\x1aDisk size value is invalid\x1aUthis.matches('^\\\\d+(\\\\.\\\\d+)?\\\\s?(Ki|Mi|Gi|Ti|Pi|Ei|K|M|G|T|P|E)$') && size(this) > 0R\bdiskSize:\xa9\x01\n" +
	"\x16default_solr_container\x12\x1d.google.protobuf.FieldOptions\x18\xe1\xfa  \x01(\v2R.project.planton.provider.kubernetes.solrkubernetes.v1.SolrKubernetesSolrContainerR\x14defaultSolrContainer:\xb3\x01\n" +
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfa  \x01(\v2R.project.planton.provider.kubernetes.solrkubernetes.v1.SolrKubernetesSolrContainerR\x19defaultZookeeperContainerB\xb9\x03\n" +
	"9com.project.planton.provider.kubernetes.solrkubernetes.v1B\tSpecProtoP\x01Zvgithub.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/solrkubernetes/v1;solrkubernetesv1\xa2\x02\x05PPPKS\xaa\x025Project.Planton.Provider.Kubernetes.Solrkubernetes.V1\xca\x025Project\\Planton\\Provider\\Kubernetes\\Solrkubernetes\\V1\xe2\x02AProject\\Planton\\Provider\\Kubernetes\\Solrkubernetes\\V1\\GPBMetadata\xea\x02:Project::Planton::Provider::Kubernetes::Solrkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDescData []byte
)
...
func file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_solrkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 2,
			NumServices:   0,
