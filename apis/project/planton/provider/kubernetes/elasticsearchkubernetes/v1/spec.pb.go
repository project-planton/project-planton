...
const file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Iproject/planton/provider/kubernetes/elasticsearchkubernetes/v1/spec.proto\x12>project.planton.provider.kubernetes.elasticsearchkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a2project/planton/shared/kubernetes/kubernetes.proto\x1a/project/planton/shared/kubernetes/options.proto\x1a,project/planton/shared/options/options.proto\"\xfb\x03\n" +
	"\x1bElasticsearchKubernetesSpec\x12\xd4\x01\n" +
	"\x17elasticsearch_container\x18\x01 \x01(\v2m.project.planton.provider.kubernetes.elasticsearchkubernetes.v1.ElasticsearchKubernetesElasticsearchContainerB,\xca\xc4\xf8\x01'\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x18\x01\"\x031GiR\x16elasticsearchContainer\x12\xba\x01\n" +
	"\x10kibana_container\x18\x02 \x01(\v2f.project.planton.provider.kubernetes.elasticsearchkubernetes.v1.ElasticsearchKubernetesKibanaContainerB'\xd2\xc4\xf8\x01\"\b\x01\x10\x01\x1a\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	...
	"\tresources\x18\x03 \x01(\v25.project.planton.shared.kubernetes.ContainerResourcesR\tresources:\xd6\x01\n" +
	"\x1fdefault_elasticsearch_container\x12\x1d.google.protobuf.FieldOptions\x18Ɉ\x1f \x01(\v2m.project.planton.provider.kubernetes.elasticsearchkubernetes.v1.ElasticsearchKubernetesElasticsearchContainerR\x1ddefaultElasticsearchContainer:\xc1\x01\n" +
	"\x18default_kibana_container\x12\x1d.google.protobuf.FieldOptions\x18ʈ\x1f \x01(\v2f.project.planton.provider.kubernetes.elasticsearchkubernetes.v1.ElasticsearchKubernetesKibanaContainerR\x16defaultKibanaContainerB\xf9\x03\n" +
	"Bcom.project.planton.provider.kubernetes.elasticsearchkubernetes.v1B\tSpecProtoP\x01Z\x88\x01github.com/project-planton/project-planton/apis/project/planton/provider/kubernetes/elasticsearchkubernetes/v1;elasticsearchkubernetesv1\xa2\x02\x05PPPKE\xaa\x02>Project.Planton.Provider.Kubernetes.Elasticsearchkubernetes.V1\xca\x02>Project\\Planton\\Provider\\Kubernetes\\Elasticsearchkubernetes\\V1\xe2\x02JProject\\Planton\\Provider\\Kubernetes\\Elasticsearchkubernetes\\V1\\GPBMetadata\xea\x02CProject::Planton::Provider::Kubernetes::Elasticsearchkubernetes::V1b\x06proto3"

var (
	file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDescData []byte
)
...
func file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDesc)))
	})
...
func file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_project_planton_provider_kubernetes_elasticsearchkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 2,
			NumServices:   0,
