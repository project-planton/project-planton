...
// AzureDnsZoneSpec defines the specification required to deploy an Azure Kubernetes Service (AKS) cluster.
...
func (x *AzureDnsZoneSpec) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *AzureDnsZoneSpec) GetKubernetesVersion() string {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetDnsPrefix() string {
	if x != nil {
		return x.DnsPrefix
	}
	return ""
...
func (x *AzureDnsZoneSpec) GetIsPrivateCluster() bool {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetSubnetId() string {
	if x != nil {
		return x.SubnetId
	}
	return ""
...
func (x *AzureDnsZoneSpec) GetNodeVmSize() string {
	if x != nil {
		return x.NodeVmSize
	}
	return ""
...
func (x *AzureDnsZoneSpec) GetMinNodeCount() int32 {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetMaxNodeCount() int32 {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetSshPublicKey() string {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetEnableAzureAd() bool {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetAadAdminGroupObjectIds() []string {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetEnableMonitoring() bool {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetLogAnalyticsWorkspaceId() string {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetAuthorizedIpRanges() []string {
	if x != nil {
...
func (x *AzureDnsZoneSpec) GetAcrName() string {
	if x != nil {
		return x.AcrName
	}
	return ""
...
const file_project_planton_provider_azure_azurednszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9project/planton/provider/azure/azurednszone/v1/spec.proto\x12.project.planton.provider.azure.azurednszone.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\xe5\a\n" +
	"\x10AzureDnsZoneSpec\x12\"\n" +
	...
	"\bacr_name\x18\x10 \x01(\tR\aacrName\x12^\n" +
	"\x04tags\x18\x11 \x03(\v2J.project.planton.provider.azure.azurednszone.v1.AzureDnsZoneSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var file_project_planton_provider_azure_azurednszone_v1_spec_proto_goTypes = []any{
	...
	nil,                      // 1: project.planton.provider.azure.azurednszone.v1.AzureDnsZoneSpec.TagsEntry
}
var file_project_planton_provider_azure_azurednszone_v1_spec_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.azure.azurednszone.v1.AzureDnsZoneSpec.tags:type_name -> project.planton.provider.azure.azurednszone.v1.AzureDnsZoneSpec.TagsEntry
