...
func TestAzureAksCluster(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "AzureAksCluster Suite")
}

var _ = Describe("AzureAksCluster Custom Validation Tests", func() {

	var input *AzureAksCluster
