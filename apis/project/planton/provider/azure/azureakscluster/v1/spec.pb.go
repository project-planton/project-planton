...
const file_project_planton_provider_azure_azureakscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<project/planton/provider/azure/azureakscluster/v1/spec.proto\x121project.planton.provider.azure.azureakscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\xee\a\n" +
	"\x13AzureAksClusterSpec\x12\"\n" +
	...
	"\x04tags\x18\x11 \x03(\v2P.project.planton.provider.azure.azureakscluster.v1.AzureAksClusterSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
