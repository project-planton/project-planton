...
// AzureNatGatewaySpec defines the specification required to deploy an Azure Kubernetes Service (AKS) cluster.
...
func (x *AzureNatGatewaySpec) Reset() {
	*x = AzureNatGatewaySpec{}
	mi := &file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_msgTypes[0]
...
func (*AzureNatGatewaySpec) Descriptor() ([]byte, []int) {
	return file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureNatGatewaySpec) GetResourceGroup() string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetKubernetesVersion() string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetDnsPrefix() string {
	if x != nil {
		return x.DnsPrefix
	}
	return ""
...
func (x *AzureNatGatewaySpec) GetIsPrivateCluster() bool {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetSubnetId() string {
	if x != nil {
		return x.SubnetId
	}
	return ""
...
func (x *AzureNatGatewaySpec) GetNodeVmSize() string {
	if x != nil {
		return x.NodeVmSize
	}
	return ""
...
func (x *AzureNatGatewaySpec) GetMinNodeCount() int32 {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetMaxNodeCount() int32 {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetSshPublicKey() string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetEnableAzureAd() bool {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetAadAdminGroupObjectIds() []string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetEnableMonitoring() bool {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetLogAnalyticsWorkspaceId() string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetAuthorizedIpRanges() []string {
	if x != nil {
...
func (x *AzureNatGatewaySpec) GetAcrName() string {
	if x != nil {
		return x.AcrName
	}
	return ""
...
var File_project_planton_provider_azure_azurenatgateway_v1_spec_proto protoreflect.FileDescriptor

const file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<project/planton/provider/azure/azurenatgateway/v1/spec.proto\x121project.planton.provider.azure.azurenatgateway.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\xee\a\n" +
	...
	"\bacr_name\x18\x10 \x01(\tR\aacrName\x12d\n" +
	"\x04tags\x18\x11 \x03(\v2P.project.planton.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var (
	file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescOnce sync.Once
	file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescData []byte
)

func file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescGZIP() []byte {
	file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescOnce.Do(func() {
		file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDesc), len(file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDesc)))
	})
	return file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDescData
}

var file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_goTypes = []any{
	(*AzureNatGatewaySpec)(nil), // 0: project.planton.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec
	nil,                         // 1: project.planton.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec.TagsEntry
}
var file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec.tags:type_name -> project.planton.provider.azure.azurenatgateway.v1.AzureNatGatewaySpec.TagsEntry
...
func init() { file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_init() }
func file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_init() {
	if File_project_planton_provider_azure_azurenatgateway_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDesc), len(file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_goTypes,
		DependencyIndexes: file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_depIdxs,
		MessageInfos:      file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_msgTypes,
	}.Build()
	File_project_planton_provider_azure_azurenatgateway_v1_spec_proto = out.File
	file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_goTypes = nil
	file_project_planton_provider_azure_azurenatgateway_v1_spec_proto_depIdxs = nil
}
