...
// AzureContainerRegistrySpec defines the specification required to deploy an Azure Kubernetes Service (AKS) cluster.
...
func (x *AzureContainerRegistrySpec) GetResourceGroup() string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetKubernetesVersion() string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetDnsPrefix() string {
	if x != nil {
		return x.DnsPrefix
	}
	return ""
...
func (x *AzureContainerRegistrySpec) GetIsPrivateCluster() bool {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetSubnetId() string {
	if x != nil {
		return x.SubnetId
	}
	return ""
...
func (x *AzureContainerRegistrySpec) GetNodeVmSize() string {
	if x != nil {
		return x.NodeVmSize
	}
	return ""
...
func (x *AzureContainerRegistrySpec) GetMinNodeCount() int32 {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetMaxNodeCount() int32 {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetSshPublicKey() string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetEnableAzureAd() bool {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetAadAdminGroupObjectIds() []string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetEnableMonitoring() bool {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetLogAnalyticsWorkspaceId() string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetAuthorizedIpRanges() []string {
	if x != nil {
...
func (x *AzureContainerRegistrySpec) GetAcrName() string {
	if x != nil {
		return x.AcrName
	}
	return ""
...
const file_project_planton_provider_azure_azurecontainerregistry_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cproject/planton/provider/azure/azurecontainerregistry/v1/spec.proto\x128project.planton.provider.azure.azurecontainerregistry.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\x83\b\n" +
	...
	"\bacr_name\x18\x10 \x01(\tR\aacrName\x12r\n" +
	"\x04tags\x18\x11 \x03(\v2^.project.planton.provider.azure.azurecontainerregistry.v1.AzureContainerRegistrySpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xd4\x03\n" +
...
var file_project_planton_provider_azure_azurecontainerregistry_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_project_planton_provider_azure_azurecontainerregistry_v1_spec_proto_goTypes = []any{
	(*AzureContainerRegistrySpec)(nil), // 0: project.planton.provider.azure.azurecontainerregistry.v1.AzureContainerRegistrySpec
	nil,                                // 1: project.planton.provider.azure.azurecontainerregistry.v1.AzureContainerRegistrySpec.TagsEntry
}
var file_project_planton_provider_azure_azurecontainerregistry_v1_spec_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.azure.azurecontainerregistry.v1.AzureContainerRegistrySpec.tags:type_name -> project.planton.provider.azure.azurecontainerregistry.v1.AzureContainerRegistrySpec.TagsEntry
