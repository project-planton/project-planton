...
// AzureAksNodePoolSpec defines the specification required to deploy an Azure Kubernetes Service (AKS) cluster.
...
func (x *AzureAksNodePoolSpec) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *AzureAksNodePoolSpec) GetResourceGroup() string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetKubernetesVersion() string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetDnsPrefix() string {
	if x != nil {
		return x.DnsPrefix
	}
	return ""
...
func (x *AzureAksNodePoolSpec) GetIsPrivateCluster() bool {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetSubnetId() string {
	if x != nil {
		return x.SubnetId
	}
	return ""
...
func (x *AzureAksNodePoolSpec) GetNodeVmSize() string {
	if x != nil {
		return x.NodeVmSize
	}
	return ""
...
func (x *AzureAksNodePoolSpec) GetMinNodeCount() int32 {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetMaxNodeCount() int32 {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetSshPublicKey() string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetEnableAzureAd() bool {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetAadAdminGroupObjectIds() []string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetEnableMonitoring() bool {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetLogAnalyticsWorkspaceId() string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetAuthorizedIpRanges() []string {
	if x != nil {
...
func (x *AzureAksNodePoolSpec) GetAcrName() string {
	if x != nil {
		return x.AcrName
	}
	return ""
...
const file_project_planton_provider_azure_azureaksnodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=project/planton/provider/azure/azureaksnodepool/v1/spec.proto\x122project.planton.provider.azure.azureaksnodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a,project/planton/shared/options/options.proto\"\xf1\a\n" +
	...
	"\bacr_name\x18\x10 \x01(\tR\aacrName\x12f\n" +
	"\x04tags\x18\x11 \x03(\v2R.project.planton.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
...
var file_project_planton_provider_azure_azureaksnodepool_v1_spec_proto_goTypes = []any{
	(*AzureAksNodePoolSpec)(nil), // 0: project.planton.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec
	nil,                          // 1: project.planton.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec.TagsEntry
}
var file_project_planton_provider_azure_azureaksnodepool_v1_spec_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec.tags:type_name -> project.planton.provider.azure.azureaksnodepool.v1.AzureAksNodePoolSpec.TagsEntry
