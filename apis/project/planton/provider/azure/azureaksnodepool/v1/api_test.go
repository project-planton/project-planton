...
func TestAzureAksNodePool(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "AzureAksNodePool Suite")
}

var _ = Describe("AzureAksNodePool Custom Validation Tests", func() {

	var input *AzureAksNodePool
