...
const file_project_planton_provider_azure_azureaksnodepool_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Fproject/planton/provider/azure/azureaksnodepool/v1/stack_outputs.proto\x122project.planton.provider.azure.azureaksnodepool.v1\"\x1e\n" +
	"\x1cAzureAksNodePoolStackOutputsB\xb1\x03\n" +
