...
// 	protoc        (unknown)
// source: org/project-planton/provider/azure/azurevpc/v1/spec.proto
...
const file_org_project_planton_provider_azure_azurevpc_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9org/project-planton/provider/azure/azurevpc/v1/spec.proto\x12.org.project_planton.provider.azure.azurevpc.v1\x1a\x1bbuf/validate/validate.proto\"\xf7\x02\n" +
	"\fAzureVpcSpec\x124\n" +
