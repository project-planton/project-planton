...
// 	protoc        (unknown)
// source: org/project-planton/provider/atlas/mongodbatlas/v1/spec.proto
...
func (x *MongodbAtlasSpec) Reset() {
	*x = MongodbAtlasSpec{}
	mi := &file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes[0]
...
func (*MongodbAtlasSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *MongodbAtlasClusterConfig) Reset() {
	*x = MongodbAtlasClusterConfig{}
	mi := &file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MongodbAtlasClusterConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=org/project-planton/provider/atlas/mongodbatlas/v1/spec.proto\x122org.project_planton.provider.atlas.mongodbatlas.v1\"\x88\x01\n" +
	"\x10MongodbAtlasSpec\x12t\n" +
	"\x0ecluster_config\x18\x01 \x01(\v2M.org.project_planton.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfigR\rclusterConfig\"\xc6\x03\n" +
	...
	"6com.org.project_planton.provider.atlas.mongodbatlas.v1B\tSpecProtoP\x01Zqgithub.com/project-planton/project-planton/apis/org/project-planton/provider/atlas/mongodbatlas/v1;mongodbatlasv1\xa2\x02\x05OPPAM\xaa\x021Org.ProjectPlanton.Provider.Atlas.Mongodbatlas.V1\xca\x021Org\\ProjectPlanton\\Provider\\Atlas\\Mongodbatlas\\V1\xe2\x02=Org\\ProjectPlanton\\Provider\\Atlas\\Mongodbatlas\\V1\\GPBMetadata\xea\x026Org::ProjectPlanton::Provider::Atlas::Mongodbatlas::V1b\x06proto3"

var (
	file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_goTypes = []any{
	(*MongodbAtlasSpec)(nil),          // 0: org.project_planton.provider.atlas.mongodbatlas.v1.MongodbAtlasSpec
	(*MongodbAtlasClusterConfig)(nil), // 1: org.project_planton.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfig
}
var file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.atlas.mongodbatlas.v1.MongodbAtlasSpec.cluster_config:type_name -> org.project_planton.provider.atlas.mongodbatlas.v1.MongodbAtlasClusterConfig
...
func init() { file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_init() }
func file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_init() {
	if File_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto = out.File
	file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_atlas_mongodbatlas_v1_spec_proto_depIdxs = nil
}
