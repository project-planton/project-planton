...
// 	protoc        (unknown)
// source: org/project-planton/provider/digitalocean/digitaloceanfirewall/v1/spec.proto
...
const file_org_project_planton_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Lorg/project-planton/provider/digitalocean/digitaloceanfirewall/v1/spec.proto\x12Aorg.project_planton.provider.digitalocean.digitaloceanfirewall.v1\"\xfa\x02\n" +
