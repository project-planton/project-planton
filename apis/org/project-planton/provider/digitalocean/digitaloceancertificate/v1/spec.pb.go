...
// 	protoc        (unknown)
// source: org/project-planton/provider/digitalocean/digitaloceancertificate/v1/spec.proto
...
func (DigitalOceanCertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanCertificateType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanCertificateType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type DigitalOceanCertificateSpec struct {
	...
	Type DigitalOceanCertificateType `protobuf:"varint,2,opt,name=type,proto3,enum=org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateType" json:"type,omitempty"`
...
func (x *DigitalOceanCertificateSpec) Reset() {
	*x = DigitalOceanCertificateSpec{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanCertificateLetsEncryptParams) Reset() {
	*x = DigitalOceanCertificateLetsEncryptParams{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanCertificateLetsEncryptParams) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DigitalOceanCertificateCustomParams) Reset() {
	*x = DigitalOceanCertificateCustomParams{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanCertificateCustomParams) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Oorg/project-planton/provider/digitalocean/digitaloceancertificate/v1/spec.proto\x12Dorg.project_planton.provider.digitalocean.digitaloceancertificate.v1\x1a\x1bbuf/validate/validate.proto\"\xde\x04\n" +
	"\x1bDigitalOceanCertificateSpec\x127\n" +
	"\x10certificate_name\x18\x01 \x01(\tB\f\xbaH\t\xc8\x01\x01r\x04\x10\x01\x18@R\x0fcertificateName\x12\x82\x01\n" +
	"\x04type\x18\x02 \x01(\x0e2a.org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateTypeB\v\xbaH\b\xc8\x01\x01\x82\x01\x02\x10\x01R\x04type\x12\x93\x01\n" +
	"\flets_encrypt\x18\x03 \x01(\v2n.org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateLetsEncryptParamsH\x00R\vletsEncrypt\x12\x83\x01\n" +
	"\x06custom\x18\x04 \x01(\v2i.org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateCustomParamsH\x00R\x06custom\x12*\n" +
	...
	"Hcom.org.project_planton.provider.digitalocean.digitaloceancertificate.v1B\tSpecProtoP\x01Z\x8e\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/digitalocean/digitaloceancertificate/v1;digitaloceancertificatev1\xa2\x02\x05OPPDD\xaa\x02COrg.ProjectPlanton.Provider.Digitalocean.Digitaloceancertificate.V1\xca\x02COrg\\ProjectPlanton\\Provider\\Digitalocean\\Digitaloceancertificate\\V1\xe2\x02OOrg\\ProjectPlanton\\Provider\\Digitalocean\\Digitaloceancertificate\\V1\\GPBMetadata\xea\x02HOrg::ProjectPlanton::Provider::Digitalocean::Digitaloceancertificate::V1b\x06proto3"

var (
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes = []any{
	(DigitalOceanCertificateType)(0),                 // 0: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateType
	(*DigitalOceanCertificateSpec)(nil),              // 1: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateSpec
	(*DigitalOceanCertificateLetsEncryptParams)(nil), // 2: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateLetsEncryptParams
	(*DigitalOceanCertificateCustomParams)(nil),      // 3: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateCustomParams
}
var file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs = []int32{
	0, // 0: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateSpec.type:type_name -> org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateType
	2, // 1: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateSpec.lets_encrypt:type_name -> org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateLetsEncryptParams
	3, // 2: org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateSpec.custom:type_name -> org.project_planton.provider.digitalocean.digitaloceancertificate.v1.DigitalOceanCertificateCustomParams
...
func file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_init() {
	if File_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto = out.File
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs = nil
}
