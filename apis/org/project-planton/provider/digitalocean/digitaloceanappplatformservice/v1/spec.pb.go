...
// 	protoc        (unknown)
// source: org/project-planton/provider/digitalocean/digitaloceanappplatformservice/v1/spec.proto
...
func (DigitalOceanAppPlatformServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanAppPlatformServiceType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanAppPlatformServiceType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (DigitalOceanAppPlatformInstanceSize) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[1].Descriptor()
}

func (DigitalOceanAppPlatformInstanceSize) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[1]
}
...
func (DigitalOceanAppPlatformInstanceSize) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type DigitalOceanAppPlatformServiceSpec struct {
	...
	ServiceType DigitalOceanAppPlatformServiceType `protobuf:"varint,3,opt,name=service_type,json=serviceType,proto3,enum=org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceType" json:"service_type,omitempty"`
	...
	InstanceSizeSlug DigitalOceanAppPlatformInstanceSize `protobuf:"varint,6,opt,name=instance_size_slug,json=instanceSizeSlug,proto3,enum=org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformInstanceSize" json:"instance_size_slug,omitempty"`
...
func (x *DigitalOceanAppPlatformServiceSpec) Reset() {
	*x = DigitalOceanAppPlatformServiceSpec{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanAppPlatformGitSource) Reset() {
	*x = DigitalOceanAppPlatformGitSource{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DigitalOceanAppPlatformRegistrySource) Reset() {
	*x = DigitalOceanAppPlatformRegistrySource{}
	mi := &file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanAppPlatformRegistrySource) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Vorg/project-planton/provider/digitalocean/digitaloceanappplatformservice/v1/spec.proto\x12Korg.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1\x1a\x1bbuf/validate/validate.proto\x1a6org/project-planton/provider/digitalocean/region.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project-planton/shared/options/options.proto\"\xd1\n" +
	"\n" +
	"\"DigitalOceanAppPlatformServiceSpec\x12N\n" +
	"\fservice_name\x18\x01 \x01(\tB+\xbaH(\xc8\x01\x01r#\x18?2\x1f^[a-z0-9]([-a-z0-9]*[a-z0-9])?$R\vserviceName\x12]\n" +
	"\x06region\x18\x02 \x01(\x0e2=.org.project_planton.provider.digitalocean.DigitalOceanRegionB\x06\xbaH\x03\xc8\x01\x01R\x06region\x12\x9a\x01\n" +
	"\fservice_type\x18\x03 \x01(\x0e2o.org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceTypeB\x06\xbaH\x03\xc8\x01\x01R\vserviceType\x12\x8e\x01\n" +
	"\n" +
	"git_source\x18\x04 \x01(\v2m.org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformGitSourceH\x00R\tgitSource\x12\x97\x01\n" +
	"\fimage_source\x18\x05 \x01(\v2r.org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformRegistrySourceH\x00R\vimageSource\x12\xb3\x01\n" +
	"\x12instance_size_slug\x18\x06 \x01(\x0e2p.org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformInstanceSizeB\x13\xbaH\x03\xc8\x01\x01\x92\xa6\x1d\tbasic-xxsR\x10instanceSizeSlug\x12,\n" +
	...
	" \x01(\rR\x10maxInstanceCount\x12\x8a\x01\n" +
	"\x03env\x18\v \x03(\v2x.org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.EnvEntryR\x03env\x12z\n" +
	"\rcustom_domain\x18\f \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\x19\x88\xd4a\xb4\t\x92\xd4a\x10spec.domain_nameR\fcustomDomain\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	...
	"runCommand\"\xee\x01\n" +
	"%DigitalOceanAppPlatformRegistrySource\x12\x82\x01\n" +
	"\bregistry\x18\x01 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB*\xbaH\x03\xc8\x01\x01\x88\xd4a\xb2\t\x92\xd4a\x1bstatus.outputs.registry_urlR\bregistry\x12&\n" +
	"\n" +
...
var (
	...
	file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes = []any{
	(DigitalOceanAppPlatformServiceType)(0),       // 0: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceType
	(DigitalOceanAppPlatformInstanceSize)(0),      // 1: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformInstanceSize
	(*DigitalOceanAppPlatformServiceSpec)(nil),    // 2: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec
	(*DigitalOceanAppPlatformGitSource)(nil),      // 3: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformGitSource
	(*DigitalOceanAppPlatformRegistrySource)(nil), // 4: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformRegistrySource
	nil,                                  // 5: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	(digitalocean.DigitalOceanRegion)(0), // 6: org.project_planton.provider.digitalocean.DigitalOceanRegion
	(*v1.StringValueOrRef)(nil),          // 7: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs = []int32{
	6, // 0: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.region:type_name -> org.project_planton.provider.digitalocean.DigitalOceanRegion
	0, // 1: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.service_type:type_name -> org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceType
	3, // 2: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.git_source:type_name -> org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformGitSource
	4, // 3: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.image_source:type_name -> org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformRegistrySource
	1, // 4: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.instance_size_slug:type_name -> org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformInstanceSize
	5, // 5: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.env:type_name -> org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.EnvEntry
	7, // 6: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformServiceSpec.custom_domain:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	7, // 7: org.project_planton.provider.digitalocean.digitaloceanappplatformservice.v1.DigitalOceanAppPlatformRegistrySource.registry:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
...
func file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_init() {
	if File_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto = out.File
	file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs = nil
}
