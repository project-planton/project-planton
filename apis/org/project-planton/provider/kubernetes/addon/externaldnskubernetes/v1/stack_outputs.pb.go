...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/addon/externaldnskubernetes/v1/stack_outputs.proto
...
const file_org_project_planton_provider_kubernetes_addon_externaldnskubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Zorg/project-planton/provider/kubernetes/addon/externaldnskubernetes/v1/stack_outputs.proto\x12Forg.project_planton.provider.kubernetes.addon.externaldnskubernetes.v1\"\x81\x01\n" +
