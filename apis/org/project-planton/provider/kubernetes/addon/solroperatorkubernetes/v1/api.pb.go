...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/addon/solroperatorkubernetes/v1/api.proto
...
const file_org_project_planton_provider_kubernetes_addon_solroperatorkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	"Qorg/project-planton/provider/kubernetes/addon/solroperatorkubernetes/v1/api.proto\x12Gorg.project_planton.provider.kubernetes.addon.solroperatorkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1aRorg/project-planton/provider/kubernetes/addon/solroperatorkubernetes/v1/spec.proto\x1a[org/project-planton/provider/kubernetes/addon/solroperatorkubernetes/v1/stack_outputs.proto\x1a)org/project-planton/shared/metadata.proto\"\xed\x03\n" +
