...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/addon/postgresoperatorkubernetes/v1/stack_outputs.proto
...
const file_org_project_planton_provider_kubernetes_addon_postgresoperatorkubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"_org/project-planton/provider/kubernetes/addon/postgresoperatorkubernetes/v1/stack_outputs.proto\x12Korg.project_planton.provider.kubernetes.addon.postgresoperatorkubernetes.v1\"\xe2\x01\n" +
