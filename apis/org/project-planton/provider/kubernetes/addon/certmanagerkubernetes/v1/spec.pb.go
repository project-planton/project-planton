...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto
...
const file_org_project_planton_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Qorg/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto\x12Forg.project_planton.provider.kubernetes.addon.certmanagerkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/kubernetes/target_cluster.proto\x1a0org/project-planton/shared/options/options.proto\"\xbf\x05\n" +
