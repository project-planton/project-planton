...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/api.proto
...
const file_org_project_planton_provider_kubernetes_addon_certmanagerkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	"Porg/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/api.proto\x12Forg.project_planton.provider.kubernetes.addon.certmanagerkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1aQorg/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto\x1aZorg/project-planton/provider/kubernetes/addon/certmanagerkubernetes/v1/stack_outputs.proto\x1a)org/project-planton/shared/metadata.proto\"\xe7\x03\n" +
