...
// elasticOperator installs the Elastic Cloud on Kubernetes operator.
func elasticOperator(ctx *pulumi.Context, locals *Locals,
	...
	// 3. Helm release
	// --------------------------------------------------------------------
	_, err = helm.NewRelease(ctx, "elastic-operator", &helm.ReleaseArgs{
