...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/provider.proto
...
const file_org_project_planton_provider_kubernetes_provider_proto_rawDesc = "" +
	"\n" +
	"6org/project-planton/provider/kubernetes/provider.proto\x12'org.project_planton.provider.kubernetes\x1a\x1bbuf/validate/validate.proto\"\xa8\x04\n" +
