...
import (
	...
	signozkubernetesv1 "github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/signozkubernetes/v1"
...
func Resources(ctx *pulumi.Context, stackInput *signozkubernetesv1.SignozKubernetesStackInput) error {
	...
	if err := createSignozUIIngress(ctx, locals, kubernetesProvider, createdNamespace); err != nil {
	...
	if err := createOtelCollectorIngress(ctx, locals, kubernetesProvider, createdNamespace); err != nil {
