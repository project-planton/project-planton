...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/signozkubernetes/v1/stack_outputs.proto
...
func (x *SignozKubernetesStackOutputs) Reset() {
	*x = SignozKubernetesStackOutputs{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_msgTypes[0]
...
func (*SignozKubernetesStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Xorg/project-planton/provider/kubernetes/workload/signozkubernetes/v1/stack_outputs.proto\x12Dorg.project_planton.provider.kubernetes.workload.signozkubernetes.v1\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\"\xcc\x06\n" +
	...
	"Hcom.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1B\x11StackOutputsProtoP\x01Z\x87\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/signozkubernetes/v1;signozkubernetesv1\xa2\x02\x06OPPKWS\xaa\x02COrg.ProjectPlanton.Provider.Kubernetes.Workload.Signozkubernetes.V1\xca\x02COrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Signozkubernetes\\V1\xe2\x02OOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Signozkubernetes\\V1\\GPBMetadata\xea\x02IOrg::ProjectPlanton::Provider::Kubernetes::Workload::Signozkubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_goTypes = []any{
	(*SignozKubernetesStackOutputs)(nil),   // 0: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: org.project_planton.shared.kubernetes.KubernetesSecretKey
}
var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesStackOutputs.clickhouse_password_secret:type_name -> org.project_planton.shared.kubernetes.KubernetesSecretKey
...
func file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_stack_outputs_proto_depIdxs = nil
}
