...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/signozkubernetes/v1/spec.proto
...
func (x *SignozKubernetesSpec) Reset() {
	*x = SignozKubernetesSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[0]
...
func (*SignozKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SignozKubernetesContainer) Reset() {
	*x = SignozKubernetesContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *SignozKubernetesDatabaseConfig) Reset() {
	*x = SignozKubernetesDatabaseConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesDatabaseConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *SignozKubernetesExternalClickhouse) Reset() {
	*x = SignozKubernetesExternalClickhouse{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesExternalClickhouse) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *SignozKubernetesManagedClickhouse) Reset() {
	*x = SignozKubernetesManagedClickhouse{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesManagedClickhouse) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *SignozKubernetesClickhouseContainer) Reset() {
	*x = SignozKubernetesClickhouseContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesClickhouseContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *SignozKubernetesClickhouseCluster) Reset() {
	*x = SignozKubernetesClickhouseCluster{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesClickhouseCluster) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *SignozKubernetesZookeeperConfig) Reset() {
	*x = SignozKubernetesZookeeperConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesZookeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *SignozKubernetesZookeeperContainer) Reset() {
	*x = SignozKubernetesZookeeperContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
func (x *SignozKubernetesIngress) Reset() {
	*x = SignozKubernetesIngress{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{9}
}
...
func (x *SignozKubernetesIngressEndpoint) Reset() {
	*x = SignozKubernetesIngressEndpoint{}
	mi := &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignozKubernetesIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP(), []int{10}
}
...
var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*SignozKubernetesContainer)(nil),
		Field:         560001,
		Name:          "org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_signoz_container",
		Tag:           "bytes,560001,opt,name=default_signoz_container",
		Filename:      "org/project-planton/provider/kubernetes/workload/signozkubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*SignozKubernetesContainer)(nil),
		Field:         560002,
		Name:          "org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_otel_collector_container",
	...
	},
	{
		...
		Field:         560003,
		Name:          "org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_clickhouse_container",
	...
	},
	{
		...
		Field:         560004,
		Name:          "org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_zookeeper_container",
...
var (
	// optional org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer default_signoz_container = 560001;
	E_DefaultSignozContainer = &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes[0]
	// optional org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer default_otel_collector_container = 560002;
	E_DefaultOtelCollectorContainer = &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes[1]
	// optional org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer default_clickhouse_container = 560003;
	E_DefaultClickhouseContainer = &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes[2]
	// optional org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer default_zookeeper_container = 560004;
	E_DefaultZookeeperContainer = &file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes[3]
)

var File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Oorg/project-planton/provider/kubernetes/workload/signozkubernetes/v1/spec.proto\x12Dorg.project_planton.provider.kubernetes.workload.signozkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\x1a0org/project-planton/shared/options/options.proto\"\xde\x06\n" +
	"\x14SignozKubernetesSpec\x12\xb2\x01\n" +
	"\x10signoz_container\x18\x01 \x01(\v2_.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainerB&\x8a\xb8\x91\x02!\b\x01\x12\x1d\n" +
	"\f\n" +
	"\x051000m\x12\x032Gi\x12\r\n" +
	"\x04200m\x12\x05512MiR\x0fsignozContainer\x12\xbf\x01\n" +
	"\x18otel_collector_container\x18\x02 \x01(\v2_.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainerB$\x92\xb8\x91\x02\x1f\b\x02\x12\x1b\n" +
	"\f\n" +
	"\x052000m\x12\x034Gi\x12\v\n" +
	"\x04500m\x12\x031GiR\x16otelCollectorContainer\x12\x88\x01\n" +
	"\bdatabase\x18\x03 \x01(\v2d.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesDatabaseConfigB\x06\xbaH\x03\xc8\x01\x01R\bdatabase\x12w\n" +
	"\aingress\x18\x04 \x01(\v2].org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressR\aingress\x12\x8b\x01\n" +
	"\vhelm_values\x18\x05 \x03(\v2j.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.HelmValuesEntryR\n" +
	"helmValues\x1a=\n" +
	...
	"\x11external_database\x18\x02 \x01(\v2h.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesExternalClickhouseR\x10externalDatabase\x12\x92\x01\n" +
	"\x10managed_database\x18\x03 \x01(\v2g.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouseR\x0fmanagedDatabase:\xa0\x01\xbaH\x9c\x01\x1a\x99\x01\n" +
	...
	"!SignozKubernetesManagedClickhouse\x12\xb5\x01\n" +
	"\tcontainer\x18\x01 \x01(\v2i.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainerB,\x9a\xb8\x91\x02'\b\x01\x12\x1b\n" +
	"\f\n" +
	"\x052000m\x12\x034Gi\x12\v\n" +
	"\x04500m\x12\x031Gi \x01*\x0420GiR\tcontainer\x12\x81\x01\n" +
	"\acluster\x18\x02 \x01(\v2g.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseClusterR\acluster\x12\x83\x01\n" +
	"\tzookeeper\x18\x03 \x01(\v2e.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperConfigR\tzookeeper\"\xa3\x05\n" +
	...
	"\tcontainer\x18\x02 \x01(\v2h.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainerB,\xa2\xb8\x91\x02'\b\x01\x12\x1e\n" +
	"\r\n" +
	...
	"\x17SignozKubernetesIngress\x12u\n" +
	"\x02ui\x18\x01 \x01(\v2e.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressEndpointR\x02ui\x12\x8c\x01\n" +
	"\x0eotel_collector\x18\x02 \x01(\v2e.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressEndpointR\rotelCollector\"\xd6\x01\n" +
	...
	"\x18default_signoz_container\x12\x1d.google.protobuf.FieldOptions\x18\x81\x97\" \x01(\v2_.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainerR\x16defaultSignozContainer:\xc9\x01\n" +
	" default_otel_collector_container\x12\x1d.google.protobuf.FieldOptions\x18\x82\x97\" \x01(\v2_.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainerR\x1ddefaultOtelCollectorContainer:\xcc\x01\n" +
	"\x1cdefault_clickhouse_container\x12\x1d.google.protobuf.FieldOptions\x18\x83\x97\" \x01(\v2i.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainerR\x1adefaultClickhouseContainer:\xc9\x01\n" +
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\x84\x97\" \x01(\v2h.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainerR\x19defaultZookeeperContainerB\x94\x04\n" +
	"Hcom.org.project_planton.provider.kubernetes.workload.signozkubernetes.v1B\tSpecProtoP\x01Z\x87\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/signozkubernetes/v1;signozkubernetesv1\xa2\x02\x06OPPKWS\xaa\x02COrg.ProjectPlanton.Provider.Kubernetes.Workload.Signozkubernetes.V1\xca\x02COrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Signozkubernetes\\V1\xe2\x02OOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Signozkubernetes\\V1\\GPBMetadata\xea\x02IOrg::ProjectPlanton::Provider::Kubernetes::Workload::Signozkubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_goTypes = []any{
	(*SignozKubernetesSpec)(nil),                // 0: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec
	(*SignozKubernetesContainer)(nil),           // 1: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer
	(*SignozKubernetesDatabaseConfig)(nil),      // 2: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesDatabaseConfig
	(*SignozKubernetesExternalClickhouse)(nil),  // 3: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesExternalClickhouse
	(*SignozKubernetesManagedClickhouse)(nil),   // 4: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouse
	(*SignozKubernetesClickhouseContainer)(nil), // 5: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer
	(*SignozKubernetesClickhouseCluster)(nil),   // 6: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseCluster
	(*SignozKubernetesZookeeperConfig)(nil),     // 7: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperConfig
	(*SignozKubernetesZookeeperContainer)(nil),  // 8: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer
	(*SignozKubernetesIngress)(nil),             // 9: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngress
	(*SignozKubernetesIngressEndpoint)(nil),     // 10: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressEndpoint
	nil,                                         // 11: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.HelmValuesEntry
...
var file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_depIdxs = []int32{
	1,  // 0: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.signoz_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer
	1,  // 1: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.otel_collector_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer
	2,  // 2: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.database:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesDatabaseConfig
	9,  // 3: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.ingress:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngress
	11, // 4: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.helm_values:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesSpec.HelmValuesEntry
	12, // 5: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	13, // 6: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer.image:type_name -> org.project_planton.shared.kubernetes.ContainerImage
	3,  // 7: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesDatabaseConfig.external_database:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesExternalClickhouse
	4,  // 8: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesDatabaseConfig.managed_database:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouse
	5,  // 9: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouse.container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer
	6,  // 10: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouse.cluster:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseCluster
	7,  // 11: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesManagedClickhouse.zookeeper:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperConfig
	12, // 12: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	13, // 13: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer.image:type_name -> org.project_planton.shared.kubernetes.ContainerImage
	8,  // 14: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperConfig.container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer
	12, // 15: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	13, // 16: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer.image:type_name -> org.project_planton.shared.kubernetes.ContainerImage
	10, // 17: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngress.ui:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressEndpoint
	10, // 18: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngress.otel_collector:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesIngressEndpoint
	14, // 19: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_signoz_container:extendee -> google.protobuf.FieldOptions
	14, // 20: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_otel_collector_container:extendee -> google.protobuf.FieldOptions
	14, // 21: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_clickhouse_container:extendee -> google.protobuf.FieldOptions
	14, // 22: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_zookeeper_container:extendee -> google.protobuf.FieldOptions
	1,  // 23: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_signoz_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer
	1,  // 24: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_otel_collector_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesContainer
	5,  // 25: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_clickhouse_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesClickhouseContainer
	8,  // 26: org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.default_zookeeper_container:type_name -> org.project_planton.provider.kubernetes.workload.signozkubernetes.v1.SignozKubernetesZookeeperContainer
...
func file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 4,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_signozkubernetes_v1_spec_proto_depIdxs = nil
}
