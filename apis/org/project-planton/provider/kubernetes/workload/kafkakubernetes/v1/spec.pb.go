...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/kafkakubernetes/v1/spec.proto
...
func (x *KafkaKubernetesSpec) Reset() {
	*x = KafkaKubernetesSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[0]
...
func (*KafkaKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KafkaKubernetesBrokerContainer) Reset() {
	*x = KafkaKubernetesBrokerContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesBrokerContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KafkaKubernetesZookeeperContainer) Reset() {
	*x = KafkaKubernetesZookeeperContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KafkaKubernetesSchemaRegistryContainer) Reset() {
	*x = KafkaKubernetesSchemaRegistryContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaKubernetesSchemaRegistryContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KafkaTopic) Reset() {
	*x = KafkaTopic{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaTopic) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KafkaKubernetesBrokerContainer)(nil),
		Field:         524001,
		Name:          "org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_broker_container",
		Tag:           "bytes,524001,opt,name=default_broker_container",
		Filename:      "org/project-planton/provider/kubernetes/workload/kafkakubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*KafkaKubernetesZookeeperContainer)(nil),
		Field:         524002,
		Name:          "org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_zookeeper_container",
...
var (
	// optional org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainer default_broker_container = 524001;
	E_DefaultBrokerContainer = &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes[0]
	// optional org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer default_zookeeper_container = 524002;
	E_DefaultZookeeperContainer = &file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes[1]
)

var File_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Norg/project-planton/provider/kubernetes/workload/kafkakubernetes/v1/spec.proto\x12Corg.project_planton.provider.kubernetes.workload.kafkakubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\x1a3org/project-planton/shared/kubernetes/options.proto\x1a0org/project-planton/shared/options/options.proto\"\xbb\x06\n" +
	"\x13KafkaKubernetesSpec\x12r\n" +
	"\fkafka_topics\x18\x01 \x03(\v2O.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopicR\vkafkaTopics\x12\xba\x01\n" +
	"\x10broker_container\x18\x02 \x01(\v2c.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainerB*\x8a\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x0fbrokerContainer\x12\xc3\x01\n" +
	"\x13zookeeper_container\x18\x03 \x01(\v2f.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainerB*\x92\xee\xff\x01%\b\x01\x12\x1c\n" +
	"\f\n" +
	"\x051000m\x12\x031Gi\x12\f\n" +
	"\x0350m\x12\x05100Mi\x1a\x031GiR\x12zookeeperContainer\x12\xa7\x01\n" +
	"\x19schema_registry_container\x18\x04 \x01(\v2k.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainerR\x17schemaRegistryContainer\x12L\n" +
	...
	"\x06config\x18\x04 \x03(\v2[.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic.ConfigEntryB\xd1\x02\x9a\xa6\x1d\x18\n" +
	...
	"\v_partitionsB\v\n" +
	"\t_replicas:\xbe\x01\n" +
	"\x18default_broker_container\x12\x1d.google.protobuf.FieldOptions\x18\xe1\xfd\x1f \x01(\v2c.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainerR\x16defaultBrokerContainer:\xc7\x01\n" +
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfd\x1f \x01(\v2f.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainerR\x19defaultZookeeperContainerB\x8d\x04\n" +
	"Gcom.org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1B\tSpecProtoP\x01Z\x85\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/kafkakubernetes/v1;kafkakubernetesv1\xa2\x02\x06OPPKWK\xaa\x02BOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kafkakubernetes.V1\xca\x02BOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kafkakubernetes\\V1\xe2\x02NOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kafkakubernetes\\V1\\GPBMetadata\xea\x02HOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kafkakubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes = []any{
	(*KafkaKubernetesSpec)(nil),                    // 0: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec
	(*KafkaKubernetesBrokerContainer)(nil),         // 1: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	(*KafkaKubernetesZookeeperContainer)(nil),      // 2: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
	(*KafkaKubernetesSchemaRegistryContainer)(nil), // 3: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer
	(*KafkaTopic)(nil),                             // 4: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic
	nil,                                            // 5: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic.ConfigEntry
...
var file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs = []int32{
	4,  // 0: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec.kafka_topics:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic
	1,  // 1: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec.broker_container:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	2,  // 2: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec.zookeeper_container:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
	3,  // 3: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec.schema_registry_container:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer
	6,  // 4: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSpec.ingress:type_name -> org.project_planton.shared.kubernetes.IngressSpec
	7,  // 5: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	7,  // 6: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	7,  // 7: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesSchemaRegistryContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	5,  // 8: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic.config:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaTopic.ConfigEntry
	8,  // 9: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_broker_container:extendee -> google.protobuf.FieldOptions
	8,  // 10: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_zookeeper_container:extendee -> google.protobuf.FieldOptions
	1,  // 11: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_broker_container:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesBrokerContainer
	2,  // 12: org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.default_zookeeper_container:type_name -> org.project_planton.provider.kubernetes.workload.kafkakubernetes.v1.KafkaKubernetesZookeeperContainer
...
func init() {
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_init()
}
func file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kafkakubernetes_v1_spec_proto_depIdxs = nil
}
