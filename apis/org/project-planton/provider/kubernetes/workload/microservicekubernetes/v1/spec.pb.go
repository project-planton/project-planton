...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/microservicekubernetes/v1/spec.proto

package microservicekubernetesv1

import (
	_ "buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go/buf/validate"
	kubernetes1 "github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes"
...
func (x *MicroserviceKubernetesSpec) Reset() {
	*x = MicroserviceKubernetesSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[0]
...
func (*MicroserviceKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *MicroserviceKubernetesContainer) Reset() {
	*x = MicroserviceKubernetesContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *MicroserviceKubernetesContainerApp) Reset() {
	*x = MicroserviceKubernetesContainerApp{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesContainerApp) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *MicroserviceKubernetesContainerAppEnv) Reset() {
	*x = MicroserviceKubernetesContainerAppEnv{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesContainerAppEnv) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *MicroserviceKubernetesContainerAppPort) Reset() {
	*x = MicroserviceKubernetesContainerAppPort{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesContainerAppPort) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *MicroserviceKubernetesAvailability) Reset() {
	*x = MicroserviceKubernetesAvailability{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesAvailability) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *MicroserviceKubernetesAvailabilityHpa) Reset() {
	*x = MicroserviceKubernetesAvailabilityHpa{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesAvailabilityHpa) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *MicroserviceKubernetesDeploymentStrategy) Reset() {
	*x = MicroserviceKubernetesDeploymentStrategy{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesDeploymentStrategy) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *MicroserviceKubernetesPodDisruptionBudget) Reset() {
	*x = MicroserviceKubernetesPodDisruptionBudget{}
	mi := &file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MicroserviceKubernetesPodDisruptionBudget) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var File_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Uorg/project-planton/provider/kubernetes/workload/microservicekubernetes/v1/spec.proto\x12Jorg.project_planton.provider.kubernetes.workload.microservicekubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a3org/project-planton/provider/kubernetes/probe.proto\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\x1a3org/project-planton/shared/kubernetes/options.proto\"\xff\x04\n" +
	...
	"\tcontainer\x18\x03 \x01(\v2k.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerB\x06\xbaH\x03\xc8\x01\x01R\tcontainer\x12L\n" +
	"\aingress\x18\x04 \x01(\v22.org.project_planton.shared.kubernetes.IngressSpecR\aingress\x12\x92\x01\n" +
	"\favailability\x18\x05 \x01(\v2n.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailabilityR\favailability\"\xfa\x01\n" +
	"\x1fMicroserviceKubernetesContainer\x12\x88\x01\n" +
	"\x03app\x18\x01 \x01(\v2n.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppB\x06\xbaH\x03\xc8\x01\x01R\x03app\x12L\n" +
	"\bsidecars\x18\x02 \x03(\v20.org.project_planton.shared.kubernetes.ContainerR\bsidecars\"\xc4\a\n" +
	"\"MicroserviceKubernetesContainerApp\x12\x8b\x02\n" +
	...
	"\x03env\x18\x03 \x01(\v2q.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnvR\x03env\x12\x88\x01\n" +
	"\x05ports\x18\x04 \x03(\v2r.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppPortR\x05ports\x12U\n" +
	...
	"%MicroserviceKubernetesContainerAppEnv\x12\x9f\x01\n" +
	"\tvariables\x18\x01 \x03(\v2\x80\x01.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.VariablesEntryR\tvariables\x12\x98\x01\n" +
	"\asecrets\x18\x02 \x03(\v2~.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.SecretsEntryR\asecrets\x1a<\n" +
	...
	"\x1ahorizontal_pod_autoscaling\x18\x02 \x01(\v2q.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailabilityHpaR\x18horizontalPodAutoscaling\x12\xa5\x01\n" +
	"\x13deployment_strategy\x18\x03 \x01(\v2t.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesDeploymentStrategyR\x12deploymentStrategy\x12\xa9\x01\n" +
	"\x15pod_disruption_budget\x18\x04 \x01(\v2u.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesPodDisruptionBudgetR\x13podDisruptionBudget\"\xc7\x01\n" +
	...
	"Ncom.org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1B\tSpecProtoP\x01Z\x93\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/microservicekubernetes/v1;microservicekubernetesv1\xa2\x02\x06OPPKWM\xaa\x02IOrg.ProjectPlanton.Provider.Kubernetes.Workload.Microservicekubernetes.V1\xca\x02IOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Microservicekubernetes\\V1\xe2\x02UOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Microservicekubernetes\\V1\\GPBMetadata\xea\x02OOrg::ProjectPlanton::Provider::Kubernetes::Workload::Microservicekubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_goTypes = []any{
	(*MicroserviceKubernetesSpec)(nil),                // 0: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesSpec
	(*MicroserviceKubernetesContainer)(nil),           // 1: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainer
	(*MicroserviceKubernetesContainerApp)(nil),        // 2: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp
	(*MicroserviceKubernetesContainerAppEnv)(nil),     // 3: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv
	(*MicroserviceKubernetesContainerAppPort)(nil),    // 4: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppPort
	(*MicroserviceKubernetesAvailability)(nil),        // 5: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailability
	(*MicroserviceKubernetesAvailabilityHpa)(nil),     // 6: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailabilityHpa
	(*MicroserviceKubernetesDeploymentStrategy)(nil),  // 7: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesDeploymentStrategy
	(*MicroserviceKubernetesPodDisruptionBudget)(nil), // 8: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesPodDisruptionBudget
	nil,                                   // 9: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.VariablesEntry
	nil,                                   // 10: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.SecretsEntry
...
var file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_depIdxs = []int32{
	1,  // 0: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesSpec.container:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainer
	11, // 1: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesSpec.ingress:type_name -> org.project_planton.shared.kubernetes.IngressSpec
	5,  // 2: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesSpec.availability:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailability
	2,  // 3: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainer.app:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp
	12, // 4: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainer.sidecars:type_name -> org.project_planton.shared.kubernetes.Container
	13, // 5: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.image:type_name -> org.project_planton.shared.kubernetes.ContainerImage
	14, // 6: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	3,  // 7: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.env:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv
	4,  // 8: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.ports:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppPort
	15, // 9: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.liveness_probe:type_name -> org.project_planton.provider.kubernetes.Probe
	15, // 10: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.readiness_probe:type_name -> org.project_planton.provider.kubernetes.Probe
	15, // 11: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerApp.startup_probe:type_name -> org.project_planton.provider.kubernetes.Probe
	9,  // 12: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.variables:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.VariablesEntry
	10, // 13: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.secrets:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesContainerAppEnv.SecretsEntry
	6,  // 14: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailability.horizontal_pod_autoscaling:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailabilityHpa
	7,  // 15: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailability.deployment_strategy:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesDeploymentStrategy
	8,  // 16: org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesAvailability.pod_disruption_budget:type_name -> org.project_planton.provider.kubernetes.workload.microservicekubernetes.v1.MicroserviceKubernetesPodDisruptionBudget
...
func file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_microservicekubernetes_v1_spec_proto_depIdxs = nil
}
