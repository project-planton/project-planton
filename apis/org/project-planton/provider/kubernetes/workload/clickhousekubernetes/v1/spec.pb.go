...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto
...
func (ClickHouseKubernetesCoordinationConfig_CoordinationType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (ClickHouseKubernetesCoordinationConfig_CoordinationType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[0]
}
...
func (ClickHouseKubernetesCoordinationConfig_CoordinationType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{3, 0}
}
...
func (ClickHouseKubernetesLoggingConfig_LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[1].Descriptor()
}

func (ClickHouseKubernetesLoggingConfig_LogLevel) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[1]
}
...
func (ClickHouseKubernetesLoggingConfig_LogLevel) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{6, 0}
}
...
type ClickHouseKubernetesSpec struct {
	...
	//
	// Deprecated: Marked as deprecated in org/project-planton/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto.
...
func (x *ClickHouseKubernetesSpec) Reset() {
	*x = ClickHouseKubernetesSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[0]
...
func (*ClickHouseKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ClickHouseKubernetesContainer) Reset() {
	*x = ClickHouseKubernetesContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ClickHouseKubernetesContainer) GetPersistenceEnabled() bool {
	if x != nil {
...
func (x *ClickHouseKubernetesClusterConfig) Reset() {
	*x = ClickHouseKubernetesClusterConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesClusterConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
type ClickHouseKubernetesCoordinationConfig struct {
	...
	Type ClickHouseKubernetesCoordinationConfig_CoordinationType `protobuf:"varint,1,opt,name=type,proto3,enum=org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig_CoordinationType" json:"type,omitempty"`
	// *
...
func (x *ClickHouseKubernetesCoordinationConfig) Reset() {
	*x = ClickHouseKubernetesCoordinationConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *ClickHouseKubernetesKeeperConfig) Reset() {
	*x = ClickHouseKubernetesKeeperConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesKeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *ClickHouseKubernetesExternalCoordinationConfig) Reset() {
	*x = ClickHouseKubernetesExternalCoordinationConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesExternalCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
type ClickHouseKubernetesLoggingConfig struct {
	...
	Level         ClickHouseKubernetesLoggingConfig_LogLevel `protobuf:"varint,1,opt,name=level,proto3,enum=org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig_LogLevel" json:"level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClickHouseKubernetesLoggingConfig) Reset() {
	*x = ClickHouseKubernetesLoggingConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesLoggingConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *ClickHouseKubernetesIngress) Reset() {
	*x = ClickHouseKubernetesIngress{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *ClickHouseKubernetesZookeeperConfig) Reset() {
	*x = ClickHouseKubernetesZookeeperConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesZookeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*ClickHouseKubernetesContainer)(nil),
		Field:         519001,
		Name:          "org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.default_container",
		Tag:           "bytes,519001,opt,name=default_container",
		Filename:      "org/project-planton/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainer default_container = 519001;
	E_DefaultContainer = &file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes[0]
)

var File_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Sorg/project-planton/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto\x12Horg.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\"\xf7\a\n" +
	"\x18ClickHouseKubernetesSpec\x12I\n" +
	"\fcluster_name\x18\x01 \x01(\tB&\xbaH#r!2\x1f^[a-z0-9]([-a-z0-9]*[a-z0-9])?$R\vclusterName\x12\xb3\x01\n" +
	"\tcontainer\x18\x02 \x01(\v2g.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainerB,ʵ\xfd\x01'\b\x01\x12\x1b\n" +
	"\f\n" +
	"\x052000m\x12\x034Gi\x12\v\n" +
	"\x04500m\x12\x031Gi\x18\x01\"\x0450GiR\tcontainer\x12\x7f\n" +
	"\aingress\x18\x03 \x01(\v2e.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesIngressR\aingress\x12\x85\x01\n" +
	"\acluster\x18\x04 \x01(\v2k.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesClusterConfigR\acluster\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion\x12\x94\x01\n" +
	"\fcoordination\x18\x06 \x01(\v2p.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfigR\fcoordination\x12\x8f\x01\n" +
	"\tzookeeper\x18\a \x01(\v2m.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesZookeeperConfigB\x02\x18\x01R\tzookeeper\x12\x8d\x01\n" +
	"\alogging\x18\b \x01(\v2k.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfigB\x06\xbaH\x03\xc8\x01\x01R\alogging\"\xc5\x04\n" +
	...
	"&ClickHouseKubernetesCoordinationConfig\x12\x96\x01\n" +
	"\x04type\x18\x01 \x01(\x0e2\x81\x01.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.CoordinationTypeR\x04type\x12\x8f\x01\n" +
	"\rkeeper_config\x18\x02 \x01(\v2j.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesKeeperConfigR\fkeeperConfig\x12\xa1\x01\n" +
	"\x0fexternal_config\x18\x03 \x01(\v2x.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesExternalCoordinationConfigR\x0eexternalConfig\"\\\n" +
	"\x10CoordinationType\x12\x0f\n" +
	"\vunspecified\x10\x00\x12\n" +
	"\n" +
	"\x06keeper\x10\x01\x12\x13\n" +
	"\x0fexternal_keeper\x10\x02\x12\x16\n" +
	"\x12external_zookeeper\x10\x03\"\xf9\x01\n" +
	" ClickHouseKubernetesKeeperConfig\x12'\n" +
	"\breplicas\x18\x01 \x01(\x05B\v\xbaH\b\x1a\x060\x010\x030\x05R\breplicas\x12W\n" +
	...
	"!ClickHouseKubernetesLoggingConfig\x12\x8a\x01\n" +
	"\x05level\x18\x01 \x01(\x0e2t.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig.LogLevelR\x05level\"1\n" +
	"\bLogLevel\x12\x0f\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xd9\xd6\x1f \x01(\v2g.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainerR\x10defaultContainerB\xb0\x04\n" +
	"Lcom.org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1B\tSpecProtoP\x01Z\x8f\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/clickhousekubernetes/v1;clickhousekubernetesv1\xa2\x02\x06OPPKWC\xaa\x02GOrg.ProjectPlanton.Provider.Kubernetes.Workload.Clickhousekubernetes.V1\xca\x02GOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Clickhousekubernetes\\V1\xe2\x02SOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Clickhousekubernetes\\V1\\GPBMetadata\xea\x02MOrg::ProjectPlanton::Provider::Kubernetes::Workload::Clickhousekubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes = []any{
	(ClickHouseKubernetesCoordinationConfig_CoordinationType)(0), // 0: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.CoordinationType
	(ClickHouseKubernetesLoggingConfig_LogLevel)(0),              // 1: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig.LogLevel
	(*ClickHouseKubernetesSpec)(nil),                             // 2: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec
	(*ClickHouseKubernetesContainer)(nil),                        // 3: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainer
	(*ClickHouseKubernetesClusterConfig)(nil),                    // 4: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesClusterConfig
	(*ClickHouseKubernetesCoordinationConfig)(nil),               // 5: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig
	(*ClickHouseKubernetesKeeperConfig)(nil),                     // 6: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesKeeperConfig
	(*ClickHouseKubernetesExternalCoordinationConfig)(nil),       // 7: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesExternalCoordinationConfig
	(*ClickHouseKubernetesLoggingConfig)(nil),                    // 8: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig
	(*ClickHouseKubernetesIngress)(nil),                          // 9: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesIngress
	(*ClickHouseKubernetesZookeeperConfig)(nil),                  // 10: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesZookeeperConfig
...
var file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs = []int32{
	3,  // 0: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.container:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainer
	9,  // 1: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.ingress:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesIngress
	4,  // 2: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.cluster:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesClusterConfig
	5,  // 3: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.coordination:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig
	10, // 4: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.zookeeper:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesZookeeperConfig
	8,  // 5: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesSpec.logging:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig
	11, // 6: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainer.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	0,  // 7: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.type:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.CoordinationType
	6,  // 8: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.keeper_config:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesKeeperConfig
	7,  // 9: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesCoordinationConfig.external_config:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesExternalCoordinationConfig
	11, // 10: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesKeeperConfig.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	1,  // 11: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig.level:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfig.LogLevel
	12, // 12: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.default_container:extendee -> google.protobuf.FieldOptions
	3,  // 13: org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.default_container:type_name -> org.project_planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainer
...
func file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs = nil
}
