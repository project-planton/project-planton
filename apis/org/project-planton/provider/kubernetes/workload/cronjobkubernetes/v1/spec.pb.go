...
// 	protoc        (unknown)
// source: org/project-planton/provider/kubernetes/workload/cronjobkubernetes/v1/spec.proto
...
func (x *CronJobKubernetesSpec) Reset() {
	*x = CronJobKubernetesSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[0]
...
func (*CronJobKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CronJobKubernetesContainerAppEnv) Reset() {
	*x = CronJobKubernetesContainerAppEnv{}
	mi := &file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CronJobKubernetesContainerAppEnv) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Porg/project-planton/provider/kubernetes/workload/cronjobkubernetes/v1/spec.proto\x12Eorg.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a6org/project-planton/shared/kubernetes/kubernetes.proto\x1a3org/project-planton/shared/kubernetes/options.proto\x1a0org/project-planton/shared/options/options.proto\"\xc5\b\n" +
	"\x15CronJobKubernetesSpec\x12K\n" +
	...
	"\x03env\x18\x03 \x01(\v2g.org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnvR\x03env\x12\"\n" +
	...
	" CronJobKubernetesContainerAppEnv\x12\x94\x01\n" +
	"\tvariables\x18\x01 \x03(\v2v.org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.VariablesEntryR\tvariables\x12\x8e\x01\n" +
	"\asecrets\x18\x02 \x03(\v2t.org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.SecretsEntryR\asecrets\x1a<\n" +
	...
	"Icom.org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1B\tSpecProtoP\x01Z\x89\x01github.com/project-planton/project-planton/apis/org/project-planton/provider/kubernetes/workload/cronjobkubernetes/v1;cronjobkubernetesv1\xa2\x02\x06OPPKWC\xaa\x02DOrg.ProjectPlanton.Provider.Kubernetes.Workload.Cronjobkubernetes.V1\xca\x02DOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Cronjobkubernetes\\V1\xe2\x02POrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Cronjobkubernetes\\V1\\GPBMetadata\xea\x02JOrg::ProjectPlanton::Provider::Kubernetes::Workload::Cronjobkubernetes::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes = []any{
	(*CronJobKubernetesSpec)(nil),            // 0: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesSpec
	(*CronJobKubernetesContainerAppEnv)(nil), // 1: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv
	nil,                                      // 2: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.VariablesEntry
	nil,                                      // 3: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.SecretsEntry
...
var file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs = []int32{
	4, // 0: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesSpec.image:type_name -> org.project_planton.shared.kubernetes.ContainerImage
	5, // 1: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesSpec.resources:type_name -> org.project_planton.shared.kubernetes.ContainerResources
	1, // 2: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesSpec.env:type_name -> org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv
	2, // 3: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.variables:type_name -> org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.VariablesEntry
	3, // 4: org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.secrets:type_name -> org.project_planton.provider.kubernetes.workload.cronjobkubernetes.v1.CronJobKubernetesContainerAppEnv.SecretsEntry
...
func file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs = nil
}
