...
// 	protoc        (unknown)
// source: org/project-planton/provider/civo/civofirewall/v1/spec.proto
...
func (x *CivoFirewallSpec) Reset() {
	*x = CivoFirewallSpec{}
	mi := &file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_msgTypes[0]
...
func (*CivoFirewallSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoFirewallInboundRule) Reset() {
	*x = CivoFirewallInboundRule{}
	mi := &file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallInboundRule) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoFirewallOutboundRule) Reset() {
	*x = CivoFirewallOutboundRule{}
	mi := &file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallOutboundRule) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_project_planton_provider_civo_civofirewall_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<org/project-planton/provider/civo/civofirewall/v1/spec.proto\x121org.project_planton.provider.civo.civofirewall.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\"\xad\x03\n" +
	...
	"5com.org.project_planton.provider.civo.civofirewall.v1B\tSpecProtoP\x01Zpgithub.com/project-planton/project-planton/apis/org/project-planton/provider/civo/civofirewall/v1;civofirewallv1\xa2\x02\x05OPPCC\xaa\x020Org.ProjectPlanton.Provider.Civo.Civofirewall.V1\xca\x020Org\\ProjectPlanton\\Provider\\Civo\\Civofirewall\\V1\xe2\x02<Org\\ProjectPlanton\\Provider\\Civo\\Civofirewall\\V1\\GPBMetadata\xea\x025Org::ProjectPlanton::Provider::Civo::Civofirewall::V1b\x06proto3"

var (
	file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_goTypes = []any{
	(*CivoFirewallSpec)(nil),         // 0: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallSpec
	(*CivoFirewallInboundRule)(nil),  // 1: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallInboundRule
	(*CivoFirewallOutboundRule)(nil), // 2: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallOutboundRule
	(*v1.StringValueOrRef)(nil),      // 3: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallSpec.network_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallSpec.inbound_rules:type_name -> org.project_planton.provider.civo.civofirewall.v1.CivoFirewallInboundRule
	2, // 2: org.project_planton.provider.civo.civofirewall.v1.CivoFirewallSpec.outbound_rules:type_name -> org.project_planton.provider.civo.civofirewall.v1.CivoFirewallOutboundRule
...
func init() { file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_init() }
func file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_init() {
	if File_org_project_planton_provider_civo_civofirewall_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_civo_civofirewall_v1_spec_proto = out.File
	file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_civo_civofirewall_v1_spec_proto_depIdxs = nil
}
