...
// 	protoc        (unknown)
// source: org/project-planton/provider/cloudflare/cloudflared1database/v1/spec.proto
...
const file_org_project_planton_provider_cloudflare_cloudflared1database_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Jorg/project-planton/provider/cloudflare/cloudflared1database/v1/spec.proto\x12?org.project_planton.provider.cloudflare.cloudflared1database.v1\x1a\x1bbuf/validate/validate.proto\"\xaf\x02\n" +
