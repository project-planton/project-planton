...
// 	protoc        (unknown)
// source: org/project-planton/provider/aws/awssecuritygroup/v1/spec.proto
...
func (x *AwsSecurityGroupSpec) Reset() {
	*x = AwsSecurityGroupSpec{}
	mi := &file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[0]
...
func (*AwsSecurityGroupSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SecurityGroupRule) Reset() {
	*x = SecurityGroupRule{}
	mi := &file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecurityGroupRule) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"?org/project-planton/provider/aws/awssecuritygroup/v1/spec.proto\x124org.project_planton.provider.aws.awssecuritygroup.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\"\xda\x03\n" +
	...
	"\x06egress\x18\x04 \x03(\v2G.org.project_planton.provider.aws.awssecuritygroup.v1.SecurityGroupRuleR\x06egress\"\xe0\x03\n" +
...
var (
	...
	file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = []any{
	(*AwsSecurityGroupSpec)(nil), // 0: org.project_planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupSpec
	(*SecurityGroupRule)(nil),    // 1: org.project_planton.provider.aws.awssecuritygroup.v1.SecurityGroupRule
	(*v1.StringValueOrRef)(nil),  // 2: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.project_planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupSpec.vpc_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 1: org.project_planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupSpec.ingress:type_name -> org.project_planton.provider.aws.awssecuritygroup.v1.SecurityGroupRule
	1, // 2: org.project_planton.provider.aws.awssecuritygroup.v1.AwsSecurityGroupSpec.egress:type_name -> org.project_planton.provider.aws.awssecuritygroup.v1.SecurityGroupRule
...
func init() { file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_init() }
func file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_init() {
	if File_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = nil
}
