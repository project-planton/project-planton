...
// 	protoc        (unknown)
// source: org/project-planton/provider/aws/awsdynamodb/v1/spec.proto
...
func (AwsDynamodbSpec_BillingMode) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsDynamodbSpec_BillingMode) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[0]
}
...
func (AwsDynamodbSpec_BillingMode) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (AwsDynamodbSpec_AttributeType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AwsDynamodbSpec_AttributeType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[1]
}
...
func (AwsDynamodbSpec_AttributeType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 1}
}
...
func (AwsDynamodbSpec_StreamViewType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[2].Descriptor()
}

func (AwsDynamodbSpec_StreamViewType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[2]
}
...
func (AwsDynamodbSpec_StreamViewType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 2}
}
...
func (AwsDynamodbSpec_ProjectionType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[3].Descriptor()
}

func (AwsDynamodbSpec_ProjectionType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[3]
}
...
func (AwsDynamodbSpec_ProjectionType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 3}
}
...
func (AwsDynamodbSpec_TableClass) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[4].Descriptor()
}

func (AwsDynamodbSpec_TableClass) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[4]
}
...
func (AwsDynamodbSpec_KeySchemaElement_KeyType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[5].Descriptor()
}

func (AwsDynamodbSpec_KeySchemaElement_KeyType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes[5]
}
...
func (AwsDynamodbSpec_KeySchemaElement_KeyType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
type AwsDynamodbSpec struct {
	...
	BillingMode AwsDynamodbSpec_BillingMode `protobuf:"varint,1,opt,name=billing_mode,json=billingMode,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_BillingMode" json:"billing_mode,omitempty"`
	...
	StreamViewType AwsDynamodbSpec_StreamViewType `protobuf:"varint,9,opt,name=stream_view_type,json=streamViewType,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_StreamViewType" json:"stream_view_type,omitempty"`
	...
	// Table storage class.
	TableClass AwsDynamodbSpec_TableClass `protobuf:"varint,12,opt,name=table_class,json=tableClass,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_TableClass" json:"table_class,omitempty"`
...
func (x *AwsDynamodbSpec) Reset() {
	*x = AwsDynamodbSpec{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[0]
...
func (*AwsDynamodbSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
type AwsDynamodbSpec_AttributeDefinition struct {
	...
	Type          AwsDynamodbSpec_AttributeType `protobuf:"varint,2,opt,name=type,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_AttributeType" json:"type,omitempty"` // Attribute type
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AwsDynamodbSpec_AttributeDefinition) Reset() {
	*x = AwsDynamodbSpec_AttributeDefinition{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AwsDynamodbSpec_KeySchemaElement struct {
	...
	KeyType       AwsDynamodbSpec_KeySchemaElement_KeyType `protobuf:"varint,2,opt,name=key_type,json=keyType,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_KeySchemaElement_KeyType" json:"key_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AwsDynamodbSpec_KeySchemaElement) Reset() {
	*x = AwsDynamodbSpec_KeySchemaElement{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AwsDynamodbSpec_Projection struct {
	state            protoimpl.MessageState         `protogen:"open.v1"`
	Type             AwsDynamodbSpec_ProjectionType `protobuf:"varint,1,opt,name=type,proto3,enum=org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec_ProjectionType" json:"type,omitempty"` // ALL, KEYS_ONLY, or INCLUDE
...
func (x *AwsDynamodbSpec_Projection) Reset() {
	*x = AwsDynamodbSpec_Projection{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsDynamodbSpec_ProvisionedThroughput) Reset() {
	*x = AwsDynamodbSpec_ProvisionedThroughput{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsDynamodbSpec_GlobalSecondaryIndex) Reset() {
	*x = AwsDynamodbSpec_GlobalSecondaryIndex{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AwsDynamodbSpec_LocalSecondaryIndex) Reset() {
	*x = AwsDynamodbSpec_LocalSecondaryIndex{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDynamodbSpec_LocalSecondaryIndex) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *AwsDynamodbSpec_ServerSideEncryption) Reset() {
	*x = AwsDynamodbSpec_ServerSideEncryption{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDynamodbSpec_ServerSideEncryption) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 6}
}
...
func (x *AwsDynamodbSpec_TimeToLive) Reset() {
	*x = AwsDynamodbSpec_TimeToLive{}
	mi := &file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsDynamodbSpec_TimeToLive) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP(), []int{0, 7}
}
...
var File_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc = "" +
	"\n" +
	":org/project-planton/provider/aws/awsdynamodb/v1/spec.proto\x12/org.project_planton.provider.aws.awsdynamodb.v1\x1a\x1bbuf/validate/validate.proto\"\xc52\n" +
	...
	"\x15attribute_definitions\x18\x03 \x03(\v2T.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeDefinitionB\b\xbaH\x05\x92\x01\x02\b\x01R\x14attributeDefinitions\x12z\n" +
	"\n" +
	"key_schema\x18\x04 \x03(\v2Q.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElementB\b\xbaH\x05\x92\x01\x02\b\x01R\tkeySchema\x12\x8f\x01\n" +
	"\x18global_secondary_indexes\x18\x05 \x03(\v2U.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndexR\x16globalSecondaryIndexes\x12\x8c\x01\n" +
	"\x17local_secondary_indexes\x18\x06 \x03(\v2T.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.LocalSecondaryIndexR\x15localSecondaryIndexes\x12]\n" +
	"\x03ttl\x18\a \x01(\v2K.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TimeToLiveR\x03ttl\x12%\n" +
	"\x0estream_enabled\x18\b \x01(\bR\rstreamEnabled\x12\x83\x01\n" +
	"\x10stream_view_type\x18\t \x01(\x0e2O.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.StreamViewTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x0estreamViewType\x12B\n" +
	"\x1epoint_in_time_recovery_enabled\x18\n" +
	" \x01(\bR\x1apointInTimeRecoveryEnabled\x12\x8b\x01\n" +
	"\x16server_side_encryption\x18\v \x01(\v2U.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ServerSideEncryptionR\x14serverSideEncryption\x12v\n" +
	"\vtable_class\x18\f \x01(\x0e2K.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TableClassB\b\xbaH\x05\x82\x01\x02\x10\x01R\n" +
	"tableClass\x12>\n" +
	...
	"\x14write_capacity_units\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x12writeCapacityUnits\x1a\xbb\x05\n" +
	"\x14GlobalSecondaryIndex\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04name\x12z\n" +
	"\n" +
	"key_schema\x18\x02 \x03(\v2Q.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElementB\b\xbaH\x05\x92\x01\x02\b\x01R\tkeySchema\x12k\n" +
	"\n" +
	"projection\x18\x03 \x01(\v2K.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProjectionR\n" +
	"projection\x12\x8d\x01\n" +
	"\x16provisioned_throughput\x18\x04 \x01(\v2V.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProvisionedThroughputR\x15provisionedThroughput:\x8c\x02\xbaH\x88\x02\x1a\x85\x02\n" +
	"\x14gsi_key_schema_shape\x12<GSI must have exactly one HASH key and at most one RANGE key\x1a\xae\x01this.key_schema.filter(k, k.key_type == 1).size() == 1 && this.key_schema.filter(k, k.key_type == 2).size() <= 1 && this.key_schema.size() >= 1 && this.key_schema.size() <= 2\x1a\x83\x04\n" +
	"\x13LocalSecondaryIndex\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04name\x12z\n" +
	"\n" +
	"key_schema\x18\x02 \x03(\v2Q.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElementB\b\xbaH\x05\x92\x01\x02\b\x02R\tkeySchema\x12k\n" +
	"\n" +
	"projection\x18\x03 \x01(\v2K.org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProjectionR\n" +
	...
	"\x1egsi_throughput_matches_billing\x12\x93\x01For each GSI: when billing_mode is PROVISIONED, provisioned_throughput must be set with RCUs/WCUs > 0; for PAY_PER_REQUEST it must be unset or zero\x1a\xd7\x02this.global_secondary_indexes.all(i, this.billing_mode == 1 ? (has(i.provisioned_throughput) && i.provisioned_throughput.read_capacity_units > 0 && i.provisioned_throughput.write_capacity_units > 0) : (!has(i.provisioned_throughput) || (i.provisioned_throughput.read_capacity_units == 0 && i.provisioned_throughput.write_capacity_units == 0)))B\x8e\x03\n" +
	"3com.org.project_planton.provider.aws.awsdynamodb.v1B\tSpecProtoP\x01Zmgithub.com/project-planton/project-planton/apis/org/project-planton/provider/aws/awsdynamodb/v1;awsdynamodbv1\xa2\x02\x05OPPAA\xaa\x02.Org.ProjectPlanton.Provider.Aws.Awsdynamodb.V1\xca\x02.Org\\ProjectPlanton\\Provider\\Aws\\Awsdynamodb\\V1\xe2\x02:Org\\ProjectPlanton\\Provider\\Aws\\Awsdynamodb\\V1\\GPBMetadata\xea\x023Org::ProjectPlanton::Provider::Aws::Awsdynamodb::V1b\x06proto3"

var (
	file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_goTypes = []any{
	(AwsDynamodbSpec_BillingMode)(0),              // 0: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.BillingMode
	(AwsDynamodbSpec_AttributeType)(0),            // 1: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeType
	(AwsDynamodbSpec_StreamViewType)(0),           // 2: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.StreamViewType
	(AwsDynamodbSpec_ProjectionType)(0),           // 3: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProjectionType
	(AwsDynamodbSpec_TableClass)(0),               // 4: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TableClass
	(AwsDynamodbSpec_KeySchemaElement_KeyType)(0), // 5: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement.KeyType
	(*AwsDynamodbSpec)(nil),                       // 6: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec
	(*AwsDynamodbSpec_AttributeDefinition)(nil),   // 7: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeDefinition
	(*AwsDynamodbSpec_KeySchemaElement)(nil),      // 8: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement
	(*AwsDynamodbSpec_Projection)(nil),            // 9: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.Projection
	(*AwsDynamodbSpec_ProvisionedThroughput)(nil), // 10: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProvisionedThroughput
	(*AwsDynamodbSpec_GlobalSecondaryIndex)(nil),  // 11: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndex
	(*AwsDynamodbSpec_LocalSecondaryIndex)(nil),   // 12: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.LocalSecondaryIndex
	(*AwsDynamodbSpec_ServerSideEncryption)(nil),  // 13: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ServerSideEncryption
	(*AwsDynamodbSpec_TimeToLive)(nil),            // 14: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TimeToLive
}
var file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_depIdxs = []int32{
	0,  // 0: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.billing_mode:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.BillingMode
	10, // 1: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.provisioned_throughput:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProvisionedThroughput
	7,  // 2: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.attribute_definitions:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeDefinition
	8,  // 3: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.key_schema:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement
	11, // 4: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.global_secondary_indexes:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndex
	12, // 5: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.local_secondary_indexes:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.LocalSecondaryIndex
	14, // 6: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ttl:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TimeToLive
	2,  // 7: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.stream_view_type:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.StreamViewType
	13, // 8: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.server_side_encryption:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ServerSideEncryption
	4,  // 9: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.table_class:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.TableClass
	1,  // 10: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeDefinition.type:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.AttributeType
	5,  // 11: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement.key_type:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement.KeyType
	3,  // 12: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.Projection.type:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProjectionType
	8,  // 13: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndex.key_schema:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement
	9,  // 14: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndex.projection:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.Projection
	10, // 15: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.GlobalSecondaryIndex.provisioned_throughput:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.ProvisionedThroughput
	8,  // 16: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.LocalSecondaryIndex.key_schema:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.KeySchemaElement
	9,  // 17: org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.LocalSecondaryIndex.projection:type_name -> org.project_planton.provider.aws.awsdynamodb.v1.AwsDynamodbSpec.Projection
...
func init() { file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_init() }
func file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_init() {
	if File_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_depIdxs = nil
}
