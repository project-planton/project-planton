...
// 	protoc        (unknown)
// source: org/project-planton/provider/aws/awsstaticwebsite/v1/spec.proto
...
func (x *AwsStaticWebsiteSpec) Reset() {
	*x = AwsStaticWebsiteSpec{}
	mi := &file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_msgTypes[0]
...
func (*AwsStaticWebsiteSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsStaticWebsiteLogging) Reset() {
	*x = AwsStaticWebsiteLogging{}
	mi := &file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsStaticWebsiteLogging) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDesc = "" +
	"\n" +
	"?org/project-planton/provider/aws/awsstaticwebsite/v1/spec.proto\x124org.project_planton.provider.aws.awsstaticwebsite.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project-planton/shared/options/options.proto\"\x80\f\n" +
	"\x14AwsStaticWebsiteSpec\x12'\n" +
	"\n" +
	"enable_cdn\x18\x01 \x01(\bB\b\x92\xa6\x1d\x04trueR\tenableCdn\x12\x83\x01\n" +
	...
	"\x0edomain_aliases\x18\x03 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\rdomainAliases\x12\x85\x01\n" +
	"\x0fcertificate_arn\x18\x04 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xc9\x01\x92\xd4a\x17status.outputs.cert_arnR\x0ecertificateArn\x12\x8c\x01\n" +
	"\x12content_bucket_arn\x18\x05 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\xd5\x01\x92\xd4a\x19status.outputs.bucket_arnR\x10contentBucketArn\x12%\n" +
	...
	"priceClass\x12g\n" +
	"\alogging\x18\x10 \x01(\v2M.org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteLoggingR\alogging\x12h\n" +
	"\x04tags\x18\x11 \x03(\v2T.org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xc8\x01\xbaH\xc4\x01\x1a\xc1\x01\n" +
	"\x18cdn_aliases_require_cert\x12Scertificate_arn must be set when enable_cdn is true and domain_aliases are provided\x1aP!this.enable_cdn || this.domain_aliases.size() == 0 || has(this.certificate_arn)\"\x95\x02\n" +
	"\x17AwsStaticWebsiteLogging\x12\x1d\n" +
	"\n" +
	"s3_enabled\x18\x01 \x01(\bR\ts3Enabled\x12\x8f\x01\n" +
	"\x14s3_target_bucket_arn\x18\x02 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\"\x88\xd4a\xd5\x01\x92\xd4a\x19status.outputs.bucket_arnR\x11s3TargetBucketArn\x12(\n" +
	"\x10s3_target_prefix\x18\x03 \x01(\tR\x0es3TargetPrefix\x12\x1f\n" +
	"\vcdn_enabled\x18\x04 \x01(\bR\n" +
	"cdnEnabledB\xb1\x03\n" +
	"8com.org.project_planton.provider.aws.awsstaticwebsite.v1B\tSpecProtoP\x01Zwgithub.com/project-planton/project-planton/apis/org/project-planton/provider/aws/awsstaticwebsite/v1;awsstaticwebsitev1\xa2\x02\x05OPPAA\xaa\x023Org.ProjectPlanton.Provider.Aws.Awsstaticwebsite.V1\xca\x023Org\\ProjectPlanton\\Provider\\Aws\\Awsstaticwebsite\\V1\xe2\x02?Org\\ProjectPlanton\\Provider\\Aws\\Awsstaticwebsite\\V1\\GPBMetadata\xea\x028Org::ProjectPlanton::Provider::Aws::Awsstaticwebsite::V1b\x06proto3"

var (
	file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_goTypes = []any{
	(*AwsStaticWebsiteSpec)(nil),    // 0: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec
	(*AwsStaticWebsiteLogging)(nil), // 1: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteLogging
	nil,                             // 2: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.TagsEntry
	(*v1.StringValueOrRef)(nil),     // 3: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_depIdxs = []int32{
	3, // 0: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.route53_zone_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	3, // 1: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.certificate_arn:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	3, // 2: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.content_bucket_arn:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 3: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.logging:type_name -> org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteLogging
	2, // 4: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.tags:type_name -> org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteSpec.TagsEntry
	3, // 5: org.project_planton.provider.aws.awsstaticwebsite.v1.AwsStaticWebsiteLogging.s3_target_bucket_arn:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
...
func init() { file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_init() }
func file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_init() {
	if File_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awsstaticwebsite_v1_spec_proto_depIdxs = nil
}
