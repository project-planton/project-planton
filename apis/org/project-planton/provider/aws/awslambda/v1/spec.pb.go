...
// 	protoc        (unknown)
// source: org/project-planton/provider/aws/awslambda/v1/spec.proto
...
func (Architecture) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[0].Descriptor()
}

func (Architecture) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[0]
}
...
func (Architecture) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (CodeSourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[1].Descriptor()
}

func (CodeSourceType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes[1]
}
...
func (CodeSourceType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
type AwsLambdaSpec struct {
	...
	Architecture Architecture `protobuf:"varint,12,opt,name=architecture,proto3,enum=org.project_planton.provider.aws.awslambda.v1.Architecture" json:"architecture,omitempty"`
	...
	CodeSourceType CodeSourceType `protobuf:"varint,15,opt,name=code_source_type,json=codeSourceType,proto3,enum=org.project_planton.provider.aws.awslambda.v1.CodeSourceType" json:"code_source_type,omitempty"`
...
func (x *AwsLambdaSpec) Reset() {
	*x = AwsLambdaSpec{}
	mi := &file_org_project_planton_provider_aws_awslambda_v1_spec_proto_msgTypes[0]
...
func (x *S3Code) Reset() {
	*x = S3Code{}
	mi := &file_org_project_planton_provider_aws_awslambda_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_org_project_planton_provider_aws_awslambda_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8org/project-planton/provider/aws/awslambda/v1/spec.proto\x12-org.project_planton.provider.aws.awslambda.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\"\xd5\x12\n" +
	"\rAwsLambdaSpec\x12,\n" +
	"\rfunction_name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\ffunctionName\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12}\n" +
	"\brole_arn\x18\x03 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB&\xbaH\x03\xc8\x01\x01\x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\aroleArn\x12\x18\n" +
	...
	"1com.org.project_planton.provider.aws.awslambda.v1B\tSpecProtoP\x01Zigithub.com/project-planton/project-planton/apis/org/project-planton/provider/aws/awslambda/v1;awslambdav1\xa2\x02\x05OPPAA\xaa\x02,Org.ProjectPlanton.Provider.Aws.Awslambda.V1\xca\x02,Org\\ProjectPlanton\\Provider\\Aws\\Awslambda\\V1\xe2\x028Org\\ProjectPlanton\\Provider\\Aws\\Awslambda\\V1\\GPBMetadata\xea\x021Org::ProjectPlanton::Provider::Aws::Awslambda::V1b\x06proto3"

var (
	file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_project_planton_provider_aws_awslambda_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_project_planton_provider_aws_awslambda_v1_spec_proto_goTypes = []any{
	(Architecture)(0),           // 0: org.project_planton.provider.aws.awslambda.v1.Architecture
	(CodeSourceType)(0),         // 1: org.project_planton.provider.aws.awslambda.v1.CodeSourceType
	(*AwsLambdaSpec)(nil),       // 2: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec
	(*S3Code)(nil),              // 3: org.project_planton.provider.aws.awslambda.v1.S3Code
	nil,                         // 4: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.EnvironmentEntry
	(*v1.StringValueOrRef)(nil), // 5: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_aws_awslambda_v1_spec_proto_depIdxs = []int32{
	5, // 0: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.role_arn:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	4, // 1: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.environment:type_name -> org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.EnvironmentEntry
	5, // 2: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.subnets:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	5, // 3: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.security_groups:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	0, // 4: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.architecture:type_name -> org.project_planton.provider.aws.awslambda.v1.Architecture
	5, // 5: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.layer_arns:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	5, // 6: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.kms_key_arn:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 7: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.code_source_type:type_name -> org.project_planton.provider.aws.awslambda.v1.CodeSourceType
	3, // 8: org.project_planton.provider.aws.awslambda.v1.AwsLambdaSpec.s3:type_name -> org.project_planton.provider.aws.awslambda.v1.S3Code
...
func init() { file_org_project_planton_provider_aws_awslambda_v1_spec_proto_init() }
func file_org_project_planton_provider_aws_awslambda_v1_spec_proto_init() {
	if File_org_project_planton_provider_aws_awslambda_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awslambda_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_aws_awslambda_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awslambda_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_aws_awslambda_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_aws_awslambda_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awslambda_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awslambda_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awslambda_v1_spec_proto_depIdxs = nil
}
