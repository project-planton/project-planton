...
// 	protoc        (unknown)
// source: org/project-planton/provider/aws/awsecsservice/v1/spec.proto
...
func (x *AwsEcsServiceSpec) Reset() {
	*x = AwsEcsServiceSpec{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[0]
...
func (*AwsEcsServiceSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEcsServiceContainer) Reset() {
	*x = AwsEcsServiceContainer{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEcsServiceContainerLogging) Reset() {
	*x = AwsEcsServiceContainerLogging{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerLogging) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsEcsServiceContainerImage) Reset() {
	*x = AwsEcsServiceContainerImage{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerImage) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsEcsServiceContainerEnv) Reset() {
	*x = AwsEcsServiceContainerEnv{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerEnv) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsEcsServiceNetwork) Reset() {
	*x = AwsEcsServiceNetwork{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceNetwork) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsEcsServiceIam) Reset() {
	*x = AwsEcsServiceIam{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceIam) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsEcsServiceAlb) Reset() {
	*x = AwsEcsServiceAlb{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceAlb) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsEcsServiceHealthCheck) Reset() {
	*x = AwsEcsServiceHealthCheck{}
	mi := &file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceHealthCheck) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
const file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<org/project-planton/provider/aws/awsecsservice/v1/spec.proto\x121org.project_planton.provider.aws.awsecsservice.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project-planton/shared/options/options.proto\"\xa6\x04\n" +
	...
	"\x06memory\x18\x06 \x01(\x05B\x06\xbaH\x03\xc8\x01\x01R\x06memory\x12j\n" +
	"\alogging\x18\a \x01(\v2P.org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerLoggingR\alogging\"C\n" +
	...
	"\x03tag\x18\x02 \x01(\tR\x03tag\"\xaa\x03\n" +
	"\x19AwsEcsServiceContainerEnv\x12y\n" +
	"\tvariables\x18\x01 \x03(\v2[.org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntryR\tvariables\x12s\n" +
	"\asecrets\x18\x02 \x03(\v2Y.org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntryR\asecrets\x12#\n" +
	...
	"\x14AwsEcsServiceNetwork\x12a\n" +
	"\asubnets\x18\x01 \x03(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB\v\xbaH\x03\xc8\x01\x01\x88\xd4a\xd9\x01R\asubnets\x12\x8e\x01\n" +
	"\x0fsecurity_groups\x18\x02 \x03(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xd7\x01\x92\xd4a status.outputs.security_group_idR\x0esecurityGroups\"\xab\x02\n" +
	"\x10AwsEcsServiceIam\x12\x93\x01\n" +
	"\x17task_execution_role_arn\x18\x01 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\x14taskExecutionRoleArn\x12\x80\x01\n" +
	"\rtask_role_arn\x18\x02 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xd0\x01\x92\xd4a\x17status.outputs.role_arnR\vtaskRoleArn\"\x83\x04\n" +
	"\x10AwsEcsServiceAlb\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12w\n" +
	"\x03arn\x18\x02 \x01(\v2:.org.project_planton.shared.foreignkey.v1.StringValueOrRefB)\x88\xd4a\xc8\x01\x92\xd4a status.outputs.load_balancer_arnR\x03arn\x128\n" +
	...
	"\x11listener_priority\x18\a \x01(\x05B\a\x8a\xa6\x1d\x03100H\x00R\x10listenerPriority\x88\x01\x01\x12n\n" +
	"\fhealth_check\x18\b \x01(\v2K.org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheckR\vhealthCheckB\x14\n" +
	...
	"5com.org.project_planton.provider.aws.awsecsservice.v1B\tSpecProtoP\x01Zqgithub.com/project-planton/project-planton/apis/org/project-planton/provider/aws/awsecsservice/v1;awsecsservicev1\xa2\x02\x05OPPAA\xaa\x020Org.ProjectPlanton.Provider.Aws.Awsecsservice.V1\xca\x020Org\\ProjectPlanton\\Provider\\Aws\\Awsecsservice\\V1\xe2\x02<Org\\ProjectPlanton\\Provider\\Aws\\Awsecsservice\\V1\\GPBMetadata\xea\x025Org::ProjectPlanton::Provider::Aws::Awsecsservice::V1b\x06proto3"

var (
	file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_rawDesc)))
	})
...
var file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_goTypes = []any{
	...
	(*AwsEcsServiceContainerLogging)(nil), // 2: org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerLogging
	(*AwsEcsServiceContainerImage)(nil),   // 3: org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerImage
	(*AwsEcsServiceContainerEnv)(nil),     // 4: org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv
	(*AwsEcsServiceNetwork)(nil),          // 5: org.project_planton.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork
...
func file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_aws_awsecsservice_v1_spec_proto = out.File
	file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_aws_awsecsservice_v1_spec_proto_depIdxs = nil
}
