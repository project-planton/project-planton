...
// 	protoc        (unknown)
// source: org/project-planton/provider/gcp/gcpproject/v1/spec.proto
...
func (GcpProjectParentType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpProjectParentType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes[0]
}
...
func (x *GcpProjectSpec) Reset() {
	*x = GcpProjectSpec{}
	mi := &file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes[0]
...
const file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc = "" +
	"\n" +
	"9org/project-planton/provider/gcp/gcpproject/v1/spec.proto\x12.org.project_planton.provider.gcp.gcpproject.v1\x1a\x1bbuf/validate/validate.proto\x1a0org/project-planton/shared/options/options.proto\"\xeb\x04\n" +
...
var (
	...
	file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_goTypes = []any{
	(GcpProjectParentType)(0), // 0: org.project_planton.provider.gcp.gcpproject.v1.GcpProjectParentType
	(*GcpProjectSpec)(nil),    // 1: org.project_planton.provider.gcp.gcpproject.v1.GcpProjectSpec
	nil,                       // 2: org.project_planton.provider.gcp.gcpproject.v1.GcpProjectSpec.LabelsEntry
}
var file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_depIdxs = []int32{
	0, // 0: org.project_planton.provider.gcp.gcpproject.v1.GcpProjectSpec.parent_type:type_name -> org.project_planton.provider.gcp.gcpproject.v1.GcpProjectParentType
	2, // 1: org.project_planton.provider.gcp.gcpproject.v1.GcpProjectSpec.labels:type_name -> org.project_planton.provider.gcp.gcpproject.v1.GcpProjectSpec.LabelsEntry
...
func init() { file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_init() }
func file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_init() {
	if File_org_project_planton_provider_gcp_gcpproject_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_gcp_gcpproject_v1_spec_proto = out.File
	file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_gcp_gcpproject_v1_spec_proto_depIdxs = nil
}
