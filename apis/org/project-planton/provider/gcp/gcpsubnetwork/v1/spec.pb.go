...
// 	protoc        (unknown)
// source: org/project-planton/provider/gcp/gcpsubnetwork/v1/spec.proto
...
func (x *GcpSubnetworkSpec) Reset() {
	*x = GcpSubnetworkSpec{}
	mi := &file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes[0]
...
func (*GcpSubnetworkSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSubnetworkSecondaryRange) Reset() {
	*x = GcpSubnetworkSecondaryRange{}
	mi := &file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSubnetworkSecondaryRange) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<org/project-planton/provider/gcp/gcpsubnetwork/v1/spec.proto\x121org.project_planton.provider.gcp.gcpsubnetwork.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\"\xec\x04\n" +
	...
	"5com.org.project_planton.provider.gcp.gcpsubnetwork.v1B\tSpecProtoP\x01Zqgithub.com/project-planton/project-planton/apis/org/project-planton/provider/gcp/gcpsubnetwork/v1;gcpsubnetworkv1\xa2\x02\x05OPPGG\xaa\x020Org.ProjectPlanton.Provider.Gcp.Gcpsubnetwork.V1\xca\x020Org\\ProjectPlanton\\Provider\\Gcp\\Gcpsubnetwork\\V1\xe2\x02<Org\\ProjectPlanton\\Provider\\Gcp\\Gcpsubnetwork\\V1\\GPBMetadata\xea\x025Org::ProjectPlanton::Provider::Gcp::Gcpsubnetwork::V1b\x06proto3"

var (
	file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes = []any{
	(*GcpSubnetworkSpec)(nil),           // 0: org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSpec
	(*GcpSubnetworkSecondaryRange)(nil), // 1: org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSecondaryRange
	(*v1.StringValueOrRef)(nil),         // 2: org.project_planton.shared.foreignkey.v1.StringValueOrRef
}
var file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs = []int32{
	2, // 0: org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSpec.project_id:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	2, // 1: org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSpec.vpc_self_link:type_name -> org.project_planton.shared.foreignkey.v1.StringValueOrRef
	1, // 2: org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSpec.secondary_ip_ranges:type_name -> org.project_planton.provider.gcp.gcpsubnetwork.v1.GcpSubnetworkSecondaryRange
...
func init() { file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_init() }
func file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_init() {
	if File_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto = out.File
	file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs = nil
}
