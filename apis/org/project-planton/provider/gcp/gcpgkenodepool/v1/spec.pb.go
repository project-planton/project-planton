...
// 	protoc        (unknown)
// source: org/project-planton/provider/gcp/gcpgkenodepool/v1/spec.proto
...
func (x *GcpGkeNodePoolSpec) Reset() {
	*x = GcpGkeNodePoolSpec{}
	mi := &file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeNodePoolAutoscaling) Reset() {
	*x = GcpGkeNodePoolAutoscaling{}
	mi := &file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolAutoscaling) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGkeClusterNodePoolNodeManagement) Reset() {
	*x = GcpGkeClusterNodePoolNodeManagement{}
	mi := &file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterNodePoolNodeManagement) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=org/project-planton/provider/gcp/gcpgkenodepool/v1/spec.proto\x122org.project_planton.provider.gcp.gcpgkenodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project-planton/shared/foreignkey/v1/foreign_key.proto\x1a0org/project-planton/shared/options/options.proto\"\xd1\b\n" +
	...
	"6com.org.project_planton.provider.gcp.gcpgkenodepool.v1B\tSpecProtoP\x01Zsgithub.com/project-planton/project-planton/apis/org/project-planton/provider/gcp/gcpgkenodepool/v1;gcpgkenodepoolv1\xa2\x02\x05OPPGG\xaa\x021Org.ProjectPlanton.Provider.Gcp.Gcpgkenodepool.V1\xca\x021Org\\ProjectPlanton\\Provider\\Gcp\\Gcpgkenodepool\\V1\xe2\x02=Org\\ProjectPlanton\\Provider\\Gcp\\Gcpgkenodepool\\V1\\GPBMetadata\xea\x026Org::ProjectPlanton::Provider::Gcp::Gcpgkenodepool::V1b\x06proto3"

var (
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = []any{
	(*GcpGkeNodePoolSpec)(nil),                  // 0: org.project_planton.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec
	(*GcpGkeNodePoolAutoscaling)(nil),           // 1: org.project_planton.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolAutoscaling
	(*GcpGkeClusterNodePoolNodeManagement)(nil), // 2: org.project_planton.provider.gcp.gcpgkenodepool.v1.GcpGkeClusterNodePoolNodeManagement
	nil,                         // 3: org.project_planton.provider.gcp.gcpgkenodepool.v1.GcpGkeNodePoolSpec.NodeLabelsEntry
...
func file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_init() {
	if File_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
		(*GcpGkeNodePoolSpec_NodeCount)(nil),
		(*GcpGkeNodePoolSpec_Autoscaling)(nil),
	}
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto = out.File
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs = nil
}
