...
// 	protoc        (unknown)
// source: org/project-planton/provider/snowflake/snowflakedatabase/v1/spec.proto
...
func (x *SnowflakeDatabaseSpec) Reset() {
	*x = SnowflakeDatabaseSpec{}
	mi := &file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[0]
...
func (*SnowflakeDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SnowflakeDatabaseUserTask) Reset() {
	*x = SnowflakeDatabaseUserTask{}
	mi := &file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SnowflakeDatabaseUserTask) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Forg/project-planton/provider/snowflake/snowflakedatabase/v1/spec.proto\x12;org.project_planton.provider.snowflake.snowflakedatabase.v1\"\xd1\a\n" +
	...
	"traceLevel\x12s\n" +
	"\tuser_task\x18\x12 \x01(\v2V.org.project_planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTaskR\buserTask\"\xcd\x01\n" +
	...
	"?com.org.project_planton.provider.snowflake.snowflakedatabase.v1B\tSpecProtoP\x01Z\x7fgithub.com/project-planton/project-planton/apis/org/project-planton/provider/snowflake/snowflakedatabase/v1;snowflakedatabasev1\xa2\x02\x05OPPSS\xaa\x02:Org.ProjectPlanton.Provider.Snowflake.Snowflakedatabase.V1\xca\x02:Org\\ProjectPlanton\\Provider\\Snowflake\\Snowflakedatabase\\V1\xe2\x02FOrg\\ProjectPlanton\\Provider\\Snowflake\\Snowflakedatabase\\V1\\GPBMetadata\xea\x02?Org::ProjectPlanton::Provider::Snowflake::Snowflakedatabase::V1b\x06proto3"

var (
	file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = []any{
	(*SnowflakeDatabaseSpec)(nil),     // 0: org.project_planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseSpec
	(*SnowflakeDatabaseUserTask)(nil), // 1: org.project_planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTask
}
var file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseSpec.user_task:type_name -> org.project_planton.provider.snowflake.snowflakedatabase.v1.SnowflakeDatabaseUserTask
...
func init() { file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_init() }
func file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_init() {
	if File_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto = out.File
	file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = nil
}
