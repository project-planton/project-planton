...
const file_org_project_planton_provider_aws_awsdynamodb_v1_spec_proto_rawDesc = "" +
	...
	"\x1egsi_throughput_matches_billing\x12\x93\x01For each GSI: when billing_mode is PROVISIONED, provisioned_throughput must be set with RCUs/WCUs > 0; for PAY_PER_REQUEST it must be unset or zero\x1a\xd7\x02this.global_secondary_indexes.all(i, this.billing_mode == 1 ? (has(i.provisioned_throughput) && i.provisioned_throughput.read_capacity_units > 0 && i.provisioned_throughput.write_capacity_units > 0) : (!has(i.provisioned_throughput) || (i.provisioned_throughput.read_capacity_units == 0 && i.provisioned_throughput.write_capacity_units == 0)))B\x88\x03\n" +
	"3com.org.project_planton.provider.aws.awsdynamodb.v1B\tSpecProtoP\x01Zggithub.com/plantonhq/project-planton/apis/org/project_planton/provider/aws/awsdynamodb/v1;awsdynamodbv1\xa2\x02\x05OPPAA\xaa\x02.Org.ProjectPlanton.Provider.Aws.Awsdynamodb.V1\xca\x02.Org\\ProjectPlanton\\Provider\\Aws\\Awsdynamodb\\V1\xe2\x02:Org\\ProjectPlanton\\Provider\\Aws\\Awsdynamodb\\V1\\GPBMetadata\xea\x023Org::ProjectPlanton::Provider::Aws::Awsdynamodb::V1b\x06proto3"
