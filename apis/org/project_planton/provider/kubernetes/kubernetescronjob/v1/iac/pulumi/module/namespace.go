...
// resource in the KubernetesCronJob deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetescronjobv1.KubernetesCronJobStackInput,
