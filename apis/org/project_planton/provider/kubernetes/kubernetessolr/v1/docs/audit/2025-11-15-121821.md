...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetessolr/v1/`  
**Enum Value:** 818  
**ID Prefix:** k8ssolr
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetessolr/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetessolr/v1/
go test -v
```
