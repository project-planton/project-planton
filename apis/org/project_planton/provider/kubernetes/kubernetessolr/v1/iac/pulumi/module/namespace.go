...
// resource in the KubernetesSolr deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetessolrv1.KubernetesSolrStackInput,
