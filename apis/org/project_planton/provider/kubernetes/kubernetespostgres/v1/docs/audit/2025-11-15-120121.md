...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetespostgres/v1/`  
**Enum Value:** 814  
**ID Prefix:** k8spg  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetespostgres/v1/`
...
- `apis/org/project_planton/provider/kubernetes/kuberneteselasticsearch/v1/`
- `apis/org/project_planton/provider/kubernetes/kubernetesclickhouse/v1/`
