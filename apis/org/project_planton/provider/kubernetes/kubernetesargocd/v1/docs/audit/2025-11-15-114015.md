...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetesargocd/v1/`  
**Enum Value:** 800  
**ID Prefix:** k8sargo  
...
- Folder exists at correct path: `apis/org/project_planton/provider/kubernetes/kubernetesargocd/v1/`
