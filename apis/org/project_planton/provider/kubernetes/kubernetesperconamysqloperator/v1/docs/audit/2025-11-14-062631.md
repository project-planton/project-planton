...
**Provider:** kubernetes  
**Category:** addon  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamysqloperator/v1/`  
**Enum Value:** 834  
**ID Prefix:** percpgop
...
1. **Missing Unit Tests (spec_test.go)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamysqloperator/v1/spec_test.go`
...
- Folder exists at correct path: `apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamysqloperator/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamysqloperator/v1/
go test -v
```
