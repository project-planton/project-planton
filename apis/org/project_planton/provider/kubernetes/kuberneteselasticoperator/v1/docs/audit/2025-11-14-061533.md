...
**Provider:** kubernetes  
**Category:** addon  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/`  
**Enum Value:** 822  
**ID Prefix:** elaopk8s
...
1. **Add spec_test.go with unit tests**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/spec_test.go`
...
2. **Create user-facing README.md**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/README.md`
...
3. **Add Terraform locals.tf and outputs.tf**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/tf/locals.tf`, `outputs.tf`
...
2. **Incomplete Terraform implementation**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/tf/main.tf`
...
3. **Missing user-facing documentation**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/README.md`, `examples.md`
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/`
- Correctly placed under kubernetes/ category (matches kubernetes_meta.category)
...
```bash
cd apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/
go test -v
```
...
4. **Create examples.md with usage examples**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/examples.md`
...
7. **Create hack manifest for testing**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kuberneteselasticoperator/v1/iac/hack/manifest.yaml`
...
- [x] Folder exists under correct provider hierarchy (kubernetes/)
