# KubernetesPerconaPostgresOperator Terraform Module
...
**Value**: `kubernetes-percona-postgres-operator` (or custom namespace from spec)
...
helm status -n kubernetes-percona-postgres-operator pg-operator
```
