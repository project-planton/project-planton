...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesgitlab/v1/`  
**Enum Value:** 803  
**ID Prefix:** k8sgl  
**Category:** workload  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesgitlab/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesgitlab/v1/
go test -v
```
