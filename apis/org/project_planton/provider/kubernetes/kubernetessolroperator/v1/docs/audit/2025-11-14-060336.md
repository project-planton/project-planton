...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetessolroperator/v1/`  
**Enum Value:** 828  
**ID Prefix:** slropk8s
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetessolroperator/v1/`
