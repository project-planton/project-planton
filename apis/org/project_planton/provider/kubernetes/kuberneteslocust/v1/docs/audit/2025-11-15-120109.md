...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kuberneteslocust/v1/`  
**Enum Value:** 809  
**ID Prefix:** k8sloc
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kuberneteslocust/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/kuberneteslocust/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/kubernetesargocd/v1/`
