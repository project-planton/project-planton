...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/`  
**Enum Value:** 827  
**ID Prefix:** pgopk8s  
**Category:** addon
...
1. **Create v1/README.md (+6.67%)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/README.md`
...
2. **Create v1/examples.md (+6.66%)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/examples.md`
...
3. **Create iac/pulumi/README.md (+3.34%)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/pulumi/README.md`
...
1. **Missing User-Facing Documentation (13.33%)**
   ...
   - **Files:**
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/README.md`
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/examples.md`
...
2. **Incomplete Terraform Implementation (2.66%)**
   ...
   - **Files:**
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/main.tf` (empty)
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/locals.tf` (missing)
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/outputs.tf` (missing)
...
3. **Missing Supporting Documentation (12.22%)**
   ...
   - **Files:**
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/pulumi/README.md`
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/pulumi/overview.md`
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/README.md`
     - `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/hack/manifest.yaml`
...
- Folder exists under correct hierarchy: `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/
go test -v
```
...
3. **Complete or Remove Terraform Implementation**
   - **Files:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/`
...
5. **Create iac/pulumi/overview.md**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/pulumi/overview.md`
...
6. **Create iac/hack/manifest.yaml**
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/hack/manifest.yaml`
...
7. **Add Terraform supporting docs (if Terraform is implemented)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/tf/README.md`
...
8. **Consider adding iac/pulumi/examples.md (optional)**
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/kuberneteszalandopostgresoperator/v1/iac/pulumi/examples.md`
