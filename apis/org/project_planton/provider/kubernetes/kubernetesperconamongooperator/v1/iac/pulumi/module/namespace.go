...
// resource in the KubernetesPerconaMongoOperator deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetesperconamongooperatorv1.KubernetesPerconaMongoOperatorStackInput,
