...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamongooperator/v1/`  
**Enum Value:** 833  
**ID Prefix:** percmdbop  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/addon/kubernetesperconamongooperator/v1/`
