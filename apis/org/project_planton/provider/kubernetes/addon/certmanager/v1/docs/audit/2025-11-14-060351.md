# Audit Report: CertManager

**Audit Date:** 2025-11-14 06:03:51  
**Component Kind:** CertManager  
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/certmanager/v1/`  
**Enum Value:** 821  
**ID Prefix:** cmk8s  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/addon/certmanager/v1/`
- Folder is under correct Kubernetes category (addon)
- Folder name matches lowercase enum name (certmanager)
- `v1/` subfolder exists
...
```bash
cd apis/org/project_planton/provider/kubernetes/addon/certmanager/v1/
go test -v
```
...
- `variables.tf` is a minimal stub that doesn't reflect the complexity of CertManagerSpec
...
2. **variables.tf** - Complete variable definitions matching spec.proto:
   ...
   - cert_manager_version (with default)
...
- Contains all required sections:
  ...
  - Using cert-manager section (understanding resources, requesting certificates)
...
- For Terraform implementation: `apis/org/project_planton/provider/kubernetes/addon/externaldns/v1/iac/tf/`
- For test structure: `apis/org/project_planton/provider/kubernetes/addon/externaldns/v1/*_test.go`
- For examples: `apis/org/project_planton/provider/kubernetes/addon/externaldns/v1/examples.md`
...
- [x] Folder name is lowercase (certmanager)
