...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/addon/externaldns/v1/api.proto
...
var File_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto protoreflect.FileDescriptor
...
var (
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDescData
}
...
func init() { file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_init() }
func file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_init() {
	if File_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_spec_proto_init()
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto = out.File
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_addon_externaldns_v1_api_proto_depIdxs = nil
}
