...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetesneo4j/v1/`  
**Enum Value:** 812  
**ID Prefix:** k8sneo  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetesneo4j/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/kubernetesneo4j/v1/
go test -v
```
