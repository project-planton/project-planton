...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/kubernetesclickhouse/v1/api.proto
...
func (x *KubernetesClickHouse) Reset() {
	*x = KubernetesClickHouse{}
	mi := &file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_msgTypes[0]
...
func (*KubernetesClickHouse) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesClickHouseStatus) Reset() {
	*x = KubernetesClickHouseStatus{}
	mi := &file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseStatus) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto protoreflect.FileDescriptor
...
const file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDesc = "" +
	...
	"\aoutputs\x18\x01 \x01(\v2a.org.project_planton.provider.kubernetes.kubernetesclickhouse.v1.KubernetesClickHouseStackOutputsR\aoutputsB\xf1\x03\n" +
...
var (
	...
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDescData
}
...
func init() { file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_init() }
func file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_init() {
	if File_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_spec_proto_init()
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto = out.File
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_kubernetesclickhouse_v1_api_proto_depIdxs = nil
}
