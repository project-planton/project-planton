...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/kuberneteskafka/v1/stack_outputs.proto
...
func (x *KubernetesKafkaStackOutputs) Reset() {
	*x = KubernetesKafkaStackOutputs{}
	mi := &file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesKafkaStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Norg/project_planton/provider/kubernetes/kuberneteskafka/v1/stack_outputs.proto\x12Corg.project_planton.provider.kubernetes.workload.kuberneteskafka.v1\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\"\x8b\x04\n" +
	...
	"\x15kafka_ui_external_url\x18\b \x01(\tR\x12kafkaUiExternalUrlB\x8b\x04\n" +
...
var (
	...
	file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDescData
}
...
func file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_init() {
	if File_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto = out.File
	file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_kuberneteskafka_v1_stack_outputs_proto_depIdxs = nil
}
