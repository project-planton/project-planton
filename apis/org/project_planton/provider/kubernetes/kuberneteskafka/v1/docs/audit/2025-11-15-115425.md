...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/`  
**Enum Value:** 807  
**ID Prefix:** k8skaf
...
- Folder exists at correct path: `apis/org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/workload/kuberneteselasticsearch/v1/`
