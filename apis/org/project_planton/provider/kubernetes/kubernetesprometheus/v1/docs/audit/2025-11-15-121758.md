...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetesprometheus/v1/`  
**Enum Value:** 815  
**ID Prefix:** k8sprom  
**Category:** workload  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetesprometheus/v1/`
