...
// resource in the KubernetesSignoz deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetessignozv1.KubernetesSignozStackInput,
