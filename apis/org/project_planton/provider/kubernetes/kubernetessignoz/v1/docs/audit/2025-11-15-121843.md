...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetessignoz/v1/`  
**Enum Value:** 817  
**ID Prefix:** k8ssgz  
**Category:** workload  
...
**Excellent News!** This component is already fully complete. There are no quick wins needed—all items are implemented.
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetessignoz/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/kubernetessignoz/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/kubernetessignoz/v1/`
