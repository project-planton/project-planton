...
// resource in the KubernetesRedis deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetesredisv1.KubernetesRedisStackInput,
