...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesredis/v1/`  
**Enum Value:** 816  
**ID Prefix:** k8sred  
**Category:** workload  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesredis/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesredis/v1/
go test -v
```
