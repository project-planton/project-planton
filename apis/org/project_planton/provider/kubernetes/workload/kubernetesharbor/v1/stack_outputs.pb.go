...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kubernetesharbor/v1/stack_outputs.proto
...
func (x *KubernetesHarborStackOutputs) Reset() {
	*x = KubernetesHarborStackOutputs{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesHarborStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Xorg/project_planton/provider/kubernetes/workload/kubernetesharbor/v1/stack_outputs.proto\x12Dorg.project_planton.provider.kubernetes.workload.kubernetesharbor.v1\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\"\xa9\b\n" +
	...
	"Hcom.org.project_planton.provider.kubernetes.workload.kubernetesharbor.v1B\x11StackOutputsProtoP\x01Z\x87\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kubernetesharbor/v1;kubernetesharborv1\xa2\x02\x06OPPKWK\xaa\x02COrg.ProjectPlanton.Provider.Kubernetes.Workload.Kubernetesharbor.V1\xca\x02COrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesharbor\\V1\xe2\x02OOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesharbor\\V1\\GPBMetadata\xea\x02IOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kubernetesharbor::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_goTypes = []any{
	(*KubernetesHarborStackOutputs)(nil),   // 0: org.project_planton.provider.kubernetes.workload.kubernetesharbor.v1.KubernetesHarborStackOutputs
	(*kubernetes.KubernetesSecretKey)(nil), // 1: org.project_planton.shared.kubernetes.KubernetesSecretKey
}
var file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.kubernetes.workload.kubernetesharbor.v1.KubernetesHarborStackOutputs.admin_password_secret:type_name -> org.project_planton.shared.kubernetes.KubernetesSecretKey
	1, // 1: org.project_planton.provider.kubernetes.workload.kubernetesharbor.v1.KubernetesHarborStackOutputs.database_password_secret:type_name -> org.project_planton.shared.kubernetes.KubernetesSecretKey
	1, // 2: org.project_planton.provider.kubernetes.workload.kubernetesharbor.v1.KubernetesHarborStackOutputs.redis_password_secret:type_name -> org.project_planton.shared.kubernetes.KubernetesSecretKey
...
func file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kubernetesharbor_v1_stack_outputs_proto_depIdxs = nil
}
