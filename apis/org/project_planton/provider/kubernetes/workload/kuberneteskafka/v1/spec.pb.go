...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/spec.proto
...
func (x *KubernetesKafkaSpec) Reset() {
	*x = KubernetesKafkaSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[0]
...
func (*KubernetesKafkaSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesKafkaBrokerContainer) Reset() {
	*x = KubernetesKafkaBrokerContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaBrokerContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesKafkaZookeeperContainer) Reset() {
	*x = KubernetesKafkaZookeeperContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesKafkaSchemaRegistryContainer) Reset() {
	*x = KubernetesKafkaSchemaRegistryContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesKafkaSchemaRegistryContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KafkaTopic) Reset() {
	*x = KafkaTopic{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KafkaTopic) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
...
var (
	...
	E_DefaultBrokerContainer = &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_extTypes[0]
	...
	E_DefaultZookeeperContainer = &file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_extTypes[1]
)

var File_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Norg/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/spec.proto\x12Corg.project_planton.provider.kubernetes.workload.kuberneteskafka.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\x1a3org/project_planton/shared/kubernetes/options.proto\x1a0org/project_planton/shared/options/options.proto\"\xbb\x06\n" +
	...
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfd\x1f \x01(\v2f.org.project_planton.provider.kubernetes.workload.kuberneteskafka.v1.KubernetesKafkaZookeeperContainerR\x19defaultZookeeperContainerB\x8d\x04\n" +
	"Gcom.org.project_planton.provider.kubernetes.workload.kuberneteskafka.v1B\tSpecProtoP\x01Z\x85\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1;kuberneteskafkav1\xa2\x02\x06OPPKWK\xaa\x02BOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kuberneteskafka.V1\xca\x02BOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kuberneteskafka\\V1\xe2\x02NOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kuberneteskafka\\V1\\GPBMetadata\xea\x02HOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kuberneteskafka::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_goTypes = []any{
...
var file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_depIdxs = []int32{
...
func file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kuberneteskafka_v1_spec_proto_depIdxs = nil
}
