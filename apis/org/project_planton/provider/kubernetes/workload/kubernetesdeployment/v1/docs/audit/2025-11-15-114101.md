...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesdeployment/v1/`  
**Enum Value:** 810  
**ID Prefix:** k8sdpl  
**Category:** workload  
...
- Folder exists at correct path: `apis/org/project_planton/provider/kubernetes/workload/kubernetesdeployment/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesdeployment/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesdeployment/v1/`
