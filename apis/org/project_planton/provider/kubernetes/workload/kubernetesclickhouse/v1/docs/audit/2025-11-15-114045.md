...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/`  
**Enum Value:** 830  
**ID Prefix:** k8sclkhs  
**Category:** workload  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/
go test -v
```
...
**Recommended as reference:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/`
