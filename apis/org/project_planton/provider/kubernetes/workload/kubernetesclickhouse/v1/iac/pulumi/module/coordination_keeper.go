...
func buildAutoManagedKeeperReference(coordination *kubernetesclickhousev1.KubernetesClickHouseCoordinationConfig) *altinityv1.ClickHouseInstallationSpecConfigurationZookeeperArgs {
...
func buildExternalKeeperReference(coordination *kubernetesclickhousev1.KubernetesClickHouseCoordinationConfig) *altinityv1.ClickHouseInstallationSpecConfigurationZookeeperArgs {
