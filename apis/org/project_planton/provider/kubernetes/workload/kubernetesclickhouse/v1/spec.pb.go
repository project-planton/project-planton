...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/spec.proto
...
func (KubernetesClickHouseCoordinationConfig_CoordinationType) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes[0].Descriptor()
}

func (KubernetesClickHouseCoordinationConfig_CoordinationType) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes[0]
}
...
func (KubernetesClickHouseCoordinationConfig_CoordinationType) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{3, 0}
}
...
func (KubernetesClickHouseLoggingConfig_LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes[1].Descriptor()
}

func (KubernetesClickHouseLoggingConfig_LogLevel) Type() protoreflect.EnumType {
	return &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes[1]
}
...
func (KubernetesClickHouseLoggingConfig_LogLevel) EnumDescriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{6, 0}
}
...
type KubernetesClickHouseSpec struct {
	...
	Container *KubernetesClickHouseContainer `protobuf:"bytes,2,opt,name=container,proto3" json:"container,omitempty"`
	// The ingress configuration for the ClickHouse deployment.
	Ingress *KubernetesClickHouseIngress `protobuf:"bytes,3,opt,name=ingress,proto3" json:"ingress,omitempty"`
	// The cluster configuration for ClickHouse sharding and replication.
	Cluster *KubernetesClickHouseClusterConfig `protobuf:"bytes,4,opt,name=cluster,proto3" json:"cluster,omitempty"`
	// *
	...
	Coordination *KubernetesClickHouseCoordinationConfig `protobuf:"bytes,6,opt,name=coordination,proto3" json:"coordination,omitempty"`
	// *
	...
	//
	// Deprecated: Marked as deprecated in org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/spec.proto.
	Zookeeper *KubernetesClickHouseZookeeperConfig `protobuf:"bytes,7,opt,name=zookeeper,proto3" json:"zookeeper,omitempty"`
	// *
	...
	Logging       *KubernetesClickHouseLoggingConfig `protobuf:"bytes,8,opt,name=logging,proto3" json:"logging,omitempty"`
...
func (x *KubernetesClickHouseSpec) Reset() {
	*x = KubernetesClickHouseSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[0]
...
func (*KubernetesClickHouseSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesClickHouseContainer) Reset() {
	*x = KubernetesClickHouseContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesClickHouseClusterConfig) Reset() {
	*x = KubernetesClickHouseClusterConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseClusterConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *KubernetesClickHouseCoordinationConfig) Reset() {
	*x = KubernetesClickHouseCoordinationConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *KubernetesClickHouseKeeperConfig) Reset() {
	*x = KubernetesClickHouseKeeperConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseKeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *KubernetesClickHouseExternalCoordinationConfig) Reset() {
	*x = KubernetesClickHouseExternalCoordinationConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseExternalCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *KubernetesClickHouseLoggingConfig) Reset() {
	*x = KubernetesClickHouseLoggingConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseLoggingConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *KubernetesClickHouseIngress) Reset() {
	*x = KubernetesClickHouseIngress{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseIngress) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *KubernetesClickHouseZookeeperConfig) Reset() {
	*x = KubernetesClickHouseZookeeperConfig{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClickHouseZookeeperConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_extTypes[0]
)

var File_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Sorg/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1/spec.proto\x12Horg.project_planton.provider.kubernetes.workload.kubernetesclickhouse.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\"\xf7\a\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xd9\xd6\x1f \x01(\v2g.org.project_planton.provider.kubernetes.workload.kubernetesclickhouse.v1.KubernetesClickHouseContainerR\x10defaultContainerB\xb0\x04\n" +
	"Lcom.org.project_planton.provider.kubernetes.workload.kubernetesclickhouse.v1B\tSpecProtoP\x01Z\x8f\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kubernetesclickhouse/v1;kubernetesclickhousev1\xa2\x02\x06OPPKWK\xaa\x02GOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kubernetesclickhouse.V1\xca\x02GOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesclickhouse\\V1\xe2\x02SOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesclickhouse\\V1\\GPBMetadata\xea\x02MOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kubernetesclickhouse::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_goTypes = []any{
...
var file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_depIdxs = []int32{
...
func init() {
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_init()
}
func file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_depIdxs,
		EnumInfos:         file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_enumTypes,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kubernetesclickhouse_v1_spec_proto_depIdxs = nil
}
