...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kuberneteshttpendpoint/v1/spec.proto
...
func (x *KubernetesHttpEndpointSpec) Reset() {
	*x = KubernetesHttpEndpointSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[0]
...
func (*KubernetesHttpEndpointSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesHttpEndpointRoutingRule) Reset() {
	*x = KubernetesHttpEndpointRoutingRule{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRule) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesHttpEndpointRoutingRuleBackendService) Reset() {
	*x = KubernetesHttpEndpointRoutingRuleBackendService{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRuleBackendService) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Uorg/project_planton/provider/kubernetes/workload/kuberneteshttpendpoint/v1/spec.proto\x12Jorg.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1\x1a\x1bbuf/validate/validate.proto\"\xc5\x02\n" +
	...
	"\x16is_grpc_web_compatible\x18\x03 \x01(\bR\x13isGrpcWebCompatible\x12\x92\x01\n" +
	"\rrouting_rules\x18\x04 \x03(\v2m.org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleR\froutingRules\"\x82\x02\n" +
	"!KubernetesHttpEndpointRoutingRule\x12.\n" +
	"\x0furl_path_prefix\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\rurlPathPrefix\x12\xac\x01\n" +
	"\x0fbackend_service\x18\x02 \x01(\v2{.org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleBackendServiceB\x06\xbaH\x03\xc8\x01\x01R\x0ebackendService\"w\n" +
	"/KubernetesHttpEndpointRoutingRuleBackendService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x12\n" +
	"\x04port\x18\x03 \x01(\x05R\x04portB\xbe\x04\n" +
	"Ncom.org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1B\tSpecProtoP\x01Z\x93\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kuberneteshttpendpoint/v1;kuberneteshttpendpointv1\xa2\x02\x06OPPKWK\xaa\x02IOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kuberneteshttpendpoint.V1\xca\x02IOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kuberneteshttpendpoint\\V1\xe2\x02UOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kuberneteshttpendpoint\\V1\\GPBMetadata\xea\x02OOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kuberneteshttpendpoint::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes = []any{
	(*KubernetesHttpEndpointSpec)(nil),                      // 0: org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointSpec
	(*KubernetesHttpEndpointRoutingRule)(nil),               // 1: org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRule
	(*KubernetesHttpEndpointRoutingRuleBackendService)(nil), // 2: org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleBackendService
}
var file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointSpec.routing_rules:type_name -> org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRule
	2, // 1: org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRule.backend_service:type_name -> org.project_planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1.KubernetesHttpEndpointRoutingRuleBackendService
...
func file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs = nil
}
