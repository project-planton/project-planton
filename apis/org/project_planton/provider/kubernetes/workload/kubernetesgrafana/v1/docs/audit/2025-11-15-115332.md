...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesgrafana/v1/`  
**Enum Value:** 804  
**ID Prefix:** k8sgfn  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesgrafana/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesgrafana/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesredis/v1/`
