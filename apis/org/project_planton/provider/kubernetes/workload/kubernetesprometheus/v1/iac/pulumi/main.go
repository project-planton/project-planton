...
import (
	...
	"github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kubernetesprometheus/v1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &kubernetesprometheusv1.KubernetesPrometheusStackInput{}
