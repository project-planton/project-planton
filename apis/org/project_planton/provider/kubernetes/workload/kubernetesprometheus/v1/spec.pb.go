...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kubernetesprometheus/v1/spec.proto
...
func (x *KubernetesPrometheusSpec) Reset() {
	*x = KubernetesPrometheusSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_msgTypes[0]
...
func (*KubernetesPrometheusSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesPrometheusContainer) Reset() {
	*x = KubernetesPrometheusContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesPrometheusContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Sorg/project_planton/provider/kubernetes/workload/kubernetesprometheus/v1/spec.proto\x12Horg.project_planton.provider.kubernetes.workload.kubernetesprometheus.v1\x1a\x1bbuf/validate/validate.proto\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\x1a3org/project_planton/shared/kubernetes/options.proto\x1a0org/project_planton/shared/options/options.proto\"\xf8\x01\n" +
	...
	"Lcom.org.project_planton.provider.kubernetes.workload.kubernetesprometheus.v1B\tSpecProtoP\x01Z\x8f\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kubernetesprometheus/v1;kubernetesprometheusv1\xa2\x02\x06OPPKWK\xaa\x02GOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kubernetesprometheus.V1\xca\x02GOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesprometheus\\V1\xe2\x02SOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesprometheus\\V1\\GPBMetadata\xea\x02MOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kubernetesprometheus::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_goTypes = []any{
...
var file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_depIdxs = []int32{
...
func file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kubernetesprometheus_v1_spec_proto_depIdxs = nil
}
