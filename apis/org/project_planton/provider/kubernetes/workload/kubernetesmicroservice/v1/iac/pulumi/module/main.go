...
func Resources(ctx *pulumi.Context, stackInput *kubernetesmicroservicev1.KubernetesMicroserviceStackInput) error {
	...
	if locals.KubernetesMicroservice.Spec.Ingress.Enabled {
