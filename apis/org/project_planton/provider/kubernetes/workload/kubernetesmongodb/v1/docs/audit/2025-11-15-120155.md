...
**Provider:** kubernetes  
**Category:** workload  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/`  
**Enum Value:** 811  
**ID Prefix:** k8smdb  
...
- Folder exists at correct path: `apis/org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/workload/kuberneteskafka/v1/`
