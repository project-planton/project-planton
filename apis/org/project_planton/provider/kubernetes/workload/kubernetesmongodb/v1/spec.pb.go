...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/spec.proto
...
func (x *KubernetesMongodbSpec) Reset() {
	*x = KubernetesMongodbSpec{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_msgTypes[0]
...
func (*KubernetesMongodbSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesMongodbIngress) Reset() {
	*x = KubernetesMongodbIngress{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesMongodbIngress) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesMongodbContainer) Reset() {
	*x = KubernetesMongodbContainer{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesMongodbContainer) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_extTypes[0]
)

var File_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Porg/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1/spec.proto\x12Eorg.project_planton.provider.kubernetes.workload.kubernetesmongodb.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6org/project_planton/shared/kubernetes/kubernetes.proto\"\x91\x04\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18Ѭ  \x01(\v2a.org.project_planton.provider.kubernetes.workload.kubernetesmongodb.v1.KubernetesMongodbContainerR\x10defaultContainerB\x9b\x04\n" +
	"Icom.org.project_planton.provider.kubernetes.workload.kubernetesmongodb.v1B\tSpecProtoP\x01Z\x89\x01github.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/workload/kubernetesmongodb/v1;kubernetesmongodbv1\xa2\x02\x06OPPKWK\xaa\x02DOrg.ProjectPlanton.Provider.Kubernetes.Workload.Kubernetesmongodb.V1\xca\x02DOrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesmongodb\\V1\xe2\x02POrg\\ProjectPlanton\\Provider\\Kubernetes\\Workload\\Kubernetesmongodb\\V1\\GPBMetadata\xea\x02JOrg::ProjectPlanton::Provider::Kubernetes::Workload::Kubernetesmongodb::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_goTypes = []any{
...
var file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_depIdxs = []int32{
...
func file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_extTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kubernetesmongodb_v1_spec_proto_depIdxs = nil
}
