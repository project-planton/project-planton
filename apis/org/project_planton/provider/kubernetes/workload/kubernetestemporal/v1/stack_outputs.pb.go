...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/workload/kubernetestemporal/v1/stack_outputs.proto
...
func (x *KubernetesTemporalStackOutputs) Reset() {
	*x = KubernetesTemporalStackOutputs{}
	mi := &file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesTemporalStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Zorg/project_planton/provider/kubernetes/workload/kubernetestemporal/v1/stack_outputs.proto\x12Forg.project_planton.provider.kubernetes.workload.kubernetestemporal.v1\"\xd9\x03\n" +
...
var (
	file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_goTypes = []any{
	(*KubernetesTemporalStackOutputs)(nil), // 0: org.project_planton.provider.kubernetes.workload.kubernetestemporal.v1.KubernetesTemporalStackOutputs
}
var file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_depIdxs = []int32{
...
func file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_init() {
	if File_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto = out.File
	file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_workload_kubernetestemporal_v1_stack_outputs_proto_depIdxs = nil
}
