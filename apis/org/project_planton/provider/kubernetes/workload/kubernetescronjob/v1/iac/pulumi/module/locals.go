...
type Locals struct {
	KubernetesCronJob   *kubernetescronjobv1.KubernetesCronJob
	Namespace           string
...
func initializeLocals(ctx *pulumi.Context, stackInput *kubernetescronjobv1.KubernetesCronJobStackInput) (*Locals, error) {
	locals := &Locals{}
	target := stackInput.Target

	locals.KubernetesCronJob = target
