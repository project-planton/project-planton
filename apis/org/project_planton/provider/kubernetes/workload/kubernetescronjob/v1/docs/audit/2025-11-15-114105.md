...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetescronjob/v1/`  
**Enum Value:** 801  
**ID Prefix:** k8scron  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetescronjob/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetescronjob/v1/
go test -v
```
...
**Path to reference:** `apis/org/project_planton/provider/kubernetes/workload/kubernetescronjob/v1/`
