...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesnats/v1/`  
**Enum Value:** 820  
**ID Prefix:** k8snats
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesnats/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesnats/v1/
go test -v
```
...
1. ✅ **Critical items complete** - Component is production-ready for Pulumi users
2. ⚠️ **High priority** - Complete Terraform main.tf implementation
3. 💡 **Medium priority** - Add IaC-specific examples files
4. 🎨 **Low priority** - Consider test file naming alignment
