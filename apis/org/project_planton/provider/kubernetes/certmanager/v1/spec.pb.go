...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/certmanager/v1/spec.proto
...
func (x *CertManagerSpec) Reset() {
	*x = CertManagerSpec{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[0]
...
func (*CertManagerSpec) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AcmeConfig) Reset() {
	*x = AcmeConfig{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AcmeConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DnsProviderConfig) Reset() {
	*x = DnsProviderConfig{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DnsProviderConfig) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpCloudDnsProvider) Reset() {
	*x = GcpCloudDnsProvider{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudDnsProvider) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsRoute53Provider) Reset() {
	*x = AwsRoute53Provider{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53Provider) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AzureDnsProvider) Reset() {
	*x = AzureDnsProvider{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsProvider) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *CloudflareProvider) Reset() {
	*x = CloudflareProvider{}
	mi := &file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareProvider) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Aorg/project_planton/provider/kubernetes/certmanager/v1/spec.proto\x12<org.project_planton.provider.kubernetes.addon.certmanager.v1\x1a\x1bbuf/validate/validate.proto\x1a:org/project_planton/shared/kubernetes/target_cluster.proto\x1a0org/project_planton/shared/options/options.proto\"\xa0\x05\n" +
	...
	"\x1fskip_install_self_signed_issuer\x18\x05 \x01(\bR\x1bskipInstallSelfSignedIssuer\x12d\n" +
	"\x04acme\x18\x06 \x01(\v2H.org.project_planton.provider.kubernetes.addon.certmanager.v1.AcmeConfigB\x06\xbaH\x03\xc8\x01\x01R\x04acme\x12~\n" +
	"\rdns_providers\x18\a \x03(\v2O.org.project_planton.provider.kubernetes.addon.certmanager.v1.DnsProviderConfigB\b\xbaH\x05\x92\x01\x02\b\x01R\fdnsProvidersB\f\n" +
	"\n" +
	"_namespaceB\x17\n" +
	...
	"\tdns_zones\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\b\x01R\bdnsZones\x12w\n" +
	"\rgcp_cloud_dns\x18d \x01(\v2Q.org.project_planton.provider.kubernetes.addon.certmanager.v1.GcpCloudDnsProviderH\x00R\vgcpCloudDns\x12s\n" +
	"\vaws_route53\x18e \x01(\v2P.org.project_planton.provider.kubernetes.addon.certmanager.v1.AwsRoute53ProviderH\x00R\n" +
	"awsRoute53\x12m\n" +
	"\tazure_dns\x18f \x01(\v2N.org.project_planton.provider.kubernetes.addon.certmanager.v1.AzureDnsProviderH\x00R\bazureDns\x12r\n" +
	"\n" +
	"cloudflare\x18g \x01(\v2P.org.project_planton.provider.kubernetes.addon.certmanager.v1.CloudflareProviderH\x00R\n" +
	"cloudflareB\n" +
	"\n" +
	"\bprovider\"x\n" +
	...
	"\tapi_token\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\bapiTokenB\xd8\x03\n" +
	"@com.org.project_planton.provider.kubernetes.addon.certmanager.v1B\tSpecProtoP\x01Ztgithub.com/project-planton/project-planton/apis/org/project_planton/provider/kubernetes/certmanager/v1;certmanagerv1\xa2\x02\x06OPPKAC\xaa\x02;Org.ProjectPlanton.Provider.Kubernetes.Addon.Certmanager.V1\xca\x02;Org\\ProjectPlanton\\Provider\\Kubernetes\\Addon\\Certmanager\\V1\xe2\x02GOrg\\ProjectPlanton\\Provider\\Kubernetes\\Addon\\Certmanager\\V1\\GPBMetadata\xea\x02AOrg::ProjectPlanton::Provider::Kubernetes::Addon::Certmanager::V1b\x06proto3"

var (
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescOnce sync.Once
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDescData
}

var file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_goTypes = []any{
	...
	(*AwsRoute53Provider)(nil),                      // 4: org.project_planton.provider.kubernetes.addon.certmanager.v1.AwsRoute53Provider
	(*AzureDnsProvider)(nil),                        // 5: org.project_planton.provider.kubernetes.addon.certmanager.v1.AzureDnsProvider
	(*CloudflareProvider)(nil),                      // 6: org.project_planton.provider.kubernetes.addon.certmanager.v1.CloudflareProvider
	(*kubernetes.KubernetesAddonTargetCluster)(nil), // 7: org.project_planton.shared.kubernetes.KubernetesAddonTargetCluster
}
var file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_depIdxs = []int32{
	...
	6, // 6: org.project_planton.provider.kubernetes.addon.certmanager.v1.DnsProviderConfig.cloudflare:type_name -> org.project_planton.provider.kubernetes.addon.certmanager.v1.CloudflareProvider
...
func init() { file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_init() }
func file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_init() {
	if File_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto != nil {
		return
	}
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto = out.File
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_certmanager_v1_spec_proto_depIdxs = nil
}
