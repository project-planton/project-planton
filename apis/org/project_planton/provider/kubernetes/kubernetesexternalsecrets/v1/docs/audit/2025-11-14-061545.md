...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/`  
**Enum Value:** 829  
**ID Prefix:** extseck8s  
**Category:** addon
...
1. **Create spec_test.go with validation tests**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/spec_test.go`
...
2. **Create README.md at v1 level**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/README.md`
...
3. **Create examples.md**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/examples.md`
...
2. **Empty Terraform main.tf**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/iac/tf/main.tf`
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/
go test -v
```
...
5. **Add missing Pulumi module file (locals.go)**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/iac/pulumi/module/locals.go`
...
7. **Add iac/hack/manifest.yaml for testing**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesexternalsecrets/v1/iac/hack/manifest.yaml`
