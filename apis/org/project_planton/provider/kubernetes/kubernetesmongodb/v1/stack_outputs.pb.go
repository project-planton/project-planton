...
// 	protoc        (unknown)
// source: org/project_planton/provider/kubernetes/kubernetesmongodb/v1/stack_outputs.proto
...
func (x *KubernetesMongodbStackOutputs) Reset() {
	*x = KubernetesMongodbStackOutputs{}
	mi := &file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_msgTypes[0]
...
func (*KubernetesMongodbStackOutputs) Descriptor() ([]byte, []int) {
	return file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Porg/project_planton/provider/kubernetes/kubernetesmongodb/v1/stack_outputs.proto\x12<org.project_planton.provider.kubernetes.kubernetesmongodb.v1\x1a8org/project_planton/provider/kubernetes/kubernetes.proto\"\x8b\x03\n" +
...
var (
	...
	file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescData []byte
)

func file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDesc)))
	})
	return file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDescData
}
...
var file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_depIdxs = []int32{
	1, // 0: org.project_planton.provider.kubernetes.kubernetesmongodb.v1.KubernetesMongodbStackOutputs.password_secret:type_name -> org.project_planton.provider.kubernetes.KubernetesSecretKey
...
func file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_init() {
	if File_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDesc), len(file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto = out.File
	file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_goTypes = nil
	file_org_project_planton_provider_kubernetes_kubernetesmongodb_v1_stack_outputs_proto_depIdxs = nil
}
