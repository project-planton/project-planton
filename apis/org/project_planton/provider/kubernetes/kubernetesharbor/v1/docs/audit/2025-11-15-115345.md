...
- Folder exists under Kubernetes workload category: `apis/org/project_planton/provider/kubernetes/kubernetesharbor/v1/`
...
1. **Create spec_test.go with comprehensive validation tests**
   ...
   - **Reference:** See `apis/org/project_planton/provider/kubernetes/kubernetespostgres/v1/spec_test.go` for similar validation test patterns
...
4. **Review and enhance Terraform main.tf**
   - **File:** `apis/org/project_planton/provider/kubernetes/kubernetesharbor/v1/iac/tf/main.tf`
