...
- Folder exists at correct location: `apis/org/project_planton/provider/kubernetes/kuberneteshelmrelease/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/kuberneteshelmrelease/v1/
go test -v
```
