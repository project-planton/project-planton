...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/kubernetescertmanager/v1/`  
**Enum Value:** 821  
**ID Prefix:** cmk8s  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/addon/kubernetescertmanager/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/addon/kubernetescertmanager/v1/
go test -v
```
