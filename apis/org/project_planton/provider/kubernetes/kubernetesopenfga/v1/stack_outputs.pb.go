...
const file_org_project_planton_provider_kubernetes_kubernetesopenfga_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"Porg/project_planton/provider/kubernetes/kubernetesopenfga/v1/stack_outputs.proto\x12Eorg.project_planton.provider.kubernetes.workload.kubernetesopenfga.v1\"\x88\x02\n" +
