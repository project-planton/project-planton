...
// resource in the KubernetesOpenFga deployment based on the create_namespace flag.
...
func namespace(ctx *pulumi.Context, stackInput *kubernetesopenfgav1.KubernetesOpenFgaStackInput,
