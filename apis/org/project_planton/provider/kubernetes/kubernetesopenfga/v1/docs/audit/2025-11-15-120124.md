...
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/workload/kubernetesopenfga/v1/`  
**Enum Value:** 813  
**ID Prefix:** k8sfga  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/workload/kubernetesopenfga/v1/`
...
```bash
cd apis/org/project_planton/provider/kubernetes/workload/kubernetesopenfga/v1/
go test -v
```
