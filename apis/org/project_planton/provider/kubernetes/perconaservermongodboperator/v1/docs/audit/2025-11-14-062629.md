# Audit Report: PerconaServerMongodbOperator

**Audit Date:** 2025-11-14 06:26:29  
**Component Kind:** PerconaServerMongodbOperator  
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/perconaservermongodboperator/v1/`  
**Enum Value:** 833  
**ID Prefix:** percmdbop  
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/addon/perconaservermongodboperator/v1/`
- Correctly placed under kubernetes/addon hierarchy
...
- [x] Under correct category (kubernetes/addon)
