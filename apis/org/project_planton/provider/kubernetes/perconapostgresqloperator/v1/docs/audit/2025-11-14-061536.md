# Audit Report: PerconaPostgresqlOperator

**Audit Date:** 2025-11-14 06:15:36  
**Component Kind:** PerconaPostgresqlOperator  
**Provider:** kubernetes  
**Component Path:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/`  
**Enum Value:** 832  
**ID Prefix:** percpgop
...
1. **Create spec_test.go**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/spec_test.go`
...
2. **Add Terraform outputs.tf**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/iac/tf/outputs.tf`

3. **Add Terraform locals.tf**
   - **Why:** Standard Terraform module structure - worth 0.89% of total score
   - **How:** Create file with local variables for namespace and chart configuration
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/iac/tf/locals.tf`
...
- Folder exists: `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/`
...
1. **Add iac/pulumi/module/locals.go**
   ...
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/iac/pulumi/module/locals.go`
...
2. **Add iac/pulumi/overview.md**
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/iac/pulumi/overview.md`
...
1. **Expand main.tf size**
   - **File:** `apis/org/project_planton/provider/kubernetes/addon/perconapostgresqloperator/v1/iac/tf/main.tf`
