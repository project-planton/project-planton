# OpenFGA Authorization Model - Pulumi Module Overview
...
Outputs:
    notice: "OpenFGA Authorization Model was not created. No Pulumi provider available. Use Terraform/Tofu provisioner."
```
