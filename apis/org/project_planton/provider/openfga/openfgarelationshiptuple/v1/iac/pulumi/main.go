...
import (
	...
	"github.com/plantonhq/project-planton/apis/org/project_planton/provider/openfga/openfgarelationshiptuple/v1/iac/pulumi/module"
...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		stackInput := &openfgarelationshiptuplev1.OpenFgaRelationshipTupleStackInput{}
