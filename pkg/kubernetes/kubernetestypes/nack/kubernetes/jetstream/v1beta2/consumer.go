...
func NewConsumer(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:jetstream.nats.io/v1beta1:Consumer"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Consumer
	err := ctx.RegisterResource("kubernetes:jetstream.nats.io/v1beta2:Consumer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConsumer(ctx *pulumi.Context,
	...
	var resource Consumer
	err := ctx.ReadResource("kubernetes:jetstream.nats.io/v1beta2:Consumer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
