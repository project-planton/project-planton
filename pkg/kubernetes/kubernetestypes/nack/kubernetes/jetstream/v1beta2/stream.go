...
func NewStream(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:jetstream.nats.io/v1beta1:Stream"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Stream
	err := ctx.RegisterResource("kubernetes:jetstream.nats.io/v1beta2:Stream", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStream(ctx *pulumi.Context,
	...
	var resource Stream
	err := ctx.ReadResource("kubernetes:jetstream.nats.io/v1beta2:Stream", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
