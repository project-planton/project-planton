...
func NewKafkaTopic(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1beta2:KafkaTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaTopic(ctx *pulumi.Context,
	...
	var resource KafkaTopic
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1beta2:KafkaTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
