...
func NewKafkaTopicPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:kafka.strimzi.io/v1beta1:KafkaTopicPatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaTopicPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaTopicPatch(ctx *pulumi.Context,
	...
	var resource KafkaTopicPatch
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaTopicPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
