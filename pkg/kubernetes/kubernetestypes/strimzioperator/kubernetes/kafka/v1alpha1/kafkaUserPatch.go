...
func NewKafkaUserPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:kafka.strimzi.io/v1beta2:KafkaUserPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KafkaUserPatch
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaUserPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaUserPatch(ctx *pulumi.Context,
	...
	var resource KafkaUserPatch
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaUserPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
