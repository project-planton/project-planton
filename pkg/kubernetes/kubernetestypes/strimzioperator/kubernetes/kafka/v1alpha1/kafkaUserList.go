...
func NewKafkaUserList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaUserList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaUserList(ctx *pulumi.Context,
	...
	var resource KafkaUserList
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaUserList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
