...
func NewKafkaUserPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaUserPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaUserPatch(ctx *pulumi.Context,
	...
	var resource KafkaUserPatch
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaUserPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
