...
func NewKafkaUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:kafka.strimzi.io/v1beta2:KafkaUser"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource KafkaUser
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaUser(ctx *pulumi.Context,
	...
	var resource KafkaUser
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
