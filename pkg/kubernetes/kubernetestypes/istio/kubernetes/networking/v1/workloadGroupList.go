...
func NewWorkloadGroupList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:WorkloadGroupList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroupList(ctx *pulumi.Context,
	...
	var resource WorkloadGroupList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:WorkloadGroupList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
