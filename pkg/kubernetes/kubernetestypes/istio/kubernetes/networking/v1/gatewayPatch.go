...
func NewGatewayPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:GatewayPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayPatch(ctx *pulumi.Context,
	...
	var resource GatewayPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:GatewayPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
