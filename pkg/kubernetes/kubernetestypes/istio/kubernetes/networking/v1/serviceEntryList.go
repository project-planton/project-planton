...
func NewServiceEntryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:ServiceEntryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEntryList(ctx *pulumi.Context,
	...
	var resource ServiceEntryList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:ServiceEntryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
