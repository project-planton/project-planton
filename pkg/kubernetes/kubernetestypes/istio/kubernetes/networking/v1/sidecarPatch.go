...
func NewSidecarPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:SidecarPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSidecarPatch(ctx *pulumi.Context,
	...
	var resource SidecarPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:SidecarPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
