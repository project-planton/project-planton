...
func NewVirtualServicePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:VirtualServicePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualServicePatch(ctx *pulumi.Context,
	...
	var resource VirtualServicePatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:VirtualServicePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
