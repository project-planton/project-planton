...
func NewDestinationRuleList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:DestinationRuleList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDestinationRuleList(ctx *pulumi.Context,
	...
	var resource DestinationRuleList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:DestinationRuleList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
