...
func NewServiceEntryPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:ServiceEntryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEntryPatch(ctx *pulumi.Context,
	...
	var resource ServiceEntryPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:ServiceEntryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
