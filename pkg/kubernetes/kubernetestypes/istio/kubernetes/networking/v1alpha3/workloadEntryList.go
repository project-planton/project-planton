...
func NewWorkloadEntryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:WorkloadEntryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadEntryList(ctx *pulumi.Context,
	...
	var resource WorkloadEntryList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:WorkloadEntryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
