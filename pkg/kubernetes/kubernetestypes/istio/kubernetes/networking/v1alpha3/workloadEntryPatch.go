...
func NewWorkloadEntryPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:WorkloadEntryPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkloadEntryPatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:WorkloadEntryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadEntryPatch(ctx *pulumi.Context,
	...
	var resource WorkloadEntryPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:WorkloadEntryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
