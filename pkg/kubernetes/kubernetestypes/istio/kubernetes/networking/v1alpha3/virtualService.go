...
func NewVirtualService(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:VirtualService"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualService
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:VirtualService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualService(ctx *pulumi.Context,
	...
	var resource VirtualService
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:VirtualService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
