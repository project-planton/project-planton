...
func NewDestinationRulePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1alpha3:DestinationRulePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource DestinationRulePatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:DestinationRulePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDestinationRulePatch(ctx *pulumi.Context,
	...
	var resource DestinationRulePatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:DestinationRulePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
