...
func NewSidecarPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1alpha3:SidecarPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource SidecarPatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:SidecarPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSidecarPatch(ctx *pulumi.Context,
	...
	var resource SidecarPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:SidecarPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
