...
func NewTelemetryPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:telemetry.istio.io/v1:TelemetryPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource TelemetryPatch
	err := ctx.RegisterResource("kubernetes:telemetry.istio.io/v1alpha1:TelemetryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTelemetryPatch(ctx *pulumi.Context,
	...
	var resource TelemetryPatch
	err := ctx.ReadResource("kubernetes:telemetry.istio.io/v1alpha1:TelemetryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
