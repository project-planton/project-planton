...
func NewTelemetryList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:telemetry.istio.io/v1:TelemetryList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTelemetryList(ctx *pulumi.Context,
	...
	var resource TelemetryList
	err := ctx.ReadResource("kubernetes:telemetry.istio.io/v1:TelemetryList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
