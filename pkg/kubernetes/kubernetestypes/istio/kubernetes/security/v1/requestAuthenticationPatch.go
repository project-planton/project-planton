...
func NewRequestAuthenticationPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:security.istio.io/v1beta1:RequestAuthenticationPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource RequestAuthenticationPatch
	err := ctx.RegisterResource("kubernetes:security.istio.io/v1:RequestAuthenticationPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRequestAuthenticationPatch(ctx *pulumi.Context,
	...
	var resource RequestAuthenticationPatch
	err := ctx.ReadResource("kubernetes:security.istio.io/v1:RequestAuthenticationPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
