...
func NewAuthorizationPolicyPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:security.istio.io/v1:AuthorizationPolicyPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource AuthorizationPolicyPatch
	err := ctx.RegisterResource("kubernetes:security.istio.io/v1beta1:AuthorizationPolicyPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationPolicyPatch(ctx *pulumi.Context,
	...
	var resource AuthorizationPolicyPatch
	err := ctx.ReadResource("kubernetes:security.istio.io/v1beta1:AuthorizationPolicyPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
