...
func NewGatewayList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayList(ctx *pulumi.Context,
	...
	var resource GatewayList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
