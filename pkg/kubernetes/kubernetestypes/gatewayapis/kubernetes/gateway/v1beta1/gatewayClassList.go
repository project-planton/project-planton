...
func NewGatewayClassList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClassList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayClassList(ctx *pulumi.Context,
	...
	var resource GatewayClassList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClassList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
