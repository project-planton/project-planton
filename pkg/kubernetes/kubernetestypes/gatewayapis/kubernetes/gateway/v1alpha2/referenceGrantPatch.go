...
func NewReferenceGrantPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1beta1:ReferenceGrantPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ReferenceGrantPatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1alpha2:ReferenceGrantPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReferenceGrantPatch(ctx *pulumi.Context,
	...
	var resource ReferenceGrantPatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1alpha2:ReferenceGrantPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
