...
func NewPerconaServerMongoDB(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:psmdb.percona.com/v1-4-0:PerconaServerMongoDB", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerconaServerMongoDB(ctx *pulumi.Context,
	...
	var resource PerconaServerMongoDB
	err := ctx.ReadResource("kubernetes:psmdb.percona.com/v1-4-0:PerconaServerMongoDB", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
