...
func NewPerconaServerMongoDBList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:psmdb.percona.com/v1-12-0:PerconaServerMongoDBList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerconaServerMongoDBList(ctx *pulumi.Context,
	...
	var resource PerconaServerMongoDBList
	err := ctx.ReadResource("kubernetes:psmdb.percona.com/v1-12-0:PerconaServerMongoDBList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
