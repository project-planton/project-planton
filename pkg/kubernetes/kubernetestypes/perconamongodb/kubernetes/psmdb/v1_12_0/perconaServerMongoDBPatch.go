...
func NewPerconaServerMongoDBPatch(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("psmdb.percona.com/v1-12-0")
	...
	err := ctx.RegisterResource("kubernetes:psmdb.percona.com/v1-12-0:PerconaServerMongoDBPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerconaServerMongoDBPatch(ctx *pulumi.Context,
	...
	var resource PerconaServerMongoDBPatch
	err := ctx.ReadResource("kubernetes:psmdb.percona.com/v1-12-0:PerconaServerMongoDBPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
