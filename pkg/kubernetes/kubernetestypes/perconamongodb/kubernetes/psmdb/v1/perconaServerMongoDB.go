...
type PerconaServerMongoDB struct {
	...
	Spec     PerconaServerMongoDBSpecOutput      `pulumi:"spec"`
	Status   PerconaServerMongoDBStatusPtrOutput `pulumi:"status"`
}
...
func NewPerconaServerMongoDB(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:psmdb.percona.com/v1-11-0:PerconaServerMongoDB"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:psmdb.percona.com/v1:PerconaServerMongoDB", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerconaServerMongoDB(ctx *pulumi.Context,
	...
	var resource PerconaServerMongoDB
	err := ctx.ReadResource("kubernetes:psmdb.percona.com/v1:PerconaServerMongoDB", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type perconaServerMongoDBArgs struct {
	...
	Spec     *PerconaServerMongoDBSpec `pulumi:"spec"`
}
...
type PerconaServerMongoDBArgs struct {
	...
	Spec     PerconaServerMongoDBSpecPtrInput
}
...
func (o PerconaServerMongoDBOutput) Spec() PerconaServerMongoDBSpecOutput {
	return o.ApplyT(func(v *PerconaServerMongoDB) PerconaServerMongoDBSpecOutput { return v.Spec }).(PerconaServerMongoDBSpecOutput)
}

func (o PerconaServerMongoDBOutput) Status() PerconaServerMongoDBStatusPtrOutput {
	return o.ApplyT(func(v *PerconaServerMongoDB) PerconaServerMongoDBStatusPtrOutput { return v.Status }).(PerconaServerMongoDBStatusPtrOutput)
}
