...
type PerconaServerMongoDBPatch struct {
	...
	Spec     PerconaServerMongoDBSpecPatchPtrOutput   `pulumi:"spec"`
	Status   PerconaServerMongoDBStatusPatchPtrOutput `pulumi:"status"`
}
...
func NewPerconaServerMongoDBPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:psmdb.percona.com/v1-10-0:PerconaServerMongoDBPatch"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:psmdb.percona.com/v1:PerconaServerMongoDBPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPerconaServerMongoDBPatch(ctx *pulumi.Context,
	...
	var resource PerconaServerMongoDBPatch
	err := ctx.ReadResource("kubernetes:psmdb.percona.com/v1:PerconaServerMongoDBPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type perconaServerMongoDBPatchArgs struct {
	...
	Spec     *PerconaServerMongoDBSpecPatch `pulumi:"spec"`
}
...
type PerconaServerMongoDBPatchArgs struct {
	...
	Spec     PerconaServerMongoDBSpecPatchPtrInput
}
...
func (o PerconaServerMongoDBPatchOutput) Spec() PerconaServerMongoDBSpecPatchPtrOutput {
	return o.ApplyT(func(v *PerconaServerMongoDBPatch) PerconaServerMongoDBSpecPatchPtrOutput { return v.Spec }).(PerconaServerMongoDBSpecPatchPtrOutput)
}

func (o PerconaServerMongoDBPatchOutput) Status() PerconaServerMongoDBStatusPatchPtrOutput {
	return o.ApplyT(func(v *PerconaServerMongoDBPatch) PerconaServerMongoDBStatusPatchPtrOutput { return v.Status }).(PerconaServerMongoDBStatusPatchPtrOutput)
}
