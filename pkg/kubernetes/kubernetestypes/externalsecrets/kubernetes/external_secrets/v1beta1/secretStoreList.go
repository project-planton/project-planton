...
func NewSecretStoreList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1beta1:SecretStoreList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecretStoreList(ctx *pulumi.Context,
	...
	var resource SecretStoreList
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1beta1:SecretStoreList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
