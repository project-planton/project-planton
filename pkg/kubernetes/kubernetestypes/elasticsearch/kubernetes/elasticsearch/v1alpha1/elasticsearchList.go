...
func NewElasticsearchList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:ElasticsearchList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticsearchList(ctx *pulumi.Context,
	...
	var resource ElasticsearchList
	err := ctx.ReadResource("kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:ElasticsearchList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
