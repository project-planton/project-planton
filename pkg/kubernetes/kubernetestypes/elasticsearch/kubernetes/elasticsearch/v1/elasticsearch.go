...
type Elasticsearch struct {
	...
	Spec     ElasticsearchSpecOutput      `pulumi:"spec"`
...
func NewElasticsearch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:Elasticsearch"),
		},
		{
...
func (o ElasticsearchOutput) Spec() ElasticsearchSpecOutput {
	return o.ApplyT(func(v *Elasticsearch) ElasticsearchSpecOutput { return v.Spec }).(ElasticsearchSpecOutput)
}
