...
func NewApmServerPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:apm.k8s.elastic.co/v1beta1:ApmServerPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ApmServerPatch
	err := ctx.RegisterResource("kubernetes:apm.k8s.elastic.co/v1alpha1:ApmServerPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApmServerPatch(ctx *pulumi.Context,
	...
	var resource ApmServerPatch
	err := ctx.ReadResource("kubernetes:apm.k8s.elastic.co/v1alpha1:ApmServerPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
