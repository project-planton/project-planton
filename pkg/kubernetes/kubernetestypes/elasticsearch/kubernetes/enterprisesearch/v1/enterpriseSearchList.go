...
func NewEnterpriseSearchList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:enterprisesearch.k8s.elastic.co/v1:EnterpriseSearchList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseSearchList(ctx *pulumi.Context,
	...
	var resource EnterpriseSearchList
	err := ctx.ReadResource("kubernetes:enterprisesearch.k8s.elastic.co/v1:EnterpriseSearchList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
