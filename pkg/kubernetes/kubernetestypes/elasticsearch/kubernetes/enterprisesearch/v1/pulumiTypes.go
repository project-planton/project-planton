...
// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
func (o EnterpriseSearchSpecPatchOutput) RevisionHistoryLimit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v EnterpriseSearchSpecPatch) *int { return v.RevisionHistoryLimit }).(pulumi.IntPtrOutput)
}
...
// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
func (o EnterpriseSearchSpecPatchPtrOutput) RevisionHistoryLimit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *EnterpriseSearchSpecPatch) *int {
		if v == nil {
			return nil
		}
...
// If the generation observed in status diverges from the generation in metadata, the Enterprise Search
// controller has not yet processed the changes contained in the Enterprise Search specification.
func (o EnterpriseSearchStatusPatchOutput) ObservedGeneration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v EnterpriseSearchStatusPatch) *int { return v.ObservedGeneration }).(pulumi.IntPtrOutput)
}
...
// If the generation observed in status diverges from the generation in metadata, the Enterprise Search
// controller has not yet processed the changes contained in the Enterprise Search specification.
func (o EnterpriseSearchStatusPatchPtrOutput) ObservedGeneration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *EnterpriseSearchStatusPatch) *int {
		if v == nil {
			return nil
		}
