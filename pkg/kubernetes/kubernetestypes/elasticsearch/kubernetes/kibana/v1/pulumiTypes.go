...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecElasticsearchRefPatchOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecElasticsearchRefPatch) *string { return v.SecretName }).(pulumi.StringPtrOutput)
}

// ServiceName is the name of an existing Kubernetes service which is used to make requests to the referenced
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecElasticsearchRefPatchOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecElasticsearchRefPatch) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}
...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecElasticsearchRefPatchPtrOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecElasticsearchRefPatch) *string {
		if v == nil {
			return nil
		}
...
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecElasticsearchRefPatchPtrOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecElasticsearchRefPatch) *string {
		if v == nil {
			return nil
		}
...
// EnterpriseSearchRef is a reference to an EnterpriseSearch running in the same Kubernetes cluster.
// Kibana provides the default Enterprise Search UI starting version 7.14.
type KibanaSpecEnterpriseSearchRefPatch struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name *string `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace *string `pulumi:"namespace"`
...
// KibanaSpecEnterpriseSearchRefPatchInput is an input type that accepts KibanaSpecEnterpriseSearchRefPatchArgs and KibanaSpecEnterpriseSearchRefPatchOutput values.
// You can construct a concrete instance of `KibanaSpecEnterpriseSearchRefPatchInput` via:
//
//	KibanaSpecEnterpriseSearchRefPatchArgs{...}
type KibanaSpecEnterpriseSearchRefPatchInput interface {
	pulumi.Input

	ToKibanaSpecEnterpriseSearchRefPatchOutput() KibanaSpecEnterpriseSearchRefPatchOutput
	ToKibanaSpecEnterpriseSearchRefPatchOutputWithContext(context.Context) KibanaSpecEnterpriseSearchRefPatchOutput
}

// EnterpriseSearchRef is a reference to an EnterpriseSearch running in the same Kubernetes cluster.
// Kibana provides the default Enterprise Search UI starting version 7.14.
type KibanaSpecEnterpriseSearchRefPatchArgs struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name pulumi.StringPtrInput `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace pulumi.StringPtrInput `pulumi:"namespace"`
...
func (KibanaSpecEnterpriseSearchRefPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecEnterpriseSearchRefPatch)(nil)).Elem()
}

func (i KibanaSpecEnterpriseSearchRefPatchArgs) ToKibanaSpecEnterpriseSearchRefPatchOutput() KibanaSpecEnterpriseSearchRefPatchOutput {
	return i.ToKibanaSpecEnterpriseSearchRefPatchOutputWithContext(context.Background())
}

func (i KibanaSpecEnterpriseSearchRefPatchArgs) ToKibanaSpecEnterpriseSearchRefPatchOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecEnterpriseSearchRefPatchOutput)
}

func (i KibanaSpecEnterpriseSearchRefPatchArgs) ToKibanaSpecEnterpriseSearchRefPatchPtrOutput() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return i.ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(context.Background())
}

func (i KibanaSpecEnterpriseSearchRefPatchArgs) ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecEnterpriseSearchRefPatchOutput).ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(ctx)
}

// KibanaSpecEnterpriseSearchRefPatchPtrInput is an input type that accepts KibanaSpecEnterpriseSearchRefPatchArgs, KibanaSpecEnterpriseSearchRefPatchPtr and KibanaSpecEnterpriseSearchRefPatchPtrOutput values.
// You can construct a concrete instance of `KibanaSpecEnterpriseSearchRefPatchPtrInput` via:
//
//	        KibanaSpecEnterpriseSearchRefPatchArgs{...}
//
//	or:
//
//	        nil
type KibanaSpecEnterpriseSearchRefPatchPtrInput interface {
	pulumi.Input

	ToKibanaSpecEnterpriseSearchRefPatchPtrOutput() KibanaSpecEnterpriseSearchRefPatchPtrOutput
	ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(context.Context) KibanaSpecEnterpriseSearchRefPatchPtrOutput
}

type kibanaSpecEnterpriseSearchRefPatchPtrType KibanaSpecEnterpriseSearchRefPatchArgs

func KibanaSpecEnterpriseSearchRefPatchPtr(v *KibanaSpecEnterpriseSearchRefPatchArgs) KibanaSpecEnterpriseSearchRefPatchPtrInput {
	return (*kibanaSpecEnterpriseSearchRefPatchPtrType)(v)
}

func (*kibanaSpecEnterpriseSearchRefPatchPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecEnterpriseSearchRefPatch)(nil)).Elem()
}

func (i *kibanaSpecEnterpriseSearchRefPatchPtrType) ToKibanaSpecEnterpriseSearchRefPatchPtrOutput() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return i.ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(context.Background())
}

func (i *kibanaSpecEnterpriseSearchRefPatchPtrType) ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecEnterpriseSearchRefPatchPtrOutput)
}

// EnterpriseSearchRef is a reference to an EnterpriseSearch running in the same Kubernetes cluster.
// Kibana provides the default Enterprise Search UI starting version 7.14.
type KibanaSpecEnterpriseSearchRefPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecEnterpriseSearchRefPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecEnterpriseSearchRefPatch)(nil)).Elem()
}

func (o KibanaSpecEnterpriseSearchRefPatchOutput) ToKibanaSpecEnterpriseSearchRefPatchOutput() KibanaSpecEnterpriseSearchRefPatchOutput {
	return o
}

func (o KibanaSpecEnterpriseSearchRefPatchOutput) ToKibanaSpecEnterpriseSearchRefPatchOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchOutput {
	return o
}

func (o KibanaSpecEnterpriseSearchRefPatchOutput) ToKibanaSpecEnterpriseSearchRefPatchPtrOutput() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o.ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(context.Background())
}

func (o KibanaSpecEnterpriseSearchRefPatchOutput) ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v KibanaSpecEnterpriseSearchRefPatch) *KibanaSpecEnterpriseSearchRefPatch {
		return &v
	}).(KibanaSpecEnterpriseSearchRefPatchPtrOutput)
}

// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
func (o KibanaSpecEnterpriseSearchRefPatchOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecEnterpriseSearchRefPatch) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
func (o KibanaSpecEnterpriseSearchRefPatchOutput) Namespace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecEnterpriseSearchRefPatch) *string { return v.Namespace }).(pulumi.StringPtrOutput)
}
...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecEnterpriseSearchRefPatchOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecEnterpriseSearchRefPatch) *string { return v.SecretName }).(pulumi.StringPtrOutput)
}

// ServiceName is the name of an existing Kubernetes service which is used to make requests to the referenced
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecEnterpriseSearchRefPatchOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecEnterpriseSearchRefPatch) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}

type KibanaSpecEnterpriseSearchRefPatchPtrOutput struct{ *pulumi.OutputState }

func (KibanaSpecEnterpriseSearchRefPatchPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecEnterpriseSearchRefPatch)(nil)).Elem()
}

func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) ToKibanaSpecEnterpriseSearchRefPatchPtrOutput() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o
}

func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) ToKibanaSpecEnterpriseSearchRefPatchPtrOutputWithContext(ctx context.Context) KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o
}

func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) Elem() KibanaSpecEnterpriseSearchRefPatchOutput {
	return o.ApplyT(func(v *KibanaSpecEnterpriseSearchRefPatch) KibanaSpecEnterpriseSearchRefPatch {
		if v != nil {
			return *v
		}
		var ret KibanaSpecEnterpriseSearchRefPatch
		return ret
	}).(KibanaSpecEnterpriseSearchRefPatchOutput)
}

// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecEnterpriseSearchRefPatch) *string {
		if v == nil {
			return nil
		}
		return v.Name
...
// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) Namespace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecEnterpriseSearchRefPatch) *string {
		if v == nil {
			return nil
		}
...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecEnterpriseSearchRefPatch) *string {
		if v == nil {
			return nil
		}
...
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecEnterpriseSearchRefPatchPtrOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecEnterpriseSearchRefPatch) *string {
		if v == nil {
			return nil
		}
...
// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringLogsElasticsearchRefsPatch struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name *string `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace *string `pulumi:"namespace"`
...
// KibanaSpecMonitoringLogsElasticsearchRefsPatchInput is an input type that accepts KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs and KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringLogsElasticsearchRefsPatchInput` via:
//
//	KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs{...}
type KibanaSpecMonitoringLogsElasticsearchRefsPatchInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput
	ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutputWithContext(context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput
}

// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name pulumi.StringPtrInput `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace pulumi.StringPtrInput `pulumi:"namespace"`
...
func (KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringLogsElasticsearchRefsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput {
	return i.ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput)
}

// KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayInput is an input type that accepts KibanaSpecMonitoringLogsElasticsearchRefsPatchArray and KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayInput` via:
//
//	KibanaSpecMonitoringLogsElasticsearchRefsPatchArray{ KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs{...} }
type KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput
	ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutputWithContext(context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput
}

type KibanaSpecMonitoringLogsElasticsearchRefsPatchArray []KibanaSpecMonitoringLogsElasticsearchRefsPatchInput

func (KibanaSpecMonitoringLogsElasticsearchRefsPatchArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]KibanaSpecMonitoringLogsElasticsearchRefsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringLogsElasticsearchRefsPatchArray) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return i.ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringLogsElasticsearchRefsPatchArray) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput)
}

// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringLogsElasticsearchRefsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput {
	return o
}

// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringLogsElasticsearchRefsPatch) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) Namespace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringLogsElasticsearchRefsPatch) *string { return v.Namespace }).(pulumi.StringPtrOutput)
}
...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringLogsElasticsearchRefsPatch) *string { return v.SecretName }).(pulumi.StringPtrOutput)
}

// ServiceName is the name of an existing Kubernetes service which is used to make requests to the referenced
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringLogsElasticsearchRefsPatch) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}

type KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]KibanaSpecMonitoringLogsElasticsearchRefsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return o
}

func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput) ToKibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return o
}

func (o KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput) Index(i pulumi.IntInput) KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) KibanaSpecMonitoringLogsElasticsearchRefsPatch {
		return vs[0].([]KibanaSpecMonitoringLogsElasticsearchRefsPatch)[vs[1].(int)]
	}).(KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput)
}

// Logs holds references to Elasticsearch clusters which receive log data from an associated resource.
type KibanaSpecMonitoringLogsPatch struct {
	// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
	// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
	ElasticsearchRefs []KibanaSpecMonitoringLogsElasticsearchRefsPatch `pulumi:"elasticsearchRefs"`
}

// KibanaSpecMonitoringLogsPatchInput is an input type that accepts KibanaSpecMonitoringLogsPatchArgs and KibanaSpecMonitoringLogsPatchOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringLogsPatchInput` via:
//
//	KibanaSpecMonitoringLogsPatchArgs{...}
type KibanaSpecMonitoringLogsPatchInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringLogsPatchOutput() KibanaSpecMonitoringLogsPatchOutput
	ToKibanaSpecMonitoringLogsPatchOutputWithContext(context.Context) KibanaSpecMonitoringLogsPatchOutput
}

// Logs holds references to Elasticsearch clusters which receive log data from an associated resource.
type KibanaSpecMonitoringLogsPatchArgs struct {
	// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
	// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
	ElasticsearchRefs KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayInput `pulumi:"elasticsearchRefs"`
}

func (KibanaSpecMonitoringLogsPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringLogsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringLogsPatchArgs) ToKibanaSpecMonitoringLogsPatchOutput() KibanaSpecMonitoringLogsPatchOutput {
	return i.ToKibanaSpecMonitoringLogsPatchOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringLogsPatchArgs) ToKibanaSpecMonitoringLogsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringLogsPatchOutput)
}

func (i KibanaSpecMonitoringLogsPatchArgs) ToKibanaSpecMonitoringLogsPatchPtrOutput() KibanaSpecMonitoringLogsPatchPtrOutput {
	return i.ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringLogsPatchArgs) ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringLogsPatchOutput).ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(ctx)
}

// KibanaSpecMonitoringLogsPatchPtrInput is an input type that accepts KibanaSpecMonitoringLogsPatchArgs, KibanaSpecMonitoringLogsPatchPtr and KibanaSpecMonitoringLogsPatchPtrOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringLogsPatchPtrInput` via:
//
//	        KibanaSpecMonitoringLogsPatchArgs{...}
//
//	or:
//
//	        nil
type KibanaSpecMonitoringLogsPatchPtrInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringLogsPatchPtrOutput() KibanaSpecMonitoringLogsPatchPtrOutput
	ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(context.Context) KibanaSpecMonitoringLogsPatchPtrOutput
}

type kibanaSpecMonitoringLogsPatchPtrType KibanaSpecMonitoringLogsPatchArgs

func KibanaSpecMonitoringLogsPatchPtr(v *KibanaSpecMonitoringLogsPatchArgs) KibanaSpecMonitoringLogsPatchPtrInput {
	return (*kibanaSpecMonitoringLogsPatchPtrType)(v)
}

func (*kibanaSpecMonitoringLogsPatchPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringLogsPatch)(nil)).Elem()
}

func (i *kibanaSpecMonitoringLogsPatchPtrType) ToKibanaSpecMonitoringLogsPatchPtrOutput() KibanaSpecMonitoringLogsPatchPtrOutput {
	return i.ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(context.Background())
}

func (i *kibanaSpecMonitoringLogsPatchPtrType) ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringLogsPatchPtrOutput)
}

// Logs holds references to Elasticsearch clusters which receive log data from an associated resource.
type KibanaSpecMonitoringLogsPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringLogsPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringLogsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringLogsPatchOutput) ToKibanaSpecMonitoringLogsPatchOutput() KibanaSpecMonitoringLogsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringLogsPatchOutput) ToKibanaSpecMonitoringLogsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringLogsPatchOutput) ToKibanaSpecMonitoringLogsPatchPtrOutput() KibanaSpecMonitoringLogsPatchPtrOutput {
	return o.ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(context.Background())
}

func (o KibanaSpecMonitoringLogsPatchOutput) ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v KibanaSpecMonitoringLogsPatch) *KibanaSpecMonitoringLogsPatch {
		return &v
	}).(KibanaSpecMonitoringLogsPatchPtrOutput)
}

// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
func (o KibanaSpecMonitoringLogsPatchOutput) ElasticsearchRefs() KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringLogsPatch) []KibanaSpecMonitoringLogsElasticsearchRefsPatch {
		return v.ElasticsearchRefs
	}).(KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput)
}

type KibanaSpecMonitoringLogsPatchPtrOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringLogsPatchPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringLogsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringLogsPatchPtrOutput) ToKibanaSpecMonitoringLogsPatchPtrOutput() KibanaSpecMonitoringLogsPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringLogsPatchPtrOutput) ToKibanaSpecMonitoringLogsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringLogsPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringLogsPatchPtrOutput) Elem() KibanaSpecMonitoringLogsPatchOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringLogsPatch) KibanaSpecMonitoringLogsPatch {
		if v != nil {
			return *v
		}
		var ret KibanaSpecMonitoringLogsPatch
		return ret
	}).(KibanaSpecMonitoringLogsPatchOutput)
}

// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
func (o KibanaSpecMonitoringLogsPatchPtrOutput) ElasticsearchRefs() KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringLogsPatch) []KibanaSpecMonitoringLogsElasticsearchRefsPatch {
		if v == nil {
			return nil
		}
...
// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringMetricsElasticsearchRefsPatch struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name *string `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace *string `pulumi:"namespace"`
...
// KibanaSpecMonitoringMetricsElasticsearchRefsPatchInput is an input type that accepts KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs and KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringMetricsElasticsearchRefsPatchInput` via:
//
//	KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs{...}
type KibanaSpecMonitoringMetricsElasticsearchRefsPatchInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput
	ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutputWithContext(context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput
}

// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs struct {
	// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
	Name pulumi.StringPtrInput `pulumi:"name"`
	// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
	Namespace pulumi.StringPtrInput `pulumi:"namespace"`
...
func (KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringMetricsElasticsearchRefsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput {
	return i.ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput)
}

// KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayInput is an input type that accepts KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray and KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayInput` via:
//
//	KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray{ KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs{...} }
type KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput
	ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutputWithContext(context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput
}

type KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray []KibanaSpecMonitoringMetricsElasticsearchRefsPatchInput

func (KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]KibanaSpecMonitoringMetricsElasticsearchRefsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return i.ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput)
}

// ObjectSelector defines a reference to a Kubernetes object which can be an Elastic resource managed by the operator
// or a Secret describing an external Elastic resource not managed by the operator.
type KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringMetricsElasticsearchRefsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput {
	return o
}

// Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK.
func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringMetricsElasticsearchRefsPatch) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// Namespace of the Kubernetes object. If empty, defaults to the current namespace.
func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) Namespace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringMetricsElasticsearchRefsPatch) *string { return v.Namespace }).(pulumi.StringPtrOutput)
}
...
//   - `api-key`: the key to authenticate against the Elastic resource instead of a username and password (supported only for `elasticsearchRefs` in AgentSpec and in BeatSpec)
//     This field cannot be used in combination with the other fields name, namespace or serviceName.
func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringMetricsElasticsearchRefsPatch) *string { return v.SecretName }).(pulumi.StringPtrOutput)
}

// ServiceName is the name of an existing Kubernetes service which is used to make requests to the referenced
// object. It has to be in the same namespace as the referenced resource. If left empty, the default HTTP service of
// the referenced resource is used.
func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput) ServiceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringMetricsElasticsearchRefsPatch) *string { return v.ServiceName }).(pulumi.StringPtrOutput)
}

type KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]KibanaSpecMonitoringMetricsElasticsearchRefsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput() KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput) ToKibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput) Index(i pulumi.IntInput) KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) KibanaSpecMonitoringMetricsElasticsearchRefsPatch {
		return vs[0].([]KibanaSpecMonitoringMetricsElasticsearchRefsPatch)[vs[1].(int)]
	}).(KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput)
}

// Metrics holds references to Elasticsearch clusters which receive monitoring data from this resource.
type KibanaSpecMonitoringMetricsPatch struct {
	// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
	// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
	ElasticsearchRefs []KibanaSpecMonitoringMetricsElasticsearchRefsPatch `pulumi:"elasticsearchRefs"`
}

// KibanaSpecMonitoringMetricsPatchInput is an input type that accepts KibanaSpecMonitoringMetricsPatchArgs and KibanaSpecMonitoringMetricsPatchOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringMetricsPatchInput` via:
//
//	KibanaSpecMonitoringMetricsPatchArgs{...}
type KibanaSpecMonitoringMetricsPatchInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringMetricsPatchOutput() KibanaSpecMonitoringMetricsPatchOutput
	ToKibanaSpecMonitoringMetricsPatchOutputWithContext(context.Context) KibanaSpecMonitoringMetricsPatchOutput
}

// Metrics holds references to Elasticsearch clusters which receive monitoring data from this resource.
type KibanaSpecMonitoringMetricsPatchArgs struct {
	// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
	// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
	ElasticsearchRefs KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayInput `pulumi:"elasticsearchRefs"`
}

func (KibanaSpecMonitoringMetricsPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringMetricsPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringMetricsPatchArgs) ToKibanaSpecMonitoringMetricsPatchOutput() KibanaSpecMonitoringMetricsPatchOutput {
	return i.ToKibanaSpecMonitoringMetricsPatchOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringMetricsPatchArgs) ToKibanaSpecMonitoringMetricsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringMetricsPatchOutput)
}

func (i KibanaSpecMonitoringMetricsPatchArgs) ToKibanaSpecMonitoringMetricsPatchPtrOutput() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return i.ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringMetricsPatchArgs) ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringMetricsPatchOutput).ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(ctx)
}

// KibanaSpecMonitoringMetricsPatchPtrInput is an input type that accepts KibanaSpecMonitoringMetricsPatchArgs, KibanaSpecMonitoringMetricsPatchPtr and KibanaSpecMonitoringMetricsPatchPtrOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringMetricsPatchPtrInput` via:
//
//	        KibanaSpecMonitoringMetricsPatchArgs{...}
//
//	or:
//
//	        nil
type KibanaSpecMonitoringMetricsPatchPtrInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringMetricsPatchPtrOutput() KibanaSpecMonitoringMetricsPatchPtrOutput
	ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(context.Context) KibanaSpecMonitoringMetricsPatchPtrOutput
}

type kibanaSpecMonitoringMetricsPatchPtrType KibanaSpecMonitoringMetricsPatchArgs

func KibanaSpecMonitoringMetricsPatchPtr(v *KibanaSpecMonitoringMetricsPatchArgs) KibanaSpecMonitoringMetricsPatchPtrInput {
	return (*kibanaSpecMonitoringMetricsPatchPtrType)(v)
}

func (*kibanaSpecMonitoringMetricsPatchPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringMetricsPatch)(nil)).Elem()
}

func (i *kibanaSpecMonitoringMetricsPatchPtrType) ToKibanaSpecMonitoringMetricsPatchPtrOutput() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return i.ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(context.Background())
}

func (i *kibanaSpecMonitoringMetricsPatchPtrType) ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringMetricsPatchPtrOutput)
}

// Metrics holds references to Elasticsearch clusters which receive monitoring data from this resource.
type KibanaSpecMonitoringMetricsPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringMetricsPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringMetricsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringMetricsPatchOutput) ToKibanaSpecMonitoringMetricsPatchOutput() KibanaSpecMonitoringMetricsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsPatchOutput) ToKibanaSpecMonitoringMetricsPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsPatchOutput) ToKibanaSpecMonitoringMetricsPatchPtrOutput() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o.ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(context.Background())
}

func (o KibanaSpecMonitoringMetricsPatchOutput) ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v KibanaSpecMonitoringMetricsPatch) *KibanaSpecMonitoringMetricsPatch {
		return &v
	}).(KibanaSpecMonitoringMetricsPatchPtrOutput)
}

// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
func (o KibanaSpecMonitoringMetricsPatchOutput) ElasticsearchRefs() KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringMetricsPatch) []KibanaSpecMonitoringMetricsElasticsearchRefsPatch {
		return v.ElasticsearchRefs
	}).(KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput)
}

type KibanaSpecMonitoringMetricsPatchPtrOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringMetricsPatchPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringMetricsPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringMetricsPatchPtrOutput) ToKibanaSpecMonitoringMetricsPatchPtrOutput() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsPatchPtrOutput) ToKibanaSpecMonitoringMetricsPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringMetricsPatchPtrOutput) Elem() KibanaSpecMonitoringMetricsPatchOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringMetricsPatch) KibanaSpecMonitoringMetricsPatch {
		if v != nil {
			return *v
		}
		var ret KibanaSpecMonitoringMetricsPatch
		return ret
	}).(KibanaSpecMonitoringMetricsPatchOutput)
}

// ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster.
// Due to existing limitations, only a single Elasticsearch cluster is currently supported.
func (o KibanaSpecMonitoringMetricsPatchPtrOutput) ElasticsearchRefs() KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringMetricsPatch) []KibanaSpecMonitoringMetricsElasticsearchRefsPatch {
		if v == nil {
			return nil
		}
...
// Metricbeat and Filebeat are deployed in the same Pod as sidecars and each one sends data to one or two different
// Elasticsearch monitoring clusters running in the same Kubernetes cluster.
type KibanaSpecMonitoringPatch struct {
	Logs    *KibanaSpecMonitoringLogsPatch    `pulumi:"logs"`
	Metrics *KibanaSpecMonitoringMetricsPatch `pulumi:"metrics"`
}

// KibanaSpecMonitoringPatchInput is an input type that accepts KibanaSpecMonitoringPatchArgs and KibanaSpecMonitoringPatchOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringPatchInput` via:
//
//	KibanaSpecMonitoringPatchArgs{...}
type KibanaSpecMonitoringPatchInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringPatchOutput() KibanaSpecMonitoringPatchOutput
	ToKibanaSpecMonitoringPatchOutputWithContext(context.Context) KibanaSpecMonitoringPatchOutput
}
...
// Metricbeat and Filebeat are deployed in the same Pod as sidecars and each one sends data to one or two different
// Elasticsearch monitoring clusters running in the same Kubernetes cluster.
type KibanaSpecMonitoringPatchArgs struct {
	Logs    KibanaSpecMonitoringLogsPatchPtrInput    `pulumi:"logs"`
	Metrics KibanaSpecMonitoringMetricsPatchPtrInput `pulumi:"metrics"`
}

func (KibanaSpecMonitoringPatchArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringPatch)(nil)).Elem()
}

func (i KibanaSpecMonitoringPatchArgs) ToKibanaSpecMonitoringPatchOutput() KibanaSpecMonitoringPatchOutput {
	return i.ToKibanaSpecMonitoringPatchOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringPatchArgs) ToKibanaSpecMonitoringPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringPatchOutput)
}

func (i KibanaSpecMonitoringPatchArgs) ToKibanaSpecMonitoringPatchPtrOutput() KibanaSpecMonitoringPatchPtrOutput {
	return i.ToKibanaSpecMonitoringPatchPtrOutputWithContext(context.Background())
}

func (i KibanaSpecMonitoringPatchArgs) ToKibanaSpecMonitoringPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringPatchOutput).ToKibanaSpecMonitoringPatchPtrOutputWithContext(ctx)
}

// KibanaSpecMonitoringPatchPtrInput is an input type that accepts KibanaSpecMonitoringPatchArgs, KibanaSpecMonitoringPatchPtr and KibanaSpecMonitoringPatchPtrOutput values.
// You can construct a concrete instance of `KibanaSpecMonitoringPatchPtrInput` via:
//
//	        KibanaSpecMonitoringPatchArgs{...}
//
//	or:
//
//	        nil
type KibanaSpecMonitoringPatchPtrInput interface {
	pulumi.Input

	ToKibanaSpecMonitoringPatchPtrOutput() KibanaSpecMonitoringPatchPtrOutput
	ToKibanaSpecMonitoringPatchPtrOutputWithContext(context.Context) KibanaSpecMonitoringPatchPtrOutput
}

type kibanaSpecMonitoringPatchPtrType KibanaSpecMonitoringPatchArgs

func KibanaSpecMonitoringPatchPtr(v *KibanaSpecMonitoringPatchArgs) KibanaSpecMonitoringPatchPtrInput {
	return (*kibanaSpecMonitoringPatchPtrType)(v)
}

func (*kibanaSpecMonitoringPatchPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringPatch)(nil)).Elem()
}

func (i *kibanaSpecMonitoringPatchPtrType) ToKibanaSpecMonitoringPatchPtrOutput() KibanaSpecMonitoringPatchPtrOutput {
	return i.ToKibanaSpecMonitoringPatchPtrOutputWithContext(context.Background())
}

func (i *kibanaSpecMonitoringPatchPtrType) ToKibanaSpecMonitoringPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(KibanaSpecMonitoringPatchPtrOutput)
}
...
// Metricbeat and Filebeat are deployed in the same Pod as sidecars and each one sends data to one or two different
// Elasticsearch monitoring clusters running in the same Kubernetes cluster.
type KibanaSpecMonitoringPatchOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringPatchOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KibanaSpecMonitoringPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringPatchOutput) ToKibanaSpecMonitoringPatchOutput() KibanaSpecMonitoringPatchOutput {
	return o
}

func (o KibanaSpecMonitoringPatchOutput) ToKibanaSpecMonitoringPatchOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchOutput {
	return o
}

func (o KibanaSpecMonitoringPatchOutput) ToKibanaSpecMonitoringPatchPtrOutput() KibanaSpecMonitoringPatchPtrOutput {
	return o.ToKibanaSpecMonitoringPatchPtrOutputWithContext(context.Background())
}

func (o KibanaSpecMonitoringPatchOutput) ToKibanaSpecMonitoringPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v KibanaSpecMonitoringPatch) *KibanaSpecMonitoringPatch {
		return &v
	}).(KibanaSpecMonitoringPatchPtrOutput)
}

func (o KibanaSpecMonitoringPatchOutput) Logs() KibanaSpecMonitoringLogsPatchPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringPatch) *KibanaSpecMonitoringLogsPatch { return v.Logs }).(KibanaSpecMonitoringLogsPatchPtrOutput)
}

func (o KibanaSpecMonitoringPatchOutput) Metrics() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o.ApplyT(func(v KibanaSpecMonitoringPatch) *KibanaSpecMonitoringMetricsPatch { return v.Metrics }).(KibanaSpecMonitoringMetricsPatchPtrOutput)
}

type KibanaSpecMonitoringPatchPtrOutput struct{ *pulumi.OutputState }

func (KibanaSpecMonitoringPatchPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**KibanaSpecMonitoringPatch)(nil)).Elem()
}

func (o KibanaSpecMonitoringPatchPtrOutput) ToKibanaSpecMonitoringPatchPtrOutput() KibanaSpecMonitoringPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringPatchPtrOutput) ToKibanaSpecMonitoringPatchPtrOutputWithContext(ctx context.Context) KibanaSpecMonitoringPatchPtrOutput {
	return o
}

func (o KibanaSpecMonitoringPatchPtrOutput) Elem() KibanaSpecMonitoringPatchOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringPatch) KibanaSpecMonitoringPatch {
		if v != nil {
			return *v
		}
		var ret KibanaSpecMonitoringPatch
		return ret
	}).(KibanaSpecMonitoringPatchOutput)
}

func (o KibanaSpecMonitoringPatchPtrOutput) Logs() KibanaSpecMonitoringLogsPatchPtrOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringPatch) *KibanaSpecMonitoringLogsPatch {
		if v == nil {
			return nil
		}
		return v.Logs
...
func (o KibanaSpecMonitoringPatchPtrOutput) Metrics() KibanaSpecMonitoringMetricsPatchPtrOutput {
	return o.ApplyT(func(v *KibanaSpecMonitoringPatch) *KibanaSpecMonitoringMetricsPatch {
		if v == nil {
			return nil
		}
		return v.Metrics
...
type KibanaSpecPatch struct {
	...
	EnterpriseSearchRef *KibanaSpecEnterpriseSearchRefPatch `pulumi:"enterpriseSearchRef"`
	Http                *KibanaSpecHttpPatch                `pulumi:"http"`
	// Image is the Kibana Docker image to deploy.
	Image      *string                    `pulumi:"image"`
	Monitoring *KibanaSpecMonitoringPatch `pulumi:"monitoring"`
	// PodTemplate provides customisation options (labels, annotations, affinity rules, resource requests, and so on) for the Kibana pods
	PodTemplate map[string]interface{} `pulumi:"podTemplate"`
	// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
	RevisionHistoryLimit *int `pulumi:"revisionHistoryLimit"`
...
type KibanaSpecPatchArgs struct {
	...
	EnterpriseSearchRef KibanaSpecEnterpriseSearchRefPatchPtrInput `pulumi:"enterpriseSearchRef"`
	Http                KibanaSpecHttpPatchPtrInput                `pulumi:"http"`
	// Image is the Kibana Docker image to deploy.
	Image      pulumi.StringPtrInput             `pulumi:"image"`
	Monitoring KibanaSpecMonitoringPatchPtrInput `pulumi:"monitoring"`
	// PodTemplate provides customisation options (labels, annotations, affinity rules, resource requests, and so on) for the Kibana pods
	PodTemplate pulumi.MapInput `pulumi:"podTemplate"`
	// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
	RevisionHistoryLimit pulumi.IntPtrInput `pulumi:"revisionHistoryLimit"`
...
func (o KibanaSpecPatchOutput) EnterpriseSearchRef() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o.ApplyT(func(v KibanaSpecPatch) *KibanaSpecEnterpriseSearchRefPatch { return v.EnterpriseSearchRef }).(KibanaSpecEnterpriseSearchRefPatchPtrOutput)
}
...
func (o KibanaSpecPatchOutput) Monitoring() KibanaSpecMonitoringPatchPtrOutput {
	return o.ApplyT(func(v KibanaSpecPatch) *KibanaSpecMonitoringPatch { return v.Monitoring }).(KibanaSpecMonitoringPatchPtrOutput)
}
...
// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
func (o KibanaSpecPatchOutput) RevisionHistoryLimit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v KibanaSpecPatch) *int { return v.RevisionHistoryLimit }).(pulumi.IntPtrOutput)
}
...
// ServiceAccountName is used to check access from the current resource to a resource (for ex. Elasticsearch) in a different namespace.
// Can only be used if ECK is enforcing RBAC on references.
func (o KibanaSpecPatchOutput) ServiceAccountName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaSpecPatch) *string { return v.ServiceAccountName }).(pulumi.StringPtrOutput)
}
...
func (o KibanaSpecPatchPtrOutput) EnterpriseSearchRef() KibanaSpecEnterpriseSearchRefPatchPtrOutput {
	return o.ApplyT(func(v *KibanaSpecPatch) *KibanaSpecEnterpriseSearchRefPatch {
		if v == nil {
			return nil
		}
		return v.EnterpriseSearchRef
...
func (o KibanaSpecPatchPtrOutput) Monitoring() KibanaSpecMonitoringPatchPtrOutput {
	return o.ApplyT(func(v *KibanaSpecPatch) *KibanaSpecMonitoringPatch {
		if v == nil {
			return nil
		}
		return v.Monitoring
...
// RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying Deployment.
func (o KibanaSpecPatchPtrOutput) RevisionHistoryLimit() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KibanaSpecPatch) *int {
		if v == nil {
			return nil
		}
...
// ServiceAccountName is used to check access from the current resource to a resource (for ex. Elasticsearch) in a different namespace.
// Can only be used if ECK is enforcing RBAC on references.
func (o KibanaSpecPatchPtrOutput) ServiceAccountName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaSpecPatch) *string {
		if v == nil {
			return nil
		}
...
// Count corresponds to Scale.Status.Replicas, which is the actual number of observed instances of the scaled object.
func (o KibanaStatusPatchOutput) Count() pulumi.IntPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *int { return v.Count }).(pulumi.IntPtrOutput)
}

// ElasticsearchAssociationStatus is the status of any auto-linking to Elasticsearch clusters.
func (o KibanaStatusPatchOutput) ElasticsearchAssociationStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *string { return v.ElasticsearchAssociationStatus }).(pulumi.StringPtrOutput)
}

// EnterpriseSearchAssociationStatus is the status of any auto-linking to Enterprise Search.
func (o KibanaStatusPatchOutput) EnterpriseSearchAssociationStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *string { return v.EnterpriseSearchAssociationStatus }).(pulumi.StringPtrOutput)
}
...
// MonitoringAssociationStatus is the status of any auto-linking to monitoring Elasticsearch clusters.
func (o KibanaStatusPatchOutput) MonitoringAssociationStatus() pulumi.StringMapOutput {
	return o.ApplyT(func(v KibanaStatusPatch) map[string]string { return v.MonitoringAssociationStatus }).(pulumi.StringMapOutput)
}
...
// If the generation observed in status diverges from the generation in metadata, the Kibana
// controller has not yet processed the changes contained in the Kibana specification.
func (o KibanaStatusPatchOutput) ObservedGeneration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *int { return v.ObservedGeneration }).(pulumi.IntPtrOutput)
}

// Selector is the label selector used to find all pods.
func (o KibanaStatusPatchOutput) Selector() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *string { return v.Selector }).(pulumi.StringPtrOutput)
}

// Version of the stack resource currently running. During version upgrades, multiple versions may run
// in parallel: this value specifies the lowest version currently running.
func (o KibanaStatusPatchOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KibanaStatusPatch) *string { return v.Version }).(pulumi.StringPtrOutput)
}
...
// Count corresponds to Scale.Status.Replicas, which is the actual number of observed instances of the scaled object.
func (o KibanaStatusPatchPtrOutput) Count() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *int {
		if v == nil {
			return nil
		}
...
// ElasticsearchAssociationStatus is the status of any auto-linking to Elasticsearch clusters.
func (o KibanaStatusPatchPtrOutput) ElasticsearchAssociationStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *string {
		if v == nil {
			return nil
		}
...
// EnterpriseSearchAssociationStatus is the status of any auto-linking to Enterprise Search.
func (o KibanaStatusPatchPtrOutput) EnterpriseSearchAssociationStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *string {
		if v == nil {
			return nil
		}
...
// MonitoringAssociationStatus is the status of any auto-linking to monitoring Elasticsearch clusters.
func (o KibanaStatusPatchPtrOutput) MonitoringAssociationStatus() pulumi.StringMapOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) map[string]string {
		if v == nil {
			return nil
		}
		return v.MonitoringAssociationStatus
...
// If the generation observed in status diverges from the generation in metadata, the Kibana
// controller has not yet processed the changes contained in the Kibana specification.
func (o KibanaStatusPatchPtrOutput) ObservedGeneration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *int {
		if v == nil {
			return nil
		}
...
// Selector is the label selector used to find all pods.
func (o KibanaStatusPatchPtrOutput) Selector() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *string {
		if v == nil {
			return nil
		}
...
// Version of the stack resource currently running. During version upgrades, multiple versions may run
// in parallel: this value specifies the lowest version currently running.
func (o KibanaStatusPatchPtrOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KibanaStatusPatch) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecEnterpriseSearchRefPatchInput)(nil)).Elem(), KibanaSpecEnterpriseSearchRefPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecEnterpriseSearchRefPatchPtrInput)(nil)).Elem(), KibanaSpecEnterpriseSearchRefPatchArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringLogsElasticsearchRefsPatchInput)(nil)).Elem(), KibanaSpecMonitoringLogsElasticsearchRefsPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayInput)(nil)).Elem(), KibanaSpecMonitoringLogsElasticsearchRefsPatchArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringLogsPatchInput)(nil)).Elem(), KibanaSpecMonitoringLogsPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringLogsPatchPtrInput)(nil)).Elem(), KibanaSpecMonitoringLogsPatchArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringMetricsElasticsearchRefsPatchInput)(nil)).Elem(), KibanaSpecMonitoringMetricsElasticsearchRefsPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayInput)(nil)).Elem(), KibanaSpecMonitoringMetricsElasticsearchRefsPatchArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringMetricsPatchInput)(nil)).Elem(), KibanaSpecMonitoringMetricsPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringMetricsPatchPtrInput)(nil)).Elem(), KibanaSpecMonitoringMetricsPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringPatchInput)(nil)).Elem(), KibanaSpecMonitoringPatchArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*KibanaSpecMonitoringPatchPtrInput)(nil)).Elem(), KibanaSpecMonitoringPatchArgs{})
	...
	pulumi.RegisterOutputType(KibanaSpecEnterpriseSearchRefPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecEnterpriseSearchRefPatchPtrOutput{})
	...
	pulumi.RegisterOutputType(KibanaSpecMonitoringLogsElasticsearchRefsPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringLogsElasticsearchRefsPatchArrayOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringLogsPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringLogsPatchPtrOutput{})
	...
	pulumi.RegisterOutputType(KibanaSpecMonitoringMetricsElasticsearchRefsPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringMetricsElasticsearchRefsPatchArrayOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringMetricsPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringMetricsPatchPtrOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringPatchOutput{})
	pulumi.RegisterOutputType(KibanaSpecMonitoringPatchPtrOutput{})
