...
func NewKibanaPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKibanaPatch(ctx *pulumi.Context,
	...
	var resource KibanaPatch
	err := ctx.ReadResource("kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
