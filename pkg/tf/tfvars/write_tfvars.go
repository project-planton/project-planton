...
// ProtoToTerraformTFVars converts a given protobuf message into a Terraform tfvars-compatible
...
//
//	tfvarsStr, err := ProtoToTerraformTFVars(myProtoMessage)
//	if err != nil {
...
//	}
//
// This function is only intended for internal use by ProtoToTerraformTFVars.
