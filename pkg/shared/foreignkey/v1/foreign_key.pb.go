...
// 	protoc        (unknown)
// source: pkg/shared/foreignkey/v1/foreign_key.proto

package foreignkeyv1

import (
	_ "buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go/buf/validate"
	cloudresourcekind "github.com/project-planton/project-planton/pkg/shared/cloudresourcekind"
...
func (x *ValueFromRef) Reset() {
	*x = ValueFromRef{}
	mi := &file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes[0]
...
func (*ValueFromRef) Descriptor() ([]byte, []int) {
	return file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP(), []int{0}
}
...
func (x *StringValueOrRef) Reset() {
	*x = StringValueOrRef{}
	mi := &file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StringValueOrRef) Descriptor() ([]byte, []int) {
	return file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP(), []int{1}
}
...
func (x *Int32ValueOrRef) Reset() {
	*x = Int32ValueOrRef{}
	mi := &file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Int32ValueOrRef) Descriptor() ([]byte, []int) {
	return file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP(), []int{2}
}
...
var file_pkg_shared_foreignkey_v1_foreign_key_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/shared/foreignkey/v1/foreign_key.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
...
var (
	...
	E_DefaultKind = &file_pkg_shared_foreignkey_v1_foreign_key_proto_extTypes[0]
	// optional string default_kind_field_path = 200002;
	E_DefaultKindFieldPath = &file_pkg_shared_foreignkey_v1_foreign_key_proto_extTypes[1]
)

var File_pkg_shared_foreignkey_v1_foreign_key_proto protoreflect.FileDescriptor

const file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDesc = "" +
	"\n" +
	"*pkg/shared/foreignkey/v1/foreign_key.proto\x12$project.planton.shared.foreignkey.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6pkg/shared/cloudresourcekind/cloud_resource_kind.proto\"\xac\x01\n" +
	"\fValueFromRef\x12O\n" +
	...
	"\x17default_kind_field_path\x12\x1d.google.protobuf.FieldOptions\x18\u009a\f \x01(\tR\x14defaultKindFieldPathB\xc2\x02\n" +
	"(com.project.planton.shared.foreignkey.v1B\x0fForeignKeyProtoP\x01ZPgithub.com/project-planton/project-planton/pkg/shared/foreignkey/v1;foreignkeyv1\xa2\x02\x04PPSF\xaa\x02$Project.Planton.Shared.Foreignkey.V1\xca\x02$Project\\Planton\\Shared\\Foreignkey\\V1\xe2\x020Project\\Planton\\Shared\\Foreignkey\\V1\\GPBMetadata\xea\x02(Project::Planton::Shared::Foreignkey::V1b\x06proto3"

var (
	file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescOnce sync.Once
	file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescData []byte
)

func file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescGZIP() []byte {
	file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescOnce.Do(func() {
		file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDesc), len(file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDesc)))
	})
	return file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDescData
}

var file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_shared_foreignkey_v1_foreign_key_proto_goTypes = []any{
...
var file_pkg_shared_foreignkey_v1_foreign_key_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_foreignkey_v1_foreign_key_proto_init() }
func file_pkg_shared_foreignkey_v1_foreign_key_proto_init() {
	if File_pkg_shared_foreignkey_v1_foreign_key_proto != nil {
		return
	}
	file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes[1].OneofWrappers = []any{
		(*StringValueOrRef_Value)(nil),
		(*StringValueOrRef_ValueFrom)(nil),
	}
	file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDesc), len(file_pkg_shared_foreignkey_v1_foreign_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_foreignkey_v1_foreign_key_proto_goTypes,
		DependencyIndexes: file_pkg_shared_foreignkey_v1_foreign_key_proto_depIdxs,
		MessageInfos:      file_pkg_shared_foreignkey_v1_foreign_key_proto_msgTypes,
		ExtensionInfos:    file_pkg_shared_foreignkey_v1_foreign_key_proto_extTypes,
	}.Build()
	File_pkg_shared_foreignkey_v1_foreign_key_proto = out.File
	file_pkg_shared_foreignkey_v1_foreign_key_proto_goTypes = nil
	file_pkg_shared_foreignkey_v1_foreign_key_proto_depIdxs = nil
}
