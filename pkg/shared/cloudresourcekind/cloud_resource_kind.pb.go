...
// 	protoc        (unknown)
// source: pkg/shared/cloudresourcekind/cloud_resource_kind.proto
...
func (CloudResourceKindVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes[0].Descriptor()
}

func (CloudResourceKindVersion) Type() protoreflect.EnumType {
	return &file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes[0]
}
...
func (CloudResourceKindVersion) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescGZIP(), []int{0}
}
...
func (CloudResourceKind) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes[1].Descriptor()
}

func (CloudResourceKind) Type() protoreflect.EnumType {
	return &file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes[1]
}
...
func (CloudResourceKind) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescGZIP(), []int{1}
}
...
func (x *CloudResourceKindMeta) Reset() {
	*x = CloudResourceKindMeta{}
	mi := &file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_msgTypes[0]
...
func (x *KubernetesCloudResourceKindMeta) Reset() {
	*x = KubernetesCloudResourceKindMeta{}
	mi := &file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/shared/cloudresourcekind/cloud_resource_kind.proto",
	},
}
...
var (
	...
	E_KindMeta = &file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_extTypes[0]
)

var File_pkg_shared_cloudresourcekind_cloud_resource_kind_proto protoreflect.FileDescriptor

const file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc = "" +
	"\n" +
	"6pkg/shared/cloudresourcekind/cloud_resource_kind.proto\x12(project.planton.shared.cloudresourcekind\x1a google/protobuf/descriptor.proto\x1a:pkg/shared/cloudresourcekind/cloud_resource_provider.proto\x1a-pkg/shared/cloudresourcekind/kubernetes.proto\"\x9f\x03\n" +
	...
	"\aversion\x18\x02 \x01(\x0e2B.project.planton.shared.cloudresourcekind.CloudResourceKindVersionR\aversion\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1b\n" +
	"\tid_prefix\x18\x04 \x01(\tR\bidPrefix\x12&\n" +
	"\x0fis_service_kind\x18\x05 \x01(\bR\risServiceKind\x12r\n" +
	"\x0fkubernetes_meta\x18\x06 \x01(\v2I.project.planton.shared.cloudresourcekind.KubernetesCloudResourceKindMetaR\x0ekubernetesMeta\"\xb3\x01\n" +
	...
	"\x17ElasticsearchKubernetes\x10\xa2\x06\x1a#\xa2\xf7\x04\x1f\b\x13\x10\x01\"\x06elak8s2\x11\n" +
	"\relasticsearch\x10\x02\x122\n" +
	"\x10GitlabKubernetes\x10\xa3\x06\x1a\x1b\xa2\xf7\x04\x17\b\x13\x10\x01\"\x05glk8s2\n" +
	"\n" +
	"\x06gitlab\x10\x02\x125\n" +
	"\x11GrafanaKubernetes\x10\xa4\x06\x1a\x1d\xa2\xf7\x04\x19\b\x13\x10\x01\"\x06grak8s2\v\n" +
	"\agrafana\x10\x02\x12,\n" +
	"\vHelmRelease\x10\xa5\x06\x1a\x1a\xa2\xf7\x04\x16\b\x13\x10\x01\"\x06hlmk8s2\b\n" +
	"\x04helm\x10\x02\x125\n" +
	"\x11JenkinsKubernetes\x10\xa6\x06\x1a\x1d\xa2\xf7\x04\x19\b\x13\x10\x01\"\x06jenk8s2\v\n" +
	...
	"$CloudflareZeroTrustAccessApplication\x10\x8e\x0e\x1a\x0f\xa2\xf7\x04\v\b\x0f\x10\x01\"\x05cfzta:\x80\x01\n" +
	"\tkind_meta\x12!.google.protobuf.EnumValueOptions\x18\xf4N \x01(\v2?.project.planton.shared.cloudresourcekind.CloudResourceKindMetaR\bkindMetaB\xd3\x02\n" +
	",com.project.planton.shared.cloudresourcekindB\x16CloudResourceKindProtoP\x01ZGgithub.com/project-planton/project-planton/pkg/shared/cloudresourcekind\xa2\x02\x04PPSC\xaa\x02(Project.Planton.Shared.Cloudresourcekind\xca\x02(Project\\Planton\\Shared\\Cloudresourcekind\xe2\x024Project\\Planton\\Shared\\Cloudresourcekind\\GPBMetadata\xea\x02+Project::Planton::Shared::Cloudresourcekindb\x06proto3"

var (
	file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescOnce sync.Once
	file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescData []byte
)

func file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescGZIP() []byte {
	file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescOnce.Do(func() {
		file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc), len(file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc)))
	})
	return file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDescData
}

var file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_goTypes = []any{
...
var file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_init() }
func file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_init() {
	if File_pkg_shared_cloudresourcekind_cloud_resource_kind_proto != nil {
		return
	}
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_init()
	file_pkg_shared_cloudresourcekind_kubernetes_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc), len(file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_goTypes,
		DependencyIndexes: file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_depIdxs,
		EnumInfos:         file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_enumTypes,
		MessageInfos:      file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_msgTypes,
		ExtensionInfos:    file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_extTypes,
	}.Build()
	File_pkg_shared_cloudresourcekind_cloud_resource_kind_proto = out.File
	file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_goTypes = nil
	file_pkg_shared_cloudresourcekind_cloud_resource_kind_proto_depIdxs = nil
}
