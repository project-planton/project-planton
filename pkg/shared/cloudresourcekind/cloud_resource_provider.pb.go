...
// 	protoc        (unknown)
// source: pkg/shared/cloudresourcekind/cloud_resource_provider.proto
...
func (CloudResourceProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes[0].Descriptor()
}

func (CloudResourceProvider) Type() protoreflect.EnumType {
	return &file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes[0]
}
...
func (CloudResourceProvider) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudResourceProviderMeta) Reset() {
	*x = CloudResourceProviderMeta{}
	mi := &file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes[0]
...
var file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/shared/cloudresourcekind/cloud_resource_provider.proto",
	},
}
...
var (
	...
	E_ProviderMeta = &file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes[0]
)

var File_pkg_shared_cloudresourcekind_cloud_resource_provider_proto protoreflect.FileDescriptor

const file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc = "" +
	"\n" +
	":pkg/shared/cloudresourcekind/cloud_resource_provider.proto\x12(project.planton.shared.cloudresourcekind\x1a google/protobuf/descriptor.proto\"T\n" +
	...
	"\rprovider_meta\x12!.google.protobuf.EnumValueOptions\x18\xcd\xf9\x04 \x01(\v2C.project.planton.shared.cloudresourcekind.CloudResourceProviderMetaR\fproviderMetaB\xd7\x02\n" +
	",com.project.planton.shared.cloudresourcekindB\x1aCloudResourceProviderProtoP\x01ZGgithub.com/project-planton/project-planton/pkg/shared/cloudresourcekind\xa2\x02\x04PPSC\xaa\x02(Project.Planton.Shared.Cloudresourcekind\xca\x02(Project\\Planton\\Shared\\Cloudresourcekind\xe2\x024Project\\Planton\\Shared\\Cloudresourcekind\\GPBMetadata\xea\x02+Project::Planton::Shared::Cloudresourcekindb\x06proto3"

var (
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescOnce sync.Once
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData []byte
)

func file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescGZIP() []byte {
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescOnce.Do(func() {
		file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc), len(file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc)))
	})
	return file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDescData
}

var file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes = []any{
...
var file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_init() }
func file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_init() {
	if File_pkg_shared_cloudresourcekind_cloud_resource_provider_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc), len(file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes,
		DependencyIndexes: file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs,
		EnumInfos:         file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_enumTypes,
		MessageInfos:      file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_msgTypes,
		ExtensionInfos:    file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_extTypes,
	}.Build()
	File_pkg_shared_cloudresourcekind_cloud_resource_provider_proto = out.File
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_goTypes = nil
	file_pkg_shared_cloudresourcekind_cloud_resource_provider_proto_depIdxs = nil
}
