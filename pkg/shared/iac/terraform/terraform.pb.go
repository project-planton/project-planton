...
// 	protoc        (unknown)
// source: pkg/shared/iac/terraform/terraform.proto
...
func (TerraformOperationType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_iac_terraform_terraform_proto_enumTypes[0].Descriptor()
}

func (TerraformOperationType) Type() protoreflect.EnumType {
	return &file_pkg_shared_iac_terraform_terraform_proto_enumTypes[0]
}
...
func (TerraformOperationType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_iac_terraform_terraform_proto_rawDescGZIP(), []int{0}
}
...
func (TerraformBackendType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_iac_terraform_terraform_proto_enumTypes[1].Descriptor()
}

func (TerraformBackendType) Type() protoreflect.EnumType {
	return &file_pkg_shared_iac_terraform_terraform_proto_enumTypes[1]
}
...
func (TerraformBackendType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_iac_terraform_terraform_proto_rawDescGZIP(), []int{1}
}

var File_pkg_shared_iac_terraform_terraform_proto protoreflect.FileDescriptor

const file_pkg_shared_iac_terraform_terraform_proto_rawDesc = "" +
	"\n" +
	"(pkg/shared/iac/terraform/terraform.proto\x12$project.planton.shared.iac.terraform*{\n" +
	...
	"\aazurerm\x10\x04B\xb5\x02\n" +
	"(com.project.planton.shared.iac.terraformB\x0eTerraformProtoP\x01ZCgithub.com/project-planton/project-planton/pkg/shared/iac/terraform\xa2\x02\x05PPSIT\xaa\x02$Project.Planton.Shared.Iac.Terraform\xca\x02$Project\\Planton\\Shared\\Iac\\Terraform\xe2\x020Project\\Planton\\Shared\\Iac\\Terraform\\GPBMetadata\xea\x02(Project::Planton::Shared::Iac::Terraformb\x06proto3"

var (
	file_pkg_shared_iac_terraform_terraform_proto_rawDescOnce sync.Once
	file_pkg_shared_iac_terraform_terraform_proto_rawDescData []byte
)

func file_pkg_shared_iac_terraform_terraform_proto_rawDescGZIP() []byte {
	file_pkg_shared_iac_terraform_terraform_proto_rawDescOnce.Do(func() {
		file_pkg_shared_iac_terraform_terraform_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_iac_terraform_terraform_proto_rawDesc), len(file_pkg_shared_iac_terraform_terraform_proto_rawDesc)))
	})
	return file_pkg_shared_iac_terraform_terraform_proto_rawDescData
}

var file_pkg_shared_iac_terraform_terraform_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_shared_iac_terraform_terraform_proto_goTypes = []any{
...
var file_pkg_shared_iac_terraform_terraform_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_iac_terraform_terraform_proto_init() }
func file_pkg_shared_iac_terraform_terraform_proto_init() {
	if File_pkg_shared_iac_terraform_terraform_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_iac_terraform_terraform_proto_rawDesc), len(file_pkg_shared_iac_terraform_terraform_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_iac_terraform_terraform_proto_goTypes,
		DependencyIndexes: file_pkg_shared_iac_terraform_terraform_proto_depIdxs,
		EnumInfos:         file_pkg_shared_iac_terraform_terraform_proto_enumTypes,
	}.Build()
	File_pkg_shared_iac_terraform_terraform_proto = out.File
	file_pkg_shared_iac_terraform_terraform_proto_goTypes = nil
	file_pkg_shared_iac_terraform_terraform_proto_depIdxs = nil
}
