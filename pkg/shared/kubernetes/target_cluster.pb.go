...
// 	protoc        (unknown)
// source: pkg/shared/kubernetes/target_cluster.proto
...
func (x *KubernetesAddonTargetCluster) Reset() {
	*x = KubernetesAddonTargetCluster{}
	mi := &file_pkg_shared_kubernetes_target_cluster_proto_msgTypes[0]
...
func (*KubernetesAddonTargetCluster) Descriptor() ([]byte, []int) {
	return file_pkg_shared_kubernetes_target_cluster_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesClusterCloudResourceSelector) Reset() {
	*x = KubernetesClusterCloudResourceSelector{}
	mi := &file_pkg_shared_kubernetes_target_cluster_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesClusterCloudResourceSelector) Descriptor() ([]byte, []int) {
	return file_pkg_shared_kubernetes_target_cluster_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_shared_kubernetes_target_cluster_proto protoreflect.FileDescriptor

const file_pkg_shared_kubernetes_target_cluster_proto_rawDesc = "" +
	"\n" +
	"*pkg/shared/kubernetes/target_cluster.proto\x12!project.planton.shared.kubernetes\x1a\x1bbuf/validate/validate.proto\x1a6pkg/shared/cloudresourcekind/cloud_resource_kind.proto\"\xfd\x01\n" +
	...
	"\fcluster_name\x18\x02 \x01(\tR\vclusterNameB\xa5\x02\n" +
	"%com.project.planton.shared.kubernetesB\x12TargetClusterProtoP\x01Z@github.com/project-planton/project-planton/pkg/shared/kubernetes\xa2\x02\x04PPSK\xaa\x02!Project.Planton.Shared.Kubernetes\xca\x02!Project\\Planton\\Shared\\Kubernetes\xe2\x02-Project\\Planton\\Shared\\Kubernetes\\GPBMetadata\xea\x02$Project::Planton::Shared::Kubernetesb\x06proto3"

var (
	file_pkg_shared_kubernetes_target_cluster_proto_rawDescOnce sync.Once
	file_pkg_shared_kubernetes_target_cluster_proto_rawDescData []byte
)

func file_pkg_shared_kubernetes_target_cluster_proto_rawDescGZIP() []byte {
	file_pkg_shared_kubernetes_target_cluster_proto_rawDescOnce.Do(func() {
		file_pkg_shared_kubernetes_target_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_kubernetes_target_cluster_proto_rawDesc), len(file_pkg_shared_kubernetes_target_cluster_proto_rawDesc)))
	})
	return file_pkg_shared_kubernetes_target_cluster_proto_rawDescData
}

var file_pkg_shared_kubernetes_target_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_shared_kubernetes_target_cluster_proto_goTypes = []any{
...
var file_pkg_shared_kubernetes_target_cluster_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_kubernetes_target_cluster_proto_init() }
func file_pkg_shared_kubernetes_target_cluster_proto_init() {
	if File_pkg_shared_kubernetes_target_cluster_proto != nil {
		return
	}
	file_pkg_shared_kubernetes_target_cluster_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_kubernetes_target_cluster_proto_rawDesc), len(file_pkg_shared_kubernetes_target_cluster_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_kubernetes_target_cluster_proto_goTypes,
		DependencyIndexes: file_pkg_shared_kubernetes_target_cluster_proto_depIdxs,
		MessageInfos:      file_pkg_shared_kubernetes_target_cluster_proto_msgTypes,
	}.Build()
	File_pkg_shared_kubernetes_target_cluster_proto = out.File
	file_pkg_shared_kubernetes_target_cluster_proto_goTypes = nil
	file_pkg_shared_kubernetes_target_cluster_proto_depIdxs = nil
}
