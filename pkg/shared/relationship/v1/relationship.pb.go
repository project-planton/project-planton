...
// 	protoc        (unknown)
// source: pkg/shared/relationship/v1/relationship.proto
...
func (CloudResourceRelationship_RelationshipType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_shared_relationship_v1_relationship_proto_enumTypes[0].Descriptor()
}

func (CloudResourceRelationship_RelationshipType) Type() protoreflect.EnumType {
	return &file_pkg_shared_relationship_v1_relationship_proto_enumTypes[0]
}
...
func (CloudResourceRelationship_RelationshipType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_shared_relationship_v1_relationship_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CloudResourceRelationship) Reset() {
	*x = CloudResourceRelationship{}
	mi := &file_pkg_shared_relationship_v1_relationship_proto_msgTypes[0]
...
func (*CloudResourceRelationship) Descriptor() ([]byte, []int) {
	return file_pkg_shared_relationship_v1_relationship_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_shared_relationship_v1_relationship_proto protoreflect.FileDescriptor

const file_pkg_shared_relationship_v1_relationship_proto_rawDesc = "" +
	"\n" +
	"-pkg/shared/relationship/v1/relationship.proto\x12&project.planton.shared.relationship.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a6pkg/shared/cloudresourcekind/cloud_resource_kind.proto\"\x84\x03\n" +
	...
	"\x04uses\x10\x04B\xd2\x02\n" +
	"*com.project.planton.shared.relationship.v1B\x11RelationshipProtoP\x01ZTgithub.com/project-planton/project-planton/pkg/shared/relationship/v1;relationshipv1\xa2\x02\x04PPSR\xaa\x02&Project.Planton.Shared.Relationship.V1\xca\x02&Project\\Planton\\Shared\\Relationship\\V1\xe2\x022Project\\Planton\\Shared\\Relationship\\V1\\GPBMetadata\xea\x02*Project::Planton::Shared::Relationship::V1b\x06proto3"

var (
	file_pkg_shared_relationship_v1_relationship_proto_rawDescOnce sync.Once
	file_pkg_shared_relationship_v1_relationship_proto_rawDescData []byte
)

func file_pkg_shared_relationship_v1_relationship_proto_rawDescGZIP() []byte {
	file_pkg_shared_relationship_v1_relationship_proto_rawDescOnce.Do(func() {
		file_pkg_shared_relationship_v1_relationship_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_relationship_v1_relationship_proto_rawDesc), len(file_pkg_shared_relationship_v1_relationship_proto_rawDesc)))
	})
	return file_pkg_shared_relationship_v1_relationship_proto_rawDescData
}

var file_pkg_shared_relationship_v1_relationship_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_shared_relationship_v1_relationship_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_shared_relationship_v1_relationship_proto_goTypes = []any{
...
var file_pkg_shared_relationship_v1_relationship_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_relationship_v1_relationship_proto_init() }
func file_pkg_shared_relationship_v1_relationship_proto_init() {
	if File_pkg_shared_relationship_v1_relationship_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_relationship_v1_relationship_proto_rawDesc), len(file_pkg_shared_relationship_v1_relationship_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_relationship_v1_relationship_proto_goTypes,
		DependencyIndexes: file_pkg_shared_relationship_v1_relationship_proto_depIdxs,
		EnumInfos:         file_pkg_shared_relationship_v1_relationship_proto_enumTypes,
		MessageInfos:      file_pkg_shared_relationship_v1_relationship_proto_msgTypes,
	}.Build()
	File_pkg_shared_relationship_v1_relationship_proto = out.File
	file_pkg_shared_relationship_v1_relationship_proto_goTypes = nil
	file_pkg_shared_relationship_v1_relationship_proto_depIdxs = nil
}
