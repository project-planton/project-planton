...
// 	protoc        (unknown)
// source: pkg/shared/metadata.proto

package shared

import (
	v1 "github.com/project-planton/project-planton/pkg/shared/relationship/v1"
...
func (x *CloudResourceMetadata) Reset() {
	*x = CloudResourceMetadata{}
	mi := &file_pkg_shared_metadata_proto_msgTypes[0]
...
func (*CloudResourceMetadata) Descriptor() ([]byte, []int) {
	return file_pkg_shared_metadata_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_shared_metadata_proto protoreflect.FileDescriptor

const file_pkg_shared_metadata_proto_rawDesc = "" +
	"\n" +
	"\x19pkg/shared/metadata.proto\x12\x16project.planton.shared\x1a-pkg/shared/relationship/v1/relationship.proto\"\xa0\x04\n" +
	...
	"\x1acom.project.planton.sharedB\rMetadataProtoP\x01Z5github.com/project-planton/project-planton/pkg/shared\xa2\x02\x03PPS\xaa\x02\x16Project.Planton.Shared\xca\x02\x16Project\\Planton\\Shared\xe2\x02\"Project\\Planton\\Shared\\GPBMetadata\xea\x02\x18Project::Planton::Sharedb\x06proto3"

var (
	file_pkg_shared_metadata_proto_rawDescOnce sync.Once
	file_pkg_shared_metadata_proto_rawDescData []byte
)

func file_pkg_shared_metadata_proto_rawDescGZIP() []byte {
	file_pkg_shared_metadata_proto_rawDescOnce.Do(func() {
		file_pkg_shared_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_shared_metadata_proto_rawDesc), len(file_pkg_shared_metadata_proto_rawDesc)))
	})
	return file_pkg_shared_metadata_proto_rawDescData
}

var file_pkg_shared_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_shared_metadata_proto_goTypes = []any{
...
var file_pkg_shared_metadata_proto_depIdxs = []int32{
...
func init() { file_pkg_shared_metadata_proto_init() }
func file_pkg_shared_metadata_proto_init() {
	if File_pkg_shared_metadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_shared_metadata_proto_rawDesc), len(file_pkg_shared_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_shared_metadata_proto_goTypes,
		DependencyIndexes: file_pkg_shared_metadata_proto_depIdxs,
		MessageInfos:      file_pkg_shared_metadata_proto_msgTypes,
	}.Build()
	File_pkg_shared_metadata_proto = out.File
	file_pkg_shared_metadata_proto_goTypes = nil
	file_pkg_shared_metadata_proto_depIdxs = nil
}
