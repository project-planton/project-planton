...
func NewTelemetry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:telemetry.istio.io/v1alpha1:Telemetry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Telemetry
	err := ctx.RegisterResource("kubernetes:telemetry.istio.io/v1:Telemetry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTelemetry(ctx *pulumi.Context,
	...
	var resource Telemetry
	err := ctx.ReadResource("kubernetes:telemetry.istio.io/v1:Telemetry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
