...
func NewDestinationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:DestinationRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDestinationRule(ctx *pulumi.Context,
	...
	var resource DestinationRule
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:DestinationRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
