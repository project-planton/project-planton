...
func NewDestinationRulePatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:DestinationRulePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDestinationRulePatch(ctx *pulumi.Context,
	...
	var resource DestinationRulePatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:DestinationRulePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
