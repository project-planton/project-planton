...
func NewWorkloadEntry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:WorkloadEntry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource WorkloadEntry
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:WorkloadEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadEntry(ctx *pulumi.Context,
	...
	var resource WorkloadEntry
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:WorkloadEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
