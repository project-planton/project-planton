...
func NewWorkloadGroup(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1alpha3:WorkloadGroup"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:WorkloadGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroup(ctx *pulumi.Context,
	...
	var resource WorkloadGroup
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:WorkloadGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
