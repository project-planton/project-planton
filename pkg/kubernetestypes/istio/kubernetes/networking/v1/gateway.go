...
func NewGateway(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:Gateway"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Gateway
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
