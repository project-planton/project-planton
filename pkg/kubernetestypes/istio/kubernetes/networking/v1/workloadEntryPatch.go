...
func NewWorkloadEntryPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1:WorkloadEntryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadEntryPatch(ctx *pulumi.Context,
	...
	var resource WorkloadEntryPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1:WorkloadEntryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
