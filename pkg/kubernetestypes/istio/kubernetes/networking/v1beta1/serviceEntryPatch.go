...
func NewServiceEntryPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1alpha3:ServiceEntryPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServiceEntryPatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:ServiceEntryPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEntryPatch(ctx *pulumi.Context,
	...
	var resource ServiceEntryPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:ServiceEntryPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
