...
func NewVirtualServicePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1alpha3:VirtualServicePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource VirtualServicePatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:VirtualServicePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualServicePatch(ctx *pulumi.Context,
	...
	var resource VirtualServicePatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:VirtualServicePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
