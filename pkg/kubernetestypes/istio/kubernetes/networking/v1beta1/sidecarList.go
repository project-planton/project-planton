...
func NewSidecarList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:SidecarList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSidecarList(ctx *pulumi.Context,
	...
	var resource SidecarList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:SidecarList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
