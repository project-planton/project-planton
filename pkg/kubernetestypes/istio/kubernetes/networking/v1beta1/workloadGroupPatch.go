...
func NewWorkloadGroupPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1beta1:WorkloadGroupPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetWorkloadGroupPatch(ctx *pulumi.Context,
	...
	var resource WorkloadGroupPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1beta1:WorkloadGroupPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
