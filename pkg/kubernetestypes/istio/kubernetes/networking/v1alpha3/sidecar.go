...
func NewSidecar(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:Sidecar"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource Sidecar
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:Sidecar", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSidecar(ctx *pulumi.Context,
	...
	var resource Sidecar
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:Sidecar", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
