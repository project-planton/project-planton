...
func NewGatewayPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:GatewayPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GatewayPatch
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:GatewayPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayPatch(ctx *pulumi.Context,
	...
	var resource GatewayPatch
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:GatewayPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
