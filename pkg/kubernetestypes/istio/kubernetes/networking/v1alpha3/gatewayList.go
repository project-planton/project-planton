...
func NewGatewayList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:GatewayList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayList(ctx *pulumi.Context,
	...
	var resource GatewayList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:GatewayList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
