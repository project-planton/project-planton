...
func NewVirtualServiceList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:VirtualServiceList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualServiceList(ctx *pulumi.Context,
	...
	var resource VirtualServiceList
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:VirtualServiceList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
