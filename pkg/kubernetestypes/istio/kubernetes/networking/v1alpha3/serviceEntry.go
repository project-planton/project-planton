...
func NewServiceEntry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:networking.istio.io/v1beta1:ServiceEntry"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ServiceEntry
	err := ctx.RegisterResource("kubernetes:networking.istio.io/v1alpha3:ServiceEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceEntry(ctx *pulumi.Context,
	...
	var resource ServiceEntry
	err := ctx.ReadResource("kubernetes:networking.istio.io/v1alpha3:ServiceEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
