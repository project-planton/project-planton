...
func NewAuthorizationPolicyList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:security.istio.io/v1beta1:AuthorizationPolicyList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationPolicyList(ctx *pulumi.Context,
	...
	var resource AuthorizationPolicyList
	err := ctx.ReadResource("kubernetes:security.istio.io/v1beta1:AuthorizationPolicyList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
