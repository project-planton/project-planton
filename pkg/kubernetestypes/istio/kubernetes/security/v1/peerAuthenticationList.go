...
func NewPeerAuthenticationList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:security.istio.io/v1:PeerAuthenticationList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeerAuthenticationList(ctx *pulumi.Context,
	...
	var resource PeerAuthenticationList
	err := ctx.ReadResource("kubernetes:security.istio.io/v1:PeerAuthenticationList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
