...
func NewKafkaTopic(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:kafka.strimzi.io/v1beta1:KafkaTopic"),
		},
		{
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaTopic", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaTopic(ctx *pulumi.Context,
	...
	var resource KafkaTopic
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1alpha1:KafkaTopic", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
