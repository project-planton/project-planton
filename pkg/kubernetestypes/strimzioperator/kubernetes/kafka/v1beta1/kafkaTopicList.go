...
func NewKafkaTopicList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaTopicList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaTopicList(ctx *pulumi.Context,
	...
	var resource KafkaTopicList
	err := ctx.ReadResource("kubernetes:kafka.strimzi.io/v1beta1:KafkaTopicList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
