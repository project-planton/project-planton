...
func NewExternalSecretPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1beta1:ExternalSecretPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalSecretPatch(ctx *pulumi.Context,
	...
	var resource ExternalSecretPatch
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1beta1:ExternalSecretPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
