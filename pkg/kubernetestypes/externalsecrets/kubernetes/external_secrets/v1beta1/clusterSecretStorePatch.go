...
func NewClusterSecretStorePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:external-secrets.io/v1alpha1:ClusterSecretStorePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterSecretStorePatch
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1beta1:ClusterSecretStorePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterSecretStorePatch(ctx *pulumi.Context,
	...
	var resource ClusterSecretStorePatch
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1beta1:ClusterSecretStorePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
