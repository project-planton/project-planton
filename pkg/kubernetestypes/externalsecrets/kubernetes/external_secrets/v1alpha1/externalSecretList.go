...
func NewExternalSecretList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1alpha1:ExternalSecretList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetExternalSecretList(ctx *pulumi.Context,
	...
	var resource ExternalSecretList
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1alpha1:ExternalSecretList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
