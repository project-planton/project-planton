...
func NewClusterSecretStore(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:external-secrets.io/v1beta1:ClusterSecretStore"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ClusterSecretStore
	err := ctx.RegisterResource("kubernetes:external-secrets.io/v1alpha1:ClusterSecretStore", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterSecretStore(ctx *pulumi.Context,
	...
	var resource ClusterSecretStore
	err := ctx.ReadResource("kubernetes:external-secrets.io/v1alpha1:ClusterSecretStore", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
