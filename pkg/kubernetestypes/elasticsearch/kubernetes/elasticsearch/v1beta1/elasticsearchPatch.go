...
type ElasticsearchPatch struct {
	...
	Spec     ElasticsearchSpecPatchPtrOutput   `pulumi:"spec"`
	Status   ElasticsearchStatusPatchPtrOutput `pulumi:"status"`
}
...
func NewElasticsearchPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:ElasticsearchPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource ElasticsearchPatch
	err := ctx.RegisterResource("kubernetes:elasticsearch.k8s.elastic.co/v1beta1:ElasticsearchPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticsearchPatch(ctx *pulumi.Context,
	...
	var resource ElasticsearchPatch
	err := ctx.ReadResource("kubernetes:elasticsearch.k8s.elastic.co/v1beta1:ElasticsearchPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ElasticsearchPatchArgs struct {
	...
	Spec     ElasticsearchSpecPatchPtrInput
}
...
func (o ElasticsearchPatchOutput) Spec() ElasticsearchSpecPatchPtrOutput {
	return o.ApplyT(func(v *ElasticsearchPatch) ElasticsearchSpecPatchPtrOutput { return v.Spec }).(ElasticsearchSpecPatchPtrOutput)
}

func (o ElasticsearchPatchOutput) Status() ElasticsearchStatusPatchPtrOutput {
	return o.ApplyT(func(v *ElasticsearchPatch) ElasticsearchStatusPatchPtrOutput { return v.Status }).(ElasticsearchStatusPatchPtrOutput)
}
