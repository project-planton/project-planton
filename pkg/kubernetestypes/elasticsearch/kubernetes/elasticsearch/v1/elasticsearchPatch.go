...
func NewElasticsearchPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:elasticsearch.k8s.elastic.co/v1:ElasticsearchPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElasticsearchPatch(ctx *pulumi.Context,
	...
	var resource ElasticsearchPatch
	err := ctx.ReadResource("kubernetes:elasticsearch.k8s.elastic.co/v1:ElasticsearchPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
