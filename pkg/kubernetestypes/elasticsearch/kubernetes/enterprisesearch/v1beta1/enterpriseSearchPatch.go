...
func NewEnterpriseSearchPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:enterprisesearch.k8s.elastic.co/v1:EnterpriseSearchPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource EnterpriseSearchPatch
	err := ctx.RegisterResource("kubernetes:enterprisesearch.k8s.elastic.co/v1beta1:EnterpriseSearchPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEnterpriseSearchPatch(ctx *pulumi.Context,
	...
	var resource EnterpriseSearchPatch
	err := ctx.ReadResource("kubernetes:enterprisesearch.k8s.elastic.co/v1beta1:EnterpriseSearchPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
