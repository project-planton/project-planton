...
func NewApmServerPatch(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apm.k8s.elastic.co/v1:ApmServerPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApmServerPatch(ctx *pulumi.Context,
	...
	var resource ApmServerPatch
	err := ctx.ReadResource("kubernetes:apm.k8s.elastic.co/v1:ApmServerPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
