...
func NewApmServerList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:apm.k8s.elastic.co/v1alpha1:ApmServerList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetApmServerList(ctx *pulumi.Context,
	...
	var resource ApmServerList
	err := ctx.ReadResource("kubernetes:apm.k8s.elastic.co/v1alpha1:ApmServerList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
