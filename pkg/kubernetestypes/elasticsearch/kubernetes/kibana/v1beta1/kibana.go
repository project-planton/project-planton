...
type Kibana struct {
	...
	Spec     KibanaSpecOutput        `pulumi:"spec"`
...
func NewKibana(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		...
		{
			Type: pulumi.String("kubernetes:kibana.k8s.elastic.co/v1alpha1:Kibana"),
		},
	})
...
func (o KibanaOutput) Spec() KibanaSpecOutput {
	return o.ApplyT(func(v *Kibana) KibanaSpecOutput { return v.Spec }).(KibanaSpecOutput)
}
