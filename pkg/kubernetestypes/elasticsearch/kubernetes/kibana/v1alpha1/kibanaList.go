...
func NewKibanaList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKibanaList(ctx *pulumi.Context,
	...
	var resource KibanaList
	err := ctx.ReadResource("kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
