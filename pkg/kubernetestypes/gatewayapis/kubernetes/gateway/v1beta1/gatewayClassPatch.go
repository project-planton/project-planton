...
func NewGatewayClassPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1:GatewayClassPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GatewayClassPatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClassPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayClassPatch(ctx *pulumi.Context,
	...
	var resource GatewayClassPatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClassPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
