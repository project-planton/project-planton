...
type GatewayPatch struct {
	...
	Status   GatewayStatusPatchPtrOutput     `pulumi:"status"`
}
...
func NewGatewayPatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1:GatewayPatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GatewayPatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayPatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayPatch(ctx *pulumi.Context,
	...
	var resource GatewayPatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1beta1:GatewayPatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o GatewayPatchOutput) Status() GatewayStatusPatchPtrOutput {
	return o.ApplyT(func(v *GatewayPatch) GatewayStatusPatchPtrOutput { return v.Status }).(GatewayStatusPatchPtrOutput)
}
