...
func NewHTTPRoutePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1:HTTPRoutePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource HTTPRoutePatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1beta1:HTTPRoutePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHTTPRoutePatch(ctx *pulumi.Context,
	...
	var resource HTTPRoutePatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1beta1:HTTPRoutePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
