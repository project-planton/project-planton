...
func NewGRPCRoutePatch(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("kubernetes:gateway.networking.k8s.io/v1:GRPCRoutePatch"),
		},
	})
	opts = append(opts, aliases)
	opts = utilities.PkgResourceDefaultOpts(opts)
	var resource GRPCRoutePatch
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1alpha2:GRPCRoutePatch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGRPCRoutePatch(ctx *pulumi.Context,
	...
	var resource GRPCRoutePatch
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1alpha2:GRPCRoutePatch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
