...
func NewGRPCRouteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:GRPCRouteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGRPCRouteList(ctx *pulumi.Context,
	...
	var resource GRPCRouteList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:GRPCRouteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
