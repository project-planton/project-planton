...
func NewHTTPRouteList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.networking.k8s.io/v1:HTTPRouteList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHTTPRouteList(ctx *pulumi.Context,
	...
	var resource HTTPRouteList
	err := ctx.ReadResource("kubernetes:gateway.networking.k8s.io/v1:HTTPRouteList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
