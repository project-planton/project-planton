...
// 	protoc        (unknown)
// source: pkg/provider/snowflake/snowflakedatabase/v1/spec.proto
...
func (x *SnowflakeDatabaseSpec) Reset() {
	*x = SnowflakeDatabaseSpec{}
	mi := &file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[0]
...
func (*SnowflakeDatabaseSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SnowflakeDatabaseUserTask) Reset() {
	*x = SnowflakeDatabaseUserTask{}
	mi := &file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SnowflakeDatabaseUserTask) Descriptor() ([]byte, []int) {
	return file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6pkg/provider/snowflake/snowflakedatabase/v1/spec.proto\x127project.planton.provider.snowflake.snowflakedatabase.v1\"\xcd\a\n" +
	...
	"\n" +
	"timeout_ms\x18\x03 \x01(\x05R\ttimeoutMsB\xb7\x03\n" +
	";com.project.planton.provider.snowflake.snowflakedatabase.v1B\tSpecProtoP\x01Zjgithub.com/project-planton/project-planton/pkg/provider/snowflake/snowflakedatabase/v1;snowflakedatabasev1\xa2\x02\x05PPPSS\xaa\x027Project.Planton.Provider.Snowflake.Snowflakedatabase.V1\xca\x027Project\\Planton\\Provider\\Snowflake\\Snowflakedatabase\\V1\xe2\x02CProject\\Planton\\Provider\\Snowflake\\Snowflakedatabase\\V1\\GPBMetadata\xea\x02<Project::Planton::Provider::Snowflake::Snowflakedatabase::V1b\x06proto3"

var (
	file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDescData
}

var file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_init() }
func file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_init() {
	if File_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc), len(file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto = out.File
	file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_goTypes = nil
	file_pkg_provider_snowflake_snowflakedatabase_v1_spec_proto_depIdxs = nil
}
