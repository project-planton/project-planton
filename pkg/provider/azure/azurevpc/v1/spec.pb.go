...
// 	protoc        (unknown)
// source: pkg/provider/azure/azurevpc/v1/spec.proto
...
func (x *AzureVpcSpec) Reset() {
	*x = AzureVpcSpec{}
	mi := &file_pkg_provider_azure_azurevpc_v1_spec_proto_msgTypes[0]
...
func (*AzureVpcSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_azure_azurevpc_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDesc = "" +
	"\n" +
	")pkg/provider/azure/azurevpc/v1/spec.proto\x12*project.planton.provider.azure.azurevpc.v1\x1a\x1bbuf/validate/validate.proto\"\xf3\x02\n" +
	"\fAzureVpcSpec\x124\n" +
	...
	".com.project.planton.provider.azure.azurevpc.v1B\tSpecProtoP\x01ZTgithub.com/project-planton/project-planton/pkg/provider/azure/azurevpc/v1;azurevpcv1\xa2\x02\x05PPPAA\xaa\x02*Project.Planton.Provider.Azure.Azurevpc.V1\xca\x02*Project\\Planton\\Provider\\Azure\\Azurevpc\\V1\xe2\x026Project\\Planton\\Provider\\Azure\\Azurevpc\\V1\\GPBMetadata\xea\x02/Project::Planton::Provider::Azure::Azurevpc::V1b\x06proto3"

var (
	file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDescData
}

var file_pkg_provider_azure_azurevpc_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_azure_azurevpc_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_azure_azurevpc_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_azure_azurevpc_v1_spec_proto_init() }
func file_pkg_provider_azure_azurevpc_v1_spec_proto_init() {
	if File_pkg_provider_azure_azurevpc_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azurevpc_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_azure_azurevpc_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_azure_azurevpc_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_azure_azurevpc_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_azure_azurevpc_v1_spec_proto = out.File
	file_pkg_provider_azure_azurevpc_v1_spec_proto_goTypes = nil
	file_pkg_provider_azure_azurevpc_v1_spec_proto_depIdxs = nil
}
