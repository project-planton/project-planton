...
// 	protoc        (unknown)
// source: pkg/provider/azure/azureakscluster/v1/spec.proto
...
func (AzureAksClusterNetworkPlugin) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_azure_azureakscluster_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AzureAksClusterNetworkPlugin) Type() protoreflect.EnumType {
	return &file_pkg_provider_azure_azureakscluster_v1_spec_proto_enumTypes[0]
}
...
func (AzureAksClusterNetworkPlugin) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureAksClusterSpec) Reset() {
	*x = AzureAksClusterSpec{}
	mi := &file_pkg_provider_azure_azureakscluster_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_azure_azureakscluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"0pkg/provider/azure/azureakscluster/v1/spec.proto\x121project.planton.provider.azure.azureakscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xd6\x05\n" +
	...
	"\aKUBENET\x10\x01B\x91\x03\n" +
	"5com.project.planton.provider.azure.azureakscluster.v1B\tSpecProtoP\x01Zbgithub.com/project-planton/project-planton/pkg/provider/azure/azureakscluster/v1;azureaksclusterv1\xa2\x02\x05PPPAA\xaa\x021Project.Planton.Provider.Azure.Azureakscluster.V1\xca\x021Project\\Planton\\Provider\\Azure\\Azureakscluster\\V1\xe2\x02=Project\\Planton\\Provider\\Azure\\Azureakscluster\\V1\\GPBMetadata\xea\x026Project::Planton::Provider::Azure::Azureakscluster::V1b\x06proto3"

var (
	file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_azure_azureakscluster_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_azure_azureakscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_azure_azureakscluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_azure_azureakscluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_azure_azureakscluster_v1_spec_proto_init() }
func file_pkg_provider_azure_azureakscluster_v1_spec_proto_init() {
	if File_pkg_provider_azure_azureakscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azureakscluster_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_azure_azureakscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_azure_azureakscluster_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_azure_azureakscluster_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_azure_azureakscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_azure_azureakscluster_v1_spec_proto = out.File
	file_pkg_provider_azure_azureakscluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_azure_azureakscluster_v1_spec_proto_depIdxs = nil
}
