...
// 	protoc        (unknown)
// source: pkg/provider/azure/azurednszone/v1/spec.proto
...
func (x *AzureDnsZoneSpec) Reset() {
	*x = AzureDnsZoneSpec{}
	mi := &file_pkg_provider_azure_azurednszone_v1_spec_proto_msgTypes[0]
...
func (*AzureDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AzureDnsRecord) Reset() {
	*x = AzureDnsRecord{}
	mi := &file_pkg_provider_azure_azurednszone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsRecord) Descriptor() ([]byte, []int) {
	return file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_azure_azurednszone_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"-pkg/provider/azure/azurednszone/v1/spec.proto\x12.project.planton.provider.azure.azurednszone.v1\x1a\x1bbuf/validate/validate.proto\x1a?pkg/shared/networking/enums/dnsrecordtype/dns_record_type.proto\x1a pkg/shared/options/options.proto\"\xb8\x02\n" +
	...
	"\f_ttl_secondsB\xfc\x02\n" +
	"2com.project.planton.provider.azure.azurednszone.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/azure/azurednszone/v1;azurednszonev1\xa2\x02\x05PPPAA\xaa\x02.Project.Planton.Provider.Azure.Azurednszone.V1\xca\x02.Project\\Planton\\Provider\\Azure\\Azurednszone\\V1\xe2\x02:Project\\Planton\\Provider\\Azure\\Azurednszone\\V1\\GPBMetadata\xea\x023Project::Planton::Provider::Azure::Azurednszone::V1b\x06proto3"

var (
	file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDescData
}

var file_pkg_provider_azure_azurednszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_azure_azurednszone_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_azure_azurednszone_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_azure_azurednszone_v1_spec_proto_init() }
func file_pkg_provider_azure_azurednszone_v1_spec_proto_init() {
	if File_pkg_provider_azure_azurednszone_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_azure_azurednszone_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDesc), len(file_pkg_provider_azure_azurednszone_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_azure_azurednszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_azure_azurednszone_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_azure_azurednszone_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_azure_azurednszone_v1_spec_proto = out.File
	file_pkg_provider_azure_azurednszone_v1_spec_proto_goTypes = nil
	file_pkg_provider_azure_azurednszone_v1_spec_proto_depIdxs = nil
}
