...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/externalsecretskubernetes/v1/spec.proto
...
func (x *ExternalSecretsKubernetesSpec) Reset() {
	*x = ExternalSecretsKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[0]
...
func (*ExternalSecretsKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExternalSecretsKubernetesSpecContainer) Reset() {
	*x = ExternalSecretsKubernetesSpecContainer{}
	mi := &file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalSecretsKubernetesSpecContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExternalSecretsGkeConfig) Reset() {
	*x = ExternalSecretsGkeConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalSecretsGkeConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExternalSecretsEksConfig) Reset() {
	*x = ExternalSecretsEksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalSecretsEksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExternalSecretsAksConfig) Reset() {
	*x = ExternalSecretsAksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalSecretsAksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Epkg/provider/kubernetes/addon/externalsecretskubernetes/v1/spec.proto\x12Fproject.planton.provider.kubernetes.addon.externalsecretskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\x1a#pkg/shared/kubernetes/options.proto\x1a*pkg/shared/kubernetes/target_cluster.proto\x1a pkg/shared/options/options.proto\"\xf5\x05\n" +
	...
	"\x1amanaged_identity_client_id\x18\x02 \x01(\tR\x17managedIdentityClientIdB\x9c\x04\n" +
	"Jcom.project.planton.provider.kubernetes.addon.externalsecretskubernetes.v1B\tSpecProtoP\x01Z\x81\x01github.com/project-planton/project-planton/pkg/provider/kubernetes/addon/externalsecretskubernetes/v1;externalsecretskubernetesv1\xa2\x02\x06PPPKAE\xaa\x02FProject.Planton.Provider.Kubernetes.Addon.Externalsecretskubernetes.V1\xca\x02FProject\\Planton\\Provider\\Kubernetes\\Addon\\Externalsecretskubernetes\\V1\xe2\x02RProject\\Planton\\Provider\\Kubernetes\\Addon\\Externalsecretskubernetes\\V1\\GPBMetadata\xea\x02LProject::Planton::Provider::Kubernetes::Addon::Externalsecretskubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_externalsecretskubernetes_v1_spec_proto_depIdxs = nil
}
