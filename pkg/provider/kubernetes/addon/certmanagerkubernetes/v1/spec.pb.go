...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto
...
func (x *CertManagerKubernetesSpec) Reset() {
	*x = CertManagerKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[0]
...
func (*CertManagerKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AcmeConfig) Reset() {
	*x = AcmeConfig{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AcmeConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DnsProviderConfig) Reset() {
	*x = DnsProviderConfig{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DnsProviderConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpCloudDnsProvider) Reset() {
	*x = GcpCloudDnsProvider{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpCloudDnsProvider) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsRoute53Provider) Reset() {
	*x = AwsRoute53Provider{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRoute53Provider) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AzureDnsProvider) Reset() {
	*x = AzureDnsProvider{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AzureDnsProvider) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *CloudflareProvider) Reset() {
	*x = CloudflareProvider{}
	mi := &file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudflareProvider) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Apkg/provider/kubernetes/addon/certmanagerkubernetes/v1/spec.proto\x12Bproject.planton.provider.kubernetes.addon.certmanagerkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/kubernetes/target_cluster.proto\x1a pkg/shared/options/options.proto\"\xb3\x05\n" +
	...
	"Fcom.project.planton.provider.kubernetes.addon.certmanagerkubernetes.v1B\tSpecProtoP\x01Zygithub.com/project-planton/project-planton/pkg/provider/kubernetes/addon/certmanagerkubernetes/v1;certmanagerkubernetesv1\xa2\x02\x06PPPKAC\xaa\x02BProject.Planton.Provider.Kubernetes.Addon.Certmanagerkubernetes.V1\xca\x02BProject\\Planton\\Provider\\Kubernetes\\Addon\\Certmanagerkubernetes\\V1\xe2\x02NProject\\Planton\\Provider\\Kubernetes\\Addon\\Certmanagerkubernetes\\V1\\GPBMetadata\xea\x02HProject::Planton::Provider::Kubernetes::Addon::Certmanagerkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_certmanagerkubernetes_v1_spec_proto_depIdxs = nil
}
