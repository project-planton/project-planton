...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/api.proto
...
func (x *IngressNginxKubernetes) Reset() {
	*x = IngressNginxKubernetes{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_msgTypes[0]
...
func (*IngressNginxKubernetes) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *IngressNginxKubernetesStatus) Reset() {
	*x = IngressNginxKubernetesStatus{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressNginxKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	"Apkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/api.proto\x12Cproject.planton.provider.kubernetes.addon.ingressnginxkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1aBpkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/spec.proto\x1aKpkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/stack_outputs.proto\x1a\x19pkg/shared/metadata.proto\"\xe1\x03\n" +
	...
	"\aoutputs\x18\x01 \x01(\v2g.project.planton.provider.kubernetes.addon.ingressnginxkubernetes.v1.IngressNginxKubernetesStackOutputsR\aoutputsB\x85\x04\n" +
	"Gcom.project.planton.provider.kubernetes.addon.ingressnginxkubernetes.v1B\bApiProtoP\x01Z{github.com/project-planton/project-planton/pkg/provider/kubernetes/addon/ingressnginxkubernetes/v1;ingressnginxkubernetesv1\xa2\x02\x06PPPKAI\xaa\x02CProject.Planton.Provider.Kubernetes.Addon.Ingressnginxkubernetes.V1\xca\x02CProject\\Planton\\Provider\\Kubernetes\\Addon\\Ingressnginxkubernetes\\V1\xe2\x02OProject\\Planton\\Provider\\Kubernetes\\Addon\\Ingressnginxkubernetes\\V1\\GPBMetadata\xea\x02IProject::Planton::Provider::Kubernetes::Addon::Ingressnginxkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_init() }
func file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_init() {
	if File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_init()
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto = out.File
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_api_proto_depIdxs = nil
}
