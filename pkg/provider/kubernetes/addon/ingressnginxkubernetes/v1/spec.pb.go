...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/spec.proto
...
func (x *IngressNginxKubernetesSpec) Reset() {
	*x = IngressNginxKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes[0]
...
func (*IngressNginxKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *IngressNginxGkeConfig) Reset() {
	*x = IngressNginxGkeConfig{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressNginxGkeConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *IngressNginxEksConfig) Reset() {
	*x = IngressNginxEksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressNginxEksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *IngressNginxAksConfig) Reset() {
	*x = IngressNginxAksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressNginxAksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Bpkg/provider/kubernetes/addon/ingressnginxkubernetes/v1/spec.proto\x12Cproject.planton.provider.kubernetes.addon.ingressnginxkubernetes.v1\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a*pkg/shared/kubernetes/target_cluster.proto\"\xa8\x04\n" +
	...
	"Gcom.project.planton.provider.kubernetes.addon.ingressnginxkubernetes.v1B\tSpecProtoP\x01Z{github.com/project-planton/project-planton/pkg/provider/kubernetes/addon/ingressnginxkubernetes/v1;ingressnginxkubernetesv1\xa2\x02\x06PPPKAI\xaa\x02CProject.Planton.Provider.Kubernetes.Addon.Ingressnginxkubernetes.V1\xca\x02CProject\\Planton\\Provider\\Kubernetes\\Addon\\Ingressnginxkubernetes\\V1\xe2\x02OProject\\Planton\\Provider\\Kubernetes\\Addon\\Ingressnginxkubernetes\\V1\\GPBMetadata\xea\x02IProject::Planton::Provider::Kubernetes::Addon::Ingressnginxkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_ingressnginxkubernetes_v1_spec_proto_depIdxs = nil
}
