...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/postgresoperatorkubernetes/v1/spec.proto
...
func (x *PostgresOperatorKubernetesBackupR2Config) Reset() {
	*x = PostgresOperatorKubernetesBackupR2Config{}
	mi := &file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes[0]
...
func (*PostgresOperatorKubernetesBackupR2Config) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *PostgresOperatorKubernetesBackupConfig) Reset() {
	*x = PostgresOperatorKubernetesBackupConfig{}
	mi := &file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostgresOperatorKubernetesBackupConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *PostgresOperatorKubernetesSpec) Reset() {
	*x = PostgresOperatorKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostgresOperatorKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *PostgresOperatorKubernetesSpecContainer) Reset() {
	*x = PostgresOperatorKubernetesSpecContainer{}
	mi := &file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PostgresOperatorKubernetesSpecContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fpkg/provider/kubernetes/addon/postgresoperatorkubernetes/v1/spec.proto\x12Gproject.planton.provider.kubernetes.addon.postgresoperatorkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\x1a#pkg/shared/kubernetes/options.proto\x1a*pkg/shared/kubernetes/target_cluster.proto\"\xff\x01\n" +
	...
	"\x0350m\x12\x05100MiR\tresourcesB\xa3\x04\n" +
	"Kcom.project.planton.provider.kubernetes.addon.postgresoperatorkubernetes.v1B\tSpecProtoP\x01Z\x83\x01github.com/project-planton/project-planton/pkg/provider/kubernetes/addon/postgresoperatorkubernetes/v1;postgresoperatorkubernetesv1\xa2\x02\x06PPPKAP\xaa\x02GProject.Planton.Provider.Kubernetes.Addon.Postgresoperatorkubernetes.V1\xca\x02GProject\\Planton\\Provider\\Kubernetes\\Addon\\Postgresoperatorkubernetes\\V1\xe2\x02SProject\\Planton\\Provider\\Kubernetes\\Addon\\Postgresoperatorkubernetes\\V1\\GPBMetadata\xea\x02MProject::Planton::Provider::Kubernetes::Addon::Postgresoperatorkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_postgresoperatorkubernetes_v1_spec_proto_depIdxs = nil
}
