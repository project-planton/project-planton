...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/addon/externaldnskubernetes/v1/spec.proto
...
func (x *ExternalDnsKubernetesSpec) Reset() {
	*x = ExternalDnsKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[0]
...
func (*ExternalDnsKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExternalDnsGkeConfig) Reset() {
	*x = ExternalDnsGkeConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsGkeConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExternalDnsEksConfig) Reset() {
	*x = ExternalDnsEksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsEksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExternalDnsAksConfig) Reset() {
	*x = ExternalDnsAksConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsAksConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExternalDnsCloudflareConfig) Reset() {
	*x = ExternalDnsCloudflareConfig{}
	mi := &file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDnsCloudflareConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var File_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Apkg/provider/kubernetes/addon/externaldnskubernetes/v1/spec.proto\x12Bproject.planton.provider.kubernetes.addon.externaldnskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a*pkg/shared/kubernetes/target_cluster.proto\x1a pkg/shared/options/options.proto\"\xde\x06\n" +
	...
	"Fcom.project.planton.provider.kubernetes.addon.externaldnskubernetes.v1B\tSpecProtoP\x01Zygithub.com/project-planton/project-planton/pkg/provider/kubernetes/addon/externaldnskubernetes/v1;externaldnskubernetesv1\xa2\x02\x06PPPKAE\xaa\x02BProject.Planton.Provider.Kubernetes.Addon.Externaldnskubernetes.V1\xca\x02BProject\\Planton\\Provider\\Kubernetes\\Addon\\Externaldnskubernetes\\V1\xe2\x02NProject\\Planton\\Provider\\Kubernetes\\Addon\\Externaldnskubernetes\\V1\\GPBMetadata\xea\x02HProject::Planton::Provider::Kubernetes::Addon::Externaldnskubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_addon_externaldnskubernetes_v1_spec_proto_depIdxs = nil
}
