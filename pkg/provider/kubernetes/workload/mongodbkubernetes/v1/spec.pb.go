...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/mongodbkubernetes/v1/spec.proto
...
func (x *MongodbKubernetesSpec) Reset() {
	*x = MongodbKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_msgTypes[0]
...
func (*MongodbKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *MongodbKubernetesIngress) Reset() {
	*x = MongodbKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MongodbKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *MongodbKubernetesContainer) Reset() {
	*x = MongodbKubernetesContainer{}
	mi := &file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MongodbKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/mongodbkubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_extTypes[0]
)

var File_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@pkg/provider/kubernetes/workload/mongodbkubernetes/v1/spec.proto\x12Aproject.planton.provider.kubernetes.workload.mongodbkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\x85\x04\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18Ѭ  \x01(\v2].project.planton.provider.kubernetes.workload.mongodbkubernetes.v1.MongodbKubernetesContainerR\x10defaultContainerB\xf5\x03\n" +
	"Ecom.project.planton.provider.kubernetes.workload.mongodbkubernetes.v1B\tSpecProtoP\x01Ztgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/mongodbkubernetes/v1;mongodbkubernetesv1\xa2\x02\x06PPPKWM\xaa\x02AProject.Planton.Provider.Kubernetes.Workload.Mongodbkubernetes.V1\xca\x02AProject\\Planton\\Provider\\Kubernetes\\Workload\\Mongodbkubernetes\\V1\xe2\x02MProject\\Planton\\Provider\\Kubernetes\\Workload\\Mongodbkubernetes\\V1\\GPBMetadata\xea\x02GProject::Planton::Provider::Kubernetes::Workload::Mongodbkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_mongodbkubernetes_v1_spec_proto_depIdxs = nil
}
