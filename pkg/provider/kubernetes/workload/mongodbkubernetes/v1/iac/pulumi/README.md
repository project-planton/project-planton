...
planton pulumi up --manifest percona-operator.yaml \
  --module-dir provider/kubernetes/addon/perconaservermongodboperator/v1/iac/pulumi
```
...
1. Clone the repository:
    ...
    cd project-planton/provider/kubernetes/workload/mongodbkubernetes/v1/iac/pulumi
    ```
