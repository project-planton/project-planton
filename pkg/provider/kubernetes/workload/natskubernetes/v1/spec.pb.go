...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/natskubernetes/v1/spec.proto
...
func (NatsKubernetesAuthScheme) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (NatsKubernetesAuthScheme) Type() protoreflect.EnumType {
	return &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes[0]
}
...
func (NatsKubernetesAuthScheme) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *NatsKubernetesSpec) Reset() {
	*x = NatsKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[0]
...
func (x *NatsKubernetesServerContainer) Reset() {
	*x = NatsKubernetesServerContainer{}
	mi := &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesServerContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *NatsKubernetesNoAuthUser) Reset() {
	*x = NatsKubernetesNoAuthUser{}
	mi := &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesNoAuthUser) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *NatsKubernetesAuth) Reset() {
	*x = NatsKubernetesAuth{}
	mi := &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesAuth) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *NatsKubernetesIngress) Reset() {
	*x = NatsKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NatsKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
var file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/natskubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultServerContainer = &file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_extTypes[0]
)

var File_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=pkg/provider/kubernetes/workload/natskubernetes/v1/spec.proto\x12>project.planton.provider.kubernetes.workload.natskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\x1a pkg/shared/options/options.proto\"\x9f\x04\n" +
	...
	"\x18default_server_container\x12\x1d.google.protobuf.FieldOptions\x18Ʌ  \x01(\v2].project.planton.provider.kubernetes.workload.natskubernetes.v1.NatsKubernetesServerContainerR\x16defaultServerContainerB\xe0\x03\n" +
	"Bcom.project.planton.provider.kubernetes.workload.natskubernetes.v1B\tSpecProtoP\x01Zngithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/natskubernetes/v1;natskubernetesv1\xa2\x02\x06PPPKWN\xaa\x02>Project.Planton.Provider.Kubernetes.Workload.Natskubernetes.V1\xca\x02>Project\\Planton\\Provider\\Kubernetes\\Workload\\Natskubernetes\\V1\xe2\x02JProject\\Planton\\Provider\\Kubernetes\\Workload\\Natskubernetes\\V1\\GPBMetadata\xea\x02DProject::Planton::Provider::Kubernetes::Workload::Natskubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_natskubernetes_v1_spec_proto_depIdxs = nil
}
