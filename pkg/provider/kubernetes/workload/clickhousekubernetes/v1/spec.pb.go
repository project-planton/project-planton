...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto
...
func (ClickHouseKubernetesCoordinationConfig_CoordinationType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (ClickHouseKubernetesCoordinationConfig_CoordinationType) Type() protoreflect.EnumType {
	return &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[0]
}
...
func (ClickHouseKubernetesCoordinationConfig_CoordinationType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{3, 0}
}
...
func (ClickHouseKubernetesLoggingConfig_LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[1].Descriptor()
}

func (ClickHouseKubernetesLoggingConfig_LogLevel) Type() protoreflect.EnumType {
	return &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes[1]
}
...
func (ClickHouseKubernetesLoggingConfig_LogLevel) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{6, 0}
}
...
type ClickHouseKubernetesSpec struct {
	...
	//
	// Deprecated: Marked as deprecated in pkg/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto.
...
func (x *ClickHouseKubernetesSpec) Reset() {
	*x = ClickHouseKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[0]
...
func (*ClickHouseKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ClickHouseKubernetesContainer) Reset() {
	*x = ClickHouseKubernetesContainer{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ClickHouseKubernetesClusterConfig) Reset() {
	*x = ClickHouseKubernetesClusterConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesClusterConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ClickHouseKubernetesCoordinationConfig) Reset() {
	*x = ClickHouseKubernetesCoordinationConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *ClickHouseKubernetesKeeperConfig) Reset() {
	*x = ClickHouseKubernetesKeeperConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesKeeperConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *ClickHouseKubernetesExternalCoordinationConfig) Reset() {
	*x = ClickHouseKubernetesExternalCoordinationConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesExternalCoordinationConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *ClickHouseKubernetesLoggingConfig) Reset() {
	*x = ClickHouseKubernetesLoggingConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesLoggingConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *ClickHouseKubernetesIngress) Reset() {
	*x = ClickHouseKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *ClickHouseKubernetesZookeeperConfig) Reset() {
	*x = ClickHouseKubernetesZookeeperConfig{}
	mi := &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClickHouseKubernetesZookeeperConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes[0]
)

var File_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cpkg/provider/kubernetes/workload/clickhousekubernetes/v1/spec.proto\x12Dproject.planton.provider.kubernetes.workload.clickhousekubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\xdf\a\n" +
	...
	"\alogging\x18\b \x01(\v2g.project.planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesLoggingConfigB\x06\xbaH\x03\xc8\x01\x01R\alogging\"\xc1\x04\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xd9\xd6\x1f \x01(\v2c.project.planton.provider.kubernetes.workload.clickhousekubernetes.v1.ClickHouseKubernetesContainerR\x10defaultContainerB\x8a\x04\n" +
	"Hcom.project.planton.provider.kubernetes.workload.clickhousekubernetes.v1B\tSpecProtoP\x01Zzgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/clickhousekubernetes/v1;clickhousekubernetesv1\xa2\x02\x06PPPKWC\xaa\x02DProject.Planton.Provider.Kubernetes.Workload.Clickhousekubernetes.V1\xca\x02DProject\\Planton\\Provider\\Kubernetes\\Workload\\Clickhousekubernetes\\V1\xe2\x02PProject\\Planton\\Provider\\Kubernetes\\Workload\\Clickhousekubernetes\\V1\\GPBMetadata\xea\x02JProject::Planton::Provider::Kubernetes::Workload::Clickhousekubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   9,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_clickhousekubernetes_v1_spec_proto_depIdxs = nil
}
