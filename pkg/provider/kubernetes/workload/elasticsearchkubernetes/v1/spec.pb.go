...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/elasticsearchkubernetes/v1/spec.proto
...
func (x *ElasticsearchKubernetesSpec) Reset() {
	*x = ElasticsearchKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[0]
...
func (*ElasticsearchKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *ElasticsearchKubernetesElasticsearchSpec) Reset() {
	*x = ElasticsearchKubernetesElasticsearchSpec{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesElasticsearchSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *ElasticsearchKubernetesKibanaSpec) Reset() {
	*x = ElasticsearchKubernetesKibanaSpec{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesKibanaSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *ElasticsearchKubernetesElasticsearchContainer) Reset() {
	*x = ElasticsearchKubernetesElasticsearchContainer{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesElasticsearchContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *ElasticsearchKubernetesKibanaContainer) Reset() {
	*x = ElasticsearchKubernetesKibanaContainer{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesKibanaContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *ElasticsearchKubernetesIngress) Reset() {
	*x = ElasticsearchKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ElasticsearchKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
var file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/elasticsearchkubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
...
var (
	...
	E_DefaultElasticsearchSpec = &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_extTypes[0]
	...
	E_DefaultKibanaSpec = &file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_extTypes[1]
)

var File_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fpkg/provider/kubernetes/workload/elasticsearchkubernetes/v1/spec.proto\x12Gproject.planton.provider.kubernetes.workload.elasticsearchkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\x97\x03\n" +
	...
	"\x13default_kibana_spec\x12\x1d.google.protobuf.FieldOptions\x18ʈ\x1f \x01(\v2j.project.planton.provider.kubernetes.workload.elasticsearchkubernetes.v1.ElasticsearchKubernetesKibanaSpecR\x11defaultKibanaSpecB\xa0\x04\n" +
	"Kcom.project.planton.provider.kubernetes.workload.elasticsearchkubernetes.v1B\tSpecProtoP\x01Z\x80\x01github.com/project-planton/project-planton/pkg/provider/kubernetes/workload/elasticsearchkubernetes/v1;elasticsearchkubernetesv1\xa2\x02\x06PPPKWE\xaa\x02GProject.Planton.Provider.Kubernetes.Workload.Elasticsearchkubernetes.V1\xca\x02GProject\\Planton\\Provider\\Kubernetes\\Workload\\Elasticsearchkubernetes\\V1\xe2\x02SProject\\Planton\\Provider\\Kubernetes\\Workload\\Elasticsearchkubernetes\\V1\\GPBMetadata\xea\x02MProject::Planton::Provider::Kubernetes::Workload::Elasticsearchkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_elasticsearchkubernetes_v1_spec_proto_depIdxs = nil
}
