...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/openfgakubernetes/v1/spec.proto
...
func (x *OpenFgaKubernetesSpec) Reset() {
	*x = OpenFgaKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[0]
...
func (*OpenFgaKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *OpenFgaKubernetesContainer) Reset() {
	*x = OpenFgaKubernetesContainer{}
	mi := &file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *OpenFgaKubernetesDataStore) Reset() {
	*x = OpenFgaKubernetesDataStore{}
	mi := &file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesDataStore) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *OpenFgaKubernetesIngress) Reset() {
	*x = OpenFgaKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OpenFgaKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/openfgakubernetes/v1/spec.proto",
	},
}
...
var (
	...
	E_DefaultContainer = &file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_extTypes[0]
)

var File_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@pkg/provider/kubernetes/workload/openfgakubernetes/v1/spec.proto\x12Aproject.planton.provider.kubernetes.workload.openfgakubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\xb9\x03\n" +
	...
	"\x0350m\x12\x05100MiR\tcontainer\x12u\n" +
	"\aingress\x18\x02 \x01(\v2[.project.planton.provider.kubernetes.workload.openfgakubernetes.v1.OpenFgaKubernetesIngressR\aingress\x12\x83\x01\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\xb9\xb4  \x01(\v2].project.planton.provider.kubernetes.workload.openfgakubernetes.v1.OpenFgaKubernetesContainerR\x10defaultContainerB\xf5\x03\n" +
	"Ecom.project.planton.provider.kubernetes.workload.openfgakubernetes.v1B\tSpecProtoP\x01Ztgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/openfgakubernetes/v1;openfgakubernetesv1\xa2\x02\x06PPPKWO\xaa\x02AProject.Planton.Provider.Kubernetes.Workload.Openfgakubernetes.V1\xca\x02AProject\\Planton\\Provider\\Kubernetes\\Workload\\Openfgakubernetes\\V1\xe2\x02MProject\\Planton\\Provider\\Kubernetes\\Workload\\Openfgakubernetes\\V1\\GPBMetadata\xea\x02GProject::Planton::Provider::Kubernetes::Workload::Openfgakubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_goTypes = []any{
	...
	(*OpenFgaKubernetesIngress)(nil),      // 3: project.planton.provider.kubernetes.workload.openfgakubernetes.v1.OpenFgaKubernetesIngress
	(*kubernetes.ContainerResources)(nil), // 4: project.planton.shared.kubernetes.ContainerResources
	(*descriptorpb.FieldOptions)(nil),     // 5: google.protobuf.FieldOptions
}
var file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_depIdxs = []int32{
	...
	3, // 1: project.planton.provider.kubernetes.workload.openfgakubernetes.v1.OpenFgaKubernetesSpec.ingress:type_name -> project.planton.provider.kubernetes.workload.openfgakubernetes.v1.OpenFgaKubernetesIngress
...
func init() { file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_openfgakubernetes_v1_spec_proto_depIdxs = nil
}
