...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/solrkubernetes/v1/spec.proto
...
func (x *SolrKubernetesSpec) Reset() {
	*x = SolrKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes[0]
...
func (*SolrKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SolrKubernetesSolrContainer) Reset() {
	*x = SolrKubernetesSolrContainer{}
	mi := &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SolrKubernetesSolrContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *SolrKubernetesSolrConfig) Reset() {
	*x = SolrKubernetesSolrConfig{}
	mi := &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SolrKubernetesSolrConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *SolrKubernetesZookeeperContainer) Reset() {
	*x = SolrKubernetesZookeeperContainer{}
	mi := &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SolrKubernetesZookeeperContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "pkg/provider/kubernetes/workload/solrkubernetes/v1/spec.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*SolrKubernetesSolrContainer)(nil),
...
var (
	...
	E_DefaultSolrContainer = &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_extTypes[0]
	...
	E_DefaultZookeeperContainer = &file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_extTypes[1]
)

var File_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"=pkg/provider/kubernetes/workload/solrkubernetes/v1/spec.proto\x12>project.planton.provider.kubernetes.workload.solrkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\xd0\x04\n" +
	...
	"\x1bdefault_zookeeper_container\x12\x1d.google.protobuf.FieldOptions\x18\xe2\xfa  \x01(\v2[.project.planton.provider.kubernetes.workload.solrkubernetes.v1.SolrKubernetesSolrContainerR\x19defaultZookeeperContainerB\xe0\x03\n" +
	"Bcom.project.planton.provider.kubernetes.workload.solrkubernetes.v1B\tSpecProtoP\x01Zngithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/solrkubernetes/v1;solrkubernetesv1\xa2\x02\x06PPPKWS\xaa\x02>Project.Planton.Provider.Kubernetes.Workload.Solrkubernetes.V1\xca\x02>Project\\Planton\\Provider\\Kubernetes\\Workload\\Solrkubernetes\\V1\xe2\x02JProject\\Planton\\Provider\\Kubernetes\\Workload\\Solrkubernetes\\V1\\GPBMetadata\xea\x02DProject::Planton::Provider::Kubernetes::Workload::Solrkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 2,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_solrkubernetes_v1_spec_proto_depIdxs = nil
}
