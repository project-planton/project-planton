...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/kuberneteshttpendpoint/v1/spec.proto
...
func (x *KubernetesHttpEndpointSpec) Reset() {
	*x = KubernetesHttpEndpointSpec{}
	mi := &file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[0]
...
func (*KubernetesHttpEndpointSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *KubernetesHttpEndpointRoutingRule) Reset() {
	*x = KubernetesHttpEndpointRoutingRule{}
	mi := &file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesHttpEndpointRoutingRuleBackendService) Reset() {
	*x = KubernetesHttpEndpointRoutingRuleBackendService{}
	mi := &file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesHttpEndpointRoutingRuleBackendService) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Epkg/provider/kubernetes/workload/kuberneteshttpendpoint/v1/spec.proto\x12Fproject.planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1\x1a\x1bbuf/validate/validate.proto\"\xc1\x02\n" +
	...
	"\x04port\x18\x03 \x01(\x05R\x04portB\x98\x04\n" +
	"Jcom.project.planton.provider.kubernetes.workload.kuberneteshttpendpoint.v1B\tSpecProtoP\x01Z~github.com/project-planton/project-planton/pkg/provider/kubernetes/workload/kuberneteshttpendpoint/v1;kuberneteshttpendpointv1\xa2\x02\x06PPPKWK\xaa\x02FProject.Planton.Provider.Kubernetes.Workload.Kuberneteshttpendpoint.V1\xca\x02FProject\\Planton\\Provider\\Kubernetes\\Workload\\Kuberneteshttpendpoint\\V1\xe2\x02RProject\\Planton\\Provider\\Kubernetes\\Workload\\Kuberneteshttpendpoint\\V1\\GPBMetadata\xea\x02LProject::Planton::Provider::Kubernetes::Workload::Kuberneteshttpendpoint::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_kuberneteshttpendpoint_v1_spec_proto_depIdxs = nil
}
