...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/neo4jkubernetes/v1/spec.proto
...
func (x *Neo4JKubernetesSpec) Reset() {
	*x = Neo4JKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[0]
...
func (*Neo4JKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Neo4JKubernetesContainer) Reset() {
	*x = Neo4JKubernetesContainer{}
	mi := &file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neo4JKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *Neo4JKubernetesMemoryConfig) Reset() {
	*x = Neo4JKubernetesMemoryConfig{}
	mi := &file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neo4JKubernetesMemoryConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *Neo4JKubernetesIngress) Reset() {
	*x = Neo4JKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Neo4JKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.FieldOptions)(nil),
		ExtensionType: (*Neo4JKubernetesContainer)(nil),
		Field:         5008130,
		Name:          "project.planton.provider.kubernetes.workload.neo4jkubernetes.v1.default_container",
		Tag:           "bytes,5008130,opt,name=default_container",
		Filename:      "pkg/provider/kubernetes/workload/neo4jkubernetes/v1/spec.proto",
	},
}

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional project.planton.provider.kubernetes.workload.neo4jkubernetes.v1.Neo4jKubernetesContainer default_container = 5008130;
	E_DefaultContainer = &file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes[0]
)

var File_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	">pkg/provider/kubernetes/workload/neo4jkubernetes/v1/spec.proto\x12?project.planton.provider.kubernetes.workload.neo4jkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a google/protobuf/descriptor.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\"\xb0\x03\n" +
	...
	"\x11default_container\x12\x1d.google.protobuf.FieldOptions\x18\x82ֱ\x02 \x01(\v2Y.project.planton.provider.kubernetes.workload.neo4jkubernetes.v1.Neo4jKubernetesContainerR\x10defaultContainerB\xe7\x03\n" +
	"Ccom.project.planton.provider.kubernetes.workload.neo4jkubernetes.v1B\tSpecProtoP\x01Zpgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/neo4jkubernetes/v1;neo4jkubernetesv1\xa2\x02\x06PPPKWN\xaa\x02?Project.Planton.Provider.Kubernetes.Workload.Neo4jkubernetes.V1\xca\x02?Project\\Planton\\Provider\\Kubernetes\\Workload\\Neo4jkubernetes\\V1\xe2\x02KProject\\Planton\\Provider\\Kubernetes\\Workload\\Neo4jkubernetes\\V1\\GPBMetadata\xea\x02EProject::Planton::Provider::Kubernetes::Workload::Neo4jkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 1,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_msgTypes,
		ExtensionInfos:    file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_extTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_neo4jkubernetes_v1_spec_proto_depIdxs = nil
}
