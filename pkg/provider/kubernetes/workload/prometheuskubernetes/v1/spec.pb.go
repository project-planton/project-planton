...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/prometheuskubernetes/v1/spec.proto
...
func (x *PrometheusKubernetesSpec) Reset() {
	*x = PrometheusKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_msgTypes[0]
...
func (*PrometheusKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *PrometheusKubernetesContainer) Reset() {
	*x = PrometheusKubernetesContainer{}
	mi := &file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrometheusKubernetesContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Cpkg/provider/kubernetes/workload/prometheuskubernetes/v1/spec.proto\x12Dproject.planton.provider.kubernetes.workload.prometheuskubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\x1a#pkg/shared/kubernetes/options.proto\x1a pkg/shared/options/options.proto\"\xf0\x01\n" +
	...
	"!spec.container.disk_size.required\x12IDisk size is required and must match the format if persistence is enabled\x1a\xdf\x01((!this.persistence_enabled && (size(this.disk_size) == 0 || this.disk_size == '')) || (this.persistence_enabled && size(this.disk_size) > 0 && this.disk_size.matches('^\\\\d+(\\\\.\\\\d+)?\\\\s?(Ki|Mi|Gi|Ti|Pi|Ei|K|M|G|T|P|E)$')))B\x8a\x04\n" +
	"Hcom.project.planton.provider.kubernetes.workload.prometheuskubernetes.v1B\tSpecProtoP\x01Zzgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/prometheuskubernetes/v1;prometheuskubernetesv1\xa2\x02\x06PPPKWP\xaa\x02DProject.Planton.Provider.Kubernetes.Workload.Prometheuskubernetes.V1\xca\x02DProject\\Planton\\Provider\\Kubernetes\\Workload\\Prometheuskubernetes\\V1\xe2\x02PProject\\Planton\\Provider\\Kubernetes\\Workload\\Prometheuskubernetes\\V1\\GPBMetadata\xea\x02JProject::Planton::Provider::Kubernetes::Workload::Prometheuskubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_goTypes = []any{
	(*PrometheusKubernetesSpec)(nil),      // 0: project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesSpec
	(*PrometheusKubernetesContainer)(nil), // 1: project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesContainer
...
var file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_depIdxs = []int32{
	1, // 0: project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesSpec.container:type_name -> project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesContainer
	2, // 1: project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesSpec.ingress:type_name -> project.planton.shared.kubernetes.IngressSpec
	3, // 2: project.planton.provider.kubernetes.workload.prometheuskubernetes.v1.PrometheusKubernetesContainer.resources:type_name -> project.planton.shared.kubernetes.ContainerResources
...
func init() { file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_prometheuskubernetes_v1_spec_proto_depIdxs = nil
}
