...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/argocdkubernetes/v1/api.proto
...
func (x *ArgocdKubernetes) Reset() {
	*x = ArgocdKubernetes{}
	mi := &file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_msgTypes[0]
...
func (*ArgocdKubernetes) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *ArgocdKubernetesStatus) Reset() {
	*x = ArgocdKubernetesStatus{}
	mi := &file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ArgocdKubernetesStatus) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc = "" +
	"\n" +
	">pkg/provider/kubernetes/workload/argocdkubernetes/v1/api.proto\x12@project.planton.provider.kubernetes.workload.argocdkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a?pkg/provider/kubernetes/workload/argocdkubernetes/v1/spec.proto\x1aHpkg/provider/kubernetes/workload/argocdkubernetes/v1/stack_outputs.proto\x1a\x19pkg/shared/metadata.proto\"\xc3\x03\n" +
	...
	"\aoutputs\x18\x01 \x01(\v2^.project.planton.provider.kubernetes.workload.argocdkubernetes.v1.ArgocdKubernetesStackOutputsR\aoutputsB\xed\x03\n" +
	"Dcom.project.planton.provider.kubernetes.workload.argocdkubernetes.v1B\bApiProtoP\x01Zrgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/argocdkubernetes/v1;argocdkubernetesv1\xa2\x02\x06PPPKWA\xaa\x02@Project.Planton.Provider.Kubernetes.Workload.Argocdkubernetes.V1\xca\x02@Project\\Planton\\Provider\\Kubernetes\\Workload\\Argocdkubernetes\\V1\xe2\x02LProject\\Planton\\Provider\\Kubernetes\\Workload\\Argocdkubernetes\\V1\\GPBMetadata\xea\x02FProject::Planton::Provider::Kubernetes::Workload::Argocdkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_init() }
func file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_init() {
	if File_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_spec_proto_init()
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto = out.File
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_argocdkubernetes_v1_api_proto_depIdxs = nil
}
