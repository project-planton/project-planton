...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/temporalkubernetes/v1/spec.proto
...
func (TemporalKubernetesDatabaseBackend) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_enumTypes[0].Descriptor()
}

func (TemporalKubernetesDatabaseBackend) Type() protoreflect.EnumType {
	return &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_enumTypes[0]
}
...
func (TemporalKubernetesDatabaseBackend) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *TemporalKubernetesSpec) Reset() {
	*x = TemporalKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[0]
...
func (x *TemporalKubernetesDatabaseConfig) Reset() {
	*x = TemporalKubernetesDatabaseConfig{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesDatabaseConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *TemporalKubernetesExternalDatabase) Reset() {
	*x = TemporalKubernetesExternalDatabase{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesExternalDatabase) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *TemporalKubernetesExternalElasticsearch) Reset() {
	*x = TemporalKubernetesExternalElasticsearch{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesExternalElasticsearch) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *TemporalKubernetesIngress) Reset() {
	*x = TemporalKubernetesIngress{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesIngress) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *TemporalKubernetesFrontendIngressEndpoint) Reset() {
	*x = TemporalKubernetesFrontendIngressEndpoint{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesFrontendIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *TemporalKubernetesWebUiIngressEndpoint) Reset() {
	*x = TemporalKubernetesWebUiIngressEndpoint{}
	mi := &file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TemporalKubernetesWebUiIngressEndpoint) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
var File_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Apkg/provider/kubernetes/workload/temporalkubernetes/v1/spec.proto\x12Bproject.planton.provider.kubernetes.workload.temporalkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a pkg/shared/options/options.proto\"\xcf\x05\n" +
	...
	"\x05mysql\x10\x03B\xfc\x03\n" +
	"Fcom.project.planton.provider.kubernetes.workload.temporalkubernetes.v1B\tSpecProtoP\x01Zvgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/temporalkubernetes/v1;temporalkubernetesv1\xa2\x02\x06PPPKWT\xaa\x02BProject.Planton.Provider.Kubernetes.Workload.Temporalkubernetes.V1\xca\x02BProject\\Planton\\Provider\\Kubernetes\\Workload\\Temporalkubernetes\\V1\xe2\x02NProject\\Planton\\Provider\\Kubernetes\\Workload\\Temporalkubernetes\\V1\\GPBMetadata\xea\x02HProject::Planton::Provider::Kubernetes::Workload::Temporalkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_temporalkubernetes_v1_spec_proto_depIdxs = nil
}
