...
// 	protoc        (unknown)
// source: pkg/provider/kubernetes/workload/cronjobkubernetes/v1/spec.proto
...
func (x *CronJobKubernetesSpec) Reset() {
	*x = CronJobKubernetesSpec{}
	mi := &file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[0]
...
func (*CronJobKubernetesSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CronJobKubernetesContainerAppEnv) Reset() {
	*x = CronJobKubernetesContainerAppEnv{}
	mi := &file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CronJobKubernetesContainerAppEnv) Descriptor() ([]byte, []int) {
	return file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc = "" +
	"\n" +
	"@pkg/provider/kubernetes/workload/cronjobkubernetes/v1/spec.proto\x12Aproject.planton.provider.kubernetes.workload.cronjobkubernetes.v1\x1a\x1bbuf/validate/validate.proto\x1a&pkg/shared/kubernetes/kubernetes.proto\x1a#pkg/shared/kubernetes/options.proto\x1a pkg/shared/options/options.proto\"\xb9\b\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xf5\x03\n" +
	"Ecom.project.planton.provider.kubernetes.workload.cronjobkubernetes.v1B\tSpecProtoP\x01Ztgithub.com/project-planton/project-planton/pkg/provider/kubernetes/workload/cronjobkubernetes/v1;cronjobkubernetesv1\xa2\x02\x06PPPKWC\xaa\x02AProject.Planton.Provider.Kubernetes.Workload.Cronjobkubernetes.V1\xca\x02AProject\\Planton\\Provider\\Kubernetes\\Workload\\Cronjobkubernetes\\V1\xe2\x02MProject\\Planton\\Provider\\Kubernetes\\Workload\\Cronjobkubernetes\\V1\\GPBMetadata\xea\x02GProject::Planton::Provider::Kubernetes::Workload::Cronjobkubernetes::V1b\x06proto3"

var (
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDescData
}

var file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_init() }
func file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_init() {
	if File_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc), len(file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto = out.File
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_goTypes = nil
	file_pkg_provider_kubernetes_workload_cronjobkubernetes_v1_spec_proto_depIdxs = nil
}
