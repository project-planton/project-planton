...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpgkenodepool/v1/spec.proto
...
func (x *GcpGkeNodePoolSpec) Reset() {
	*x = GcpGkeNodePoolSpec{}
	mi := &file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeNodePoolAutoscaling) Reset() {
	*x = GcpGkeNodePoolAutoscaling{}
	mi := &file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeNodePoolAutoscaling) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGkeClusterNodePoolNodeManagement) Reset() {
	*x = GcpGkeClusterNodePoolNodeManagement{}
	mi := &file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterNodePoolNodeManagement) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"-pkg/provider/gcp/gcpgkenodepool/v1/spec.proto\x12.project.planton.provider.gcp.gcpgkenodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xbd\b\n" +
	...
	"\x13disable_auto_repair\x18\x02 \x01(\bR\x11disableAutoRepairB\xfe\x02\n" +
	"2com.project.planton.provider.gcp.gcpgkenodepool.v1B\tSpecProtoP\x01Z^github.com/project-planton/project-planton/pkg/provider/gcp/gcpgkenodepool/v1;gcpgkenodepoolv1\xa2\x02\x05PPPGG\xaa\x02.Project.Planton.Provider.Gcp.Gcpgkenodepool.V1\xca\x02.Project\\Planton\\Provider\\Gcp\\Gcpgkenodepool\\V1\xe2\x02:Project\\Planton\\Provider\\Gcp\\Gcpgkenodepool\\V1\\GPBMetadata\xea\x023Project::Planton::Provider::Gcp::Gcpgkenodepool::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
		(*GcpGkeNodePoolSpec_NodeCount)(nil),
		(*GcpGkeNodePoolSpec_Autoscaling)(nil),
	}
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpgkenodepool_v1_spec_proto_depIdxs = nil
}
