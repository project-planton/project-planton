...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpsubnetwork/v1/spec.proto
...
func (x *GcpSubnetworkSpec) Reset() {
	*x = GcpSubnetworkSpec{}
	mi := &file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes[0]
...
func (*GcpSubnetworkSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpSubnetworkSecondaryRange) Reset() {
	*x = GcpSubnetworkSecondaryRange{}
	mi := &file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpSubnetworkSecondaryRange) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/gcp/gcpsubnetwork/v1/spec.proto\x12-project.planton.provider.gcp.gcpsubnetwork.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xdf\x04\n" +
	...
	"\rip_cidr_range\x18\x02 \x01(\tB\"\xbaH\x1f\xc8\x01\x01r\x1a2\x18^\\d+\\.\\d+\\.\\d+\\.\\d+/\\d+$R\vipCidrRangeB\xf7\x02\n" +
	"1com.project.planton.provider.gcp.gcpsubnetwork.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/gcp/gcpsubnetwork/v1;gcpsubnetworkv1\xa2\x02\x05PPPGG\xaa\x02-Project.Planton.Provider.Gcp.Gcpsubnetwork.V1\xca\x02-Project\\Planton\\Provider\\Gcp\\Gcpsubnetwork\\V1\xe2\x029Project\\Planton\\Provider\\Gcp\\Gcpsubnetwork\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Gcp::Gcpsubnetwork::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpsubnetwork_v1_spec_proto_depIdxs = nil
}
