...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpserviceaccount/v1/spec.proto
...
func (x *GcpServiceAccountSpec) Reset() {
	*x = GcpServiceAccountSpec{}
	mi := &file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_msgTypes[0]
...
func (*GcpServiceAccountSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDesc = "" +
	"\n" +
	"0pkg/provider/gcp/gcpserviceaccount/v1/spec.proto\x121project.planton.provider.gcp.gcpserviceaccount.v1\x1a\x1bbuf/validate/validate.proto\x1a pkg/shared/options/options.proto\"\x97\x02\n" +
	...
	"\v_create_keyB\x93\x03\n" +
	"5com.project.planton.provider.gcp.gcpserviceaccount.v1B\tSpecProtoP\x01Zdgithub.com/project-planton/project-planton/pkg/provider/gcp/gcpserviceaccount/v1;gcpserviceaccountv1\xa2\x02\x05PPPGG\xaa\x021Project.Planton.Provider.Gcp.Gcpserviceaccount.V1\xca\x021Project\\Planton\\Provider\\Gcp\\Gcpserviceaccount\\V1\xe2\x02=Project\\Planton\\Provider\\Gcp\\Gcpserviceaccount\\V1\\GPBMetadata\xea\x026Project::Planton::Provider::Gcp::Gcpserviceaccount::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_goTypes = []any{
	(*GcpServiceAccountSpec)(nil), // 0: project.planton.provider.gcp.gcpserviceaccount.v1.GcpServiceAccountSpec
}
var file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpserviceaccount_v1_spec_proto_depIdxs = nil
}
