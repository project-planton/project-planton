...
import (
	...
	"github.com/project-planton/project-planton/pkg/provider/gcp/gcpgkeaddonbundle/v1/iac/pulumi/module/vars"
...
func externalDns(ctx *pulumi.Context, locals *Locals,
	...
	ctx.Export(OpExternalDnsGsaEmail, createdGoogleServiceAccount.Email)
