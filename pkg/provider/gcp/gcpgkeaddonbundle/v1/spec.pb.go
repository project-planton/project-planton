...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpgkeaddonbundle/v1/spec.proto
...
func (x *GcpGkeAddonBundleSpec) Reset() {
	*x = GcpGkeAddonBundleSpec{}
	mi := &file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeAddonBundleSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeAddonBundleIstio) Reset() {
	*x = GcpGkeAddonBundleIstio{}
	mi := &file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeAddonBundleIstio) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDesc = "" +
	"\n" +
	"0pkg/provider/gcp/gcpgkeaddonbundle/v1/spec.proto\x121project.planton.provider.gcp.gcpgkeaddonbundle.v1\x1a\x1bbuf/validate/validate.proto\"\xc7\x05\n" +
	...
	"\x15sub_network_self_link\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x12subNetworkSelfLinkB\x93\x03\n" +
	"5com.project.planton.provider.gcp.gcpgkeaddonbundle.v1B\tSpecProtoP\x01Zdgithub.com/project-planton/project-planton/pkg/provider/gcp/gcpgkeaddonbundle/v1;gcpgkeaddonbundlev1\xa2\x02\x05PPPGG\xaa\x021Project.Planton.Provider.Gcp.Gcpgkeaddonbundle.V1\xca\x021Project\\Planton\\Provider\\Gcp\\Gcpgkeaddonbundle\\V1\xe2\x02=Project\\Planton\\Provider\\Gcp\\Gcpgkeaddonbundle\\V1\\GPBMetadata\xea\x026Project::Planton::Provider::Gcp::Gcpgkeaddonbundle::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpgkeaddonbundle_v1_spec_proto_depIdxs = nil
}
