...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpgkecluster/v1/spec.proto
...
func (x *GcpGkeClusterSpec) Reset() {
	*x = GcpGkeClusterSpec{}
	mi := &file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeClusterSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpGkeClusterSharedVpcConfig) Reset() {
	*x = GcpGkeClusterSharedVpcConfig{}
	mi := &file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterSharedVpcConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *GcpGkeClusterAutoscalingConfig) Reset() {
	*x = GcpGkeClusterAutoscalingConfig{}
	mi := &file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterAutoscalingConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *GcpGkeClusterNodePool) Reset() {
	*x = GcpGkeClusterNodePool{}
	mi := &file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GcpGkeClusterNodePool) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
var File_pkg_provider_gcp_gcpgkecluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/gcp/gcpgkecluster/v1/spec.proto\x12-project.planton.provider.gcp.gcpgkecluster.v1\x1a\x1bbuf/validate/validate.proto\x1a pkg/shared/options/options.proto\"\xdc\x04\n" +
	...
	"\x0fis_spot_enabled\x18\x05 \x01(\bR\risSpotEnabledB\xf7\x02\n" +
	"1com.project.planton.provider.gcp.gcpgkecluster.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/gcp/gcpgkecluster/v1;gcpgkeclusterv1\xa2\x02\x05PPPGG\xaa\x02-Project.Planton.Provider.Gcp.Gcpgkecluster.V1\xca\x02-Project\\Planton\\Provider\\Gcp\\Gcpgkecluster\\V1\xe2\x029Project\\Planton\\Provider\\Gcp\\Gcpgkecluster\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Gcp::Gcpgkecluster::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpgkecluster_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpgkecluster_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpgkecluster_v1_spec_proto_depIdxs = nil
}
