...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpgkecluster/v1/stack_outputs.proto
...
func (x *GcpGkeClusterStackOutputs) Reset() {
	*x = GcpGkeClusterStackOutputs{}
	mi := &file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_msgTypes[0]
...
func (*GcpGkeClusterStackOutputs) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"5pkg/provider/gcp/gcpgkecluster/v1/stack_outputs.proto\x12-project.planton.provider.gcp.gcpgkecluster.v1\x1a\x18pkg/shared/gcp/gcp.proto\"\x8a\x04\n" +
	...
	"!workload_deployer_service_account\x18\t \x01(\v20.project.planton.shared.gcp.GoogleServiceAccountR\x1eworkloadDeployerServiceAccountB\xff\x02\n" +
...
var (
	file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDescData
}

var file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_init() }
func file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_init() {
	if File_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto = out.File
	file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_goTypes = nil
	file_pkg_provider_gcp_gcpgkecluster_v1_stack_outputs_proto_depIdxs = nil
}
