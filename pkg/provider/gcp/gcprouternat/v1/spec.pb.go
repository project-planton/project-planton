...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcprouternat/v1/spec.proto
...
func (x *GcpRouterNatSpec) Reset() {
	*x = GcpRouterNatSpec{}
	mi := &file_pkg_provider_gcp_gcprouternat_v1_spec_proto_msgTypes[0]
...
func (*GcpRouterNatSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_gcp_gcprouternat_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDesc = "" +
	"\n" +
	"+pkg/provider/gcp/gcprouternat/v1/spec.proto\x12,project.planton.provider.gcp.gcprouternat.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\x86\x03\n" +
	...
	"natIpNamesB\xf0\x02\n" +
	"0com.project.planton.provider.gcp.gcprouternat.v1B\tSpecProtoP\x01ZZgithub.com/project-planton/project-planton/pkg/provider/gcp/gcprouternat/v1;gcprouternatv1\xa2\x02\x05PPPGG\xaa\x02,Project.Planton.Provider.Gcp.Gcprouternat.V1\xca\x02,Project\\Planton\\Provider\\Gcp\\Gcprouternat\\V1\xe2\x028Project\\Planton\\Provider\\Gcp\\Gcprouternat\\V1\\GPBMetadata\xea\x021Project::Planton::Provider::Gcp::Gcprouternat::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcprouternat_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_gcp_gcprouternat_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcprouternat_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcprouternat_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcprouternat_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcprouternat_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcprouternat_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcprouternat_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcprouternat_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcprouternat_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcprouternat_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcprouternat_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcprouternat_v1_spec_proto_depIdxs = nil
}
