...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpartifactregistryrepo/v1/spec.proto
...
func (GcpArtifactRegistryRepoFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_enumTypes[0].Descriptor()
}

func (GcpArtifactRegistryRepoFormat) Type() protoreflect.EnumType {
	return &file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_enumTypes[0]
}
...
func (GcpArtifactRegistryRepoFormat) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *GcpArtifactRegistryRepoSpec) Reset() {
	*x = GcpArtifactRegistryRepoSpec{}
	mi := &file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6pkg/provider/gcp/gcpartifactregistryrepo/v1/spec.proto\x127project.planton.provider.gcp.gcpartifactregistryrepo.v1\x1a\x1bbuf/validate/validate.proto\"\x97\x02\n" +
	...
	"\x03YUM\x10\bB\xbd\x03\n" +
	";com.project.planton.provider.gcp.gcpartifactregistryrepo.v1B\tSpecProtoP\x01Zpgithub.com/project-planton/project-planton/pkg/provider/gcp/gcpartifactregistryrepo/v1;gcpartifactregistryrepov1\xa2\x02\x05PPPGG\xaa\x027Project.Planton.Provider.Gcp.Gcpartifactregistryrepo.V1\xca\x027Project\\Planton\\Provider\\Gcp\\Gcpartifactregistryrepo\\V1\xe2\x02CProject\\Planton\\Provider\\Gcp\\Gcpartifactregistryrepo\\V1\\GPBMetadata\xea\x02<Project::Planton::Provider::Gcp::Gcpartifactregistryrepo::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpartifactregistryrepo_v1_spec_proto_depIdxs = nil
}
