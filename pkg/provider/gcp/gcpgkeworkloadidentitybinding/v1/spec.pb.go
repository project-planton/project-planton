...
// 	protoc        (unknown)
// source: pkg/provider/gcp/gcpgkeworkloadidentitybinding/v1/spec.proto
...
func (x *GcpGkeWorkloadIdentityBindingSpec) Reset() {
	*x = GcpGkeWorkloadIdentityBindingSpec{}
	mi := &file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_msgTypes[0]
...
func (*GcpGkeWorkloadIdentityBindingSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<pkg/provider/gcp/gcpgkeworkloadidentitybinding/v1/spec.proto\x12=project.planton.provider.gcp.gcpgkeworkloadidentitybinding.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\x86\x03\n" +
	...
	"\bksa_name\x18\x04 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\aksaNameB\xe7\x03\n" +
	"Acom.project.planton.provider.gcp.gcpgkeworkloadidentitybinding.v1B\tSpecProtoP\x01Z|github.com/project-planton/project-planton/pkg/provider/gcp/gcpgkeworkloadidentitybinding/v1;gcpgkeworkloadidentitybindingv1\xa2\x02\x05PPPGG\xaa\x02=Project.Planton.Provider.Gcp.Gcpgkeworkloadidentitybinding.V1\xca\x02=Project\\Planton\\Provider\\Gcp\\Gcpgkeworkloadidentitybinding\\V1\xe2\x02IProject\\Planton\\Provider\\Gcp\\Gcpgkeworkloadidentitybinding\\V1\\GPBMetadata\xea\x02BProject::Planton::Provider::Gcp::Gcpgkeworkloadidentitybinding::V1b\x06proto3"

var (
	file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDescData
}

var file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_init() }
func file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_init() {
	if File_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc), len(file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto = out.File
	file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_goTypes = nil
	file_pkg_provider_gcp_gcpgkeworkloadidentitybinding_v1_spec_proto_depIdxs = nil
}
