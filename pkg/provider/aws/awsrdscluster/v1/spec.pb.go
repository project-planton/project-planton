...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsrdscluster/v1/spec.proto
...
func (x *AwsRdsClusterSpec) Reset() {
	*x = AwsRdsClusterSpec{}
	mi := &file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[0]
...
func (*AwsRdsClusterSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsRdsClusterParameter) Reset() {
	*x = AwsRdsClusterParameter{}
	mi := &file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterParameter) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsRdsClusterServerlessV2ScalingConfiguration) Reset() {
	*x = AwsRdsClusterServerlessV2ScalingConfiguration{}
	mi := &file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsRdsClusterServerlessV2ScalingConfiguration) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_aws_awsrdscluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/aws/awsrdscluster/v1/spec.proto\x12-project.planton.provider.aws.awsrdscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xab\x1e\n" +
	...
	"\x1cserverless_v2_scaling_bounds\x126max_capacity must be >= min_capacity when both are set\x1aBthis.max_capacity == 0.0 || this.max_capacity >= this.min_capacityB\xf7\x02\n" +
	"1com.project.planton.provider.aws.awsrdscluster.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/aws/awsrdscluster/v1;awsrdsclusterv1\xa2\x02\x05PPPAA\xaa\x02-Project.Planton.Provider.Aws.Awsrdscluster.V1\xca\x02-Project\\Planton\\Provider\\Aws\\Awsrdscluster\\V1\xe2\x029Project\\Planton\\Provider\\Aws\\Awsrdscluster\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Aws::Awsrdscluster::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_aws_awsrdscluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsrdscluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsrdscluster_v1_spec_proto_init() }
func file_pkg_provider_aws_awsrdscluster_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsrdscluster_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsrdscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsrdscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsrdscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsrdscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsrdscluster_v1_spec_proto = out.File
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsrdscluster_v1_spec_proto_depIdxs = nil
}
