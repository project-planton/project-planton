...
- Pulumi deploy: `project-planton pulumi update --manifest examples/aws/awsrdsinstance/v1/minimal.yaml --stack <org/project/stack> --module-dir provider/aws/awsrdsinstance/v1/iac/pulumi`
