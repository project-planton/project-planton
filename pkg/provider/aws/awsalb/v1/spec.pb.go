...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsalb/v1/spec.proto
...
func (x *AwsAlbSpec) Reset() {
	*x = AwsAlbSpec{}
	mi := &file_pkg_provider_aws_awsalb_v1_spec_proto_msgTypes[0]
...
func (*AwsAlbSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsAlbDns) Reset() {
	*x = AwsAlbDns{}
	mi := &file_pkg_provider_aws_awsalb_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbDns) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsAlbSsl) Reset() {
	*x = AwsAlbSsl{}
	mi := &file_pkg_provider_aws_awsalb_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsAlbSsl) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_aws_awsalb_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsalb_v1_spec_proto_rawDesc = "" +
	"\n" +
	"%pkg/provider/aws/awsalb/v1/spec.proto\x12&project.planton.provider.aws.awsalb.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\x99\x04\n" +
	"\n" +
	"AwsAlbSpec\x12b\n" +
	...
	"\x0fcertificate_arn\x18\x02 \x01(\v26.project.planton.shared.foreignkey.v1.StringValueOrRefB \x88\xd4a\xc9\x01\x92\xd4a\x17status.outputs.cert_arnR\x0ecertificateArnB\xc6\x02\n" +
	"*com.project.planton.provider.aws.awsalb.v1B\tSpecProtoP\x01ZNgithub.com/project-planton/project-planton/pkg/provider/aws/awsalb/v1;awsalbv1\xa2\x02\x05PPPAA\xaa\x02&Project.Planton.Provider.Aws.Awsalb.V1\xca\x02&Project\\Planton\\Provider\\Aws\\Awsalb\\V1\xe2\x022Project\\Planton\\Provider\\Aws\\Awsalb\\V1\\GPBMetadata\xea\x02+Project::Planton::Provider::Aws::Awsalb::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsalb_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsalb_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsalb_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsalb_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_aws_awsalb_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsalb_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsalb_v1_spec_proto_init() }
func file_pkg_provider_aws_awsalb_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsalb_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsalb_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsalb_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsalb_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsalb_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsalb_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsalb_v1_spec_proto = out.File
	file_pkg_provider_aws_awsalb_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsalb_v1_spec_proto_depIdxs = nil
}
