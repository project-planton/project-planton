...
// 	protoc        (unknown)
// source: pkg/provider/aws/awssecuritygroup/v1/spec.proto
...
func (x *AwsSecurityGroupSpec) Reset() {
	*x = AwsSecurityGroupSpec{}
	mi := &file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[0]
...
func (*AwsSecurityGroupSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *SecurityGroupRule) Reset() {
	*x = SecurityGroupRule{}
	mi := &file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SecurityGroupRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_aws_awssecuritygroup_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc = "" +
	"\n" +
	"/pkg/provider/aws/awssecuritygroup/v1/spec.proto\x120project.planton.provider.aws.awssecuritygroup.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xce\x03\n" +
	...
	"\x1drule_description_length_check\x12/Rule description must not exceed 255 characters\x1a\x11size(this) <= 255R\vdescriptionB\x8c\x03\n" +
	"4com.project.planton.provider.aws.awssecuritygroup.v1B\tSpecProtoP\x01Zbgithub.com/project-planton/project-planton/pkg/provider/aws/awssecuritygroup/v1;awssecuritygroupv1\xa2\x02\x05PPPAA\xaa\x020Project.Planton.Provider.Aws.Awssecuritygroup.V1\xca\x020Project\\Planton\\Provider\\Aws\\Awssecuritygroup\\V1\xe2\x02<Project\\Planton\\Provider\\Aws\\Awssecuritygroup\\V1\\GPBMetadata\xea\x025Project::Planton::Provider::Aws::Awssecuritygroup::V1b\x06proto3"

var (
	file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_init() }
func file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_init() {
	if File_pkg_provider_aws_awssecuritygroup_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awssecuritygroup_v1_spec_proto = out.File
	file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awssecuritygroup_v1_spec_proto_depIdxs = nil
}
