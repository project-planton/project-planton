...
// 	protoc        (unknown)
// source: pkg/provider/aws/awslambda/v1/spec.proto
...
func (Architecture) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes[0].Descriptor()
}

func (Architecture) Type() protoreflect.EnumType {
	return &file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes[0]
}
...
func (Architecture) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (CodeSourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes[1].Descriptor()
}

func (CodeSourceType) Type() protoreflect.EnumType {
	return &file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes[1]
}
...
func (CodeSourceType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsLambdaSpec) Reset() {
	*x = AwsLambdaSpec{}
	mi := &file_pkg_provider_aws_awslambda_v1_spec_proto_msgTypes[0]
...
func (x *S3Code) Reset() {
	*x = S3Code{}
	mi := &file_pkg_provider_aws_awslambda_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_pkg_provider_aws_awslambda_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awslambda_v1_spec_proto_rawDesc = "" +
	"\n" +
	"(pkg/provider/aws/awslambda/v1/spec.proto\x12)project.planton.provider.aws.awslambda.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xb1\x12\n" +
	"\rAwsLambdaSpec\x12,\n" +
	...
	"\x16CODE_SOURCE_TYPE_IMAGE\x10\x02B\xdb\x02\n" +
	"-com.project.planton.provider.aws.awslambda.v1B\tSpecProtoP\x01ZTgithub.com/project-planton/project-planton/pkg/provider/aws/awslambda/v1;awslambdav1\xa2\x02\x05PPPAA\xaa\x02)Project.Planton.Provider.Aws.Awslambda.V1\xca\x02)Project\\Planton\\Provider\\Aws\\Awslambda\\V1\xe2\x025Project\\Planton\\Provider\\Aws\\Awslambda\\V1\\GPBMetadata\xea\x02.Project::Planton::Provider::Aws::Awslambda::V1b\x06proto3"

var (
	file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awslambda_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awslambda_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awslambda_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_provider_aws_awslambda_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_aws_awslambda_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awslambda_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awslambda_v1_spec_proto_init() }
func file_pkg_provider_aws_awslambda_v1_spec_proto_init() {
	if File_pkg_provider_aws_awslambda_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awslambda_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awslambda_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awslambda_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awslambda_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_aws_awslambda_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_aws_awslambda_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awslambda_v1_spec_proto = out.File
	file_pkg_provider_aws_awslambda_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awslambda_v1_spec_proto_depIdxs = nil
}
