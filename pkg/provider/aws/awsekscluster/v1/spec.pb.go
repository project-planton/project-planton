...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsekscluster/v1/spec.proto
...
func (x *AwsEksClusterSpec) Reset() {
	*x = AwsEksClusterSpec{}
	mi := &file_pkg_provider_aws_awsekscluster_v1_spec_proto_msgTypes[0]
...
func (*AwsEksClusterSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awsekscluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/aws/awsekscluster/v1/spec.proto\x12-project.planton.provider.aws.awsekscluster.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xd9\x05\n" +
	...
	"\vkms_key_arn\x18\a \x01(\v26.project.planton.shared.foreignkey.v1.StringValueOrRefB\x1f\x88\xd4a\xdc\x01\x92\xd4a\x16status.outputs.key_arnR\tkmsKeyArnB\xf7\x02\n" +
	"1com.project.planton.provider.aws.awsekscluster.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/aws/awsekscluster/v1;awseksclusterv1\xa2\x02\x05PPPAA\xaa\x02-Project.Planton.Provider.Aws.Awsekscluster.V1\xca\x02-Project\\Planton\\Provider\\Aws\\Awsekscluster\\V1\xe2\x029Project\\Planton\\Provider\\Aws\\Awsekscluster\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Aws::Awsekscluster::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsekscluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_awsekscluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsekscluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsekscluster_v1_spec_proto_init() }
func file_pkg_provider_aws_awsekscluster_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsekscluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsekscluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsekscluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsekscluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsekscluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsekscluster_v1_spec_proto = out.File
	file_pkg_provider_aws_awsekscluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsekscluster_v1_spec_proto_depIdxs = nil
}
