...
// 	protoc        (unknown)
// source: pkg/provider/aws/awscertmanagercert/v1/spec.proto
...
func (x *AwsCertManagerCertSpec) Reset() {
	*x = AwsCertManagerCertSpec{}
	mi := &file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[0]
...
func (*AwsCertManagerCertSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awscertmanagercert_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc = "" +
	"\n" +
	"1pkg/provider/aws/awscertmanagercert/v1/spec.proto\x122project.planton.provider.aws.awscertmanagercert.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\x83\x04\n" +
	...
	"\x12_validation_methodB\x9a\x03\n" +
	"6com.project.planton.provider.aws.awscertmanagercert.v1B\tSpecProtoP\x01Zfgithub.com/project-planton/project-planton/pkg/provider/aws/awscertmanagercert/v1;awscertmanagercertv1\xa2\x02\x05PPPAA\xaa\x022Project.Planton.Provider.Aws.Awscertmanagercert.V1\xca\x022Project\\Planton\\Provider\\Aws\\Awscertmanagercert\\V1\xe2\x02>Project\\Planton\\Provider\\Aws\\Awscertmanagercert\\V1\\GPBMetadata\xea\x027Project::Planton::Provider::Aws::Awscertmanagercert::V1b\x06proto3"

var (
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_init() }
func file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_init() {
	if File_pkg_provider_aws_awscertmanagercert_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awscertmanagercert_v1_spec_proto = out.File
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awscertmanagercert_v1_spec_proto_depIdxs = nil
}
