...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsecsservice/v1/spec.proto
...
func (x *AwsEcsServiceSpec) Reset() {
	*x = AwsEcsServiceSpec{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[0]
...
func (*AwsEcsServiceSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsEcsServiceContainer) Reset() {
	*x = AwsEcsServiceContainer{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainer) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsEcsServiceContainerLogging) Reset() {
	*x = AwsEcsServiceContainerLogging{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerLogging) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
func (x *AwsEcsServiceContainerImage) Reset() {
	*x = AwsEcsServiceContainerImage{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerImage) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{3}
}
...
func (x *AwsEcsServiceContainerEnv) Reset() {
	*x = AwsEcsServiceContainerEnv{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceContainerEnv) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{4}
}
...
func (x *AwsEcsServiceNetwork) Reset() {
	*x = AwsEcsServiceNetwork{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceNetwork) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{5}
}
...
func (x *AwsEcsServiceIam) Reset() {
	*x = AwsEcsServiceIam{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceIam) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{6}
}
...
func (x *AwsEcsServiceAlb) Reset() {
	*x = AwsEcsServiceAlb{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceAlb) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{7}
}
...
func (x *AwsEcsServiceHealthCheck) Reset() {
	*x = AwsEcsServiceHealthCheck{}
	mi := &file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsEcsServiceHealthCheck) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP(), []int{8}
}
...
var File_pkg_provider_aws_awsecsservice_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/aws/awsecsservice/v1/spec.proto\x12-project.planton.provider.aws.awsecsservice.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\x92\x04\n" +
	...
	"\x13unhealthy_threshold\x18\a \x01(\x05R\x12unhealthyThresholdB\xf7\x02\n" +
	"1com.project.planton.provider.aws.awsecsservice.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/aws/awsecsservice/v1;awsecsservicev1\xa2\x02\x05PPPAA\xaa\x02-Project.Planton.Provider.Aws.Awsecsservice.V1\xca\x02-Project\\Planton\\Provider\\Aws\\Awsecsservice\\V1\xe2\x029Project\\Planton\\Provider\\Aws\\Awsecsservice\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Aws::Awsecsservice::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_pkg_provider_aws_awsecsservice_v1_spec_proto_goTypes = []any{
	...
	(*AwsEcsServiceHealthCheck)(nil),      // 8: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheck
	nil,                                   // 9: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntry
	nil,                                   // 10: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntry
	(*v1.StringValueOrRef)(nil),           // 11: project.planton.shared.foreignkey.v1.StringValueOrRef
}
var file_pkg_provider_aws_awsecsservice_v1_spec_proto_depIdxs = []int32{
	11, // 0: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceSpec.cluster_arn:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	...
	9,  // 8: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.variables:type_name -> project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.VariablesEntry
	10, // 9: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.secrets:type_name -> project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceContainerEnv.SecretsEntry
	11, // 10: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork.subnets:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 11: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceNetwork.security_groups:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 12: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceIam.task_execution_role_arn:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 13: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceIam.task_role_arn:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	11, // 14: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceAlb.arn:type_name -> project.planton.shared.foreignkey.v1.StringValueOrRef
	8,  // 15: project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceAlb.health_check:type_name -> project.planton.provider.aws.awsecsservice.v1.AwsEcsServiceHealthCheck
...
func init() { file_pkg_provider_aws_awsecsservice_v1_spec_proto_init() }
func file_pkg_provider_aws_awsecsservice_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsecsservice_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsecsservice_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsecsservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsecsservice_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsecsservice_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsecsservice_v1_spec_proto = out.File
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsecsservice_v1_spec_proto_depIdxs = nil
}
