...
// 	protoc        (unknown)
// source: pkg/provider/aws/provider.proto
...
func (x *AwsProviderConfig) Reset() {
	*x = AwsProviderConfig{}
	mi := &file_pkg_provider_aws_provider_proto_msgTypes[0]
...
func (*AwsProviderConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_provider_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_provider_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_provider_proto_rawDesc = "" +
	"\n" +
	"\x1fpkg/provider/aws/provider.proto\x12\x1cproject.planton.provider.aws\x1a\x1bbuf/validate/validate.proto\"\xf8\x06\n" +
	...
	"\a_regionB\x82\x02\n" +
	" com.project.planton.provider.awsB\rProviderProtoP\x01Z;github.com/project-planton/project-planton/pkg/provider/aws\xa2\x02\x04PPPA\xaa\x02\x1cProject.Planton.Provider.Aws\xca\x02\x1cProject\\Planton\\Provider\\Aws\xe2\x02(Project\\Planton\\Provider\\Aws\\GPBMetadata\xea\x02\x1fProject::Planton::Provider::Awsb\x06proto3"

var (
	file_pkg_provider_aws_provider_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_provider_proto_rawDescData []byte
)

func file_pkg_provider_aws_provider_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_provider_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_provider_proto_rawDesc), len(file_pkg_provider_aws_provider_proto_rawDesc)))
	})
	return file_pkg_provider_aws_provider_proto_rawDescData
}

var file_pkg_provider_aws_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_provider_proto_goTypes = []any{
	(*AwsProviderConfig)(nil), // 0: project.planton.provider.aws.AwsProviderConfig
}
var file_pkg_provider_aws_provider_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_provider_proto_init() }
func file_pkg_provider_aws_provider_proto_init() {
	if File_pkg_provider_aws_provider_proto != nil {
		return
	}
	file_pkg_provider_aws_provider_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_provider_proto_rawDesc), len(file_pkg_provider_aws_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_provider_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_provider_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_provider_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_provider_proto = out.File
	file_pkg_provider_aws_provider_proto_goTypes = nil
	file_pkg_provider_aws_provider_proto_depIdxs = nil
}
