...
// 	protoc        (unknown)
// source: pkg/provider/aws/awss3bucket/v1/spec.proto
...
func (x *AwsS3BucketSpec) Reset() {
	*x = AwsS3BucketSpec{}
	mi := &file_pkg_provider_aws_awss3bucket_v1_spec_proto_msgTypes[0]
...
func (*AwsS3BucketSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awss3bucket_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDesc = "" +
	"\n" +
	"*pkg/provider/aws/awss3bucket/v1/spec.proto\x12+project.planton.provider.aws.awss3bucket.v1\x1a\x1bbuf/validate/validate.proto\"V\n" +
	"\x0fAwsS3BucketSpec\x12\x1b\n" +
	"\tis_public\x18\x01 \x01(\bR\bisPublic\x12&\n" +
	"\n" +
	"aws_region\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tawsRegionB\xe9\x02\n" +
	"/com.project.planton.provider.aws.awss3bucket.v1B\tSpecProtoP\x01ZXgithub.com/project-planton/project-planton/pkg/provider/aws/awss3bucket/v1;awss3bucketv1\xa2\x02\x05PPPAA\xaa\x02+Project.Planton.Provider.Aws.Awss3bucket.V1\xca\x02+Project\\Planton\\Provider\\Aws\\Awss3bucket\\V1\xe2\x027Project\\Planton\\Provider\\Aws\\Awss3bucket\\V1\\GPBMetadata\xea\x020Project::Planton::Provider::Aws::Awss3bucket::V1b\x06proto3"

var (
	file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awss3bucket_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_awss3bucket_v1_spec_proto_goTypes = []any{
	(*AwsS3BucketSpec)(nil), // 0: project.planton.provider.aws.awss3bucket.v1.AwsS3BucketSpec
}
var file_pkg_provider_aws_awss3bucket_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awss3bucket_v1_spec_proto_init() }
func file_pkg_provider_aws_awss3bucket_v1_spec_proto_init() {
	if File_pkg_provider_aws_awss3bucket_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awss3bucket_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awss3bucket_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awss3bucket_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awss3bucket_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awss3bucket_v1_spec_proto = out.File
	file_pkg_provider_aws_awss3bucket_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awss3bucket_v1_spec_proto_depIdxs = nil
}
