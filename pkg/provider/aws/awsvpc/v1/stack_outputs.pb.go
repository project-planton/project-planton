...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsvpc/v1/stack_outputs.proto
...
func (x *AwsVpcStackOutputs) Reset() {
	*x = AwsVpcStackOutputs{}
	mi := &file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_msgTypes[0]
...
func (*AwsVpcStackOutputs) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsVpcSubnetStackOutputs) Reset() {
	*x = AwsVpcSubnetStackOutputs{}
	mi := &file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcSubnetStackOutputs) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsVpcNatGatewayStackOutputs) Reset() {
	*x = AwsVpcNatGatewayStackOutputs{}
	mi := &file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AwsVpcNatGatewayStackOutputs) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_aws_awsvpc_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	".pkg/provider/aws/awsvpc/v1/stack_outputs.proto\x12&project.planton.provider.aws.awsvpc.v1\"\xca\x02\n" +
	...
	"\tpublic_ip\x18\x03 \x01(\tR\bpublicIpB\xce\x02\n" +
...
var (
	file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDescData
}

var file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_init() }
func file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_init() {
	if File_pkg_provider_aws_awsvpc_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsvpc_v1_stack_outputs_proto = out.File
	file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_goTypes = nil
	file_pkg_provider_aws_awsvpc_v1_stack_outputs_proto_depIdxs = nil
}
