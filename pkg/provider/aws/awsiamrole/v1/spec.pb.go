...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsiamrole/v1/spec.proto
...
func (x *AwsIamRoleSpec) Reset() {
	*x = AwsIamRoleSpec{}
	mi := &file_pkg_provider_aws_awsiamrole_v1_spec_proto_msgTypes[0]
...
func (*AwsIamRoleSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awsiamrole_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDesc = "" +
	"\n" +
	")pkg/provider/aws/awsiamrole/v1/spec.proto\x12*project.planton.provider.aws.awsiamrole.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a pkg/shared/options/options.proto\"\xa0\x03\n" +
	...
	"\x13managed_policy_arns\x18\x04 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\x11managedPolicyArns\x12w\n" +
	"\x0finline_policies\x18\x05 \x03(\v2N.project.planton.provider.aws.awsiamrole.v1.AwsIamRoleSpec.InlinePoliciesEntryR\x0einlinePolicies\x1aZ\n" +
	"\x13InlinePoliciesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01B\xe2\x02\n" +
	".com.project.planton.provider.aws.awsiamrole.v1B\tSpecProtoP\x01ZVgithub.com/project-planton/project-planton/pkg/provider/aws/awsiamrole/v1;awsiamrolev1\xa2\x02\x05PPPAA\xaa\x02*Project.Planton.Provider.Aws.Awsiamrole.V1\xca\x02*Project\\Planton\\Provider\\Aws\\Awsiamrole\\V1\xe2\x026Project\\Planton\\Provider\\Aws\\Awsiamrole\\V1\\GPBMetadata\xea\x02/Project::Planton::Provider::Aws::Awsiamrole::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsiamrole_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_aws_awsiamrole_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsiamrole_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsiamrole_v1_spec_proto_init() }
func file_pkg_provider_aws_awsiamrole_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsiamrole_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsiamrole_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsiamrole_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsiamrole_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsiamrole_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsiamrole_v1_spec_proto = out.File
	file_pkg_provider_aws_awsiamrole_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsiamrole_v1_spec_proto_depIdxs = nil
}
