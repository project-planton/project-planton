...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsclientvpn/v1/spec.proto
...
func (AwsClientVpnAuthenticationType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsClientVpnAuthenticationType) Type() protoreflect.EnumType {
	return &file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[0]
}
...
func (AwsClientVpnAuthenticationType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (AwsClientVpnTransportProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[1].Descriptor()
}

func (AwsClientVpnTransportProtocol) Type() protoreflect.EnumType {
	return &file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes[1]
}
...
func (AwsClientVpnTransportProtocol) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *AwsClientVpnSpec) Reset() {
	*x = AwsClientVpnSpec{}
	mi := &file_pkg_provider_aws_awsclientvpn_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_aws_awsclientvpn_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDesc = "" +
	"\n" +
	"+pkg/provider/aws/awsclientvpn/v1/spec.proto\x12,project.planton.provider.aws.awsclientvpn.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\x91\x10\n" +
	...
	"\x03tcp\x10\x02B\xf0\x02\n" +
	"0com.project.planton.provider.aws.awsclientvpn.v1B\tSpecProtoP\x01ZZgithub.com/project-planton/project-planton/pkg/provider/aws/awsclientvpn/v1;awsclientvpnv1\xa2\x02\x05PPPAA\xaa\x02,Project.Planton.Provider.Aws.Awsclientvpn.V1\xca\x02,Project\\Planton\\Provider\\Aws\\Awsclientvpn\\V1\xe2\x028Project\\Planton\\Provider\\Aws\\Awsclientvpn\\V1\\GPBMetadata\xea\x021Project::Planton::Provider::Aws::Awsclientvpn::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_provider_aws_awsclientvpn_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_awsclientvpn_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsclientvpn_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsclientvpn_v1_spec_proto_init() }
func file_pkg_provider_aws_awsclientvpn_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsclientvpn_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsclientvpn_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsclientvpn_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsclientvpn_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_aws_awsclientvpn_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_aws_awsclientvpn_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsclientvpn_v1_spec_proto = out.File
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsclientvpn_v1_spec_proto_depIdxs = nil
}
