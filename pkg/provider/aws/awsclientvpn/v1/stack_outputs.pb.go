...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsclientvpn/v1/stack_outputs.proto
...
func (x *AwsClientVpnStackOutputs) Reset() {
	*x = AwsClientVpnStackOutputs{}
	mi := &file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_msgTypes[0]
...
func (*AwsClientVpnStackOutputs) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDesc = "" +
	"\n" +
	"4pkg/provider/aws/awsclientvpn/v1/stack_outputs.proto\x12,project.planton.provider.aws.awsclientvpn.v1\"\x89\x03\n" +
...
var (
	file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDescData
}

var file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_goTypes = []any{
...
var file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_init() }
func file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_init() {
	if File_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDesc), len(file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto = out.File
	file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_goTypes = nil
	file_pkg_provider_aws_awsclientvpn_v1_stack_outputs_proto_depIdxs = nil
}
