...
// 	protoc        (unknown)
// source: pkg/provider/aws/awscloudfront/v1/spec.proto
...
func (AwsCloudFrontSpec_PriceClass) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0].Descriptor()
}

func (AwsCloudFrontSpec_PriceClass) Type() protoreflect.EnumType {
	return &file_pkg_provider_aws_awscloudfront_v1_spec_proto_enumTypes[0]
}
...
func (AwsCloudFrontSpec_PriceClass) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AwsCloudFrontSpec) Reset() {
	*x = AwsCloudFrontSpec{}
	mi := &file_pkg_provider_aws_awscloudfront_v1_spec_proto_msgTypes[0]
...
func (*AwsCloudFrontSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *AwsCloudFrontSpec_Origin) Reset() {
	*x = AwsCloudFrontSpec_Origin{}
	mi := &file_pkg_provider_aws_awscloudfront_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_pkg_provider_aws_awscloudfront_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/aws/awscloudfront/v1/spec.proto\x12-project.planton.provider.aws.awscloudfront.v1\x1a\x1bbuf/validate/validate.proto\"\xfa\b\n" +
	...
	"\x1aexactly_one_default_origin\x12,exactly one origin must be marked as default\x1a0this.origins.filter(o, o.is_default).size() == 1B\xf7\x02\n" +
	"1com.project.planton.provider.aws.awscloudfront.v1B\tSpecProtoP\x01Z\\github.com/project-planton/project-planton/pkg/provider/aws/awscloudfront/v1;awscloudfrontv1\xa2\x02\x05PPPAA\xaa\x02-Project.Planton.Provider.Aws.Awscloudfront.V1\xca\x02-Project\\Planton\\Provider\\Aws\\Awscloudfront\\V1\xe2\x029Project\\Planton\\Provider\\Aws\\Awscloudfront\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Aws::Awscloudfront::V1b\x06proto3"

var (
	file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awscloudfront_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_aws_awscloudfront_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_aws_awscloudfront_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_aws_awscloudfront_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awscloudfront_v1_spec_proto_init() }
func file_pkg_provider_aws_awscloudfront_v1_spec_proto_init() {
	if File_pkg_provider_aws_awscloudfront_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awscloudfront_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awscloudfront_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awscloudfront_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_aws_awscloudfront_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_aws_awscloudfront_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awscloudfront_v1_spec_proto = out.File
	file_pkg_provider_aws_awscloudfront_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awscloudfront_v1_spec_proto_depIdxs = nil
}
