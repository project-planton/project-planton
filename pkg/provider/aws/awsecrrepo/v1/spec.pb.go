...
// 	protoc        (unknown)
// source: pkg/provider/aws/awsecrrepo/v1/spec.proto
...
func (x *AwsEcrRepoSpec) Reset() {
	*x = AwsEcrRepoSpec{}
	mi := &file_pkg_provider_aws_awsecrrepo_v1_spec_proto_msgTypes[0]
...
func (*AwsEcrRepoSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_aws_awsecrrepo_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDesc = "" +
	"\n" +
	")pkg/provider/aws/awsecrrepo/v1/spec.proto\x12*project.planton.provider.aws.awsecrrepo.v1\x1a\x1bbuf/validate/validate.proto\x1a pkg/shared/options/options.proto\"\x95\x02\n" +
	...
	"\x10_encryption_typeB\xe2\x02\n" +
	".com.project.planton.provider.aws.awsecrrepo.v1B\tSpecProtoP\x01ZVgithub.com/project-planton/project-planton/pkg/provider/aws/awsecrrepo/v1;awsecrrepov1\xa2\x02\x05PPPAA\xaa\x02*Project.Planton.Provider.Aws.Awsecrrepo.V1\xca\x02*Project\\Planton\\Provider\\Aws\\Awsecrrepo\\V1\xe2\x026Project\\Planton\\Provider\\Aws\\Awsecrrepo\\V1\\GPBMetadata\xea\x02/Project::Planton::Provider::Aws::Awsecrrepo::V1b\x06proto3"

var (
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDescData
}

var file_pkg_provider_aws_awsecrrepo_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_aws_awsecrrepo_v1_spec_proto_goTypes = []any{
	(*AwsEcrRepoSpec)(nil), // 0: project.planton.provider.aws.awsecrrepo.v1.AwsEcrRepoSpec
}
var file_pkg_provider_aws_awsecrrepo_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_aws_awsecrrepo_v1_spec_proto_init() }
func file_pkg_provider_aws_awsecrrepo_v1_spec_proto_init() {
	if File_pkg_provider_aws_awsecrrepo_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDesc), len(file_pkg_provider_aws_awsecrrepo_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_aws_awsecrrepo_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_aws_awsecrrepo_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_aws_awsecrrepo_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_aws_awsecrrepo_v1_spec_proto = out.File
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_goTypes = nil
	file_pkg_provider_aws_awsecrrepo_v1_spec_proto_depIdxs = nil
}
