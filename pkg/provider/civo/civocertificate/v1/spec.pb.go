...
// 	protoc        (unknown)
// source: pkg/provider/civo/civocertificate/v1/spec.proto
...
func (CivoCertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_civo_civocertificate_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CivoCertificateType) Type() protoreflect.EnumType {
	return &file_pkg_provider_civo_civocertificate_v1_spec_proto_enumTypes[0]
}
...
func (CivoCertificateType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoCertificateSpec) Reset() {
	*x = CivoCertificateSpec{}
	mi := &file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes[0]
...
func (x *CivoCertificateLetsEncryptParams) Reset() {
	*x = CivoCertificateLetsEncryptParams{}
	mi := &file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateLetsEncryptParams) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoCertificateCustomParams) Reset() {
	*x = CivoCertificateCustomParams{}
	mi := &file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoCertificateCustomParams) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_civo_civocertificate_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDesc = "" +
	"\n" +
	"/pkg/provider/civo/civocertificate/v1/spec.proto\x120project.planton.provider.civo.civocertificate.v1\x1a\x1bbuf/validate/validate.proto\"\xff\x03\n" +
	...
	"\n" +
	"\x06custom\x10\x01B\x8b\x03\n" +
	"4com.project.planton.provider.civo.civocertificate.v1B\tSpecProtoP\x01Zagithub.com/project-planton/project-planton/pkg/provider/civo/civocertificate/v1;civocertificatev1\xa2\x02\x05PPPCC\xaa\x020Project.Planton.Provider.Civo.Civocertificate.V1\xca\x020Project\\Planton\\Provider\\Civo\\Civocertificate\\V1\xe2\x02<Project\\Planton\\Provider\\Civo\\Civocertificate\\V1\\GPBMetadata\xea\x025Project::Planton::Provider::Civo::Civocertificate::V1b\x06proto3"

var (
	file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDescData
}

var file_pkg_provider_civo_civocertificate_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_civo_civocertificate_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_civo_civocertificate_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_civocertificate_v1_spec_proto_init() }
func file_pkg_provider_civo_civocertificate_v1_spec_proto_init() {
	if File_pkg_provider_civo_civocertificate_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civocertificate_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_civocertificate_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_civocertificate_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_civo_civocertificate_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_civo_civocertificate_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_civocertificate_v1_spec_proto = out.File
	file_pkg_provider_civo_civocertificate_v1_spec_proto_goTypes = nil
	file_pkg_provider_civo_civocertificate_v1_spec_proto_depIdxs = nil
}
