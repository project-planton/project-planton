...
// 	protoc        (unknown)
// source: pkg/provider/civo/civovolume/v1/spec.proto
...
func (CivoVolumeFilesystemType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_civo_civovolume_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CivoVolumeFilesystemType) Type() protoreflect.EnumType {
	return &file_pkg_provider_civo_civovolume_v1_spec_proto_enumTypes[0]
}
...
func (CivoVolumeFilesystemType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoVolumeSpec) Reset() {
	*x = CivoVolumeSpec{}
	mi := &file_pkg_provider_civo_civovolume_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_civo_civovolume_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_civovolume_v1_spec_proto_rawDesc = "" +
	"\n" +
	"*pkg/provider/civo/civovolume/v1/spec.proto\x12+project.planton.provider.civo.civovolume.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1epkg/provider/civo/region.proto\"\x9a\x03\n" +
	...
	"\x03XFS\x10\x02B\xe8\x02\n" +
	"/com.project.planton.provider.civo.civovolume.v1B\tSpecProtoP\x01ZWgithub.com/project-planton/project-planton/pkg/provider/civo/civovolume/v1;civovolumev1\xa2\x02\x05PPPCC\xaa\x02+Project.Planton.Provider.Civo.Civovolume.V1\xca\x02+Project\\Planton\\Provider\\Civo\\Civovolume\\V1\xe2\x027Project\\Planton\\Provider\\Civo\\Civovolume\\V1\\GPBMetadata\xea\x020Project::Planton::Provider::Civo::Civovolume::V1b\x06proto3"

var (
	file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civovolume_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civovolume_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_civo_civovolume_v1_spec_proto_rawDescData
}

var file_pkg_provider_civo_civovolume_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_civo_civovolume_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_civo_civovolume_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_civo_civovolume_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_civovolume_v1_spec_proto_init() }
func file_pkg_provider_civo_civovolume_v1_spec_proto_init() {
	if File_pkg_provider_civo_civovolume_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civovolume_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civovolume_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_civovolume_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_civovolume_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_civo_civovolume_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_civo_civovolume_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_civovolume_v1_spec_proto = out.File
	file_pkg_provider_civo_civovolume_v1_spec_proto_goTypes = nil
	file_pkg_provider_civo_civovolume_v1_spec_proto_depIdxs = nil
}
