...
// 	protoc        (unknown)
// source: pkg/provider/civo/civokubernetesnodepool/v1/spec.proto
...
func (x *CivoKubernetesNodePoolSpec) Reset() {
	*x = CivoKubernetesNodePoolSpec{}
	mi := &file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_msgTypes[0]
...
func (*CivoKubernetesNodePoolSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDesc = "" +
	"\n" +
	"6pkg/provider/civo/civokubernetesnodepool/v1/spec.proto\x127project.planton.provider.civo.civokubernetesnodepool.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xee\x02\n" +
	...
	"\x04tags\x18\b \x03(\tR\x04tagsB\xbc\x03\n" +
	";com.project.planton.provider.civo.civokubernetesnodepool.v1B\tSpecProtoP\x01Zogithub.com/project-planton/project-planton/pkg/provider/civo/civokubernetesnodepool/v1;civokubernetesnodepoolv1\xa2\x02\x05PPPCC\xaa\x027Project.Planton.Provider.Civo.Civokubernetesnodepool.V1\xca\x027Project\\Planton\\Provider\\Civo\\Civokubernetesnodepool\\V1\xe2\x02CProject\\Planton\\Provider\\Civo\\Civokubernetesnodepool\\V1\\GPBMetadata\xea\x02<Project::Planton::Provider::Civo::Civokubernetesnodepool::V1b\x06proto3"

var (
	file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDescData
}

var file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_init() }
func file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_init() {
	if File_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto = out.File
	file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_goTypes = nil
	file_pkg_provider_civo_civokubernetesnodepool_v1_spec_proto_depIdxs = nil
}
