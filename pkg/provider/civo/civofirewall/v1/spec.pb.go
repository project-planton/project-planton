...
// 	protoc        (unknown)
// source: pkg/provider/civo/civofirewall/v1/spec.proto
...
func (x *CivoFirewallSpec) Reset() {
	*x = CivoFirewallSpec{}
	mi := &file_pkg_provider_civo_civofirewall_v1_spec_proto_msgTypes[0]
...
func (*CivoFirewallSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoFirewallInboundRule) Reset() {
	*x = CivoFirewallInboundRule{}
	mi := &file_pkg_provider_civo_civofirewall_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallInboundRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CivoFirewallOutboundRule) Reset() {
	*x = CivoFirewallOutboundRule{}
	mi := &file_pkg_provider_civo_civofirewall_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoFirewallOutboundRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_civo_civofirewall_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDesc = "" +
	"\n" +
	",pkg/provider/civo/civofirewall/v1/spec.proto\x12-project.planton.provider.civo.civofirewall.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\xa0\x03\n" +
	...
	"\x05cidrs\x18\x03 \x03(\tR\x05cidrs\x12\x16\n" +
	"\x06action\x18\x04 \x01(\tR\x06action\x12\x14\n" +
	"\x05label\x18\x05 \x01(\tR\x05labelB\xf6\x02\n" +
	"1com.project.planton.provider.civo.civofirewall.v1B\tSpecProtoP\x01Z[github.com/project-planton/project-planton/pkg/provider/civo/civofirewall/v1;civofirewallv1\xa2\x02\x05PPPCC\xaa\x02-Project.Planton.Provider.Civo.Civofirewall.V1\xca\x02-Project\\Planton\\Provider\\Civo\\Civofirewall\\V1\xe2\x029Project\\Planton\\Provider\\Civo\\Civofirewall\\V1\\GPBMetadata\xea\x022Project::Planton::Provider::Civo::Civofirewall::V1b\x06proto3"

var (
	file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDescData
}

var file_pkg_provider_civo_civofirewall_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_civo_civofirewall_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_civo_civofirewall_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_civofirewall_v1_spec_proto_init() }
func file_pkg_provider_civo_civofirewall_v1_spec_proto_init() {
	if File_pkg_provider_civo_civofirewall_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civofirewall_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_civofirewall_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_civofirewall_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_civo_civofirewall_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_civofirewall_v1_spec_proto = out.File
	file_pkg_provider_civo_civofirewall_v1_spec_proto_goTypes = nil
	file_pkg_provider_civo_civofirewall_v1_spec_proto_depIdxs = nil
}
