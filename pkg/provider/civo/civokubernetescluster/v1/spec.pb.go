...
// 	protoc        (unknown)
// source: pkg/provider/civo/civokubernetescluster/v1/spec.proto
...
func (x *CivoKubernetesClusterSpec) Reset() {
	*x = CivoKubernetesClusterSpec{}
	mi := &file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes[0]
...
func (*CivoKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CivoKubernetesClusterDefaultNodePool) Reset() {
	*x = CivoKubernetesClusterDefaultNodePool{}
	mi := &file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CivoKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_civo_civokubernetescluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"5pkg/provider/civo/civokubernetescluster/v1/spec.proto\x126project.planton.provider.civo.civokubernetescluster.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1epkg/provider/civo/region.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xf8\x04\n" +
	...
	"\xbaH\a\xc8\x01\x01*\x02 \x00R\tnodeCountB\xb5\x03\n" +
	":com.project.planton.provider.civo.civokubernetescluster.v1B\tSpecProtoP\x01Zmgithub.com/project-planton/project-planton/pkg/provider/civo/civokubernetescluster/v1;civokubernetesclusterv1\xa2\x02\x05PPPCC\xaa\x026Project.Planton.Provider.Civo.Civokubernetescluster.V1\xca\x026Project\\Planton\\Provider\\Civo\\Civokubernetescluster\\V1\xe2\x02BProject\\Planton\\Provider\\Civo\\Civokubernetescluster\\V1\\GPBMetadata\xea\x02;Project::Planton::Provider::Civo::Civokubernetescluster::V1b\x06proto3"

var (
	file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_init() }
func file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_init() {
	if File_pkg_provider_civo_civokubernetescluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc), len(file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_civokubernetescluster_v1_spec_proto = out.File
	file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_civo_civokubernetescluster_v1_spec_proto_depIdxs = nil
}
