...
// 	protoc        (unknown)
// source: pkg/provider/civo/provider.proto
...
func (x *CivoProviderConfig) Reset() {
	*x = CivoProviderConfig{}
	mi := &file_pkg_provider_civo_provider_proto_msgTypes[0]
...
func (*CivoProviderConfig) Descriptor() ([]byte, []int) {
	return file_pkg_provider_civo_provider_proto_rawDescGZIP(), []int{0}
}
...
var File_pkg_provider_civo_provider_proto protoreflect.FileDescriptor

const file_pkg_provider_civo_provider_proto_rawDesc = "" +
	"\n" +
	" pkg/provider/civo/provider.proto\x12\x1dproject.planton.provider.civo\x1a\x1bbuf/validate/validate.proto\x1a\x1epkg/provider/civo/region.proto\"\xff\x01\n" +
	...
	"\x17object_store_secret_key\x18\x04 \x01(\tR\x14objectStoreSecretKeyB\x88\x02\n" +
	"!com.project.planton.provider.civoB\rProviderProtoP\x01Z<github.com/project-planton/project-planton/pkg/provider/civo\xa2\x02\x04PPPC\xaa\x02\x1dProject.Planton.Provider.Civo\xca\x02\x1dProject\\Planton\\Provider\\Civo\xe2\x02)Project\\Planton\\Provider\\Civo\\GPBMetadata\xea\x02 Project::Planton::Provider::Civob\x06proto3"

var (
	file_pkg_provider_civo_provider_proto_rawDescOnce sync.Once
	file_pkg_provider_civo_provider_proto_rawDescData []byte
)

func file_pkg_provider_civo_provider_proto_rawDescGZIP() []byte {
	file_pkg_provider_civo_provider_proto_rawDescOnce.Do(func() {
		file_pkg_provider_civo_provider_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_provider_proto_rawDesc), len(file_pkg_provider_civo_provider_proto_rawDesc)))
	})
	return file_pkg_provider_civo_provider_proto_rawDescData
}

var file_pkg_provider_civo_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_civo_provider_proto_goTypes = []any{
...
var file_pkg_provider_civo_provider_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_civo_provider_proto_init() }
func file_pkg_provider_civo_provider_proto_init() {
	if File_pkg_provider_civo_provider_proto != nil {
		return
	}
	file_pkg_provider_civo_region_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_civo_provider_proto_rawDesc), len(file_pkg_provider_civo_provider_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_civo_provider_proto_goTypes,
		DependencyIndexes: file_pkg_provider_civo_provider_proto_depIdxs,
		MessageInfos:      file_pkg_provider_civo_provider_proto_msgTypes,
	}.Build()
	File_pkg_provider_civo_provider_proto = out.File
	file_pkg_provider_civo_provider_proto_goTypes = nil
	file_pkg_provider_civo_provider_proto_depIdxs = nil
}
