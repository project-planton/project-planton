...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceanappplatformservice/v1/spec.proto
...
func (DigitalOceanAppPlatformServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanAppPlatformServiceType) Type() protoreflect.EnumType {
	return &file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanAppPlatformServiceType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (DigitalOceanAppPlatformInstanceSize) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[1].Descriptor()
}

func (DigitalOceanAppPlatformInstanceSize) Type() protoreflect.EnumType {
	return &file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes[1]
}
...
func (DigitalOceanAppPlatformInstanceSize) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DigitalOceanAppPlatformServiceSpec) Reset() {
	*x = DigitalOceanAppPlatformServiceSpec{}
	mi := &file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanAppPlatformGitSource) Reset() {
	*x = DigitalOceanAppPlatformGitSource{}
	mi := &file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *DigitalOceanAppPlatformRegistrySource) Reset() {
	*x = DigitalOceanAppPlatformRegistrySource{}
	mi := &file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanAppPlatformRegistrySource) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Fpkg/provider/digitalocean/digitaloceanappplatformservice/v1/spec.proto\x12Gproject.planton.provider.digitalocean.digitaloceanappplatformservice.v1\x1a\x1bbuf/validate/validate.proto\x1a&pkg/provider/digitalocean/region.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xb5\n" +
	"\n" +
	...
	"B\xa5\x04\n" +
	"Kcom.project.planton.provider.digitalocean.digitaloceanappplatformservice.v1B\tSpecProtoP\x01Z\x87\x01github.com/project-planton/project-planton/pkg/provider/digitalocean/digitaloceanappplatformservice/v1;digitaloceanappplatformservicev1\xa2\x02\x05PPPDD\xaa\x02GProject.Planton.Provider.Digitalocean.Digitaloceanappplatformservice.V1\xca\x02GProject\\Planton\\Provider\\Digitalocean\\Digitaloceanappplatformservice\\V1\xe2\x02SProject\\Planton\\Provider\\Digitalocean\\Digitaloceanappplatformservice\\V1\\GPBMetadata\xea\x02LProject::Planton::Provider::Digitalocean::Digitaloceanappplatformservice::V1b\x06proto3"

var (
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_init() }
func file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto = out.File
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceanappplatformservice_v1_spec_proto_depIdxs = nil
}
