...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceankubernetescluster/v1/spec.proto
...
func (x *DigitalOceanKubernetesClusterSpec) Reset() {
	*x = DigitalOceanKubernetesClusterSpec{}
	mi := &file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanKubernetesClusterSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanKubernetesClusterDefaultNodePool) Reset() {
	*x = DigitalOceanKubernetesClusterDefaultNodePool{}
	mi := &file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanKubernetesClusterDefaultNodePool) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Epkg/provider/digitalocean/digitaloceankubernetescluster/v1/spec.proto\x12Fproject.planton.provider.digitalocean.digitaloceankubernetescluster.v1\x1a\x1bbuf/validate/validate.proto\x1a&pkg/provider/digitalocean/region.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\x94\x05\n" +
	...
	"\tmax_nodes\x18\x05 \x01(\rR\bmaxNodesB\x9e\x04\n" +
	"Jcom.project.planton.provider.digitalocean.digitaloceankubernetescluster.v1B\tSpecProtoP\x01Z\x85\x01github.com/project-planton/project-planton/pkg/provider/digitalocean/digitaloceankubernetescluster/v1;digitaloceankubernetesclusterv1\xa2\x02\x05PPPDD\xaa\x02FProject.Planton.Provider.Digitalocean.Digitaloceankubernetescluster.V1\xca\x02FProject\\Planton\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\xe2\x02RProject\\Planton\\Provider\\Digitalocean\\Digitaloceankubernetescluster\\V1\\GPBMetadata\xea\x02KProject::Planton::Provider::Digitalocean::Digitaloceankubernetescluster::V1b\x06proto3"

var (
	file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_init() }
func file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto = out.File
	file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceankubernetescluster_v1_spec_proto_depIdxs = nil
}
