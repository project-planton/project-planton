...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceancertificate/v1/spec.proto
...
func (DigitalOceanCertificateType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes[0].Descriptor()
}

func (DigitalOceanCertificateType) Type() protoreflect.EnumType {
	return &file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes[0]
}
...
func (DigitalOceanCertificateType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanCertificateSpec) Reset() {
	*x = DigitalOceanCertificateSpec{}
	mi := &file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[0]
...
func (x *DigitalOceanCertificateLetsEncryptParams) Reset() {
	*x = DigitalOceanCertificateLetsEncryptParams{}
	mi := &file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanCertificateLetsEncryptParams) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DigitalOceanCertificateCustomParams) Reset() {
	*x = DigitalOceanCertificateCustomParams{}
	mi := &file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanCertificateCustomParams) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc = "" +
	"\n" +
	"?pkg/provider/digitalocean/digitaloceancertificate/v1/spec.proto\x12@project.planton.provider.digitalocean.digitaloceancertificate.v1\x1a\x1bbuf/validate/validate.proto\"\xd0\x04\n" +
	...
	"\n" +
	"\x06custom\x10\x01B\xf3\x03\n" +
	"Dcom.project.planton.provider.digitalocean.digitaloceancertificate.v1B\tSpecProtoP\x01Zygithub.com/project-planton/project-planton/pkg/provider/digitalocean/digitaloceancertificate/v1;digitaloceancertificatev1\xa2\x02\x05PPPDD\xaa\x02@Project.Planton.Provider.Digitalocean.Digitaloceancertificate.V1\xca\x02@Project\\Planton\\Provider\\Digitalocean\\Digitaloceancertificate\\V1\xe2\x02LProject\\Planton\\Provider\\Digitalocean\\Digitaloceancertificate\\V1\\GPBMetadata\xea\x02EProject::Planton::Provider::Digitalocean::Digitaloceancertificate::V1b\x06proto3"

var (
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_init() }
func file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto != nil {
		return
	}
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto = out.File
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceancertificate_v1_spec_proto_depIdxs = nil
}
