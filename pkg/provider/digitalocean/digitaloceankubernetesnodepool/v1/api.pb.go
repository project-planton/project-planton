...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceankubernetesnodepool/v1/api.proto
...
func (x *DigitalOceanKubernetesNodePool) Reset() {
	*x = DigitalOceanKubernetesNodePool{}
	mi := &file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_msgTypes[0]
...
func (*DigitalOceanKubernetesNodePool) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanKubernetesNodePoolStatus) Reset() {
	*x = DigitalOceanKubernetesNodePoolStatus{}
	mi := &file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanKubernetesNodePoolStatus) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDesc = "" +
	"\n" +
	...
	"\x1eDigitalOceanKubernetesNodePoolR\x04kind\x12Q\n" +
	...
	"\aoutputs\x18\x01 \x01(\v2s.project.planton.provider.digitalocean.digitaloceankubernetesnodepool.v1.DigitalOceanKubernetesNodePoolStackOutputsR\aoutputsB\xa4\x04\n" +
...
var (
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_depIdxs = []int32{
	2, // 0: project.planton.provider.digitalocean.digitaloceankubernetesnodepool.v1.DigitalOceanKubernetesNodePool.metadata:type_name -> project.planton.shared.CloudResourceMetadata
...
func init() { file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_init() }
func file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto != nil {
		return
	}
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_spec_proto_init()
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_stack_outputs_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_depIdxs,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto = out.File
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceankubernetesnodepool_v1_api_proto_depIdxs = nil
}
