...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceanfirewall/v1/spec.proto
...
func (x *DigitalOceanFirewallSpec) Reset() {
	*x = DigitalOceanFirewallSpec{}
	mi := &file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanFirewallSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanFirewallInboundRule) Reset() {
	*x = DigitalOceanFirewallInboundRule{}
	mi := &file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanFirewallInboundRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *DigitalOceanFirewallOutboundRule) Reset() {
	*x = DigitalOceanFirewallOutboundRule{}
	mi := &file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanFirewallOutboundRule) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<pkg/provider/digitalocean/digitaloceanfirewall/v1/spec.proto\x12=project.planton.provider.digitalocean.digitaloceanfirewall.v1\"\xf2\x02\n" +
	...
	"\x1edestination_load_balancer_uids\x18\a \x03(\tR\x1bdestinationLoadBalancerUidsB\xde\x03\n" +
	"Acom.project.planton.provider.digitalocean.digitaloceanfirewall.v1B\tSpecProtoP\x01Zsgithub.com/project-planton/project-planton/pkg/provider/digitalocean/digitaloceanfirewall/v1;digitaloceanfirewallv1\xa2\x02\x05PPPDD\xaa\x02=Project.Planton.Provider.Digitalocean.Digitaloceanfirewall.V1\xca\x02=Project\\Planton\\Provider\\Digitalocean\\Digitaloceanfirewall\\V1\xe2\x02IProject\\Planton\\Provider\\Digitalocean\\Digitaloceanfirewall\\V1\\GPBMetadata\xea\x02BProject::Planton::Provider::Digitalocean::Digitaloceanfirewall::V1b\x06proto3"

var (
	file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_init() }
func file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto = out.File
	file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceanfirewall_v1_spec_proto_depIdxs = nil
}
