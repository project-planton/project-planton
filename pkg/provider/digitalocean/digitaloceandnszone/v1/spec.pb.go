...
// 	protoc        (unknown)
// source: pkg/provider/digitalocean/digitaloceandnszone/v1/spec.proto
...
func (x *DigitalOceanDnsZoneSpec) Reset() {
	*x = DigitalOceanDnsZoneSpec{}
	mi := &file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[0]
...
func (*DigitalOceanDnsZoneSpec) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *DigitalOceanDnsZoneRecord) Reset() {
	*x = DigitalOceanDnsZoneRecord{}
	mi := &file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DigitalOceanDnsZoneRecord) Descriptor() ([]byte, []int) {
	return file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	";pkg/provider/digitalocean/digitaloceandnszone/v1/spec.proto\x12<project.planton.provider.digitalocean.digitaloceandnszone.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a?pkg/shared/networking/enums/dnsrecordtype/dns_record_type.proto\x1a pkg/shared/options/options.proto\"\xdb\x01\n" +
	...
	"ttlSeconds\x12`\n" +
	"\x04type\x18\x04 \x01(\x0e2D.project.planton.shared.networking.enums.dnsrecordtype.DnsRecordTypeB\x06\xbaH\x03\xc8\x01\x01R\x04typeB\xd7\x03\n" +
	"@com.project.planton.provider.digitalocean.digitaloceandnszone.v1B\tSpecProtoP\x01Zqgithub.com/project-planton/project-planton/pkg/provider/digitalocean/digitaloceandnszone/v1;digitaloceandnszonev1\xa2\x02\x05PPPDD\xaa\x02<Project.Planton.Provider.Digitalocean.Digitaloceandnszone.V1\xca\x02<Project\\Planton\\Provider\\Digitalocean\\Digitaloceandnszone\\V1\xe2\x02HProject\\Planton\\Provider\\Digitalocean\\Digitaloceandnszone\\V1\\GPBMetadata\xea\x02AProject::Planton::Provider::Digitalocean::Digitaloceandnszone::V1b\x06proto3"

var (
	file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDescData
}

var file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() }
func file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_init() {
	if File_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc), len(file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs,
		MessageInfos:      file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto = out.File
	file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_goTypes = nil
	file_pkg_provider_digitalocean_digitaloceandnszone_v1_spec_proto_depIdxs = nil
}
