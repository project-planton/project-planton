...
// 	protoc        (unknown)
// source: pkg/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/spec.proto

package cloudflarezerotrustaccessapplicationv1

import (
	_ "buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go/buf/validate"
	_ "github.com/project-planton/project-planton/pkg/shared/foreignkey/v1"
...
func (CloudflareZeroTrustPolicyType) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareZeroTrustPolicyType) Type() protoreflect.EnumType {
	return &file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareZeroTrustPolicyType) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudflareZeroTrustAccessApplicationSpec) Reset() {
	*x = CloudflareZeroTrustAccessApplicationSpec{}
	mi := &file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc = "" +
	"\n" +
	"Jpkg/provider/cloudflare/cloudflarezerotrustaccessapplication/v1/spec.proto\x12Kproject.planton.provider.cloudflare.cloudflarezerotrustaccessapplication.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\"\x86\x04\n" +
	...
	"\x05BLOCK\x10\x01B\xc3\x04\n" +
	"Ocom.project.planton.provider.cloudflare.cloudflarezerotrustaccessapplication.v1B\tSpecProtoP\x01Z\x91\x01github.com/project-planton/project-planton/pkg/provider/cloudflare/cloudflarezerotrustaccessapplication/v1;cloudflarezerotrustaccessapplicationv1\xa2\x02\x05PPPCC\xaa\x02KProject.Planton.Provider.Cloudflare.Cloudflarezerotrustaccessapplication.V1\xca\x02KProject\\Planton\\Provider\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1\xe2\x02WProject\\Planton\\Provider\\Cloudflare\\Cloudflarezerotrustaccessapplication\\V1\\GPBMetadata\xea\x02PProject::Planton::Provider::Cloudflare::Cloudflarezerotrustaccessapplication::V1b\x06proto3"

var (
	file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDescData
}

var file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_init() }
func file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_init() {
	if File_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto = out.File
	file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_goTypes = nil
	file_pkg_provider_cloudflare_cloudflarezerotrustaccessapplication_v1_spec_proto_depIdxs = nil
}
