...
// 	protoc        (unknown)
// source: pkg/provider/cloudflare/cloudflarer2bucket/v1/spec.proto
...
func (CloudflareR2Location) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareR2Location) Type() protoreflect.EnumType {
	return &file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareR2Location) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudflareR2BucketSpec) Reset() {
	*x = CloudflareR2BucketSpec{}
	mi := &file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDesc = "" +
	"\n" +
	"8pkg/provider/cloudflare/cloudflarer2bucket/v1/spec.proto\x129project.planton.provider.cloudflare.cloudflarer2bucket.v1\x1a\x1bbuf/validate/validate.proto\"\xf0\x02\n" +
	...
	"\x02OC\x10\x06B\xc4\x03\n" +
	"=com.project.planton.provider.cloudflare.cloudflarer2bucket.v1B\tSpecProtoP\x01Zmgithub.com/project-planton/project-planton/pkg/provider/cloudflare/cloudflarer2bucket/v1;cloudflarer2bucketv1\xa2\x02\x05PPPCC\xaa\x029Project.Planton.Provider.Cloudflare.Cloudflarer2bucket.V1\xca\x029Project\\Planton\\Provider\\Cloudflare\\Cloudflarer2bucket\\V1\xe2\x02EProject\\Planton\\Provider\\Cloudflare\\Cloudflarer2bucket\\V1\\GPBMetadata\xea\x02>Project::Planton::Provider::Cloudflare::Cloudflarer2bucket::V1b\x06proto3"

var (
	file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDescData
}

var file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_init() }
func file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_init() {
	if File_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto = out.File
	file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_goTypes = nil
	file_pkg_provider_cloudflare_cloudflarer2bucket_v1_spec_proto_depIdxs = nil
}
