...
// 	protoc        (unknown)
// source: pkg/provider/cloudflare/cloudflarednszone/v1/spec.proto
...
func (CloudflareDnsZonePlan) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareDnsZonePlan) Type() protoreflect.EnumType {
	return &file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareDnsZonePlan) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudflareDnsZoneSpec) Reset() {
	*x = CloudflareDnsZoneSpec{}
	mi := &file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_msgTypes[0]
...
var File_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDesc = "" +
	"\n" +
	"7pkg/provider/cloudflare/cloudflarednszone/v1/spec.proto\x128project.planton.provider.cloudflare.cloudflarednszone.v1\x1a\x1bbuf/validate/validate.proto\"\xb7\x03\n" +
	...
	"\n" +
	"ENTERPRISE\x10\x03B\xbd\x03\n" +
	"<com.project.planton.provider.cloudflare.cloudflarednszone.v1B\tSpecProtoP\x01Zkgithub.com/project-planton/project-planton/pkg/provider/cloudflare/cloudflarednszone/v1;cloudflarednszonev1\xa2\x02\x05PPPCC\xaa\x028Project.Planton.Provider.Cloudflare.Cloudflarednszone.V1\xca\x028Project\\Planton\\Provider\\Cloudflare\\Cloudflarednszone\\V1\xe2\x02DProject\\Planton\\Provider\\Cloudflare\\Cloudflarednszone\\V1\\GPBMetadata\xea\x02=Project::Planton::Provider::Cloudflare::Cloudflarednszone::V1b\x06proto3"

var (
	file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDescData
}

var file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_init() }
func file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_init() {
	if File_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto = out.File
	file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_goTypes = nil
	file_pkg_provider_cloudflare_cloudflarednszone_v1_spec_proto_depIdxs = nil
}
