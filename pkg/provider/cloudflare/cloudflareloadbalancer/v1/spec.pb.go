...
// 	protoc        (unknown)
// source: pkg/provider/cloudflare/cloudflareloadbalancer/v1/spec.proto
...
func (CloudflareLoadBalancerSessionAffinity) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes[0].Descriptor()
}

func (CloudflareLoadBalancerSessionAffinity) Type() protoreflect.EnumType {
	return &file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes[0]
}
...
func (CloudflareLoadBalancerSessionAffinity) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
func (CloudflareLoadBalancerSteeringPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes[1].Descriptor()
}

func (CloudflareLoadBalancerSteeringPolicy) Type() protoreflect.EnumType {
	return &file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes[1]
}
...
func (CloudflareLoadBalancerSteeringPolicy) EnumDescriptor() ([]byte, []int) {
	return file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescGZIP(), []int{1}
}
...
func (x *CloudflareLoadBalancerSpec) Reset() {
	*x = CloudflareLoadBalancerSpec{}
	mi := &file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_msgTypes[0]
...
func (x *CloudflareLoadBalancerOrigin) Reset() {
	*x = CloudflareLoadBalancerOrigin{}
	mi := &file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto protoreflect.FileDescriptor

const file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDesc = "" +
	"\n" +
	"<pkg/provider/cloudflare/cloudflareloadbalancer/v1/spec.proto\x12=project.planton.provider.cloudflare.cloudflareloadbalancer.v1\x1a\x1bbuf/validate/validate.proto\x1a*pkg/shared/foreignkey/v1/foreign_key.proto\x1a pkg/shared/options/options.proto\"\xb5\x05\n" +
	...
	"\x0fSTEERING_RANDOM\x10\x02B\xe0\x03\n" +
	"Acom.project.planton.provider.cloudflare.cloudflareloadbalancer.v1B\tSpecProtoP\x01Zugithub.com/project-planton/project-planton/pkg/provider/cloudflare/cloudflareloadbalancer/v1;cloudflareloadbalancerv1\xa2\x02\x05PPPCC\xaa\x02=Project.Planton.Provider.Cloudflare.Cloudflareloadbalancer.V1\xca\x02=Project\\Planton\\Provider\\Cloudflare\\Cloudflareloadbalancer\\V1\xe2\x02IProject\\Planton\\Provider\\Cloudflare\\Cloudflareloadbalancer\\V1\\GPBMetadata\xea\x02BProject::Planton::Provider::Cloudflare::Cloudflareloadbalancer::V1b\x06proto3"

var (
	file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescOnce sync.Once
	file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescData []byte
)

func file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescGZIP() []byte {
	file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescOnce.Do(func() {
		file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDesc)))
	})
	return file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDescData
}

var file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_goTypes = []any{
...
var file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_depIdxs = []int32{
...
func init() { file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_init() }
func file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_init() {
	if File_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDesc), len(file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_goTypes,
		DependencyIndexes: file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_depIdxs,
		EnumInfos:         file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_enumTypes,
		MessageInfos:      file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_msgTypes,
	}.Build()
	File_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto = out.File
	file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_goTypes = nil
	file_pkg_provider_cloudflare_cloudflareloadbalancer_v1_spec_proto_depIdxs = nil
}
